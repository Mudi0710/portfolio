(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))n(i);new MutationObserver(i=>{for(const l of i)if(l.type==="childList")for(const o of l.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&n(o)}).observe(document,{childList:!0,subtree:!0});function s(i){const l={};return i.integrity&&(l.integrity=i.integrity),i.referrerPolicy&&(l.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?l.credentials="include":i.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function n(i){if(i.ep)return;i.ep=!0;const l=s(i);fetch(i.href,l)}})();function Hn(e){const t=Object.create(null);for(const s of e.split(","))t[s]=1;return s=>s in t}const de={},Jt=[],rt=()=>{},ul=()=>!1,zs=e=>e.charCodeAt(0)===111&&e.charCodeAt(1)===110&&(e.charCodeAt(2)>122||e.charCodeAt(2)<97),Js=e=>e.startsWith("onUpdate:"),ye=Object.assign,Vn=(e,t)=>{const s=e.indexOf(t);s>-1&&e.splice(s,1)},Ko=Object.prototype.hasOwnProperty,le=(e,t)=>Ko.call(e,t),H=Array.isArray,Qt=e=>Rs(e)==="[object Map]",dl=e=>Rs(e)==="[object Set]",di=e=>Rs(e)==="[object Date]",W=e=>typeof e=="function",he=e=>typeof e=="string",ct=e=>typeof e=="symbol",oe=e=>e!==null&&typeof e=="object",fl=e=>(oe(e)||W(e))&&W(e.then)&&W(e.catch),hl=Object.prototype.toString,Rs=e=>hl.call(e),Wo=e=>Rs(e).slice(8,-1),_l=e=>Rs(e)==="[object Object]",Kn=e=>he(e)&&e!=="NaN"&&e[0]!=="-"&&""+parseInt(e,10)===e,ds=Hn(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),Qs=e=>{const t=Object.create(null);return(s=>t[s]||(t[s]=e(s)))},Go=/-\w/g,$e=Qs(e=>e.replace(Go,t=>t.slice(1).toUpperCase())),qo=/\B([A-Z])/g,Ft=Qs(e=>e.replace(qo,"-$1").toLowerCase()),Ys=Qs(e=>e.charAt(0).toUpperCase()+e.slice(1)),pn=Qs(e=>e?`on${Ys(e)}`:""),ot=(e,t)=>!Object.is(e,t),un=(e,...t)=>{for(let s=0;s<e.length;s++)e[s](...t)},gl=(e,t,s,n=!1)=>{Object.defineProperty(e,t,{configurable:!0,enumerable:!1,writable:n,value:s})},Xo=e=>{const t=parseFloat(e);return isNaN(t)?e:t},zo=e=>{const t=he(e)?Number(e):NaN;return isNaN(t)?e:t};let fi;const Zs=()=>fi||(fi=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});function Wn(e){if(H(e)){const t={};for(let s=0;s<e.length;s++){const n=e[s],i=he(n)?Zo(n):Wn(n);if(i)for(const l in i)t[l]=i[l]}return t}else if(he(e)||oe(e))return e}const Jo=/;(?![^(]*\))/g,Qo=/:([^]+)/,Yo=/\/\*[^]*?\*\//g;function Zo(e){const t={};return e.replace(Yo,"").split(Jo).forEach(s=>{if(s){const n=s.split(Qo);n.length>1&&(t[n[0].trim()]=n[1].trim())}}),t}function We(e){let t="";if(he(e))t=e;else if(H(e))for(let s=0;s<e.length;s++){const n=We(e[s]);n&&(t+=n+" ")}else if(oe(e))for(const s in e)e[s]&&(t+=s+" ");return t.trim()}const er="itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly",tr=Hn(er);function ml(e){return!!e||e===""}function sr(e,t){if(e.length!==t.length)return!1;let s=!0;for(let n=0;s&&n<e.length;n++)s=Gn(e[n],t[n]);return s}function Gn(e,t){if(e===t)return!0;let s=di(e),n=di(t);if(s||n)return s&&n?e.getTime()===t.getTime():!1;if(s=ct(e),n=ct(t),s||n)return e===t;if(s=H(e),n=H(t),s||n)return s&&n?sr(e,t):!1;if(s=oe(e),n=oe(t),s||n){if(!s||!n)return!1;const i=Object.keys(e).length,l=Object.keys(t).length;if(i!==l)return!1;for(const o in e){const r=e.hasOwnProperty(o),a=t.hasOwnProperty(o);if(r&&!a||!r&&a||!Gn(e[o],t[o]))return!1}}return String(e)===String(t)}const vl=e=>!!(e&&e.__v_isRef===!0),J=e=>he(e)?e:e==null?"":H(e)||oe(e)&&(e.toString===hl||!W(e.toString))?vl(e)?J(e.value):JSON.stringify(e,bl,2):String(e),bl=(e,t)=>vl(t)?bl(e,t.value):Qt(t)?{[`Map(${t.size})`]:[...t.entries()].reduce((s,[n,i],l)=>(s[dn(n,l)+" =>"]=i,s),{})}:dl(t)?{[`Set(${t.size})`]:[...t.values()].map(s=>dn(s))}:ct(t)?dn(t):oe(t)&&!H(t)&&!_l(t)?String(t):t,dn=(e,t="")=>{var s;return ct(e)?`Symbol(${(s=e.description)!=null?s:t})`:e};let Ue;class nr{constructor(t=!1){this.detached=t,this._active=!0,this._on=0,this.effects=[],this.cleanups=[],this._isPaused=!1,this.__v_skip=!0,this.parent=Ue,!t&&Ue&&(this.index=(Ue.scopes||(Ue.scopes=[])).push(this)-1)}get active(){return this._active}pause(){if(this._active){this._isPaused=!0;let t,s;if(this.scopes)for(t=0,s=this.scopes.length;t<s;t++)this.scopes[t].pause();for(t=0,s=this.effects.length;t<s;t++)this.effects[t].pause()}}resume(){if(this._active&&this._isPaused){this._isPaused=!1;let t,s;if(this.scopes)for(t=0,s=this.scopes.length;t<s;t++)this.scopes[t].resume();for(t=0,s=this.effects.length;t<s;t++)this.effects[t].resume()}}run(t){if(this._active){const s=Ue;try{return Ue=this,t()}finally{Ue=s}}}on(){++this._on===1&&(this.prevScope=Ue,Ue=this)}off(){this._on>0&&--this._on===0&&(Ue=this.prevScope,this.prevScope=void 0)}stop(t){if(this._active){this._active=!1;let s,n;for(s=0,n=this.effects.length;s<n;s++)this.effects[s].stop();for(this.effects.length=0,s=0,n=this.cleanups.length;s<n;s++)this.cleanups[s]();if(this.cleanups.length=0,this.scopes){for(s=0,n=this.scopes.length;s<n;s++)this.scopes[s].stop(!0);this.scopes.length=0}if(!this.detached&&this.parent&&!t){const i=this.parent.scopes.pop();i&&i!==this&&(this.parent.scopes[this.index]=i,i.index=this.index)}this.parent=void 0}}}function ir(){return Ue}let ue;const fn=new WeakSet;class yl{constructor(t){this.fn=t,this.deps=void 0,this.depsTail=void 0,this.flags=5,this.next=void 0,this.cleanup=void 0,this.scheduler=void 0,Ue&&Ue.active&&Ue.effects.push(this)}pause(){this.flags|=64}resume(){this.flags&64&&(this.flags&=-65,fn.has(this)&&(fn.delete(this),this.trigger()))}notify(){this.flags&2&&!(this.flags&32)||this.flags&8||Sl(this)}run(){if(!(this.flags&1))return this.fn();this.flags|=2,hi(this),El(this);const t=ue,s=qe;ue=this,qe=!0;try{return this.fn()}finally{Cl(this),ue=t,qe=s,this.flags&=-3}}stop(){if(this.flags&1){for(let t=this.deps;t;t=t.nextDep)zn(t);this.deps=this.depsTail=void 0,hi(this),this.onStop&&this.onStop(),this.flags&=-2}}trigger(){this.flags&64?fn.add(this):this.scheduler?this.scheduler():this.runIfDirty()}runIfDirty(){In(this)&&this.run()}get dirty(){return In(this)}}let Al=0,fs,hs;function Sl(e,t=!1){if(e.flags|=8,t){e.next=hs,hs=e;return}e.next=fs,fs=e}function qn(){Al++}function Xn(){if(--Al>0)return;if(hs){let t=hs;for(hs=void 0;t;){const s=t.next;t.next=void 0,t.flags&=-9,t=s}}let e;for(;fs;){let t=fs;for(fs=void 0;t;){const s=t.next;if(t.next=void 0,t.flags&=-9,t.flags&1)try{t.trigger()}catch(n){e||(e=n)}t=s}}if(e)throw e}function El(e){for(let t=e.deps;t;t=t.nextDep)t.version=-1,t.prevActiveLink=t.dep.activeLink,t.dep.activeLink=t}function Cl(e){let t,s=e.depsTail,n=s;for(;n;){const i=n.prevDep;n.version===-1?(n===s&&(s=i),zn(n),lr(n)):t=n,n.dep.activeLink=n.prevActiveLink,n.prevActiveLink=void 0,n=i}e.deps=t,e.depsTail=s}function In(e){for(let t=e.deps;t;t=t.nextDep)if(t.dep.version!==t.version||t.dep.computed&&(xl(t.dep.computed)||t.dep.version!==t.version))return!0;return!!e._dirty}function xl(e){if(e.flags&4&&!(e.flags&16)||(e.flags&=-17,e.globalVersion===As)||(e.globalVersion=As,!e.isSSR&&e.flags&128&&(!e.deps&&!e._dirty||!In(e))))return;e.flags|=2;const t=e.dep,s=ue,n=qe;ue=e,qe=!0;try{El(e);const i=e.fn(e._value);(t.version===0||ot(i,e._value))&&(e.flags|=128,e._value=i,t.version++)}catch(i){throw t.version++,i}finally{ue=s,qe=n,Cl(e),e.flags&=-3}}function zn(e,t=!1){const{dep:s,prevSub:n,nextSub:i}=e;if(n&&(n.nextSub=i,e.prevSub=void 0),i&&(i.prevSub=n,e.nextSub=void 0),s.subs===e&&(s.subs=n,!n&&s.computed)){s.computed.flags&=-5;for(let l=s.computed.deps;l;l=l.nextDep)zn(l,!0)}!t&&!--s.sc&&s.map&&s.map.delete(s.key)}function lr(e){const{prevDep:t,nextDep:s}=e;t&&(t.nextDep=s,e.prevDep=void 0),s&&(s.prevDep=t,e.nextDep=void 0)}let qe=!0;const Il=[];function vt(){Il.push(qe),qe=!1}function bt(){const e=Il.pop();qe=e===void 0?!0:e}function hi(e){const{cleanup:t}=e;if(e.cleanup=void 0,t){const s=ue;ue=void 0;try{t()}finally{ue=s}}}let As=0;class or{constructor(t,s){this.sub=t,this.dep=s,this.version=s.version,this.nextDep=this.prevDep=this.nextSub=this.prevSub=this.prevActiveLink=void 0}}class Jn{constructor(t){this.computed=t,this.version=0,this.activeLink=void 0,this.subs=void 0,this.map=void 0,this.key=void 0,this.sc=0,this.__v_skip=!0}track(t){if(!ue||!qe||ue===this.computed)return;let s=this.activeLink;if(s===void 0||s.sub!==ue)s=this.activeLink=new or(ue,this),ue.deps?(s.prevDep=ue.depsTail,ue.depsTail.nextDep=s,ue.depsTail=s):ue.deps=ue.depsTail=s,wl(s);else if(s.version===-1&&(s.version=this.version,s.nextDep)){const n=s.nextDep;n.prevDep=s.prevDep,s.prevDep&&(s.prevDep.nextDep=n),s.prevDep=ue.depsTail,s.nextDep=void 0,ue.depsTail.nextDep=s,ue.depsTail=s,ue.deps===s&&(ue.deps=n)}return s}trigger(t){this.version++,As++,this.notify(t)}notify(t){qn();try{for(let s=this.subs;s;s=s.prevSub)s.sub.notify()&&s.sub.dep.notify()}finally{Xn()}}}function wl(e){if(e.dep.sc++,e.sub.flags&4){const t=e.dep.computed;if(t&&!e.dep.subs){t.flags|=20;for(let n=t.deps;n;n=n.nextDep)wl(n)}const s=e.dep.subs;s!==e&&(e.prevSub=s,s&&(s.nextSub=e)),e.dep.subs=e}}const wn=new WeakMap,kt=Symbol(""),Pn=Symbol(""),Ss=Symbol("");function xe(e,t,s){if(qe&&ue){let n=wn.get(e);n||wn.set(e,n=new Map);let i=n.get(s);i||(n.set(s,i=new Jn),i.map=n,i.key=s),i.track()}}function gt(e,t,s,n,i,l){const o=wn.get(e);if(!o){As++;return}const r=a=>{a&&a.trigger()};if(qn(),t==="clear")o.forEach(r);else{const a=H(e),d=a&&Kn(s);if(a&&s==="length"){const c=Number(n);o.forEach((p,h)=>{(h==="length"||h===Ss||!ct(h)&&h>=c)&&r(p)})}else switch((s!==void 0||o.has(void 0))&&r(o.get(s)),d&&r(o.get(Ss)),t){case"add":a?d&&r(o.get("length")):(r(o.get(kt)),Qt(e)&&r(o.get(Pn)));break;case"delete":a||(r(o.get(kt)),Qt(e)&&r(o.get(Pn)));break;case"set":Qt(e)&&r(o.get(kt));break}}Xn()}function Gt(e){const t=te(e);return t===e?t:(xe(t,"iterate",Ss),Ke(e)?t:t.map(Xe))}function en(e){return xe(e=te(e),"iterate",Ss),e}function it(e,t){return yt(e)?ts(Lt(e)?Xe(t):t):Xe(t)}const rr={__proto__:null,[Symbol.iterator](){return hn(this,Symbol.iterator,e=>it(this,e))},concat(...e){return Gt(this).concat(...e.map(t=>H(t)?Gt(t):t))},entries(){return hn(this,"entries",e=>(e[1]=it(this,e[1]),e))},every(e,t){return ut(this,"every",e,t,void 0,arguments)},filter(e,t){return ut(this,"filter",e,t,s=>s.map(n=>it(this,n)),arguments)},find(e,t){return ut(this,"find",e,t,s=>it(this,s),arguments)},findIndex(e,t){return ut(this,"findIndex",e,t,void 0,arguments)},findLast(e,t){return ut(this,"findLast",e,t,s=>it(this,s),arguments)},findLastIndex(e,t){return ut(this,"findLastIndex",e,t,void 0,arguments)},forEach(e,t){return ut(this,"forEach",e,t,void 0,arguments)},includes(...e){return _n(this,"includes",e)},indexOf(...e){return _n(this,"indexOf",e)},join(e){return Gt(this).join(e)},lastIndexOf(...e){return _n(this,"lastIndexOf",e)},map(e,t){return ut(this,"map",e,t,void 0,arguments)},pop(){return rs(this,"pop")},push(...e){return rs(this,"push",e)},reduce(e,...t){return _i(this,"reduce",e,t)},reduceRight(e,...t){return _i(this,"reduceRight",e,t)},shift(){return rs(this,"shift")},some(e,t){return ut(this,"some",e,t,void 0,arguments)},splice(...e){return rs(this,"splice",e)},toReversed(){return Gt(this).toReversed()},toSorted(e){return Gt(this).toSorted(e)},toSpliced(...e){return Gt(this).toSpliced(...e)},unshift(...e){return rs(this,"unshift",e)},values(){return hn(this,"values",e=>it(this,e))}};function hn(e,t,s){const n=en(e),i=n[t]();return n!==e&&!Ke(e)&&(i._next=i.next,i.next=()=>{const l=i._next();return l.done||(l.value=s(l.value)),l}),i}const ar=Array.prototype;function ut(e,t,s,n,i,l){const o=en(e),r=o!==e&&!Ke(e),a=o[t];if(a!==ar[t]){const p=a.apply(e,l);return r?Xe(p):p}let d=s;o!==e&&(r?d=function(p,h){return s.call(this,it(e,p),h,e)}:s.length>2&&(d=function(p,h){return s.call(this,p,h,e)}));const c=a.call(o,d,n);return r&&i?i(c):c}function _i(e,t,s,n){const i=en(e),l=i!==e&&!Ke(e);let o=s,r=!1;i!==e&&(l?(r=n.length===0,o=function(d,c,p){return r&&(r=!1,d=it(e,d)),s.call(this,d,it(e,c),p,e)}):s.length>3&&(o=function(d,c,p){return s.call(this,d,c,p,e)}));const a=i[t](o,...n);return r?it(e,a):a}function _n(e,t,s){const n=te(e);xe(n,"iterate",Ss);const i=n[t](...s);return(i===-1||i===!1)&&Zn(s[0])?(s[0]=te(s[0]),n[t](...s)):i}function rs(e,t,s=[]){vt(),qn();const n=te(e)[t].apply(e,s);return Xn(),bt(),n}const cr=Hn("__proto__,__v_isRef,__isVue"),Pl=new Set(Object.getOwnPropertyNames(Symbol).filter(e=>e!=="arguments"&&e!=="caller").map(e=>Symbol[e]).filter(ct));function pr(e){ct(e)||(e=String(e));const t=te(this);return xe(t,"has",e),t.hasOwnProperty(e)}class Rl{constructor(t=!1,s=!1){this._isReadonly=t,this._isShallow=s}get(t,s,n){if(s==="__v_skip")return t.__v_skip;const i=this._isReadonly,l=this._isShallow;if(s==="__v_isReactive")return!i;if(s==="__v_isReadonly")return i;if(s==="__v_isShallow")return l;if(s==="__v_raw")return n===(i?l?yr:Ml:l?Ol:jl).get(t)||Object.getPrototypeOf(t)===Object.getPrototypeOf(n)?t:void 0;const o=H(t);if(!i){let a;if(o&&(a=rr[s]))return a;if(s==="hasOwnProperty")return pr}const r=Reflect.get(t,s,we(t)?t:n);if((ct(s)?Pl.has(s):cr(s))||(i||xe(t,"get",s),l))return r;if(we(r)){const a=o&&Kn(s)?r:r.value;return i&&oe(a)?Tn(a):a}return oe(r)?i?Tn(r):tn(r):r}}class Tl extends Rl{constructor(t=!1){super(!1,t)}set(t,s,n,i){let l=t[s];const o=H(t)&&Kn(s);if(!this._isShallow){const d=yt(l);if(!Ke(n)&&!yt(n)&&(l=te(l),n=te(n)),!o&&we(l)&&!we(n))return d||(l.value=n),!0}const r=o?Number(s)<t.length:le(t,s),a=Reflect.set(t,s,n,we(t)?t:i);return t===te(i)&&(r?ot(n,l)&&gt(t,"set",s,n):gt(t,"add",s,n)),a}deleteProperty(t,s){const n=le(t,s);t[s];const i=Reflect.deleteProperty(t,s);return i&&n&&gt(t,"delete",s,void 0),i}has(t,s){const n=Reflect.has(t,s);return(!ct(s)||!Pl.has(s))&&xe(t,"has",s),n}ownKeys(t){return xe(t,"iterate",H(t)?"length":kt),Reflect.ownKeys(t)}}class ur extends Rl{constructor(t=!1){super(!0,t)}set(t,s){return!0}deleteProperty(t,s){return!0}}const dr=new Tl,fr=new ur,hr=new Tl(!0);const Rn=e=>e,Os=e=>Reflect.getPrototypeOf(e);function _r(e,t,s){return function(...n){const i=this.__v_raw,l=te(i),o=Qt(l),r=e==="entries"||e===Symbol.iterator&&o,a=e==="keys"&&o,d=i[e](...n),c=s?Rn:t?ts:Xe;return!t&&xe(l,"iterate",a?Pn:kt),ye(Object.create(d),{next(){const{value:p,done:h}=d.next();return h?{value:p,done:h}:{value:r?[c(p[0]),c(p[1])]:c(p),done:h}}})}}function Ms(e){return function(...t){return e==="delete"?!1:e==="clear"?void 0:this}}function gr(e,t){const s={get(i){const l=this.__v_raw,o=te(l),r=te(i);e||(ot(i,r)&&xe(o,"get",i),xe(o,"get",r));const{has:a}=Os(o),d=t?Rn:e?ts:Xe;if(a.call(o,i))return d(l.get(i));if(a.call(o,r))return d(l.get(r));l!==o&&l.get(i)},get size(){const i=this.__v_raw;return!e&&xe(te(i),"iterate",kt),i.size},has(i){const l=this.__v_raw,o=te(l),r=te(i);return e||(ot(i,r)&&xe(o,"has",i),xe(o,"has",r)),i===r?l.has(i):l.has(i)||l.has(r)},forEach(i,l){const o=this,r=o.__v_raw,a=te(r),d=t?Rn:e?ts:Xe;return!e&&xe(a,"iterate",kt),r.forEach((c,p)=>i.call(l,d(c),d(p),o))}};return ye(s,e?{add:Ms("add"),set:Ms("set"),delete:Ms("delete"),clear:Ms("clear")}:{add(i){const l=te(this),o=Os(l),r=te(i),a=!t&&!Ke(i)&&!yt(i)?r:i;return o.has.call(l,a)||ot(i,a)&&o.has.call(l,i)||ot(r,a)&&o.has.call(l,r)||(l.add(a),gt(l,"add",a,a)),this},set(i,l){!t&&!Ke(l)&&!yt(l)&&(l=te(l));const o=te(this),{has:r,get:a}=Os(o);let d=r.call(o,i);d||(i=te(i),d=r.call(o,i));const c=a.call(o,i);return o.set(i,l),d?ot(l,c)&&gt(o,"set",i,l):gt(o,"add",i,l),this},delete(i){const l=te(this),{has:o,get:r}=Os(l);let a=o.call(l,i);a||(i=te(i),a=o.call(l,i)),r&&r.call(l,i);const d=l.delete(i);return a&&gt(l,"delete",i,void 0),d},clear(){const i=te(this),l=i.size!==0,o=i.clear();return l&&gt(i,"clear",void 0,void 0),o}}),["keys","values","entries",Symbol.iterator].forEach(i=>{s[i]=_r(i,e,t)}),s}function Qn(e,t){const s=gr(e,t);return(n,i,l)=>i==="__v_isReactive"?!e:i==="__v_isReadonly"?e:i==="__v_raw"?n:Reflect.get(le(s,i)&&i in n?s:n,i,l)}const mr={get:Qn(!1,!1)},vr={get:Qn(!1,!0)},br={get:Qn(!0,!1)};const jl=new WeakMap,Ol=new WeakMap,Ml=new WeakMap,yr=new WeakMap;function Ar(e){switch(e){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function Sr(e){return e.__v_skip||!Object.isExtensible(e)?0:Ar(Wo(e))}function tn(e){return yt(e)?e:Yn(e,!1,dr,mr,jl)}function $l(e){return Yn(e,!1,hr,vr,Ol)}function Tn(e){return Yn(e,!0,fr,br,Ml)}function Yn(e,t,s,n,i){if(!oe(e)||e.__v_raw&&!(t&&e.__v_isReactive))return e;const l=Sr(e);if(l===0)return e;const o=i.get(e);if(o)return o;const r=new Proxy(e,l===2?n:s);return i.set(e,r),r}function Lt(e){return yt(e)?Lt(e.__v_raw):!!(e&&e.__v_isReactive)}function yt(e){return!!(e&&e.__v_isReadonly)}function Ke(e){return!!(e&&e.__v_isShallow)}function Zn(e){return e?!!e.__v_raw:!1}function te(e){const t=e&&e.__v_raw;return t?te(t):e}function Er(e){return!le(e,"__v_skip")&&Object.isExtensible(e)&&gl(e,"__v_skip",!0),e}const Xe=e=>oe(e)?tn(e):e,ts=e=>oe(e)?Tn(e):e;function we(e){return e?e.__v_isRef===!0:!1}function Me(e){return Dl(e,!1)}function Cr(e){return Dl(e,!0)}function Dl(e,t){return we(e)?e:new xr(e,t)}class xr{constructor(t,s){this.dep=new Jn,this.__v_isRef=!0,this.__v_isShallow=!1,this._rawValue=s?t:te(t),this._value=s?t:Xe(t),this.__v_isShallow=s}get value(){return this.dep.track(),this._value}set value(t){const s=this._rawValue,n=this.__v_isShallow||Ke(t)||yt(t);t=n?t:te(t),ot(t,s)&&(this._rawValue=t,this._value=n?t:Xe(t),this.dep.trigger())}}function Ce(e){return we(e)?e.value:e}const Ir={get:(e,t,s)=>t==="__v_raw"?e:Ce(Reflect.get(e,t,s)),set:(e,t,s,n)=>{const i=e[t];return we(i)&&!we(s)?(i.value=s,!0):Reflect.set(e,t,s,n)}};function Nl(e){return Lt(e)?e:new Proxy(e,Ir)}class wr{constructor(t,s,n){this.fn=t,this.setter=s,this._value=void 0,this.dep=new Jn(this),this.__v_isRef=!0,this.deps=void 0,this.depsTail=void 0,this.flags=16,this.globalVersion=As-1,this.next=void 0,this.effect=this,this.__v_isReadonly=!s,this.isSSR=n}notify(){if(this.flags|=16,!(this.flags&8)&&ue!==this)return Sl(this,!0),!0}get value(){const t=this.dep.track();return xl(this),t&&(t.version=this.dep.version),this._value}set value(t){this.setter&&this.setter(t)}}function Pr(e,t,s=!1){let n,i;return W(e)?n=e:(n=e.get,i=e.set),new wr(n,i,s)}const $s={},Bs=new WeakMap;let Dt;function Rr(e,t=!1,s=Dt){if(s){let n=Bs.get(s);n||Bs.set(s,n=[]),n.push(e)}}function Tr(e,t,s=de){const{immediate:n,deep:i,once:l,scheduler:o,augmentJob:r,call:a}=s,d=j=>i?j:Ke(j)||i===!1||i===0?wt(j,1):wt(j);let c,p,h,_,C=!1,E=!1;if(we(e)?(p=()=>e.value,C=Ke(e)):Lt(e)?(p=()=>d(e),C=!0):H(e)?(E=!0,C=e.some(j=>Lt(j)||Ke(j)),p=()=>e.map(j=>{if(we(j))return j.value;if(Lt(j))return d(j);if(W(j))return a?a(j,2):j()})):W(e)?t?p=a?()=>a(e,2):e:p=()=>{if(h){vt();try{h()}finally{bt()}}const j=Dt;Dt=c;try{return a?a(e,3,[_]):e(_)}finally{Dt=j}}:p=rt,t&&i){const j=p,G=i===!0?1/0:i;p=()=>wt(j(),G)}const M=ir(),w=()=>{c.stop(),M&&M.active&&Vn(M.effects,c)};if(l&&t){const j=t;t=(...G)=>{j(...G),w()}}let x=E?new Array(e.length).fill($s):$s;const $=j=>{if(!(!(c.flags&1)||!c.dirty&&!j))if(t){const G=c.run();if(i||C||(E?G.some((Y,Q)=>ot(Y,x[Q])):ot(G,x))){h&&h();const Y=Dt;Dt=c;try{const Q=[G,x===$s?void 0:E&&x[0]===$s?[]:x,_];x=G,a?a(t,3,Q):t(...Q)}finally{Dt=Y}}}else c.run()};return r&&r($),c=new yl(p),c.scheduler=o?()=>o($,!1):$,_=j=>Rr(j,!1,c),h=c.onStop=()=>{const j=Bs.get(c);if(j){if(a)a(j,4);else for(const G of j)G();Bs.delete(c)}},t?n?$(!0):x=c.run():o?o($.bind(null,!0),!0):c.run(),w.pause=c.pause.bind(c),w.resume=c.resume.bind(c),w.stop=w,w}function wt(e,t=1/0,s){if(t<=0||!oe(e)||e.__v_skip||(s=s||new Map,(s.get(e)||0)>=t))return e;if(s.set(e,t),t--,we(e))wt(e.value,t,s);else if(H(e))for(let n=0;n<e.length;n++)wt(e[n],t,s);else if(dl(e)||Qt(e))e.forEach(n=>{wt(n,t,s)});else if(_l(e)){for(const n in e)wt(e[n],t,s);for(const n of Object.getOwnPropertySymbols(e))Object.prototype.propertyIsEnumerable.call(e,n)&&wt(e[n],t,s)}return e}function Ts(e,t,s,n){try{return n?e(...n):e()}catch(i){sn(i,t,s)}}function ze(e,t,s,n){if(W(e)){const i=Ts(e,t,s,n);return i&&fl(i)&&i.catch(l=>{sn(l,t,s)}),i}if(H(e)){const i=[];for(let l=0;l<e.length;l++)i.push(ze(e[l],t,s,n));return i}}function sn(e,t,s,n=!0){const i=t?t.vnode:null,{errorHandler:l,throwUnhandledErrorInProduction:o}=t&&t.appContext.config||de;if(t){let r=t.parent;const a=t.proxy,d=`https://vuejs.org/error-reference/#runtime-${s}`;for(;r;){const c=r.ec;if(c){for(let p=0;p<c.length;p++)if(c[p](e,a,d)===!1)return}r=r.parent}if(l){vt(),Ts(l,null,10,[e,a,d]),bt();return}}jr(e,s,i,n,o)}function jr(e,t,s,n=!0,i=!1){if(i)throw e;console.error(e)}const Te=[];let st=-1;const Yt=[];let xt=null,qt=0;const Ul=Promise.resolve();let Fs=null;function ss(e){const t=Fs||Ul;return e?t.then(this?e.bind(this):e):t}function Or(e){let t=st+1,s=Te.length;for(;t<s;){const n=t+s>>>1,i=Te[n],l=Es(i);l<e||l===e&&i.flags&2?t=n+1:s=n}return t}function ei(e){if(!(e.flags&1)){const t=Es(e),s=Te[Te.length-1];!s||!(e.flags&2)&&t>=Es(s)?Te.push(e):Te.splice(Or(t),0,e),e.flags|=1,kl()}}function kl(){Fs||(Fs=Ul.then(Bl))}function Mr(e){H(e)?Yt.push(...e):xt&&e.id===-1?xt.splice(qt+1,0,e):e.flags&1||(Yt.push(e),e.flags|=1),kl()}function gi(e,t,s=st+1){for(;s<Te.length;s++){const n=Te[s];if(n&&n.flags&2){if(e&&n.id!==e.uid)continue;Te.splice(s,1),s--,n.flags&4&&(n.flags&=-2),n(),n.flags&4||(n.flags&=-2)}}}function Ll(e){if(Yt.length){const t=[...new Set(Yt)].sort((s,n)=>Es(s)-Es(n));if(Yt.length=0,xt){xt.push(...t);return}for(xt=t,qt=0;qt<xt.length;qt++){const s=xt[qt];s.flags&4&&(s.flags&=-2),s.flags&8||s(),s.flags&=-2}xt=null,qt=0}}const Es=e=>e.id==null?e.flags&2?-1:1/0:e.id;function Bl(e){try{for(st=0;st<Te.length;st++){const t=Te[st];t&&!(t.flags&8)&&(t.flags&4&&(t.flags&=-2),Ts(t,t.i,t.i?15:14),t.flags&4||(t.flags&=-2))}}finally{for(;st<Te.length;st++){const t=Te[st];t&&(t.flags&=-2)}st=-1,Te.length=0,Ll(),Fs=null,(Te.length||Yt.length)&&Bl()}}let Ge=null,Fl=null;function Hs(e){const t=Ge;return Ge=e,Fl=e&&e.type.__scopeId||null,t}function ge(e,t=Ge,s){if(!t||e._n)return e;const n=(...i)=>{n._d&&Ws(-1);const l=Hs(t);let o;try{o=e(...i)}finally{Hs(l),n._d&&Ws(1)}return o};return n._n=!0,n._c=!0,n._d=!0,n}function jt(e,t,s,n){const i=e.dirs,l=t&&t.dirs;for(let o=0;o<i.length;o++){const r=i[o];l&&(r.oldValue=l[o].value);let a=r.dir[n];a&&(vt(),ze(a,s,8,[e.el,r,e,t]),bt())}}function Ds(e,t){if(Ie){let s=Ie.provides;const n=Ie.parent&&Ie.parent.provides;n===s&&(s=Ie.provides=Object.create(n)),s[e]=t}}function at(e,t,s=!1){const n=Co();if(n||Zt){let i=Zt?Zt._context.provides:n?n.parent==null||n.ce?n.vnode.appContext&&n.vnode.appContext.provides:n.parent.provides:void 0;if(i&&e in i)return i[e];if(arguments.length>1)return s&&W(t)?t.call(n&&n.proxy):t}}const $r=Symbol.for("v-scx"),Dr=()=>at($r);function Bt(e,t,s){return Hl(e,t,s)}function Hl(e,t,s=de){const{immediate:n,deep:i,flush:l,once:o}=s,r=ye({},s),a=t&&n||!t&&l!=="post";let d;if(Is){if(l==="sync"){const _=Dr();d=_.__watcherHandles||(_.__watcherHandles=[])}else if(!a){const _=()=>{};return _.stop=rt,_.resume=rt,_.pause=rt,_}}const c=Ie;r.call=(_,C,E)=>ze(_,c,C,E);let p=!1;l==="post"?r.scheduler=_=>{Ne(_,c&&c.suspense)}:l!=="sync"&&(p=!0,r.scheduler=(_,C)=>{C?_():ei(_)}),r.augmentJob=_=>{t&&(_.flags|=4),p&&(_.flags|=2,c&&(_.id=c.uid,_.i=c))};const h=Tr(e,t,r);return Is&&(d?d.push(h):a&&h()),h}function Nr(e,t,s){const n=this.proxy,i=he(e)?e.includes(".")?Vl(n,e):()=>n[e]:e.bind(n,n);let l;W(t)?l=t:(l=t.handler,s=t);const o=js(this),r=Hl(i,l.bind(n),s);return o(),r}function Vl(e,t){const s=t.split(".");return()=>{let n=e;for(let i=0;i<s.length&&n;i++)n=n[s[i]];return n}}const Ur=Symbol("_vte"),Kl=e=>e.__isTeleport,nt=Symbol("_leaveCb"),as=Symbol("_enterCb");function kr(){const e={isMounted:!1,isLeaving:!1,isUnmounting:!1,leavingVNodes:new Map};return Ht(()=>{e.isMounted=!0}),Zl(()=>{e.isUnmounting=!0}),e}const Ve=[Function,Array],Wl={mode:String,appear:Boolean,persisted:Boolean,onBeforeEnter:Ve,onEnter:Ve,onAfterEnter:Ve,onEnterCancelled:Ve,onBeforeLeave:Ve,onLeave:Ve,onAfterLeave:Ve,onLeaveCancelled:Ve,onBeforeAppear:Ve,onAppear:Ve,onAfterAppear:Ve,onAppearCancelled:Ve},Gl=e=>{const t=e.subTree;return t.component?Gl(t.component):t},Lr={name:"BaseTransition",props:Wl,setup(e,{slots:t}){const s=Co(),n=kr();return()=>{const i=t.default&&zl(t.default(),!0);if(!i||!i.length)return;const l=ql(i),o=te(e),{mode:r}=o;if(n.isLeaving)return gn(l);const a=mi(l);if(!a)return gn(l);let d=jn(a,o,n,s,p=>d=p);a.type!==je&&Cs(a,d);let c=s.subTree&&mi(s.subTree);if(c&&c.type!==je&&!Nt(c,a)&&Gl(s).type!==je){let p=jn(c,o,n,s);if(Cs(c,p),r==="out-in"&&a.type!==je)return n.isLeaving=!0,p.afterLeave=()=>{n.isLeaving=!1,s.job.flags&8||s.update(),delete p.afterLeave,c=void 0},gn(l);r==="in-out"&&a.type!==je?p.delayLeave=(h,_,C)=>{const E=Xl(n,c);E[String(c.key)]=c,h[nt]=()=>{_(),h[nt]=void 0,delete d.delayedLeave,c=void 0},d.delayedLeave=()=>{C(),delete d.delayedLeave,c=void 0}}:c=void 0}else c&&(c=void 0);return l}}};function ql(e){let t=e[0];if(e.length>1){for(const s of e)if(s.type!==je){t=s;break}}return t}const Br=Lr;function Xl(e,t){const{leavingVNodes:s}=e;let n=s.get(t.type);return n||(n=Object.create(null),s.set(t.type,n)),n}function jn(e,t,s,n,i){const{appear:l,mode:o,persisted:r=!1,onBeforeEnter:a,onEnter:d,onAfterEnter:c,onEnterCancelled:p,onBeforeLeave:h,onLeave:_,onAfterLeave:C,onLeaveCancelled:E,onBeforeAppear:M,onAppear:w,onAfterAppear:x,onAppearCancelled:$}=t,j=String(e.key),G=Xl(s,e),Y=(V,X)=>{V&&ze(V,n,9,X)},Q=(V,X)=>{const re=X[1];Y(V,X),H(V)?V.every(D=>D.length<=1)&&re():V.length<=1&&re()},Ae={mode:o,persisted:r,beforeEnter(V){let X=a;if(!s.isMounted)if(l)X=M||a;else return;V[nt]&&V[nt](!0);const re=G[j];re&&Nt(e,re)&&re.el[nt]&&re.el[nt](),Y(X,[V])},enter(V){if(G[j]===e)return;let X=d,re=c,D=p;if(!s.isMounted)if(l)X=w||d,re=x||c,D=$||p;else return;let se=!1;V[as]=Le=>{se||(se=!0,Le?Y(D,[V]):Y(re,[V]),Ae.delayedLeave&&Ae.delayedLeave(),V[as]=void 0)};const Se=V[as].bind(null,!1);X?Q(X,[V,Se]):Se()},leave(V,X){const re=String(e.key);if(V[as]&&V[as](!0),s.isUnmounting)return X();Y(h,[V]);let D=!1;V[nt]=Se=>{D||(D=!0,X(),Se?Y(E,[V]):Y(C,[V]),V[nt]=void 0,G[re]===e&&delete G[re])};const se=V[nt].bind(null,!1);G[re]=e,_?Q(_,[V,se]):se()},clone(V){const X=jn(V,t,s,n,i);return i&&i(X),X}};return Ae}function gn(e){if(nn(e))return e=Rt(e),e.children=null,e}function mi(e){if(!nn(e))return Kl(e.type)&&e.children?ql(e.children):e;if(e.component)return e.component.subTree;const{shapeFlag:t,children:s}=e;if(s){if(t&16)return s[0];if(t&32&&W(s.default))return s.default()}}function Cs(e,t){e.shapeFlag&6&&e.component?(e.transition=t,Cs(e.component.subTree,t)):e.shapeFlag&128?(e.ssContent.transition=t.clone(e.ssContent),e.ssFallback.transition=t.clone(e.ssFallback)):e.transition=t}function zl(e,t=!1,s){let n=[],i=0;for(let l=0;l<e.length;l++){let o=e[l];const r=s==null?o.key:String(s)+String(o.key!=null?o.key:l);o.type===ee?(o.patchFlag&128&&i++,n=n.concat(zl(o.children,t,r))):(t||o.type!==je)&&n.push(r!=null?Rt(o,{key:r}):o)}if(i>1)for(let l=0;l<n.length;l++)n[l].patchFlag=-2;return n}function Jl(e,t){return W(e)?ye({name:e.name},t,{setup:e}):e}function Ql(e){e.ids=[e.ids[0]+e.ids[2]+++"-",0,0]}function vi(e,t){let s;return!!((s=Object.getOwnPropertyDescriptor(e,t))&&!s.configurable)}const Vs=new WeakMap;function _s(e,t,s,n,i=!1){if(H(e)){e.forEach((E,M)=>_s(E,t&&(H(t)?t[M]:t),s,n,i));return}if(gs(n)&&!i){n.shapeFlag&512&&n.type.__asyncResolved&&n.component.subTree.component&&_s(e,t,s,n.component.subTree);return}const l=n.shapeFlag&4?ii(n.component):n.el,o=i?null:l,{i:r,r:a}=e,d=t&&t.r,c=r.refs===de?r.refs={}:r.refs,p=r.setupState,h=te(p),_=p===de?ul:E=>vi(c,E)?!1:le(h,E),C=(E,M)=>!(M&&vi(c,M));if(d!=null&&d!==a){if(bi(t),he(d))c[d]=null,_(d)&&(p[d]=null);else if(we(d)){const E=t;C(d,E.k)&&(d.value=null),E.k&&(c[E.k]=null)}}if(W(a))Ts(a,r,12,[o,c]);else{const E=he(a),M=we(a);if(E||M){const w=()=>{if(e.f){const x=E?_(a)?p[a]:c[a]:C()||!e.k?a.value:c[e.k];if(i)H(x)&&Vn(x,l);else if(H(x))x.includes(l)||x.push(l);else if(E)c[a]=[l],_(a)&&(p[a]=c[a]);else{const $=[l];C(a,e.k)&&(a.value=$),e.k&&(c[e.k]=$)}}else E?(c[a]=o,_(a)&&(p[a]=o)):M&&(C(a,e.k)&&(a.value=o),e.k&&(c[e.k]=o))};if(o){const x=()=>{w(),Vs.delete(e)};x.id=-1,Vs.set(e,x),Ne(x,s)}else bi(e),w()}}}function bi(e){const t=Vs.get(e);t&&(t.flags|=8,Vs.delete(e))}Zs().requestIdleCallback;Zs().cancelIdleCallback;const gs=e=>!!e.type.__asyncLoader,nn=e=>e.type.__isKeepAlive;function Fr(e,t){Yl(e,"a",t)}function Hr(e,t){Yl(e,"da",t)}function Yl(e,t,s=Ie){const n=e.__wdc||(e.__wdc=()=>{let i=s;for(;i;){if(i.isDeactivated)return;i=i.parent}return e()});if(ln(t,n,s),s){let i=s.parent;for(;i&&i.parent;)nn(i.parent.vnode)&&Vr(n,t,s,i),i=i.parent}}function Vr(e,t,s,n){const i=ln(t,e,n,!0);Vt(()=>{Vn(n[t],i)},s)}function ln(e,t,s=Ie,n=!1){if(s){const i=s[e]||(s[e]=[]),l=t.__weh||(t.__weh=(...o)=>{vt();const r=js(s),a=ze(t,s,e,o);return r(),bt(),a});return n?i.unshift(l):i.push(l),l}}const At=e=>(t,s=Ie)=>{(!Is||e==="sp")&&ln(e,(...n)=>t(...n),s)},Kr=At("bm"),Ht=At("m"),Wr=At("bu"),Gr=At("u"),Zl=At("bum"),Vt=At("um"),qr=At("sp"),Xr=At("rtg"),zr=At("rtc");function Jr(e,t=Ie){ln("ec",e,t)}const eo="components";function ls(e,t){return so(eo,e,!0,t)||e}const to=Symbol.for("v-ndc");function Qr(e){return he(e)?so(eo,e,!1)||e:e||to}function so(e,t,s=!0,n=!1){const i=Ge||Ie;if(i){const l=i.type;{const r=Da(l,!1);if(r&&(r===t||r===$e(t)||r===Ys($e(t))))return l}const o=yi(i[e]||l[e],t)||yi(i.appContext[e],t);return!o&&n?l:o}}function yi(e,t){return e&&(e[t]||e[$e(t)]||e[Ys($e(t))])}function me(e,t,s,n){let i;const l=s,o=H(e);if(o||he(e)){const r=o&&Lt(e);let a=!1,d=!1;r&&(a=!Ke(e),d=yt(e),e=en(e)),i=new Array(e.length);for(let c=0,p=e.length;c<p;c++)i[c]=t(a?d?ts(Xe(e[c])):Xe(e[c]):e[c],c,void 0,l)}else if(typeof e=="number"){i=new Array(e);for(let r=0;r<e;r++)i[r]=t(r+1,r,void 0,l)}else if(oe(e))if(e[Symbol.iterator])i=Array.from(e,(r,a)=>t(r,a,void 0,l));else{const r=Object.keys(e);i=new Array(r.length);for(let a=0,d=r.length;a<d;a++){const c=r[a];i[a]=t(e[c],c,a,l)}}else i=[];return i}const On=e=>e?xo(e)?ii(e):On(e.parent):null,ms=ye(Object.create(null),{$:e=>e,$el:e=>e.vnode.el,$data:e=>e.data,$props:e=>e.props,$attrs:e=>e.attrs,$slots:e=>e.slots,$refs:e=>e.refs,$parent:e=>On(e.parent),$root:e=>On(e.root),$host:e=>e.ce,$emit:e=>e.emit,$options:e=>io(e),$forceUpdate:e=>e.f||(e.f=()=>{ei(e.update)}),$nextTick:e=>e.n||(e.n=ss.bind(e.proxy)),$watch:e=>Nr.bind(e)}),mn=(e,t)=>e!==de&&!e.__isScriptSetup&&le(e,t),Yr={get({_:e},t){if(t==="__v_skip")return!0;const{ctx:s,setupState:n,data:i,props:l,accessCache:o,type:r,appContext:a}=e;if(t[0]!=="$"){const h=o[t];if(h!==void 0)switch(h){case 1:return n[t];case 2:return i[t];case 4:return s[t];case 3:return l[t]}else{if(mn(n,t))return o[t]=1,n[t];if(i!==de&&le(i,t))return o[t]=2,i[t];if(le(l,t))return o[t]=3,l[t];if(s!==de&&le(s,t))return o[t]=4,s[t];Mn&&(o[t]=0)}}const d=ms[t];let c,p;if(d)return t==="$attrs"&&xe(e.attrs,"get",""),d(e);if((c=r.__cssModules)&&(c=c[t]))return c;if(s!==de&&le(s,t))return o[t]=4,s[t];if(p=a.config.globalProperties,le(p,t))return p[t]},set({_:e},t,s){const{data:n,setupState:i,ctx:l}=e;return mn(i,t)?(i[t]=s,!0):n!==de&&le(n,t)?(n[t]=s,!0):le(e.props,t)||t[0]==="$"&&t.slice(1)in e?!1:(l[t]=s,!0)},has({_:{data:e,setupState:t,accessCache:s,ctx:n,appContext:i,props:l,type:o}},r){let a;return!!(s[r]||e!==de&&r[0]!=="$"&&le(e,r)||mn(t,r)||le(l,r)||le(n,r)||le(ms,r)||le(i.config.globalProperties,r)||(a=o.__cssModules)&&a[r])},defineProperty(e,t,s){return s.get!=null?e._.accessCache[t]=0:le(s,"value")&&this.set(e,t,s.value,null),Reflect.defineProperty(e,t,s)}};function Ai(e){return H(e)?e.reduce((t,s)=>(t[s]=null,t),{}):e}let Mn=!0;function Zr(e){const t=io(e),s=e.proxy,n=e.ctx;Mn=!1,t.beforeCreate&&Si(t.beforeCreate,e,"bc");const{data:i,computed:l,methods:o,watch:r,provide:a,inject:d,created:c,beforeMount:p,mounted:h,beforeUpdate:_,updated:C,activated:E,deactivated:M,beforeDestroy:w,beforeUnmount:x,destroyed:$,unmounted:j,render:G,renderTracked:Y,renderTriggered:Q,errorCaptured:Ae,serverPrefetch:V,expose:X,inheritAttrs:re,components:D,directives:se,filters:Se}=t;if(d&&ea(d,n,null),o)for(const ae in o){const ne=o[ae];W(ne)&&(n[ae]=ne.bind(s))}if(i){const ae=i.call(s,s);oe(ae)&&(e.data=tn(ae))}if(Mn=!0,l)for(const ae in l){const ne=l[ae],pt=W(ne)?ne.bind(s,s):W(ne.get)?ne.get.bind(s,s):rt,St=!W(ne)&&W(ne.set)?ne.set.bind(s):rt,Qe=Oe({get:pt,set:St});Object.defineProperty(n,ae,{enumerable:!0,configurable:!0,get:()=>Qe.value,set:De=>Qe.value=De})}if(r)for(const ae in r)no(r[ae],n,s,ae);if(a){const ae=W(a)?a.call(s):a;Reflect.ownKeys(ae).forEach(ne=>{Ds(ne,ae[ne])})}c&&Si(c,e,"c");function _e(ae,ne){H(ne)?ne.forEach(pt=>ae(pt.bind(s))):ne&&ae(ne.bind(s))}if(_e(Kr,p),_e(Ht,h),_e(Wr,_),_e(Gr,C),_e(Fr,E),_e(Hr,M),_e(Jr,Ae),_e(zr,Y),_e(Xr,Q),_e(Zl,x),_e(Vt,j),_e(qr,V),H(X))if(X.length){const ae=e.exposed||(e.exposed={});X.forEach(ne=>{Object.defineProperty(ae,ne,{get:()=>s[ne],set:pt=>s[ne]=pt,enumerable:!0})})}else e.exposed||(e.exposed={});G&&e.render===rt&&(e.render=G),re!=null&&(e.inheritAttrs=re),D&&(e.components=D),se&&(e.directives=se),V&&Ql(e)}function ea(e,t,s=rt){H(e)&&(e=$n(e));for(const n in e){const i=e[n];let l;oe(i)?"default"in i?l=at(i.from||n,i.default,!0):l=at(i.from||n):l=at(i),we(l)?Object.defineProperty(t,n,{enumerable:!0,configurable:!0,get:()=>l.value,set:o=>l.value=o}):t[n]=l}}function Si(e,t,s){ze(H(e)?e.map(n=>n.bind(t.proxy)):e.bind(t.proxy),t,s)}function no(e,t,s,n){let i=n.includes(".")?Vl(s,n):()=>s[n];if(he(e)){const l=t[e];W(l)&&Bt(i,l)}else if(W(e))Bt(i,e.bind(s));else if(oe(e))if(H(e))e.forEach(l=>no(l,t,s,n));else{const l=W(e.handler)?e.handler.bind(s):t[e.handler];W(l)&&Bt(i,l,e)}}function io(e){const t=e.type,{mixins:s,extends:n}=t,{mixins:i,optionsCache:l,config:{optionMergeStrategies:o}}=e.appContext,r=l.get(t);let a;return r?a=r:!i.length&&!s&&!n?a=t:(a={},i.length&&i.forEach(d=>Ks(a,d,o,!0)),Ks(a,t,o)),oe(t)&&l.set(t,a),a}function Ks(e,t,s,n=!1){const{mixins:i,extends:l}=t;l&&Ks(e,l,s,!0),i&&i.forEach(o=>Ks(e,o,s,!0));for(const o in t)if(!(n&&o==="expose")){const r=ta[o]||s&&s[o];e[o]=r?r(e[o],t[o]):t[o]}return e}const ta={data:Ei,props:Ci,emits:Ci,methods:us,computed:us,beforeCreate:Pe,created:Pe,beforeMount:Pe,mounted:Pe,beforeUpdate:Pe,updated:Pe,beforeDestroy:Pe,beforeUnmount:Pe,destroyed:Pe,unmounted:Pe,activated:Pe,deactivated:Pe,errorCaptured:Pe,serverPrefetch:Pe,components:us,directives:us,watch:na,provide:Ei,inject:sa};function Ei(e,t){return t?e?function(){return ye(W(e)?e.call(this,this):e,W(t)?t.call(this,this):t)}:t:e}function sa(e,t){return us($n(e),$n(t))}function $n(e){if(H(e)){const t={};for(let s=0;s<e.length;s++)t[e[s]]=e[s];return t}return e}function Pe(e,t){return e?[...new Set([].concat(e,t))]:t}function us(e,t){return e?ye(Object.create(null),e,t):t}function Ci(e,t){return e?H(e)&&H(t)?[...new Set([...e,...t])]:ye(Object.create(null),Ai(e),Ai(t??{})):t}function na(e,t){if(!e)return t;if(!t)return e;const s=ye(Object.create(null),e);for(const n in t)s[n]=Pe(e[n],t[n]);return s}function lo(){return{app:null,config:{isNativeTag:ul,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let ia=0;function la(e,t){return function(n,i=null){W(n)||(n=ye({},n)),i!=null&&!oe(i)&&(i=null);const l=lo(),o=new WeakSet,r=[];let a=!1;const d=l.app={_uid:ia++,_component:n,_props:i,_container:null,_context:l,_instance:null,version:Ua,get config(){return l.config},set config(c){},use(c,...p){return o.has(c)||(c&&W(c.install)?(o.add(c),c.install(d,...p)):W(c)&&(o.add(c),c(d,...p))),d},mixin(c){return l.mixins.includes(c)||l.mixins.push(c),d},component(c,p){return p?(l.components[c]=p,d):l.components[c]},directive(c,p){return p?(l.directives[c]=p,d):l.directives[c]},mount(c,p,h){if(!a){const _=d._ceVNode||q(n,i);return _.appContext=l,h===!0?h="svg":h===!1&&(h=void 0),e(_,c,h),a=!0,d._container=c,c.__vue_app__=d,ii(_.component)}},onUnmount(c){r.push(c)},unmount(){a&&(ze(r,d._instance,16),e(null,d._container),delete d._container.__vue_app__)},provide(c,p){return l.provides[c]=p,d},runWithContext(c){const p=Zt;Zt=d;try{return c()}finally{Zt=p}}};return d}}let Zt=null;const oa=(e,t)=>t==="modelValue"||t==="model-value"?e.modelModifiers:e[`${t}Modifiers`]||e[`${$e(t)}Modifiers`]||e[`${Ft(t)}Modifiers`];function ra(e,t,...s){if(e.isUnmounted)return;const n=e.vnode.props||de;let i=s;const l=t.startsWith("update:"),o=l&&oa(n,t.slice(7));o&&(o.trim&&(i=s.map(c=>he(c)?c.trim():c)),o.number&&(i=s.map(Xo)));let r,a=n[r=pn(t)]||n[r=pn($e(t))];!a&&l&&(a=n[r=pn(Ft(t))]),a&&ze(a,e,6,i);const d=n[r+"Once"];if(d){if(!e.emitted)e.emitted={};else if(e.emitted[r])return;e.emitted[r]=!0,ze(d,e,6,i)}}const aa=new WeakMap;function oo(e,t,s=!1){const n=s?aa:t.emitsCache,i=n.get(e);if(i!==void 0)return i;const l=e.emits;let o={},r=!1;if(!W(e)){const a=d=>{const c=oo(d,t,!0);c&&(r=!0,ye(o,c))};!s&&t.mixins.length&&t.mixins.forEach(a),e.extends&&a(e.extends),e.mixins&&e.mixins.forEach(a)}return!l&&!r?(oe(e)&&n.set(e,null),null):(H(l)?l.forEach(a=>o[a]=null):ye(o,l),oe(e)&&n.set(e,o),o)}function on(e,t){return!e||!zs(t)?!1:(t=t.slice(2).replace(/Once$/,""),le(e,t[0].toLowerCase()+t.slice(1))||le(e,Ft(t))||le(e,t))}function xi(e){const{type:t,vnode:s,proxy:n,withProxy:i,propsOptions:[l],slots:o,attrs:r,emit:a,render:d,renderCache:c,props:p,data:h,setupState:_,ctx:C,inheritAttrs:E}=e,M=Hs(e);let w,x;try{if(s.shapeFlag&4){const j=i||n,G=j;w=lt(d.call(G,j,c,p,_,h,C)),x=r}else{const j=t;w=lt(j.length>1?j(p,{attrs:r,slots:o,emit:a}):j(p,null)),x=t.props?r:ca(r)}}catch(j){vs.length=0,sn(j,e,1),w=q(je)}let $=w;if(x&&E!==!1){const j=Object.keys(x),{shapeFlag:G}=$;j.length&&G&7&&(l&&j.some(Js)&&(x=pa(x,l)),$=Rt($,x,!1,!0))}return s.dirs&&($=Rt($,null,!1,!0),$.dirs=$.dirs?$.dirs.concat(s.dirs):s.dirs),s.transition&&Cs($,s.transition),w=$,Hs(M),w}const ca=e=>{let t;for(const s in e)(s==="class"||s==="style"||zs(s))&&((t||(t={}))[s]=e[s]);return t},pa=(e,t)=>{const s={};for(const n in e)(!Js(n)||!(n.slice(9)in t))&&(s[n]=e[n]);return s};function ua(e,t,s){const{props:n,children:i,component:l}=e,{props:o,children:r,patchFlag:a}=t,d=l.emitsOptions;if(t.dirs||t.transition)return!0;if(s&&a>=0){if(a&1024)return!0;if(a&16)return n?Ii(n,o,d):!!o;if(a&8){const c=t.dynamicProps;for(let p=0;p<c.length;p++){const h=c[p];if(ro(o,n,h)&&!on(d,h))return!0}}}else return(i||r)&&(!r||!r.$stable)?!0:n===o?!1:n?o?Ii(n,o,d):!0:!!o;return!1}function Ii(e,t,s){const n=Object.keys(t);if(n.length!==Object.keys(e).length)return!0;for(let i=0;i<n.length;i++){const l=n[i];if(ro(t,e,l)&&!on(s,l))return!0}return!1}function ro(e,t,s){const n=e[s],i=t[s];return s==="style"&&oe(n)&&oe(i)?!Gn(n,i):n!==i}function da({vnode:e,parent:t,suspense:s},n){for(;t;){const i=t.subTree;if(i.suspense&&i.suspense.activeBranch===e&&(i.suspense.vnode.el=i.el=n,e=i),i===e)(e=t.vnode).el=n,t=t.parent;else break}s&&s.activeBranch===e&&(s.vnode.el=n)}const ao={},co=()=>Object.create(ao),po=e=>Object.getPrototypeOf(e)===ao;function fa(e,t,s,n=!1){const i={},l=co();e.propsDefaults=Object.create(null),uo(e,t,i,l);for(const o in e.propsOptions[0])o in i||(i[o]=void 0);s?e.props=n?i:$l(i):e.type.props?e.props=i:e.props=l,e.attrs=l}function ha(e,t,s,n){const{props:i,attrs:l,vnode:{patchFlag:o}}=e,r=te(i),[a]=e.propsOptions;let d=!1;if((n||o>0)&&!(o&16)){if(o&8){const c=e.vnode.dynamicProps;for(let p=0;p<c.length;p++){let h=c[p];if(on(e.emitsOptions,h))continue;const _=t[h];if(a)if(le(l,h))_!==l[h]&&(l[h]=_,d=!0);else{const C=$e(h);i[C]=Dn(a,r,C,_,e,!1)}else _!==l[h]&&(l[h]=_,d=!0)}}}else{uo(e,t,i,l)&&(d=!0);let c;for(const p in r)(!t||!le(t,p)&&((c=Ft(p))===p||!le(t,c)))&&(a?s&&(s[p]!==void 0||s[c]!==void 0)&&(i[p]=Dn(a,r,p,void 0,e,!0)):delete i[p]);if(l!==r)for(const p in l)(!t||!le(t,p))&&(delete l[p],d=!0)}d&&gt(e.attrs,"set","")}function uo(e,t,s,n){const[i,l]=e.propsOptions;let o=!1,r;if(t)for(let a in t){if(ds(a))continue;const d=t[a];let c;i&&le(i,c=$e(a))?!l||!l.includes(c)?s[c]=d:(r||(r={}))[c]=d:on(e.emitsOptions,a)||(!(a in n)||d!==n[a])&&(n[a]=d,o=!0)}if(l){const a=te(s),d=r||de;for(let c=0;c<l.length;c++){const p=l[c];s[p]=Dn(i,a,p,d[p],e,!le(d,p))}}return o}function Dn(e,t,s,n,i,l){const o=e[s];if(o!=null){const r=le(o,"default");if(r&&n===void 0){const a=o.default;if(o.type!==Function&&!o.skipFactory&&W(a)){const{propsDefaults:d}=i;if(s in d)n=d[s];else{const c=js(i);n=d[s]=a.call(null,t),c()}}else n=a;i.ce&&i.ce._setProp(s,n)}o[0]&&(l&&!r?n=!1:o[1]&&(n===""||n===Ft(s))&&(n=!0))}return n}const _a=new WeakMap;function fo(e,t,s=!1){const n=s?_a:t.propsCache,i=n.get(e);if(i)return i;const l=e.props,o={},r=[];let a=!1;if(!W(e)){const c=p=>{a=!0;const[h,_]=fo(p,t,!0);ye(o,h),_&&r.push(..._)};!s&&t.mixins.length&&t.mixins.forEach(c),e.extends&&c(e.extends),e.mixins&&e.mixins.forEach(c)}if(!l&&!a)return oe(e)&&n.set(e,Jt),Jt;if(H(l))for(let c=0;c<l.length;c++){const p=$e(l[c]);wi(p)&&(o[p]=de)}else if(l)for(const c in l){const p=$e(c);if(wi(p)){const h=l[c],_=o[p]=H(h)||W(h)?{type:h}:ye({},h),C=_.type;let E=!1,M=!0;if(H(C))for(let w=0;w<C.length;++w){const x=C[w],$=W(x)&&x.name;if($==="Boolean"){E=!0;break}else $==="String"&&(M=!1)}else E=W(C)&&C.name==="Boolean";_[0]=E,_[1]=M,(E||le(_,"default"))&&r.push(p)}}const d=[o,r];return oe(e)&&n.set(e,d),d}function wi(e){return e[0]!=="$"&&!ds(e)}const ti=e=>e==="_"||e==="_ctx"||e==="$stable",si=e=>H(e)?e.map(lt):[lt(e)],ga=(e,t,s)=>{if(t._n)return t;const n=ge((...i)=>si(t(...i)),s);return n._c=!1,n},ho=(e,t,s)=>{const n=e._ctx;for(const i in e){if(ti(i))continue;const l=e[i];if(W(l))t[i]=ga(i,l,n);else if(l!=null){const o=si(l);t[i]=()=>o}}},_o=(e,t)=>{const s=si(t);e.slots.default=()=>s},go=(e,t,s)=>{for(const n in t)(s||!ti(n))&&(e[n]=t[n])},ma=(e,t,s)=>{const n=e.slots=co();if(e.vnode.shapeFlag&32){const i=t._;i?(go(n,t,s),s&&gl(n,"_",i,!0)):ho(t,n)}else t&&_o(e,t)},va=(e,t,s)=>{const{vnode:n,slots:i}=e;let l=!0,o=de;if(n.shapeFlag&32){const r=t._;r?s&&r===1?l=!1:go(i,t,s):(l=!t.$stable,ho(t,i)),o=t}else t&&(_o(e,t),o={default:1});if(l)for(const r in i)!ti(r)&&o[r]==null&&delete i[r]},Ne=Ea;function ba(e){return ya(e)}function ya(e,t){const s=Zs();s.__VUE__=!0;const{insert:n,remove:i,patchProp:l,createElement:o,createText:r,createComment:a,setText:d,setElementText:c,parentNode:p,nextSibling:h,setScopeId:_=rt,insertStaticContent:C}=e,E=(u,f,g,v=null,A=null,b=null,R=void 0,P=null,I=!!f.dynamicChildren)=>{if(u===f)return;u&&!Nt(u,f)&&(v=y(u),De(u,A,b,!0),u=null),f.patchFlag===-2&&(I=!1,f.dynamicChildren=null);const{type:S,ref:B,shapeFlag:O}=f;switch(S){case rn:M(u,f,g,v);break;case je:w(u,f,g,v);break;case Ns:u==null&&x(f,g,v,R);break;case ee:D(u,f,g,v,A,b,R,P,I);break;default:O&1?G(u,f,g,v,A,b,R,P,I):O&6?se(u,f,g,v,A,b,R,P,I):(O&64||O&128)&&S.process(u,f,g,v,A,b,R,P,I,k)}B!=null&&A?_s(B,u&&u.ref,b,f||u,!f):B==null&&u&&u.ref!=null&&_s(u.ref,null,b,u,!0)},M=(u,f,g,v)=>{if(u==null)n(f.el=r(f.children),g,v);else{const A=f.el=u.el;f.children!==u.children&&d(A,f.children)}},w=(u,f,g,v)=>{u==null?n(f.el=a(f.children||""),g,v):f.el=u.el},x=(u,f,g,v)=>{[u.el,u.anchor]=C(u.children,f,g,v,u.el,u.anchor)},$=({el:u,anchor:f},g,v)=>{let A;for(;u&&u!==f;)A=h(u),n(u,g,v),u=A;n(f,g,v)},j=({el:u,anchor:f})=>{let g;for(;u&&u!==f;)g=h(u),i(u),u=g;i(f)},G=(u,f,g,v,A,b,R,P,I)=>{if(f.type==="svg"?R="svg":f.type==="math"&&(R="mathml"),u==null)Y(f,g,v,A,b,R,P,I);else{const S=u.el&&u.el._isVueCE?u.el:null;try{S&&S._beginPatch(),V(u,f,A,b,R,P,I)}finally{S&&S._endPatch()}}},Y=(u,f,g,v,A,b,R,P)=>{let I,S;const{props:B,shapeFlag:O,transition:L,dirs:K}=u;if(I=u.el=o(u.type,b,B&&B.is,B),O&8?c(I,u.children):O&16&&Ae(u.children,I,null,v,A,vn(u,b),R,P),K&&jt(u,null,v,"created"),Q(I,u,u.scopeId,R,v),B){for(const ce in B)ce!=="value"&&!ds(ce)&&l(I,ce,null,B[ce],b,v);"value"in B&&l(I,"value",null,B.value,b),(S=B.onVnodeBeforeMount)&&tt(S,v,u)}K&&jt(u,null,v,"beforeMount");const Z=Aa(A,L);Z&&L.beforeEnter(I),n(I,f,g),((S=B&&B.onVnodeMounted)||Z||K)&&Ne(()=>{S&&tt(S,v,u),Z&&L.enter(I),K&&jt(u,null,v,"mounted")},A)},Q=(u,f,g,v,A)=>{if(g&&_(u,g),v)for(let b=0;b<v.length;b++)_(u,v[b]);if(A){let b=A.subTree;if(f===b||yo(b.type)&&(b.ssContent===f||b.ssFallback===f)){const R=A.vnode;Q(u,R,R.scopeId,R.slotScopeIds,A.parent)}}},Ae=(u,f,g,v,A,b,R,P,I=0)=>{for(let S=I;S<u.length;S++){const B=u[S]=P?_t(u[S]):lt(u[S]);E(null,B,f,g,v,A,b,R,P)}},V=(u,f,g,v,A,b,R)=>{const P=f.el=u.el;let{patchFlag:I,dynamicChildren:S,dirs:B}=f;I|=u.patchFlag&16;const O=u.props||de,L=f.props||de;let K;if(g&&Ot(g,!1),(K=L.onVnodeBeforeUpdate)&&tt(K,g,f,u),B&&jt(f,u,g,"beforeUpdate"),g&&Ot(g,!0),(O.innerHTML&&L.innerHTML==null||O.textContent&&L.textContent==null)&&c(P,""),S?X(u.dynamicChildren,S,P,g,v,vn(f,A),b):R||ne(u,f,P,null,g,v,vn(f,A),b,!1),I>0){if(I&16)re(P,O,L,g,A);else if(I&2&&O.class!==L.class&&l(P,"class",null,L.class,A),I&4&&l(P,"style",O.style,L.style,A),I&8){const Z=f.dynamicProps;for(let ce=0;ce<Z.length;ce++){const pe=Z[ce],ve=O[pe],Ee=L[pe];(Ee!==ve||pe==="value")&&l(P,pe,ve,Ee,A,g)}}I&1&&u.children!==f.children&&c(P,f.children)}else!R&&S==null&&re(P,O,L,g,A);((K=L.onVnodeUpdated)||B)&&Ne(()=>{K&&tt(K,g,f,u),B&&jt(f,u,g,"updated")},v)},X=(u,f,g,v,A,b,R)=>{for(let P=0;P<f.length;P++){const I=u[P],S=f[P],B=I.el&&(I.type===ee||!Nt(I,S)||I.shapeFlag&198)?p(I.el):g;E(I,S,B,null,v,A,b,R,!0)}},re=(u,f,g,v,A)=>{if(f!==g){if(f!==de)for(const b in f)!ds(b)&&!(b in g)&&l(u,b,f[b],null,A,v);for(const b in g){if(ds(b))continue;const R=g[b],P=f[b];R!==P&&b!=="value"&&l(u,b,P,R,A,v)}"value"in g&&l(u,"value",f.value,g.value,A)}},D=(u,f,g,v,A,b,R,P,I)=>{const S=f.el=u?u.el:r(""),B=f.anchor=u?u.anchor:r("");let{patchFlag:O,dynamicChildren:L,slotScopeIds:K}=f;K&&(P=P?P.concat(K):K),u==null?(n(S,g,v),n(B,g,v),Ae(f.children||[],g,B,A,b,R,P,I)):O>0&&O&64&&L&&u.dynamicChildren&&u.dynamicChildren.length===L.length?(X(u.dynamicChildren,L,g,A,b,R,P),(f.key!=null||A&&f===A.subTree)&&mo(u,f,!0)):ne(u,f,g,B,A,b,R,P,I)},se=(u,f,g,v,A,b,R,P,I)=>{f.slotScopeIds=P,u==null?f.shapeFlag&512?A.ctx.activate(f,g,v,R,I):Se(f,g,v,A,b,R,I):Le(u,f,I)},Se=(u,f,g,v,A,b,R)=>{const P=u.component=Ta(u,v,A);if(nn(u)&&(P.ctx.renderer=k),ja(P,!1,R),P.asyncDep){if(A&&A.registerDep(P,_e,R),!u.el){const I=P.subTree=q(je);w(null,I,f,g),u.placeholder=I.el}}else _e(P,u,f,g,A,b,R)},Le=(u,f,g)=>{const v=f.component=u.component;if(ua(u,f,g))if(v.asyncDep&&!v.asyncResolved){ae(v,f,g);return}else v.next=f,v.update();else f.el=u.el,v.vnode=f},_e=(u,f,g,v,A,b,R)=>{const P=()=>{if(u.isMounted){let{next:O,bu:L,u:K,parent:Z,vnode:ce}=u;{const Ze=vo(u);if(Ze){O&&(O.el=ce.el,ae(u,O,R)),Ze.asyncDep.then(()=>{Ne(()=>{u.isUnmounted||S()},A)});return}}let pe=O,ve;Ot(u,!1),O?(O.el=ce.el,ae(u,O,R)):O=ce,L&&un(L),(ve=O.props&&O.props.onVnodeBeforeUpdate)&&tt(ve,Z,O,ce),Ot(u,!0);const Ee=xi(u),Ye=u.subTree;u.subTree=Ee,E(Ye,Ee,p(Ye.el),y(Ye),u,A,b),O.el=Ee.el,pe===null&&da(u,Ee.el),K&&Ne(K,A),(ve=O.props&&O.props.onVnodeUpdated)&&Ne(()=>tt(ve,Z,O,ce),A)}else{let O;const{el:L,props:K}=f,{bm:Z,m:ce,parent:pe,root:ve,type:Ee}=u,Ye=gs(f);Ot(u,!1),Z&&un(Z),!Ye&&(O=K&&K.onVnodeBeforeMount)&&tt(O,pe,f),Ot(u,!0);{ve.ce&&ve.ce._hasShadowRoot()&&ve.ce._injectChildStyle(Ee,u.parent?u.parent.type:void 0);const Ze=u.subTree=xi(u);E(null,Ze,g,v,u,A,b),f.el=Ze.el}if(ce&&Ne(ce,A),!Ye&&(O=K&&K.onVnodeMounted)){const Ze=f;Ne(()=>tt(O,pe,Ze),A)}(f.shapeFlag&256||pe&&gs(pe.vnode)&&pe.vnode.shapeFlag&256)&&u.a&&Ne(u.a,A),u.isMounted=!0,f=g=v=null}};u.scope.on();const I=u.effect=new yl(P);u.scope.off();const S=u.update=I.run.bind(I),B=u.job=I.runIfDirty.bind(I);B.i=u,B.id=u.uid,I.scheduler=()=>ei(B),Ot(u,!0),S()},ae=(u,f,g)=>{f.component=u;const v=u.vnode.props;u.vnode=f,u.next=null,ha(u,f.props,v,g),va(u,f.children,g),vt(),gi(u),bt()},ne=(u,f,g,v,A,b,R,P,I=!1)=>{const S=u&&u.children,B=u?u.shapeFlag:0,O=f.children,{patchFlag:L,shapeFlag:K}=f;if(L>0){if(L&128){St(S,O,g,v,A,b,R,P,I);return}else if(L&256){pt(S,O,g,v,A,b,R,P,I);return}}K&8?(B&16&&He(S,A,b),O!==S&&c(g,O)):B&16?K&16?St(S,O,g,v,A,b,R,P,I):He(S,A,b,!0):(B&8&&c(g,""),K&16&&Ae(O,g,v,A,b,R,P,I))},pt=(u,f,g,v,A,b,R,P,I)=>{u=u||Jt,f=f||Jt;const S=u.length,B=f.length,O=Math.min(S,B);let L;for(L=0;L<O;L++){const K=f[L]=I?_t(f[L]):lt(f[L]);E(u[L],K,g,null,A,b,R,P,I)}S>B?He(u,A,b,!0,!1,O):Ae(f,g,v,A,b,R,P,I,O)},St=(u,f,g,v,A,b,R,P,I)=>{let S=0;const B=f.length;let O=u.length-1,L=B-1;for(;S<=O&&S<=L;){const K=u[S],Z=f[S]=I?_t(f[S]):lt(f[S]);if(Nt(K,Z))E(K,Z,g,null,A,b,R,P,I);else break;S++}for(;S<=O&&S<=L;){const K=u[O],Z=f[L]=I?_t(f[L]):lt(f[L]);if(Nt(K,Z))E(K,Z,g,null,A,b,R,P,I);else break;O--,L--}if(S>O){if(S<=L){const K=L+1,Z=K<B?f[K].el:v;for(;S<=L;)E(null,f[S]=I?_t(f[S]):lt(f[S]),g,Z,A,b,R,P,I),S++}}else if(S>L)for(;S<=O;)De(u[S],A,b,!0),S++;else{const K=S,Z=S,ce=new Map;for(S=Z;S<=L;S++){const Be=f[S]=I?_t(f[S]):lt(f[S]);Be.key!=null&&ce.set(Be.key,S)}let pe,ve=0;const Ee=L-Z+1;let Ye=!1,Ze=0;const os=new Array(Ee);for(S=0;S<Ee;S++)os[S]=0;for(S=K;S<=O;S++){const Be=u[S];if(ve>=Ee){De(Be,A,b,!0);continue}let et;if(Be.key!=null)et=ce.get(Be.key);else for(pe=Z;pe<=L;pe++)if(os[pe-Z]===0&&Nt(Be,f[pe])){et=pe;break}et===void 0?De(Be,A,b,!0):(os[et-Z]=S+1,et>=Ze?Ze=et:Ye=!0,E(Be,f[et],g,null,A,b,R,P,I),ve++)}const ci=Ye?Sa(os):Jt;for(pe=ci.length-1,S=Ee-1;S>=0;S--){const Be=Z+S,et=f[Be],pi=f[Be+1],ui=Be+1<B?pi.el||bo(pi):v;os[S]===0?E(null,et,g,ui,A,b,R,P,I):Ye&&(pe<0||S!==ci[pe]?Qe(et,g,ui,2):pe--)}}},Qe=(u,f,g,v,A=null)=>{const{el:b,type:R,transition:P,children:I,shapeFlag:S}=u;if(S&6){Qe(u.component.subTree,f,g,v);return}if(S&128){u.suspense.move(f,g,v);return}if(S&64){R.move(u,f,g,k);return}if(R===ee){n(b,f,g);for(let O=0;O<I.length;O++)Qe(I[O],f,g,v);n(u.anchor,f,g);return}if(R===Ns){$(u,f,g);return}if(v!==2&&S&1&&P)if(v===0)P.beforeEnter(b),n(b,f,g),Ne(()=>P.enter(b),A);else{const{leave:O,delayLeave:L,afterLeave:K}=P,Z=()=>{u.ctx.isUnmounted?i(b):n(b,f,g)},ce=()=>{b._isLeaving&&b[nt](!0),O(b,()=>{Z(),K&&K()})};L?L(b,Z,ce):ce()}else n(b,f,g)},De=(u,f,g,v=!1,A=!1)=>{const{type:b,props:R,ref:P,children:I,dynamicChildren:S,shapeFlag:B,patchFlag:O,dirs:L,cacheIndex:K,memo:Z}=u;if(O===-2&&(A=!1),P!=null&&(vt(),_s(P,null,g,u,!0),bt()),K!=null&&(f.renderCache[K]=void 0),B&256){f.ctx.deactivate(u);return}const ce=B&1&&L,pe=!gs(u);let ve;if(pe&&(ve=R&&R.onVnodeBeforeUnmount)&&tt(ve,f,u),B&6)Tt(u.component,g,v);else{if(B&128){u.suspense.unmount(g,v);return}ce&&jt(u,null,f,"beforeUnmount"),B&64?u.type.remove(u,f,g,k,v):S&&!S.hasOnce&&(b!==ee||O>0&&O&64)?He(S,f,g,!1,!0):(b===ee&&O&384||!A&&B&16)&&He(I,f,g),v&&Kt(u)}const Ee=Z!=null&&K==null;(pe&&(ve=R&&R.onVnodeUnmounted)||ce||Ee)&&Ne(()=>{ve&&tt(ve,f,u),ce&&jt(u,null,f,"unmounted"),Ee&&(u.el=null)},g)},Kt=u=>{const{type:f,el:g,anchor:v,transition:A}=u;if(f===ee){Wt(g,v);return}if(f===Ns){j(u);return}const b=()=>{i(g),A&&!A.persisted&&A.afterLeave&&A.afterLeave()};if(u.shapeFlag&1&&A&&!A.persisted){const{leave:R,delayLeave:P}=A,I=()=>R(g,b);P?P(u.el,b,I):I()}else b()},Wt=(u,f)=>{let g;for(;u!==f;)g=h(u),i(u),u=g;i(f)},Tt=(u,f,g)=>{const{bum:v,scope:A,job:b,subTree:R,um:P,m:I,a:S}=u;Pi(I),Pi(S),v&&un(v),A.stop(),b&&(b.flags|=8,De(R,u,f,g)),P&&Ne(P,f),Ne(()=>{u.isUnmounted=!0},f)},He=(u,f,g,v=!1,A=!1,b=0)=>{for(let R=b;R<u.length;R++)De(u[R],f,g,v,A)},y=u=>{if(u.shapeFlag&6)return y(u.component.subTree);if(u.shapeFlag&128)return u.suspense.next();const f=h(u.anchor||u.el),g=f&&f[Ur];return g?h(g):f};let N=!1;const T=(u,f,g)=>{let v;u==null?f._vnode&&(De(f._vnode,null,null,!0),v=f._vnode.component):E(f._vnode||null,u,f,null,null,null,g),f._vnode=u,N||(N=!0,gi(v),Ll(),N=!1)},k={p:E,um:De,m:Qe,r:Kt,mt:Se,mc:Ae,pc:ne,pbc:X,n:y,o:e};return{render:T,hydrate:void 0,createApp:la(T)}}function vn({type:e,props:t},s){return s==="svg"&&e==="foreignObject"||s==="mathml"&&e==="annotation-xml"&&t&&t.encoding&&t.encoding.includes("html")?void 0:s}function Ot({effect:e,job:t},s){s?(e.flags|=32,t.flags|=4):(e.flags&=-33,t.flags&=-5)}function Aa(e,t){return(!e||e&&!e.pendingBranch)&&t&&!t.persisted}function mo(e,t,s=!1){const n=e.children,i=t.children;if(H(n)&&H(i))for(let l=0;l<n.length;l++){const o=n[l];let r=i[l];r.shapeFlag&1&&!r.dynamicChildren&&((r.patchFlag<=0||r.patchFlag===32)&&(r=i[l]=_t(i[l]),r.el=o.el),!s&&r.patchFlag!==-2&&mo(o,r)),r.type===rn&&(r.patchFlag===-1&&(r=i[l]=_t(r)),r.el=o.el),r.type===je&&!r.el&&(r.el=o.el)}}function Sa(e){const t=e.slice(),s=[0];let n,i,l,o,r;const a=e.length;for(n=0;n<a;n++){const d=e[n];if(d!==0){if(i=s[s.length-1],e[i]<d){t[n]=i,s.push(n);continue}for(l=0,o=s.length-1;l<o;)r=l+o>>1,e[s[r]]<d?l=r+1:o=r;d<e[s[l]]&&(l>0&&(t[n]=s[l-1]),s[l]=n)}}for(l=s.length,o=s[l-1];l-- >0;)s[l]=o,o=t[o];return s}function vo(e){const t=e.subTree.component;if(t)return t.asyncDep&&!t.asyncResolved?t:vo(t)}function Pi(e){if(e)for(let t=0;t<e.length;t++)e[t].flags|=8}function bo(e){if(e.placeholder)return e.placeholder;const t=e.component;return t?bo(t.subTree):null}const yo=e=>e.__isSuspense;function Ea(e,t){t&&t.pendingBranch?H(e)?t.effects.push(...e):t.effects.push(e):Mr(e)}const ee=Symbol.for("v-fgt"),rn=Symbol.for("v-txt"),je=Symbol.for("v-cmt"),Ns=Symbol.for("v-stc"),vs=[];let Fe=null;function U(e=!1){vs.push(Fe=e?null:[])}function Ca(){vs.pop(),Fe=vs[vs.length-1]||null}let xs=1;function Ws(e,t=!1){xs+=e,e<0&&Fe&&t&&(Fe.hasOnce=!0)}function Ao(e){return e.dynamicChildren=xs>0?Fe||Jt:null,Ca(),xs>0&&Fe&&Fe.push(e),e}function F(e,t,s,n,i,l){return Ao(m(e,t,s,n,i,l,!0))}function Pt(e,t,s,n,i){return Ao(q(e,t,s,n,i,!0))}function Gs(e){return e?e.__v_isVNode===!0:!1}function Nt(e,t){return e.type===t.type&&e.key===t.key}const So=({key:e})=>e??null,Us=({ref:e,ref_key:t,ref_for:s})=>(typeof e=="number"&&(e=""+e),e!=null?he(e)||we(e)||W(e)?{i:Ge,r:e,k:t,f:!!s}:e:null);function m(e,t=null,s=null,n=0,i=null,l=e===ee?0:1,o=!1,r=!1){const a={__v_isVNode:!0,__v_skip:!0,type:e,props:t,key:t&&So(t),ref:t&&Us(t),scopeId:Fl,slotScopeIds:null,children:s,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetStart:null,targetAnchor:null,staticCount:0,shapeFlag:l,patchFlag:n,dynamicProps:i,dynamicChildren:null,appContext:null,ctx:Ge};return r?(ni(a,s),l&128&&e.normalize(a)):s&&(a.shapeFlag|=he(s)?8:16),xs>0&&!o&&Fe&&(a.patchFlag>0||l&6)&&a.patchFlag!==32&&Fe.push(a),a}const q=xa;function xa(e,t=null,s=null,n=0,i=null,l=!1){if((!e||e===to)&&(e=je),Gs(e)){const r=Rt(e,t,!0);return s&&ni(r,s),xs>0&&!l&&Fe&&(r.shapeFlag&6?Fe[Fe.indexOf(e)]=r:Fe.push(r)),r.patchFlag=-2,r}if(Na(e)&&(e=e.__vccOpts),t){t=Ia(t);let{class:r,style:a}=t;r&&!he(r)&&(t.class=We(r)),oe(a)&&(Zn(a)&&!H(a)&&(a=ye({},a)),t.style=Wn(a))}const o=he(e)?1:yo(e)?128:Kl(e)?64:oe(e)?4:W(e)?2:0;return m(e,t,s,n,i,o,l,!0)}function Ia(e){return e?Zn(e)||po(e)?ye({},e):e:null}function Rt(e,t,s=!1,n=!1){const{props:i,ref:l,patchFlag:o,children:r,transition:a}=e,d=t?wa(i||{},t):i,c={__v_isVNode:!0,__v_skip:!0,type:e.type,props:d,key:d&&So(d),ref:t&&t.ref?s&&l?H(l)?l.concat(Us(t)):[l,Us(t)]:Us(t):l,scopeId:e.scopeId,slotScopeIds:e.slotScopeIds,children:r,target:e.target,targetStart:e.targetStart,targetAnchor:e.targetAnchor,staticCount:e.staticCount,shapeFlag:e.shapeFlag,patchFlag:t&&e.type!==ee?o===-1?16:o|16:o,dynamicProps:e.dynamicProps,dynamicChildren:e.dynamicChildren,appContext:e.appContext,dirs:e.dirs,transition:a,component:e.component,suspense:e.suspense,ssContent:e.ssContent&&Rt(e.ssContent),ssFallback:e.ssFallback&&Rt(e.ssFallback),placeholder:e.placeholder,el:e.el,anchor:e.anchor,ctx:e.ctx,ce:e.ce};return a&&n&&Cs(c,a.clone(c)),c}function ke(e=" ",t=0){return q(rn,null,e,t)}function es(e,t){const s=q(Ns,null,e);return s.staticCount=t,s}function Eo(e="",t=!1){return t?(U(),Pt(je,null,e)):q(je,null,e)}function lt(e){return e==null||typeof e=="boolean"?q(je):H(e)?q(ee,null,e.slice()):Gs(e)?_t(e):q(rn,null,String(e))}function _t(e){return e.el===null&&e.patchFlag!==-1||e.memo?e:Rt(e)}function ni(e,t){let s=0;const{shapeFlag:n}=e;if(t==null)t=null;else if(H(t))s=16;else if(typeof t=="object")if(n&65){const i=t.default;i&&(i._c&&(i._d=!1),ni(e,i()),i._c&&(i._d=!0));return}else{s=32;const i=t._;!i&&!po(t)?t._ctx=Ge:i===3&&Ge&&(Ge.slots._===1?t._=1:(t._=2,e.patchFlag|=1024))}else W(t)?(t={default:t,_ctx:Ge},s=32):(t=String(t),n&64?(s=16,t=[ke(t)]):s=8);e.children=t,e.shapeFlag|=s}function wa(...e){const t={};for(let s=0;s<e.length;s++){const n=e[s];for(const i in n)if(i==="class")t.class!==n.class&&(t.class=We([t.class,n.class]));else if(i==="style")t.style=Wn([t.style,n.style]);else if(zs(i)){const l=t[i],o=n[i];o&&l!==o&&!(H(l)&&l.includes(o))?t[i]=l?[].concat(l,o):o:o==null&&l==null&&!Js(i)&&(t[i]=o)}else i!==""&&(t[i]=n[i])}return t}function tt(e,t,s,n=null){ze(e,t,7,[s,n])}const Pa=lo();let Ra=0;function Ta(e,t,s){const n=e.type,i=(t?t.appContext:e.appContext)||Pa,l={uid:Ra++,vnode:e,type:n,parent:t,appContext:i,root:null,next:null,subTree:null,effect:null,update:null,job:null,scope:new nr(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:t?t.provides:Object.create(i.provides),ids:t?t.ids:["",0,0],accessCache:null,renderCache:[],components:null,directives:null,propsOptions:fo(n,i),emitsOptions:oo(n,i),emit:null,emitted:null,propsDefaults:de,inheritAttrs:n.inheritAttrs,ctx:de,data:de,props:de,attrs:de,slots:de,refs:de,setupState:de,setupContext:null,suspense:s,suspenseId:s?s.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return l.ctx={_:l},l.root=t?t.root:l,l.emit=ra.bind(null,l),e.ce&&e.ce(l),l}let Ie=null;const Co=()=>Ie||Ge;let qs,Nn;{const e=Zs(),t=(s,n)=>{let i;return(i=e[s])||(i=e[s]=[]),i.push(n),l=>{i.length>1?i.forEach(o=>o(l)):i[0](l)}};qs=t("__VUE_INSTANCE_SETTERS__",s=>Ie=s),Nn=t("__VUE_SSR_SETTERS__",s=>Is=s)}const js=e=>{const t=Ie;return qs(e),e.scope.on(),()=>{e.scope.off(),qs(t)}},Ri=()=>{Ie&&Ie.scope.off(),qs(null)};function xo(e){return e.vnode.shapeFlag&4}let Is=!1;function ja(e,t=!1,s=!1){t&&Nn(t);const{props:n,children:i}=e.vnode,l=xo(e);fa(e,n,l,t),ma(e,i,s||t);const o=l?Oa(e,t):void 0;return t&&Nn(!1),o}function Oa(e,t){const s=e.type;e.accessCache=Object.create(null),e.proxy=new Proxy(e.ctx,Yr);const{setup:n}=s;if(n){vt();const i=e.setupContext=n.length>1?$a(e):null,l=js(e),o=Ts(n,e,0,[e.props,i]),r=fl(o);if(bt(),l(),(r||e.sp)&&!gs(e)&&Ql(e),r){if(o.then(Ri,Ri),t)return o.then(a=>{Ti(e,a)}).catch(a=>{sn(a,e,0)});e.asyncDep=o}else Ti(e,o)}else Io(e)}function Ti(e,t,s){W(t)?e.type.__ssrInlineRender?e.ssrRender=t:e.render=t:oe(t)&&(e.setupState=Nl(t)),Io(e)}function Io(e,t,s){const n=e.type;e.render||(e.render=n.render||rt);{const i=js(e);vt();try{Zr(e)}finally{bt(),i()}}}const Ma={get(e,t){return xe(e,"get",""),e[t]}};function $a(e){const t=s=>{e.exposed=s||{}};return{attrs:new Proxy(e.attrs,Ma),slots:e.slots,emit:e.emit,expose:t}}function ii(e){return e.exposed?e.exposeProxy||(e.exposeProxy=new Proxy(Nl(Er(e.exposed)),{get(t,s){if(s in t)return t[s];if(s in ms)return ms[s](e)},has(t,s){return s in t||s in ms}})):e.proxy}function Da(e,t=!0){return W(e)?e.displayName||e.name:e.name||t&&e.__name}function Na(e){return W(e)&&"__vccOpts"in e}const Oe=(e,t)=>Pr(e,t,Is);function li(e,t,s){try{Ws(-1);const n=arguments.length;return n===2?oe(t)&&!H(t)?Gs(t)?q(e,null,[t]):q(e,t):q(e,null,t):(n>3?s=Array.prototype.slice.call(arguments,2):n===3&&Gs(s)&&(s=[s]),q(e,t,s))}finally{Ws(1)}}const Ua="3.5.31";let Un;const ji=typeof window<"u"&&window.trustedTypes;if(ji)try{Un=ji.createPolicy("vue",{createHTML:e=>e})}catch{}const wo=Un?e=>Un.createHTML(e):e=>e,ka="http://www.w3.org/2000/svg",La="http://www.w3.org/1998/Math/MathML",ht=typeof document<"u"?document:null,Oi=ht&&ht.createElement("template"),Ba={insert:(e,t,s)=>{t.insertBefore(e,s||null)},remove:e=>{const t=e.parentNode;t&&t.removeChild(e)},createElement:(e,t,s,n)=>{const i=t==="svg"?ht.createElementNS(ka,e):t==="mathml"?ht.createElementNS(La,e):s?ht.createElement(e,{is:s}):ht.createElement(e);return e==="select"&&n&&n.multiple!=null&&i.setAttribute("multiple",n.multiple),i},createText:e=>ht.createTextNode(e),createComment:e=>ht.createComment(e),setText:(e,t)=>{e.nodeValue=t},setElementText:(e,t)=>{e.textContent=t},parentNode:e=>e.parentNode,nextSibling:e=>e.nextSibling,querySelector:e=>ht.querySelector(e),setScopeId(e,t){e.setAttribute(t,"")},insertStaticContent(e,t,s,n,i,l){const o=s?s.previousSibling:t.lastChild;if(i&&(i===l||i.nextSibling))for(;t.insertBefore(i.cloneNode(!0),s),!(i===l||!(i=i.nextSibling)););else{Oi.innerHTML=wo(n==="svg"?`<svg>${e}</svg>`:n==="mathml"?`<math>${e}</math>`:e);const r=Oi.content;if(n==="svg"||n==="mathml"){const a=r.firstChild;for(;a.firstChild;)r.appendChild(a.firstChild);r.removeChild(a)}t.insertBefore(r,s)}return[o?o.nextSibling:t.firstChild,s?s.previousSibling:t.lastChild]}},Et="transition",cs="animation",ws=Symbol("_vtc"),Po={name:String,type:String,css:{type:Boolean,default:!0},duration:[String,Number,Object],enterFromClass:String,enterActiveClass:String,enterToClass:String,appearFromClass:String,appearActiveClass:String,appearToClass:String,leaveFromClass:String,leaveActiveClass:String,leaveToClass:String},Fa=ye({},Wl,Po),Ha=e=>(e.displayName="Transition",e.props=Fa,e),Va=Ha((e,{slots:t})=>li(Br,Ka(e),t)),Mt=(e,t=[])=>{H(e)?e.forEach(s=>s(...t)):e&&e(...t)},Mi=e=>e?H(e)?e.some(t=>t.length>1):e.length>1:!1;function Ka(e){const t={};for(const D in e)D in Po||(t[D]=e[D]);if(e.css===!1)return t;const{name:s="v",type:n,duration:i,enterFromClass:l=`${s}-enter-from`,enterActiveClass:o=`${s}-enter-active`,enterToClass:r=`${s}-enter-to`,appearFromClass:a=l,appearActiveClass:d=o,appearToClass:c=r,leaveFromClass:p=`${s}-leave-from`,leaveActiveClass:h=`${s}-leave-active`,leaveToClass:_=`${s}-leave-to`}=e,C=Wa(i),E=C&&C[0],M=C&&C[1],{onBeforeEnter:w,onEnter:x,onEnterCancelled:$,onLeave:j,onLeaveCancelled:G,onBeforeAppear:Y=w,onAppear:Q=x,onAppearCancelled:Ae=$}=t,V=(D,se,Se,Le)=>{D._enterCancelled=Le,$t(D,se?c:r),$t(D,se?d:o),Se&&Se()},X=(D,se)=>{D._isLeaving=!1,$t(D,p),$t(D,_),$t(D,h),se&&se()},re=D=>(se,Se)=>{const Le=D?Q:x,_e=()=>V(se,D,Se);Mt(Le,[se,_e]),$i(()=>{$t(se,D?a:l),dt(se,D?c:r),Mi(Le)||Di(se,n,E,_e)})};return ye(t,{onBeforeEnter(D){Mt(w,[D]),dt(D,l),dt(D,o)},onBeforeAppear(D){Mt(Y,[D]),dt(D,a),dt(D,d)},onEnter:re(!1),onAppear:re(!0),onLeave(D,se){D._isLeaving=!0;const Se=()=>X(D,se);dt(D,p),D._enterCancelled?(dt(D,h),ki(D)):(ki(D),dt(D,h)),$i(()=>{D._isLeaving&&($t(D,p),dt(D,_),Mi(j)||Di(D,n,M,Se))}),Mt(j,[D,Se])},onEnterCancelled(D){V(D,!1,void 0,!0),Mt($,[D])},onAppearCancelled(D){V(D,!0,void 0,!0),Mt(Ae,[D])},onLeaveCancelled(D){X(D),Mt(G,[D])}})}function Wa(e){if(e==null)return null;if(oe(e))return[bn(e.enter),bn(e.leave)];{const t=bn(e);return[t,t]}}function bn(e){return zo(e)}function dt(e,t){t.split(/\s+/).forEach(s=>s&&e.classList.add(s)),(e[ws]||(e[ws]=new Set)).add(t)}function $t(e,t){t.split(/\s+/).forEach(n=>n&&e.classList.remove(n));const s=e[ws];s&&(s.delete(t),s.size||(e[ws]=void 0))}function $i(e){requestAnimationFrame(()=>{requestAnimationFrame(e)})}let Ga=0;function Di(e,t,s,n){const i=e._endId=++Ga,l=()=>{i===e._endId&&n()};if(s!=null)return setTimeout(l,s);const{type:o,timeout:r,propCount:a}=qa(e,t);if(!o)return n();const d=o+"end";let c=0;const p=()=>{e.removeEventListener(d,h),l()},h=_=>{_.target===e&&++c>=a&&p()};setTimeout(()=>{c<a&&p()},r+1),e.addEventListener(d,h)}function qa(e,t){const s=window.getComputedStyle(e),n=C=>(s[C]||"").split(", "),i=n(`${Et}Delay`),l=n(`${Et}Duration`),o=Ni(i,l),r=n(`${cs}Delay`),a=n(`${cs}Duration`),d=Ni(r,a);let c=null,p=0,h=0;t===Et?o>0&&(c=Et,p=o,h=l.length):t===cs?d>0&&(c=cs,p=d,h=a.length):(p=Math.max(o,d),c=p>0?o>d?Et:cs:null,h=c?c===Et?l.length:a.length:0);const _=c===Et&&/\b(?:transform|all)(?:,|$)/.test(n(`${Et}Property`).toString());return{type:c,timeout:p,propCount:h,hasTransform:_}}function Ni(e,t){for(;e.length<t.length;)e=e.concat(e);return Math.max(...t.map((s,n)=>Ui(s)+Ui(e[n])))}function Ui(e){return e==="auto"?0:Number(e.slice(0,-1).replace(",","."))*1e3}function ki(e){return(e?e.ownerDocument:document).body.offsetHeight}function Xa(e,t,s){const n=e[ws];n&&(t=(t?[t,...n]:[...n]).join(" ")),t==null?e.removeAttribute("class"):s?e.setAttribute("class",t):e.className=t}const Li=Symbol("_vod"),za=Symbol("_vsh"),Ja=Symbol(""),Qa=/(?:^|;)\s*display\s*:/;function Ya(e,t,s){const n=e.style,i=he(s);let l=!1;if(s&&!i){if(t)if(he(t))for(const o of t.split(";")){const r=o.slice(0,o.indexOf(":")).trim();s[r]==null&&ks(n,r,"")}else for(const o in t)s[o]==null&&ks(n,o,"");for(const o in s)o==="display"&&(l=!0),ks(n,o,s[o])}else if(i){if(t!==s){const o=n[Ja];o&&(s+=";"+o),n.cssText=s,l=Qa.test(s)}}else t&&e.removeAttribute("style");Li in e&&(e[Li]=l?n.display:"",e[za]&&(n.display="none"))}const Bi=/\s*!important$/;function ks(e,t,s){if(H(s))s.forEach(n=>ks(e,t,n));else if(s==null&&(s=""),t.startsWith("--"))e.setProperty(t,s);else{const n=Za(e,t);Bi.test(s)?e.setProperty(Ft(n),s.replace(Bi,""),"important"):e[n]=s}}const Fi=["Webkit","Moz","ms"],yn={};function Za(e,t){const s=yn[t];if(s)return s;let n=$e(t);if(n!=="filter"&&n in e)return yn[t]=n;n=Ys(n);for(let i=0;i<Fi.length;i++){const l=Fi[i]+n;if(l in e)return yn[t]=l}return t}const Hi="http://www.w3.org/1999/xlink";function Vi(e,t,s,n,i,l=tr(t)){n&&t.startsWith("xlink:")?s==null?e.removeAttributeNS(Hi,t.slice(6,t.length)):e.setAttributeNS(Hi,t,s):s==null||l&&!ml(s)?e.removeAttribute(t):e.setAttribute(t,l?"":ct(s)?String(s):s)}function Ki(e,t,s,n,i){if(t==="innerHTML"||t==="textContent"){s!=null&&(e[t]=t==="innerHTML"?wo(s):s);return}const l=e.tagName;if(t==="value"&&l!=="PROGRESS"&&!l.includes("-")){const r=l==="OPTION"?e.getAttribute("value")||"":e.value,a=s==null?e.type==="checkbox"?"on":"":String(s);(r!==a||!("_value"in e))&&(e.value=a),s==null&&e.removeAttribute(t),e._value=s;return}let o=!1;if(s===""||s==null){const r=typeof e[t];r==="boolean"?s=ml(s):s==null&&r==="string"?(s="",o=!0):r==="number"&&(s=0,o=!0)}try{e[t]=s}catch{}o&&e.removeAttribute(i||t)}function ec(e,t,s,n){e.addEventListener(t,s,n)}function tc(e,t,s,n){e.removeEventListener(t,s,n)}const Wi=Symbol("_vei");function sc(e,t,s,n,i=null){const l=e[Wi]||(e[Wi]={}),o=l[t];if(n&&o)o.value=n;else{const[r,a]=nc(t);if(n){const d=l[t]=oc(n,i);ec(e,r,d,a)}else o&&(tc(e,r,o,a),l[t]=void 0)}}const Gi=/(?:Once|Passive|Capture)$/;function nc(e){let t;if(Gi.test(e)){t={};let n;for(;n=e.match(Gi);)e=e.slice(0,e.length-n[0].length),t[n[0].toLowerCase()]=!0}return[e[2]===":"?e.slice(3):Ft(e.slice(2)),t]}let An=0;const ic=Promise.resolve(),lc=()=>An||(ic.then(()=>An=0),An=Date.now());function oc(e,t){const s=n=>{if(!n._vts)n._vts=Date.now();else if(n._vts<=s.attached)return;ze(rc(n,s.value),t,5,[n])};return s.value=e,s.attached=lc(),s}function rc(e,t){if(H(t)){const s=e.stopImmediatePropagation;return e.stopImmediatePropagation=()=>{s.call(e),e._stopped=!0},t.map(n=>i=>!i._stopped&&n&&n(i))}else return t}const qi=e=>e.charCodeAt(0)===111&&e.charCodeAt(1)===110&&e.charCodeAt(2)>96&&e.charCodeAt(2)<123,ac=(e,t,s,n,i,l)=>{const o=i==="svg";t==="class"?Xa(e,n,o):t==="style"?Ya(e,s,n):zs(t)?Js(t)||sc(e,t,s,n,l):(t[0]==="."?(t=t.slice(1),!0):t[0]==="^"?(t=t.slice(1),!1):cc(e,t,n,o))?(Ki(e,t,n),!e.tagName.includes("-")&&(t==="value"||t==="checked"||t==="selected")&&Vi(e,t,n,o,l,t!=="value")):e._isVueCE&&(pc(e,t)||e._def.__asyncLoader&&(/[A-Z]/.test(t)||!he(n)))?Ki(e,$e(t),n,l,t):(t==="true-value"?e._trueValue=n:t==="false-value"&&(e._falseValue=n),Vi(e,t,n,o))};function cc(e,t,s,n){if(n)return!!(t==="innerHTML"||t==="textContent"||t in e&&qi(t)&&W(s));if(t==="spellcheck"||t==="draggable"||t==="translate"||t==="autocorrect"||t==="sandbox"&&e.tagName==="IFRAME"||t==="form"||t==="list"&&e.tagName==="INPUT"||t==="type"&&e.tagName==="TEXTAREA")return!1;if(t==="width"||t==="height"){const i=e.tagName;if(i==="IMG"||i==="VIDEO"||i==="CANVAS"||i==="SOURCE")return!1}return qi(t)&&he(s)?!1:t in e}function pc(e,t){const s=e._def.props;if(!s)return!1;const n=$e(t);return Array.isArray(s)?s.some(i=>$e(i)===n):Object.keys(s).some(i=>$e(i)===n)}const uc=["ctrl","shift","alt","meta"],dc={stop:e=>e.stopPropagation(),prevent:e=>e.preventDefault(),self:e=>e.target!==e.currentTarget,ctrl:e=>!e.ctrlKey,shift:e=>!e.shiftKey,alt:e=>!e.altKey,meta:e=>!e.metaKey,left:e=>"button"in e&&e.button!==0,middle:e=>"button"in e&&e.button!==1,right:e=>"button"in e&&e.button!==2,exact:(e,t)=>uc.some(s=>e[`${s}Key`]&&!t.includes(s))},Xs=(e,t)=>{if(!e)return e;const s=e._withMods||(e._withMods={}),n=t.join(".");return s[n]||(s[n]=((i,...l)=>{for(let o=0;o<t.length;o++){const r=dc[t[o]];if(r&&r(i,t))return}return e(i,...l)}))},fc=ye({patchProp:ac},Ba);let Xi;function hc(){return Xi||(Xi=ba(fc))}const _c=((...e)=>{const t=hc().createApp(...e),{mount:s}=t;return t.mount=n=>{const i=mc(n);if(!i)return;const l=t._component;!W(l)&&!l.render&&!l.template&&(l.template=i.innerHTML),i.nodeType===1&&(i.textContent="");const o=s(i,!1,gc(i));return i instanceof Element&&(i.removeAttribute("v-cloak"),i.setAttribute("data-v-app","")),o},t});function gc(e){if(e instanceof SVGElement)return"svg";if(typeof MathMLElement=="function"&&e instanceof MathMLElement)return"mathml"}function mc(e){return he(e)?document.querySelector(e):e}const Xt=typeof document<"u";function Ro(e){return typeof e=="object"||"displayName"in e||"props"in e||"__vccOpts"in e}function vc(e){return e.__esModule||e[Symbol.toStringTag]==="Module"||e.default&&Ro(e.default)}const ie=Object.assign;function Sn(e,t){const s={};for(const n in t){const i=t[n];s[n]=Je(i)?i.map(e):e(i)}return s}const bs=()=>{},Je=Array.isArray;function zi(e,t){const s={};for(const n in e)s[n]=n in t?t[n]:e[n];return s}let fe=(function(e){return e[e.MATCHER_NOT_FOUND=1]="MATCHER_NOT_FOUND",e[e.NAVIGATION_GUARD_REDIRECT=2]="NAVIGATION_GUARD_REDIRECT",e[e.NAVIGATION_ABORTED=4]="NAVIGATION_ABORTED",e[e.NAVIGATION_CANCELLED=8]="NAVIGATION_CANCELLED",e[e.NAVIGATION_DUPLICATED=16]="NAVIGATION_DUPLICATED",e})({});const To=Symbol("");fe.MATCHER_NOT_FOUND+"",fe.NAVIGATION_GUARD_REDIRECT+"",fe.NAVIGATION_ABORTED+"",fe.NAVIGATION_CANCELLED+"",fe.NAVIGATION_DUPLICATED+"";function ns(e,t){return ie(new Error,{type:e,[To]:!0},t)}function ft(e,t){return e instanceof Error&&To in e&&(t==null||!!(e.type&t))}const bc=["params","query","hash"];function yc(e){if(typeof e=="string")return e;if(e.path!=null)return e.path;const t={};for(const s of bc)s in e&&(t[s]=e[s]);return JSON.stringify(t,null,2)}const Ac=Symbol(""),Ji=Symbol(""),oi=Symbol(""),ri=Symbol(""),kn=Symbol("");function jo(e){return at(ri)}const Oo=/#/g,Sc=/&/g,Ec=/\//g,Cc=/=/g,xc=/\?/g,Mo=/\+/g,Ic=/%5B/g,wc=/%5D/g,$o=/%5E/g,Pc=/%60/g,Do=/%7B/g,Rc=/%7C/g,No=/%7D/g,Tc=/%20/g;function ai(e){return e==null?"":encodeURI(""+e).replace(Rc,"|").replace(Ic,"[").replace(wc,"]")}function jc(e){return ai(e).replace(Do,"{").replace(No,"}").replace($o,"^")}function Ln(e){return ai(e).replace(Mo,"%2B").replace(Tc,"+").replace(Oo,"%23").replace(Sc,"%26").replace(Pc,"`").replace(Do,"{").replace(No,"}").replace($o,"^")}function Oc(e){return Ln(e).replace(Cc,"%3D")}function Mc(e){return ai(e).replace(Oo,"%23").replace(xc,"%3F")}function $c(e){return Mc(e).replace(Ec,"%2F")}function Ps(e){if(e==null)return null;try{return decodeURIComponent(""+e)}catch{}return""+e}const Dc=/\/$/,Nc=e=>e.replace(Dc,"");function En(e,t,s="/"){let n,i={},l="",o="";const r=t.indexOf("#");let a=t.indexOf("?");return a=r>=0&&a>r?-1:a,a>=0&&(n=t.slice(0,a),l=t.slice(a,r>0?r:t.length),i=e(l.slice(1))),r>=0&&(n=n||t.slice(0,r),o=t.slice(r,t.length)),n=Bc(n??t,s),{fullPath:n+l+o,path:n,query:i,hash:Ps(o)}}function Uc(e,t){const s=t.query?e(t.query):"";return t.path+(s&&"?")+s+(t.hash||"")}function Qi(e,t){return!t||!e.toLowerCase().startsWith(t.toLowerCase())?e:e.slice(t.length)||"/"}function kc(e,t,s){const n=t.matched.length-1,i=s.matched.length-1;return n>-1&&n===i&&is(t.matched[n],s.matched[i])&&Uo(t.params,s.params)&&e(t.query)===e(s.query)&&t.hash===s.hash}function is(e,t){return(e.aliasOf||e)===(t.aliasOf||t)}function Uo(e,t){if(Object.keys(e).length!==Object.keys(t).length)return!1;for(var s in e)if(!Lc(e[s],t[s]))return!1;return!0}function Lc(e,t){return Je(e)?Yi(e,t):Je(t)?Yi(t,e):(e&&e.valueOf())===(t&&t.valueOf())}function Yi(e,t){return Je(t)?e.length===t.length&&e.every((s,n)=>s===t[n]):e.length===1&&e[0]===t}function Bc(e,t){if(e.startsWith("/"))return e;if(!e)return t;const s=t.split("/"),n=e.split("/"),i=n[n.length-1];(i===".."||i===".")&&n.push("");let l=s.length-1,o,r;for(o=0;o<n.length;o++)if(r=n[o],r!==".")if(r==="..")l>1&&l--;else break;return s.slice(0,l).join("/")+"/"+n.slice(o).join("/")}const Ct={path:"/",name:void 0,params:{},query:{},hash:"",fullPath:"/",matched:[],meta:{},redirectedFrom:void 0};let Bn=(function(e){return e.pop="pop",e.push="push",e})({}),Cn=(function(e){return e.back="back",e.forward="forward",e.unknown="",e})({});function Fc(e){if(!e)if(Xt){const t=document.querySelector("base");e=t&&t.getAttribute("href")||"/",e=e.replace(/^\w+:\/\/[^\/]+/,"")}else e="/";return e[0]!=="/"&&e[0]!=="#"&&(e="/"+e),Nc(e)}const Hc=/^[^#]+#/;function Vc(e,t){return e.replace(Hc,"#")+t}function Kc(e,t){const s=document.documentElement.getBoundingClientRect(),n=e.getBoundingClientRect();return{behavior:t.behavior,left:n.left-s.left-(t.left||0),top:n.top-s.top-(t.top||0)}}const an=()=>({left:window.scrollX,top:window.scrollY});function Wc(e){let t;if("el"in e){const s=e.el,n=typeof s=="string"&&s.startsWith("#"),i=typeof s=="string"?n?document.getElementById(s.slice(1)):document.querySelector(s):s;if(!i)return;t=Kc(i,e)}else t=e;"scrollBehavior"in document.documentElement.style?window.scrollTo(t):window.scrollTo(t.left!=null?t.left:window.scrollX,t.top!=null?t.top:window.scrollY)}function Zi(e,t){return(history.state?history.state.position-t:-1)+e}const Fn=new Map;function Gc(e,t){Fn.set(e,t)}function qc(e){const t=Fn.get(e);return Fn.delete(e),t}function Xc(e){return typeof e=="string"||e&&typeof e=="object"}function ko(e){return typeof e=="string"||typeof e=="symbol"}function zc(e){const t={};if(e===""||e==="?")return t;const s=(e[0]==="?"?e.slice(1):e).split("&");for(let n=0;n<s.length;++n){const i=s[n].replace(Mo," "),l=i.indexOf("="),o=Ps(l<0?i:i.slice(0,l)),r=l<0?null:Ps(i.slice(l+1));if(o in t){let a=t[o];Je(a)||(a=t[o]=[a]),a.push(r)}else t[o]=r}return t}function el(e){let t="";for(let s in e){const n=e[s];if(s=Oc(s),n==null){n!==void 0&&(t+=(t.length?"&":"")+s);continue}(Je(n)?n.map(i=>i&&Ln(i)):[n&&Ln(n)]).forEach(i=>{i!==void 0&&(t+=(t.length?"&":"")+s,i!=null&&(t+="="+i))})}return t}function Jc(e){const t={};for(const s in e){const n=e[s];n!==void 0&&(t[s]=Je(n)?n.map(i=>i==null?null:""+i):n==null?n:""+n)}return t}function ps(){let e=[];function t(n){return e.push(n),()=>{const i=e.indexOf(n);i>-1&&e.splice(i,1)}}function s(){e=[]}return{add:t,list:()=>e.slice(),reset:s}}function It(e,t,s,n,i,l=o=>o()){const o=n&&(n.enterCallbacks[i]=n.enterCallbacks[i]||[]);return()=>new Promise((r,a)=>{const d=h=>{h===!1?a(ns(fe.NAVIGATION_ABORTED,{from:s,to:t})):h instanceof Error?a(h):Xc(h)?a(ns(fe.NAVIGATION_GUARD_REDIRECT,{from:t,to:h})):(o&&n.enterCallbacks[i]===o&&typeof h=="function"&&o.push(h),r())},c=l(()=>e.call(n&&n.instances[i],t,s,d));let p=Promise.resolve(c);e.length<3&&(p=p.then(d)),p.catch(h=>a(h))})}function xn(e,t,s,n,i=l=>l()){const l=[];for(const o of e)for(const r in o.components){let a=o.components[r];if(!(t!=="beforeRouteEnter"&&!o.instances[r]))if(Ro(a)){const d=(a.__vccOpts||a)[t];d&&l.push(It(d,s,n,o,r,i))}else{let d=a();l.push(()=>d.then(c=>{if(!c)throw new Error(`Couldn't resolve component "${r}" at "${o.path}"`);const p=vc(c)?c.default:c;o.mods[r]=c,o.components[r]=p;const h=(p.__vccOpts||p)[t];return h&&It(h,s,n,o,r,i)()}))}}return l}function Qc(e,t){const s=[],n=[],i=[],l=Math.max(t.matched.length,e.matched.length);for(let o=0;o<l;o++){const r=t.matched[o];r&&(e.matched.find(d=>is(d,r))?n.push(r):s.push(r));const a=e.matched[o];a&&(t.matched.find(d=>is(d,a))||i.push(a))}return[s,n,i]}let Yc=()=>location.protocol+"//"+location.host;function Lo(e,t){const{pathname:s,search:n,hash:i}=t,l=e.indexOf("#");if(l>-1){let o=i.includes(e.slice(l))?e.slice(l).length:1,r=i.slice(o);return r[0]!=="/"&&(r="/"+r),Qi(r,"")}return Qi(s,e)+n+i}function Zc(e,t,s,n){let i=[],l=[],o=null;const r=({state:h})=>{const _=Lo(e,location),C=s.value,E=t.value;let M=0;if(h){if(s.value=_,t.value=h,o&&o===C){o=null;return}M=E?h.position-E.position:0}else n(_);i.forEach(w=>{w(s.value,C,{delta:M,type:Bn.pop,direction:M?M>0?Cn.forward:Cn.back:Cn.unknown})})};function a(){o=s.value}function d(h){i.push(h);const _=()=>{const C=i.indexOf(h);C>-1&&i.splice(C,1)};return l.push(_),_}function c(){if(document.visibilityState==="hidden"){const{history:h}=window;if(!h.state)return;h.replaceState(ie({},h.state,{scroll:an()}),"")}}function p(){for(const h of l)h();l=[],window.removeEventListener("popstate",r),window.removeEventListener("pagehide",c),document.removeEventListener("visibilitychange",c)}return window.addEventListener("popstate",r),window.addEventListener("pagehide",c),document.addEventListener("visibilitychange",c),{pauseListeners:a,listen:d,destroy:p}}function tl(e,t,s,n=!1,i=!1){return{back:e,current:t,forward:s,replaced:n,position:window.history.length,scroll:i?an():null}}function ep(e){const{history:t,location:s}=window,n={value:Lo(e,s)},i={value:t.state};i.value||l(n.value,{back:null,current:n.value,forward:null,position:t.length-1,replaced:!0,scroll:null},!0);function l(a,d,c){const p=e.indexOf("#"),h=p>-1?(s.host&&document.querySelector("base")?e:e.slice(p))+a:Yc()+e+a;try{t[c?"replaceState":"pushState"](d,"",h),i.value=d}catch(_){console.error(_),s[c?"replace":"assign"](h)}}function o(a,d){l(a,ie({},t.state,tl(i.value.back,a,i.value.forward,!0),d,{position:i.value.position}),!0),n.value=a}function r(a,d){const c=ie({},i.value,t.state,{forward:a,scroll:an()});l(c.current,c,!0),l(a,ie({},tl(n.value,a,null),{position:c.position+1},d),!1),n.value=a}return{location:n,state:i,push:r,replace:o}}function tp(e){e=Fc(e);const t=ep(e),s=Zc(e,t.state,t.location,t.replace);function n(l,o=!0){o||s.pauseListeners(),history.go(l)}const i=ie({location:"",base:e,go:n,createHref:Vc.bind(null,e)},t,s);return Object.defineProperty(i,"location",{enumerable:!0,get:()=>t.location.value}),Object.defineProperty(i,"state",{enumerable:!0,get:()=>t.state.value}),i}function sp(e){return e=location.host?e||location.pathname+location.search:"",e.includes("#")||(e+="#"),tp(e)}let Ut=(function(e){return e[e.Static=0]="Static",e[e.Param=1]="Param",e[e.Group=2]="Group",e})({});var be=(function(e){return e[e.Static=0]="Static",e[e.Param=1]="Param",e[e.ParamRegExp=2]="ParamRegExp",e[e.ParamRegExpEnd=3]="ParamRegExpEnd",e[e.EscapeNext=4]="EscapeNext",e})(be||{});const np={type:Ut.Static,value:""},ip=/[a-zA-Z0-9_]/;function lp(e){if(!e)return[[]];if(e==="/")return[[np]];if(!e.startsWith("/"))throw new Error(`Invalid path "${e}"`);function t(_){throw new Error(`ERR (${s})/"${d}": ${_}`)}let s=be.Static,n=s;const i=[];let l;function o(){l&&i.push(l),l=[]}let r=0,a,d="",c="";function p(){d&&(s===be.Static?l.push({type:Ut.Static,value:d}):s===be.Param||s===be.ParamRegExp||s===be.ParamRegExpEnd?(l.length>1&&(a==="*"||a==="+")&&t(`A repeatable param (${d}) must be alone in its segment. eg: '/:ids+.`),l.push({type:Ut.Param,value:d,regexp:c,repeatable:a==="*"||a==="+",optional:a==="*"||a==="?"})):t("Invalid state to consume buffer"),d="")}function h(){d+=a}for(;r<e.length;){if(a=e[r++],a==="\\"&&s!==be.ParamRegExp){n=s,s=be.EscapeNext;continue}switch(s){case be.Static:a==="/"?(d&&p(),o()):a===":"?(p(),s=be.Param):h();break;case be.EscapeNext:h(),s=n;break;case be.Param:a==="("?s=be.ParamRegExp:ip.test(a)?h():(p(),s=be.Static,a!=="*"&&a!=="?"&&a!=="+"&&r--);break;case be.ParamRegExp:a===")"?c[c.length-1]=="\\"?c=c.slice(0,-1)+a:s=be.ParamRegExpEnd:c+=a;break;case be.ParamRegExpEnd:p(),s=be.Static,a!=="*"&&a!=="?"&&a!=="+"&&r--,c="";break;default:t("Unknown state");break}}return s===be.ParamRegExp&&t(`Unfinished custom RegExp for param "${d}"`),p(),o(),i}const sl="[^/]+?",op={sensitive:!1,strict:!1,start:!0,end:!0};var Re=(function(e){return e[e._multiplier=10]="_multiplier",e[e.Root=90]="Root",e[e.Segment=40]="Segment",e[e.SubSegment=30]="SubSegment",e[e.Static=40]="Static",e[e.Dynamic=20]="Dynamic",e[e.BonusCustomRegExp=10]="BonusCustomRegExp",e[e.BonusWildcard=-50]="BonusWildcard",e[e.BonusRepeatable=-20]="BonusRepeatable",e[e.BonusOptional=-8]="BonusOptional",e[e.BonusStrict=.7000000000000001]="BonusStrict",e[e.BonusCaseSensitive=.25]="BonusCaseSensitive",e})(Re||{});const rp=/[.+*?^${}()[\]/\\]/g;function ap(e,t){const s=ie({},op,t),n=[];let i=s.start?"^":"";const l=[];for(const d of e){const c=d.length?[]:[Re.Root];s.strict&&!d.length&&(i+="/");for(let p=0;p<d.length;p++){const h=d[p];let _=Re.Segment+(s.sensitive?Re.BonusCaseSensitive:0);if(h.type===Ut.Static)p||(i+="/"),i+=h.value.replace(rp,"\\$&"),_+=Re.Static;else if(h.type===Ut.Param){const{value:C,repeatable:E,optional:M,regexp:w}=h;l.push({name:C,repeatable:E,optional:M});const x=w||sl;if(x!==sl){_+=Re.BonusCustomRegExp;try{new RegExp(`(${x})`)}catch(j){throw new Error(`Invalid custom RegExp for param "${C}" (${x}): `+j.message)}}let $=E?`((?:${x})(?:/(?:${x}))*)`:`(${x})`;p||($=M&&d.length<2?`(?:/${$})`:"/"+$),M&&($+="?"),i+=$,_+=Re.Dynamic,M&&(_+=Re.BonusOptional),E&&(_+=Re.BonusRepeatable),x===".*"&&(_+=Re.BonusWildcard)}c.push(_)}n.push(c)}if(s.strict&&s.end){const d=n.length-1;n[d][n[d].length-1]+=Re.BonusStrict}s.strict||(i+="/?"),s.end?i+="$":s.strict&&!i.endsWith("/")&&(i+="(?:/|$)");const o=new RegExp(i,s.sensitive?"":"i");function r(d){const c=d.match(o),p={};if(!c)return null;for(let h=1;h<c.length;h++){const _=c[h]||"",C=l[h-1];p[C.name]=_&&C.repeatable?_.split("/"):_}return p}function a(d){let c="",p=!1;for(const h of e){(!p||!c.endsWith("/"))&&(c+="/"),p=!1;for(const _ of h)if(_.type===Ut.Static)c+=_.value;else if(_.type===Ut.Param){const{value:C,repeatable:E,optional:M}=_,w=C in d?d[C]:"";if(Je(w)&&!E)throw new Error(`Provided param "${C}" is an array but it is not repeatable (* or + modifiers)`);const x=Je(w)?w.join("/"):w;if(!x)if(M)h.length<2&&(c.endsWith("/")?c=c.slice(0,-1):p=!0);else throw new Error(`Missing required param "${C}"`);c+=x}}return c||"/"}return{re:o,score:n,keys:l,parse:r,stringify:a}}function cp(e,t){let s=0;for(;s<e.length&&s<t.length;){const n=t[s]-e[s];if(n)return n;s++}return e.length<t.length?e.length===1&&e[0]===Re.Static+Re.Segment?-1:1:e.length>t.length?t.length===1&&t[0]===Re.Static+Re.Segment?1:-1:0}function Bo(e,t){let s=0;const n=e.score,i=t.score;for(;s<n.length&&s<i.length;){const l=cp(n[s],i[s]);if(l)return l;s++}if(Math.abs(i.length-n.length)===1){if(nl(n))return 1;if(nl(i))return-1}return i.length-n.length}function nl(e){const t=e[e.length-1];return e.length>0&&t[t.length-1]<0}const pp={strict:!1,end:!0,sensitive:!1};function up(e,t,s){const n=ap(lp(e.path),s),i=ie(n,{record:e,parent:t,children:[],alias:[]});return t&&!i.record.aliasOf==!t.record.aliasOf&&t.children.push(i),i}function dp(e,t){const s=[],n=new Map;t=zi(pp,t);function i(p){return n.get(p)}function l(p,h,_){const C=!_,E=ll(p);E.aliasOf=_&&_.record;const M=zi(t,p),w=[E];if("alias"in p){const j=typeof p.alias=="string"?[p.alias]:p.alias;for(const G of j)w.push(ll(ie({},E,{components:_?_.record.components:E.components,path:G,aliasOf:_?_.record:E})))}let x,$;for(const j of w){const{path:G}=j;if(h&&G[0]!=="/"){const Y=h.record.path,Q=Y[Y.length-1]==="/"?"":"/";j.path=h.record.path+(G&&Q+G)}if(x=up(j,h,M),_?_.alias.push(x):($=$||x,$!==x&&$.alias.push(x),C&&p.name&&!ol(x)&&o(p.name)),Fo(x)&&a(x),E.children){const Y=E.children;for(let Q=0;Q<Y.length;Q++)l(Y[Q],x,_&&_.children[Q])}_=_||x}return $?()=>{o($)}:bs}function o(p){if(ko(p)){const h=n.get(p);h&&(n.delete(p),s.splice(s.indexOf(h),1),h.children.forEach(o),h.alias.forEach(o))}else{const h=s.indexOf(p);h>-1&&(s.splice(h,1),p.record.name&&n.delete(p.record.name),p.children.forEach(o),p.alias.forEach(o))}}function r(){return s}function a(p){const h=_p(p,s);s.splice(h,0,p),p.record.name&&!ol(p)&&n.set(p.record.name,p)}function d(p,h){let _,C={},E,M;if("name"in p&&p.name){if(_=n.get(p.name),!_)throw ns(fe.MATCHER_NOT_FOUND,{location:p});M=_.record.name,C=ie(il(h.params,_.keys.filter($=>!$.optional).concat(_.parent?_.parent.keys.filter($=>$.optional):[]).map($=>$.name)),p.params&&il(p.params,_.keys.map($=>$.name))),E=_.stringify(C)}else if(p.path!=null)E=p.path,_=s.find($=>$.re.test(E)),_&&(C=_.parse(E),M=_.record.name);else{if(_=h.name?n.get(h.name):s.find($=>$.re.test(h.path)),!_)throw ns(fe.MATCHER_NOT_FOUND,{location:p,currentLocation:h});M=_.record.name,C=ie({},h.params,p.params),E=_.stringify(C)}const w=[];let x=_;for(;x;)w.unshift(x.record),x=x.parent;return{name:M,path:E,params:C,matched:w,meta:hp(w)}}e.forEach(p=>l(p));function c(){s.length=0,n.clear()}return{addRoute:l,resolve:d,removeRoute:o,clearRoutes:c,getRoutes:r,getRecordMatcher:i}}function il(e,t){const s={};for(const n of t)n in e&&(s[n]=e[n]);return s}function ll(e){const t={path:e.path,redirect:e.redirect,name:e.name,meta:e.meta||{},aliasOf:e.aliasOf,beforeEnter:e.beforeEnter,props:fp(e),children:e.children||[],instances:{},leaveGuards:new Set,updateGuards:new Set,enterCallbacks:{},components:"components"in e?e.components||null:e.component&&{default:e.component}};return Object.defineProperty(t,"mods",{value:{}}),t}function fp(e){const t={},s=e.props||!1;if("component"in e)t.default=s;else for(const n in e.components)t[n]=typeof s=="object"?s[n]:s;return t}function ol(e){for(;e;){if(e.record.aliasOf)return!0;e=e.parent}return!1}function hp(e){return e.reduce((t,s)=>ie(t,s.meta),{})}function _p(e,t){let s=0,n=t.length;for(;s!==n;){const l=s+n>>1;Bo(e,t[l])<0?n=l:s=l+1}const i=gp(e);return i&&(n=t.lastIndexOf(i,n-1)),n}function gp(e){let t=e;for(;t=t.parent;)if(Fo(t)&&Bo(e,t)===0)return t}function Fo({record:e}){return!!(e.name||e.components&&Object.keys(e.components).length||e.redirect)}function rl(e){const t=at(oi),s=at(ri),n=Oe(()=>{const a=Ce(e.to);return t.resolve(a)}),i=Oe(()=>{const{matched:a}=n.value,{length:d}=a,c=a[d-1],p=s.matched;if(!c||!p.length)return-1;const h=p.findIndex(is.bind(null,c));if(h>-1)return h;const _=al(a[d-2]);return d>1&&al(c)===_&&p[p.length-1].path!==_?p.findIndex(is.bind(null,a[d-2])):h}),l=Oe(()=>i.value>-1&&yp(s.params,n.value.params)),o=Oe(()=>i.value>-1&&i.value===s.matched.length-1&&Uo(s.params,n.value.params));function r(a={}){if(bp(a)){const d=t[Ce(e.replace)?"replace":"push"](Ce(e.to)).catch(bs);return e.viewTransition&&typeof document<"u"&&"startViewTransition"in document&&document.startViewTransition(()=>d),d}return Promise.resolve()}return{route:n,href:Oe(()=>n.value.href),isActive:l,isExactActive:o,navigate:r}}function mp(e){return e.length===1?e[0]:e}const vp=Jl({name:"RouterLink",compatConfig:{MODE:3},props:{to:{type:[String,Object],required:!0},replace:Boolean,activeClass:String,exactActiveClass:String,custom:Boolean,ariaCurrentValue:{type:String,default:"page"},viewTransition:Boolean},useLink:rl,setup(e,{slots:t}){const s=tn(rl(e)),{options:n}=at(oi),i=Oe(()=>({[cl(e.activeClass,n.linkActiveClass,"router-link-active")]:s.isActive,[cl(e.exactActiveClass,n.linkExactActiveClass,"router-link-exact-active")]:s.isExactActive}));return()=>{const l=t.default&&mp(t.default(s));return e.custom?l:li("a",{"aria-current":s.isExactActive?e.ariaCurrentValue:null,href:s.href,onClick:s.navigate,class:i.value},l)}}}),zt=vp;function bp(e){if(!(e.metaKey||e.altKey||e.ctrlKey||e.shiftKey)&&!e.defaultPrevented&&!(e.button!==void 0&&e.button!==0)){if(e.currentTarget&&e.currentTarget.getAttribute){const t=e.currentTarget.getAttribute("target");if(/\b_blank\b/i.test(t))return}return e.preventDefault&&e.preventDefault(),!0}}function yp(e,t){for(const s in t){const n=t[s],i=e[s];if(typeof n=="string"){if(n!==i)return!1}else if(!Je(i)||i.length!==n.length||n.some((l,o)=>l.valueOf()!==i[o].valueOf()))return!1}return!0}function al(e){return e?e.aliasOf?e.aliasOf.path:e.path:""}const cl=(e,t,s)=>e??t??s,Ap=Jl({name:"RouterView",inheritAttrs:!1,props:{name:{type:String,default:"default"},route:Object},compatConfig:{MODE:3},setup(e,{attrs:t,slots:s}){const n=at(kn),i=Oe(()=>e.route||n.value),l=at(Ji,0),o=Oe(()=>{let d=Ce(l);const{matched:c}=i.value;let p;for(;(p=c[d])&&!p.components;)d++;return d}),r=Oe(()=>i.value.matched[o.value]);Ds(Ji,Oe(()=>o.value+1)),Ds(Ac,r),Ds(kn,i);const a=Me();return Bt(()=>[a.value,r.value,e.name],([d,c,p],[h,_,C])=>{c&&(c.instances[p]=d,_&&_!==c&&d&&d===h&&(c.leaveGuards.size||(c.leaveGuards=_.leaveGuards),c.updateGuards.size||(c.updateGuards=_.updateGuards))),d&&c&&(!_||!is(c,_)||!h)&&(c.enterCallbacks[p]||[]).forEach(E=>E(d))},{flush:"post"}),()=>{const d=i.value,c=e.name,p=r.value,h=p&&p.components[c];if(!h)return pl(s.default,{Component:h,route:d});const _=p.props[c],C=_?_===!0?d.params:typeof _=="function"?_(d):_:null,M=li(h,ie({},C,t,{onVnodeUnmounted:w=>{w.component.isUnmounted&&(p.instances[c]=null)},ref:a}));return pl(s.default,{Component:M,route:d})||M}}});function pl(e,t){if(!e)return null;const s=e(t);return s.length===1?s[0]:s}const Sp=Ap;function Ep(e){const t=dp(e.routes,e),s=e.parseQuery||zc,n=e.stringifyQuery||el,i=e.history,l=ps(),o=ps(),r=ps(),a=Cr(Ct);let d=Ct;Xt&&e.scrollBehavior&&"scrollRestoration"in history&&(history.scrollRestoration="manual");const c=Sn.bind(null,y=>""+y),p=Sn.bind(null,$c),h=Sn.bind(null,Ps);function _(y,N){let T,k;return ko(y)?(T=t.getRecordMatcher(y),k=N):k=y,t.addRoute(k,T)}function C(y){const N=t.getRecordMatcher(y);N&&t.removeRoute(N)}function E(){return t.getRoutes().map(y=>y.record)}function M(y){return!!t.getRecordMatcher(y)}function w(y,N){if(N=ie({},N||a.value),typeof y=="string"){const g=En(s,y,N.path),v=t.resolve({path:g.path},N),A=i.createHref(g.fullPath);return ie(g,v,{params:h(v.params),hash:Ps(g.hash),redirectedFrom:void 0,href:A})}let T;if(y.path!=null)T=ie({},y,{path:En(s,y.path,N.path).path});else{const g=ie({},y.params);for(const v in g)g[v]==null&&delete g[v];T=ie({},y,{params:p(g)}),N.params=p(N.params)}const k=t.resolve(T,N),z=y.hash||"";k.params=c(h(k.params));const u=Uc(n,ie({},y,{hash:jc(z),path:k.path})),f=i.createHref(u);return ie({fullPath:u,hash:z,query:n===el?Jc(y.query):y.query||{}},k,{redirectedFrom:void 0,href:f})}function x(y){return typeof y=="string"?En(s,y,a.value.path):ie({},y)}function $(y,N){if(d!==y)return ns(fe.NAVIGATION_CANCELLED,{from:N,to:y})}function j(y){return Q(y)}function G(y){return j(ie(x(y),{replace:!0}))}function Y(y,N){const T=y.matched[y.matched.length-1];if(T&&T.redirect){const{redirect:k}=T;let z=typeof k=="function"?k(y,N):k;return typeof z=="string"&&(z=z.includes("?")||z.includes("#")?z=x(z):{path:z},z.params={}),ie({query:y.query,hash:y.hash,params:z.path!=null?{}:y.params},z)}}function Q(y,N){const T=d=w(y),k=a.value,z=y.state,u=y.force,f=y.replace===!0,g=Y(T,k);if(g)return Q(ie(x(g),{state:typeof g=="object"?ie({},z,g.state):z,force:u,replace:f}),N||T);const v=T;v.redirectedFrom=N;let A;return!u&&kc(n,k,T)&&(A=ns(fe.NAVIGATION_DUPLICATED,{to:v,from:k}),Qe(k,k,!0,!1)),(A?Promise.resolve(A):X(v,k)).catch(b=>ft(b)?ft(b,fe.NAVIGATION_GUARD_REDIRECT)?b:St(b):ne(b,v,k)).then(b=>{if(b){if(ft(b,fe.NAVIGATION_GUARD_REDIRECT))return Q(ie({replace:f},x(b.to),{state:typeof b.to=="object"?ie({},z,b.to.state):z,force:u}),N||v)}else b=D(v,k,!0,f,z);return re(v,k,b),b})}function Ae(y,N){const T=$(y,N);return T?Promise.reject(T):Promise.resolve()}function V(y){const N=Wt.values().next().value;return N&&typeof N.runWithContext=="function"?N.runWithContext(y):y()}function X(y,N){let T;const[k,z,u]=Qc(y,N);T=xn(k.reverse(),"beforeRouteLeave",y,N);for(const g of k)g.leaveGuards.forEach(v=>{T.push(It(v,y,N))});const f=Ae.bind(null,y,N);return T.push(f),He(T).then(()=>{T=[];for(const g of l.list())T.push(It(g,y,N));return T.push(f),He(T)}).then(()=>{T=xn(z,"beforeRouteUpdate",y,N);for(const g of z)g.updateGuards.forEach(v=>{T.push(It(v,y,N))});return T.push(f),He(T)}).then(()=>{T=[];for(const g of u)if(g.beforeEnter)if(Je(g.beforeEnter))for(const v of g.beforeEnter)T.push(It(v,y,N));else T.push(It(g.beforeEnter,y,N));return T.push(f),He(T)}).then(()=>(y.matched.forEach(g=>g.enterCallbacks={}),T=xn(u,"beforeRouteEnter",y,N,V),T.push(f),He(T))).then(()=>{T=[];for(const g of o.list())T.push(It(g,y,N));return T.push(f),He(T)}).catch(g=>ft(g,fe.NAVIGATION_CANCELLED)?g:Promise.reject(g))}function re(y,N,T){r.list().forEach(k=>V(()=>k(y,N,T)))}function D(y,N,T,k,z){const u=$(y,N);if(u)return u;const f=N===Ct,g=Xt?history.state:{};T&&(k||f?i.replace(y.fullPath,ie({scroll:f&&g&&g.scroll},z)):i.push(y.fullPath,z)),a.value=y,Qe(y,N,T,f),St()}let se;function Se(){se||(se=i.listen((y,N,T)=>{if(!Tt.listening)return;const k=w(y),z=Y(k,Tt.currentRoute.value);if(z){Q(ie(z,{replace:!0,force:!0}),k).catch(bs);return}d=k;const u=a.value;Xt&&Gc(Zi(u.fullPath,T.delta),an()),X(k,u).catch(f=>ft(f,fe.NAVIGATION_ABORTED|fe.NAVIGATION_CANCELLED)?f:ft(f,fe.NAVIGATION_GUARD_REDIRECT)?(Q(ie(x(f.to),{force:!0}),k).then(g=>{ft(g,fe.NAVIGATION_ABORTED|fe.NAVIGATION_DUPLICATED)&&!T.delta&&T.type===Bn.pop&&i.go(-1,!1)}).catch(bs),Promise.reject()):(T.delta&&i.go(-T.delta,!1),ne(f,k,u))).then(f=>{f=f||D(k,u,!1),f&&(T.delta&&!ft(f,fe.NAVIGATION_CANCELLED)?i.go(-T.delta,!1):T.type===Bn.pop&&ft(f,fe.NAVIGATION_ABORTED|fe.NAVIGATION_DUPLICATED)&&i.go(-1,!1)),re(k,u,f)}).catch(bs)}))}let Le=ps(),_e=ps(),ae;function ne(y,N,T){St(y);const k=_e.list();return k.length?k.forEach(z=>z(y,N,T)):console.error(y),Promise.reject(y)}function pt(){return ae&&a.value!==Ct?Promise.resolve():new Promise((y,N)=>{Le.add([y,N])})}function St(y){return ae||(ae=!y,Se(),Le.list().forEach(([N,T])=>y?T(y):N()),Le.reset()),y}function Qe(y,N,T,k){const{scrollBehavior:z}=e;if(!Xt||!z)return Promise.resolve();const u=!T&&qc(Zi(y.fullPath,0))||(k||!T)&&history.state&&history.state.scroll||null;return ss().then(()=>z(y,N,u)).then(f=>f&&Wc(f)).catch(f=>ne(f,y,N))}const De=y=>i.go(y);let Kt;const Wt=new Set,Tt={currentRoute:a,listening:!0,addRoute:_,removeRoute:C,clearRoutes:t.clearRoutes,hasRoute:M,getRoutes:E,resolve:w,options:e,push:j,replace:G,go:De,back:()=>De(-1),forward:()=>De(1),beforeEach:l.add,beforeResolve:o.add,afterEach:r.add,onError:_e.add,isReady:pt,install(y){y.component("RouterLink",zt),y.component("RouterView",Sp),y.config.globalProperties.$router=Tt,Object.defineProperty(y.config.globalProperties,"$route",{enumerable:!0,get:()=>Ce(a)}),Xt&&!Kt&&a.value===Ct&&(Kt=!0,j(i.location).catch(k=>{}));const N={};for(const k in Ct)Object.defineProperty(N,k,{get:()=>a.value[k],enumerable:!0});y.provide(oi,Tt),y.provide(ri,$l(N)),y.provide(kn,a);const T=y.unmount;Wt.add(y),y.unmount=function(){Wt.delete(y),Wt.size<1&&(d=Ct,se&&se(),se=null,a.value=Ct,Kt=!1,ae=!1),T()}}};function He(y){return y.reduce((N,T)=>N.then(()=>V(T)),Promise.resolve())}return Tt}const Cp={class:"header"},xp={class:"container header__inner"},Ip=["aria-expanded"],wp={__name:"Header",setup(e){const t=Me(!1),s=()=>{t.value=!t.value},n=()=>{t.value=!1};return Bt(t,i=>{document.body.style.overflow=i?"hidden":""}),(i,l)=>(U(),F("header",Cp,[m("div",xp,[q(Ce(zt),{to:"/",class:"header__logo",onClick:n},{default:ge(()=>[...l[0]||(l[0]=[ke(" Nomis ",-1)])]),_:1}),m("nav",{class:We(["header__nav",{"header__nav--open":t.value}])},[q(Ce(zt),{to:"/",class:"header__nav-link",onClick:n},{default:ge(()=>[...l[1]||(l[1]=[ke("Home",-1)])]),_:1}),q(Ce(zt),{to:"/projects",class:"header__nav-link",onClick:n},{default:ge(()=>[...l[2]||(l[2]=[ke("Projects",-1)])]),_:1}),q(Ce(zt),{to:"/leadership",class:"header__nav-link",onClick:n},{default:ge(()=>[...l[3]||(l[3]=[ke("Leadership",-1)])]),_:1}),q(Ce(zt),{to:"/about",class:"header__nav-link",onClick:n},{default:ge(()=>[...l[4]||(l[4]=[ke("About",-1)])]),_:1}),m("a",{href:"/resume.pdf",target:"_blank",class:"header__nav-link header__nav-link--resume",onClick:n},"Resume")],2),m("button",{class:We(["header__hamburger",{"header__hamburger--open":t.value}]),onClick:s,"aria-expanded":t.value},[...l[5]||(l[5]=[m("span",null,null,-1),m("span",null,null,-1),m("span",null,null,-1)])],10,Ip)])]))}},cn=(e,t)=>{const s=e.__vccOpts||e;for(const[n,i]of t)s[n]=i;return s},Pp={},Rp={class:"footer"};function Tp(e,t){return U(),F("footer",Rp,[...t[0]||(t[0]=[m("div",{class:"container footer__inner"},[m("p",{class:"footer__copy"},"© 2026 Nomis. All rights reserved."),m("a",{href:"mailto:nomis820710@gmail.com",class:"footer__email"},"nomis820710@gmail.com")],-1)])])}const jp=cn(Pp,[["render",Tp]]),Op={__name:"BackToTop",setup(e){const t=Me(!1),s=()=>{t.value=window.scrollY>400},n=()=>{window.scrollTo({top:0,behavior:"smooth"})};return Ht(()=>window.addEventListener("scroll",s)),Vt(()=>window.removeEventListener("scroll",s)),(i,l)=>(U(),F("button",{class:We(["back-to-top",{"back-to-top--visible":t.value}]),onClick:n,"aria-label":"回到頂部"},[...l[0]||(l[0]=[m("i",{class:"fa-solid fa-arrow-up"},null,-1)])],2))}},Mp={__name:"App",setup(e){return(t,s)=>{const n=ls("RouterView");return U(),F(ee,null,[q(wp),m("main",null,[q(n,null,{default:ge(({Component:i})=>[q(Va,{name:"fade",mode:"out-in"},{default:ge(()=>[(U(),Pt(Qr(i)))]),_:2},1024)]),_:1})]),q(jp),q(Op)],64)}}},$p=cn(Mp,[["__scopeId","data-v-91c92250"]]),Dp="/portfolio/images/general/hero-photo.jpg",Np="/portfolio/images/general/avatar-chen.jpg",Up="/portfolio/images/general/avatar-liao.jpg";function mt(e){return"/portfolio/"+e.replace(/^\//,"")}const kp={class:"project-card__cover"},Lp=["src","alt"],Bp={class:"project-card__body"},Fp={class:"project-card__hashtags"},Hp={class:"project-card__title"},Vp={class:"project-card__desc"},Kp={class:"project-card__tags"},Ho={__name:"ProjectCard",props:{project:{type:Object,required:!0}},setup(e){return(t,s)=>{const n=ls("RouterLink");return U(),Pt(n,{to:`/projects/${e.project.id}`,class:"project-card"},{default:ge(()=>[m("div",kp,[m("img",{src:Ce(mt)(e.project.cover),alt:e.project.title},null,8,Lp)]),m("div",Bp,[m("div",Fp,[(U(!0),F(ee,null,me(e.project.hashtags,i=>(U(),F("span",{key:i,class:"project-card__hashtag"}," #"+J(i),1))),128))]),m("h3",Hp,J(e.project.title),1),m("p",Vp,J(e.project.description),1),m("div",Kp,[(U(!0),F(ee,null,me(e.project.tags,i=>(U(),F("span",{key:i,class:"project-card__tag"},J(i),1))),128))])]),s[0]||(s[0]=m("div",{class:"project-card__cta"}," 查看專案 → ",-1))]),_:1},8,["to"])}}},ys=[{id:"elementary-king-ai-mv",title:"成本降低 99.7%：一人 15 天用 AI 完成傳統團隊 120 萬的動畫 MV",description:"公司尾牙業務表揚大會需要造勢影片，我在無預算、無團隊、無動畫背景的條件下，自主規劃 12 階段 AI 製作流程，獨立完成一部含 6 個角色的 3D 動畫 MV。影片現場引爆掌聲，董事長當場轉發集團主管群，並直接促成公司全面導入 AI 工具的決策。",cover:"/images/projects/project-3.jpg",hashtags:["AI-Native Workflow","跨職能執行力","ROI 極大化"],tags:["AI","Cross-functional"],category:["ai"],content:`
    <!-- 成效數字 -->
  ...
  `}],Wp={__name:"HeroCanvas",setup(e){const t=Me(null);let s=null;return Ht(()=>{const n=t.value,i=n.getContext("2d"),l=()=>{n.width=n.offsetWidth,n.height=n.offsetHeight};l(),window.addEventListener("resize",l);const r=Array.from({length:80},()=>({x:Math.random()*n.width,y:Math.random()*n.height,vx:(Math.random()-.5)*.3,vy:(Math.random()-.5)*.3,r:Math.random()*2+1}));let a=0;const d=()=>{n.width=n.offsetWidth,n.height=n.offsetHeight;const c=n.width,p=n.height;i.clearRect(0,0,c,p),a+=.005;const h=(Math.sin(a)+1)/2,_=i.createRadialGradient(c*.15,p*.5,0,c*.15,p*.5,c*.55);_.addColorStop(0,`rgba(79,142,247,${.25+h*.12})`),_.addColorStop(1,"transparent"),i.fillStyle=_,i.fillRect(0,0,c,p);const C=i.createRadialGradient(c*.85,p*.2,0,c*.85,p*.2,c*.45);C.addColorStop(0,`rgba(124,95,247,${.15+h*.1})`),C.addColorStop(1,"transparent"),i.fillStyle=C,i.fillRect(0,0,c,p);const E=i.createRadialGradient(c*.6,p*.8,0,c*.6,p*.8,c*.3);E.addColorStop(0,`rgba(79,142,247,${.08+h*.06})`),E.addColorStop(1,"transparent"),i.fillStyle=E,i.fillRect(0,0,c,p),r.forEach(w=>{w.x+=w.vx,w.y+=w.vy,(w.x<0||w.x>c)&&(w.vx*=-1),(w.y<0||w.y>p)&&(w.vy*=-1)});const M=130;for(let w=0;w<r.length;w++)for(let x=w+1;x<r.length;x++){const $=r[w].x-r[x].x,j=r[w].y-r[x].y,G=Math.sqrt($*$+j*j);if(G<M){const Y=(1-G/M)*.35;i.beginPath(),i.moveTo(r[w].x,r[w].y),i.lineTo(r[x].x,r[x].y),i.strokeStyle=`rgba(79,142,247,${Y})`,i.lineWidth=.8,i.stroke()}}r.forEach(w=>{i.beginPath(),i.arc(w.x,w.y,w.r,0,Math.PI*2),i.fillStyle="rgba(79,142,247,0.65)",i.fill()}),s=requestAnimationFrame(d)};Vt(()=>{cancelAnimationFrame(s),window.removeEventListener("resize",l)}),d()}),(n,i)=>(U(),F("canvas",{ref_key:"canvasRef",ref:t,class:"hero-canvas"},null,512))}},Gp=cn(Wp,[["__scopeId","data-v-92edd766"]]),qp={class:"home"},Xp={class:"hero section"},zp={class:"projects-preview section"},Jp={class:"container"},Qp={class:"projects-preview__grid"},Yp={class:"leadership-preview section"},Zp={class:"container leadership-preview__inner"},eu={class:"leadership-preview__content"},tu={class:"leadership-preview__articles"},su={class:"skills section"},nu={class:"container"},iu={class:"skills__grid"},lu={class:"skills__card-title"},ou={class:"skills__card-list"},ru={class:"skills__card-tags"},au={__name:"Home",setup(e){const t=[{title:"UIUX 設計",items:["使用者研究","資訊架構","互動設計","視覺設計"],tags:[{label:"查看 UIUX 專案",link:"/projects?tag=UIUX"}]},{title:"前端切版",items:["Vue.js","HTML / CSS","RWD","SCSS"],tags:[{label:"查看切版專案",link:"/projects?tag=Frontend"}]},{title:"設計策略",items:["競品分析","A/B 測試","數據分析","設計系統"],tags:[{label:"查看相關專案",link:"/projects?tag=Growth Design"}]},{title:"設計領導",items:["團隊管理","跨部門協作","設計評審","人才培育"],tags:[{label:"閱讀 Leadership 文章",link:"/leadership"}]},{title:"AI 產品設計",items:["AI 框架制定","AI 互動設計","信任設計","Prompt 設計"],tags:[{label:"查看 AI 專案",link:"/projects?tag=AI"}]},{title:"溝通與協作",items:["利害關係人溝通","設計提案","跨文化協作","衝突處理"],tags:[{label:"閱讀 Leadership 文章",link:"/leadership"}]},{title:"使用者研究",items:["使用者訪談","易用性測試","問卷設計","研究報告"],tags:[{label:"查看研究相關專案",link:"/projects?tag=Research"}]},{title:"數據驅動設計",items:["數據判讀","A/B 測試規劃","轉換率優化","成效追蹤"],tags:[{label:"查看相關專案",link:"/projects?tag=A/B Testing"}]},{title:"成長心態",items:["快速學習","主動解決問題","接受回饋","持續優化"],tags:[{label:"閱讀我的反思文章",link:"/leadership"}]}];return(s,n)=>{const i=ls("RouterLink");return U(),F("div",qp,[m("section",Xp,[q(Gp),n[0]||(n[0]=es('<div class="container hero__inner"><div class="hero__content"><h1 class="hero__title">嗨，我是 Nomis！</h1><p class="hero__subtitle">UIUX 設計師・前端工程師・設計主管</p><p class="hero__desc"> 擅長以數據驅動設計決策，打造以使用者為中心的產品體驗，跨文化協作與跨部門溝通是我的強項。 </p><div class="hero__cta"><a href="/portfolio/resume.pdf" target="_blank" class="btn btn--primary">下載履歷</a><a href="https://www.linkedin.com/in/" target="_blank" class="btn btn--secondary">LinkedIn</a><a href="mailto:nomis820710@gmail.com" class="btn btn--secondary">聯絡我</a></div></div><div class="hero__photo"><img src="'+Dp+'" alt="Nomis Yang"></div></div>',1))]),n[10]||(n[10]=es('<section class="features section"><div class="container features__grid"><div class="features__item"><h3 class="features__title">跨領域設計能力</h3><p class="features__desc"> 橫跨 UIUX 設計、前端切版與設計管理，能從使用者研究、視覺設計到程式實作一手包辦，確保設計落地不失真。 </p></div><div class="features__item"><h3 class="features__title">數據驅動的設計決策</h3><p class="features__desc"> 習慣以數據佐證設計方向，透過 A/B 測試、使用者訪談與競品分析，持續優化產品體驗並創造可量化的成效。 </p></div><div class="features__item"><h3 class="features__title">跨部門協作與領導</h3><p class="features__desc"> 具備帶領設計團隊的實戰經驗，善於在產品、工程與商業目標之間建立共識，推動專案從 0 到 1 順利落地。 </p></div></div></section>',1)),m("section",zp,[m("div",Jp,[m("div",Qp,[(U(!0),F(ee,null,me(Ce(ys),l=>(U(),Pt(Ho,{key:l.id,project:l},null,8,["project"]))),128))])])]),m("section",Yp,[m("div",Zp,[m("div",eu,[n[2]||(n[2]=m("p",{class:"leadership-preview__label"},"Leadership",-1)),n[3]||(n[3]=m("h2",{class:"leadership-preview__title"},"設計領導力的實踐與反思",-1)),n[4]||(n[4]=m("p",{class:"leadership-preview__desc"}," 從個人貢獻者到帶領團隊，我持續記錄在設計管理路上的觀察與學習。 包含團隊管理心得、專案決策過程、帶人的方法論，以及個人成長反思。 ",-1)),q(i,{to:"/leadership",class:"btn btn--primary"},{default:ge(()=>[...n[1]||(n[1]=[ke(" 閱讀更多文章 → ",-1)])]),_:1})]),m("div",tu,[q(i,{to:"/leadership/psychological-safety",class:"leadership-preview__article"},{default:ge(()=>[...n[5]||(n[5]=[m("p",{class:"leadership-preview__article-tag"},"帶團隊的方法論",-1),m("h4",{class:"leadership-preview__article-title"},"如何在設計評審中建立心理安全感",-1),m("p",{class:"leadership-preview__article-cta"},"閱讀文章 →",-1)])]),_:1}),q(i,{to:"/leadership/design-vs-business",class:"leadership-preview__article"},{default:ge(()=>[...n[6]||(n[6]=[m("p",{class:"leadership-preview__article-tag"},"專案決策過程",-1),m("h4",{class:"leadership-preview__article-title"},"當設計目標與商業目標衝突時，我怎麼做決定",-1),m("p",{class:"leadership-preview__article-cta"},"閱讀文章 →",-1)])]),_:1}),q(i,{to:"/leadership/designer-to-lead",class:"leadership-preview__article"},{default:ge(()=>[...n[7]||(n[7]=[m("p",{class:"leadership-preview__article-tag"},"個人成長反思",-1),m("h4",{class:"leadership-preview__article-title"},"從設計師到設計主管：角色轉換的第一年",-1),m("p",{class:"leadership-preview__article-cta"},"閱讀文章 →",-1)])]),_:1})])])]),m("section",su,[m("div",nu,[n[8]||(n[8]=m("p",{class:"skills__label"},"How I Contribute",-1)),n[9]||(n[9]=m("h2",{class:"skills__title"},"我如何用專業技能貢獻",-1)),m("div",iu,[(U(),F(ee,null,me(t,l=>m("div",{key:l.title,class:"skills__card"},[m("h4",lu,J(l.title),1),m("ul",ou,[(U(!0),F(ee,null,me(l.items,o=>(U(),F("li",{key:o},J(o),1))),128))]),m("div",ru,[(U(!0),F(ee,null,me(l.tags,o=>(U(),Pt(i,{key:o.label,to:o.link,class:"skills__card-tag"},{default:ge(()=>[ke(J(o.label),1)]),_:2},1032,["to"]))),128))])])),64))])])]),n[11]||(n[11]=es('<section class="testimonials section"><div class="container"><p class="testimonials__label">Recommendations</p><h2 class="testimonials__title">他們這樣說</h2><div class="testimonials__grid"><div class="testimonials__card"><p class="testimonials__card-title">執行力與溝通能力超乎預期，對回饋保持開放</p><p class="testimonials__card-content"> Nomis 是一位充滿熱情的 UIUX 設計師，以創新思維和快速適應新挑戰的能力著稱。 她的執行速度與溝通品質持續超乎預期，是團隊中不可或缺的夥伴。 對回饋始終保持開放，持續尋求改進，對團隊的成功貢獻良多。 </p><div class="testimonials__card-author"><img src="'+Np+'" alt="陳大明" class="testimonials__card-avatar"><div><p class="testimonials__card-name">陳大明</p><p class="testimonials__card-role">2024年6月・iOS 工程師・直接主管</p></div></div></div><div class="testimonials__card"><p class="testimonials__card-title">能理解並轉化使用者需求為直覺且美觀的設計</p><p class="testimonials__card-content"> 與 Nomis 共事是非常愉快的經驗。她始終展現出理解並將使用者需求轉化為直覺且視覺吸引力設計的能力。 她的創意和解決問題的技巧在應對專案挑戰時發揮了關鍵作用。 支持性的個性與強大的溝通技巧營造了積極的協作環境，是可靠又具創新力的夥伴。 </p><div class="testimonials__card-author"><img src="'+Up+'" alt="廖小華" class="testimonials__card-avatar"><div><p class="testimonials__card-name">廖小華</p><p class="testimonials__card-role">2024年6月・產品經理・同團隊成員</p></div></div></div></div></div></section>',1))])}}},cu={class:"projects-page"},pu={class:"projects-list section"},uu={class:"container"},du={class:"projects-list__filters"},fu=["onClick"],hu={class:"projects-list__grid"},_u={key:0,class:"projects-list__empty"},gu={__name:"Projects",setup(e){const t=["All",...new Set(ys.flatMap(i=>i.tags))],s=Me("All"),n=Oe(()=>s.value==="All"?ys:ys.filter(i=>i.tags.includes(s.value)));return(i,l)=>(U(),F("div",cu,[l[0]||(l[0]=es('<section class="projects-hero section"><div class="container"><p class="projects-hero__label">My Work</p><h1 class="projects-hero__title">Projects</h1><p class="projects-hero__desc"> 橫跨 UIUX 設計、前端切版與 AI 產品設計的實戰專案，每個專案都有可量化的成效與完整的設計思考過程。 </p></div></section>',1)),m("section",pu,[m("div",uu,[m("div",du,[(U(),F(ee,null,me(t,o=>m("button",{key:o,class:We(["projects-list__filter",{"projects-list__filter--active":s.value===o}]),onClick:r=>s.value=o},J(o),11,fu)),64))]),m("div",hu,[(U(!0),F(ee,null,me(n.value,o=>(U(),Pt(Ho,{key:o.id,project:o},null,8,["project"]))),128))]),n.value.length===0?(U(),F("p",_u," 目前沒有符合此分類的專案。 ")):Eo("",!0)])])]))}},mu={key:0,class:"project-detail"},vu={class:"project-detail-hero section"},bu={class:"container"},yu={class:"project-detail-hero__hashtags"},Au={class:"project-detail-hero__title"},Su={class:"project-detail-hero__desc"},Eu={class:"project-detail-hero__tags"},Cu={class:"project-detail-cover"},xu={class:"container"},Iu=["src","alt"],wu={class:"project-detail-content section"},Pu={class:"container project-detail-content__layout"},Ru={class:"toc-float__panel"},Tu={class:"toc-float__list"},ju=["onClick"],Ou={class:"toc-sidebar"},Mu={class:"toc-sidebar__list"},$u=["onClick"],Du=["innerHTML"],Nu={class:"project-detail-nav section"},Uu={class:"container"},ku={key:1,class:"project-detail-notfound section"},Lu={class:"container"},Bu={__name:"ProjectDetail",setup(e){const t=jo(),s=Oe(()=>ys.find(c=>c.id===t.params.id)),n=Me([]),i=Me(""),l=Me(null),o=Me(!1),r=()=>{if(!l.value)return;const c=l.value.querySelectorAll("h2, h3");n.value=Array.from(c).map((p,h)=>{const _=`heading-${h}`;return p.id=_,{id:_,text:p.textContent,level:p.tagName}})},a=()=>{if(!l.value)return;const c=l.value.querySelectorAll("h2, h3");let p="";c.forEach(h=>{h.getBoundingClientRect().top<=350&&(p=h.id)}),i.value=p},d=c=>{const p=document.getElementById(c);p&&p.scrollIntoView({behavior:"smooth",block:"start"})};return Ht(()=>{ss(()=>{r(),window.addEventListener("scroll",a)})}),Vt(()=>{window.removeEventListener("scroll",a)}),Bt(s,()=>{ss(()=>r())}),(c,p)=>{const h=ls("RouterLink");return s.value?(U(),F("div",mu,[m("section",vu,[m("div",bu,[q(h,{to:"/projects",class:"project-detail-hero__back"},{default:ge(()=>[...p[1]||(p[1]=[ke("← 返回 Projects",-1)])]),_:1}),m("div",yu,[(U(!0),F(ee,null,me(s.value.hashtags,_=>(U(),F("span",{key:_,class:"project-detail-hero__hashtag"},"#"+J(_),1))),128))]),m("h1",Au,J(s.value.title),1),m("p",Su,J(s.value.description),1),m("div",Eu,[(U(!0),F(ee,null,me(s.value.tags,_=>(U(),F("span",{key:_,class:"project-detail-hero__tag"},J(_),1))),128))])])]),m("div",Cu,[m("div",xu,[m("img",{src:Ce(mt)(s.value.cover),alt:s.value.title,class:"project-detail-cover__img"},null,8,Iu)])]),m("section",wu,[m("div",Pu,[m("div",{class:We(["toc-float",{"toc-float--open":o.value}])},[m("button",{class:"toc-float__toggle",onClick:p[0]||(p[0]=_=>o.value=!o.value),"aria-label":"目錄"},[...p[2]||(p[2]=[m("i",{class:"fa-solid fa-list"},null,-1)])]),m("div",Ru,[p[3]||(p[3]=m("p",{class:"toc-float__title"},"目錄",-1)),m("ul",Tu,[(U(!0),F(ee,null,me(n.value,_=>(U(),F("li",{key:_.id},[m("a",{onClick:Xs(C=>{d(_.id),o.value=!1},["prevent"]),href:"#"},J(_.text),9,ju)]))),128))])])],2),m("aside",Ou,[p[4]||(p[4]=m("p",{class:"toc-sidebar__title"},"目錄",-1)),m("ul",Mu,[(U(!0),F(ee,null,me(n.value,_=>(U(),F("li",{key:_.id,class:"toc-sidebar__item"},[m("a",{onClick:Xs(C=>d(_.id),["prevent"]),href:"#",class:We(["toc-sidebar__link",{"toc-sidebar__link--active":i.value===_.id}])},J(_.text),11,$u)]))),128))])]),m("div",{class:"project-detail-content__body",ref_key:"contentRef",ref:l,innerHTML:s.value.content},null,8,Du)])]),m("section",Nu,[m("div",Uu,[q(h,{to:"/projects",class:"btn btn--secondary"},{default:ge(()=>[...p[5]||(p[5]=[ke("← 查看所有專案",-1)])]),_:1})])])])):(U(),F("div",ku,[m("div",Lu,[p[7]||(p[7]=m("h1",null,"找不到此專案",-1)),q(h,{to:"/projects",class:"btn btn--primary"},{default:ge(()=>[...p[6]||(p[6]=[ke("返回 Projects",-1)])]),_:1})])]))}}},Fu={class:"article-card__cover"},Hu=["src","alt"],Vu={class:"article-card__body"},Ku={class:"article-card__hashtags"},Wu={class:"article-card__title"},Gu={class:"article-card__desc"},qu={class:"article-card__date"},Xu={__name:"ArticleCard",props:{article:{type:Object,required:!0}},setup(e){return(t,s)=>{const n=ls("RouterLink");return U(),Pt(n,{to:`/leadership/${e.article.id}`,class:"article-card"},{default:ge(()=>[m("div",Fu,[m("img",{src:Ce(mt)(e.article.cover),alt:e.article.title},null,8,Hu)]),m("div",Vu,[m("div",Ku,[(U(!0),F(ee,null,me(e.article.hashtags,i=>(U(),F("span",{key:i,class:"article-card__hashtag"}," #"+J(i),1))),128))]),m("h3",Wu,J(e.article.title),1),m("p",Gu,J(e.article.description),1),m("p",qu,J(e.article.date),1)]),s[0]||(s[0]=m("div",{class:"article-card__cta"}," 閱讀文章 → ",-1))]),_:1},8,["to"])}}},Ls=[{id:"equal-treatment-trap",title:"我以為一視同仁是公平，這機會卻差點壓垮了她",description:"把同一份標準套在每個人身上，不一定是公平，有時候是一種忽視。這篇文章分享我如何在一個新手設計師的第一個獨立 UIUX 專案中，從「太晚發現問題」到「找到適合她的工作方式」。",cover:"/images/articles/article-1.jpg",hashtags:["工作拆解","因材施教","設計師成長"],tags:["個人成長反思","設計團隊管理心得","專案決策過程"],date:"2026-02-06",content:`
  ...
  `},{id:"impossible-deadline-two-weeks",title:"我們如何在兩週內，完成一個不可能的任務",description:"老闆踩死的 deadline、PM 規劃一個月才丟來的需求，但最後設計部不只準時交付，還讓我看見一件更重要的事：真正讓任務得以完成的力量，早在這個專案之前就已經存在了。",cover:"/images/articles/article-3.jpg",hashtags:["任務拆解與同步推進","自主分工設計","長期信任感積累"],tags:["帶團隊的方法論","專案決策過程"],date:"2025-02-24",content:`
    ...
    <p>我何德何能，有這樣一群夥伴。</p>
  `}],zu={class:"leadership-page"},Ju={class:"leadership-list section"},Qu={class:"container"},Yu={class:"leadership-list__filters"},Zu=["onClick"],ed={class:"leadership-list__grid"},td={key:0,class:"leadership-list__empty"},sd={__name:"Leadership",setup(e){const t=["All",...new Set(Ls.flatMap(i=>i.tags))],s=Me("All"),n=Oe(()=>s.value==="All"?Ls:Ls.filter(i=>i.tags.includes(s.value)));return(i,l)=>(U(),F("div",zu,[l[0]||(l[0]=es('<section class="leadership-hero section"><div class="container"><p class="leadership-hero__label">My Thoughts</p><h1 class="leadership-hero__title">Leadership</h1><p class="leadership-hero__desc"> 記錄我在設計管理路上真實發生的事：那些摸索過的方法論、踩過的決策、帶人時的觀察，以及在過程中慢慢長出來的反思。 </p></div></section>',1)),m("section",Ju,[m("div",Qu,[m("div",Yu,[(U(),F(ee,null,me(t,o=>m("button",{key:o,class:We(["leadership-list__filter",{"leadership-list__filter--active":s.value===o}]),onClick:r=>s.value=o},J(o),11,Zu)),64))]),m("div",ed,[(U(!0),F(ee,null,me(n.value,o=>(U(),Pt(Xu,{key:o.id,article:o},null,8,["article"]))),128))]),n.value.length===0?(U(),F("p",td," 目前沒有符合此分類的文章。 ")):Eo("",!0)])])]))}},nd={key:0,class:"article-detail"},id={class:"article-detail-hero section"},ld={class:"container"},od={class:"article-detail-hero__hashtags"},rd={class:"article-detail-hero__title"},ad={class:"article-detail-hero__desc"},cd={class:"article-detail-hero__date"},pd={class:"article-detail-cover"},ud={class:"container"},dd=["src","alt"],fd={class:"article-detail-content section"},hd={class:"container article-detail-content__layout"},_d={class:"article-toc-float__panel"},gd={class:"article-toc-float__list"},md=["onClick"],vd={class:"article-toc-sidebar"},bd={class:"article-toc-sidebar__list"},yd=["onClick"],Ad=["innerHTML"],Sd={class:"article-detail-nav section"},Ed={class:"container"},Cd={key:1,class:"article-detail-notfound section"},xd={class:"container"},Id={__name:"ArticleDetail",setup(e){const t=jo(),s=Oe(()=>Ls.find(c=>c.id===t.params.id)),n=Me([]),i=Me(""),l=Me(null),o=Me(!1),r=()=>{if(!l.value)return;const c=l.value.querySelectorAll("h2, h3");n.value=Array.from(c).map((p,h)=>{const _=`article-heading-${h}`;return p.id=_,{id:_,text:p.textContent,level:p.tagName}})},a=()=>{if(!l.value)return;const c=l.value.querySelectorAll("h2, h3");let p="";c.forEach(h=>{h.getBoundingClientRect().top<=350&&(p=h.id)}),i.value=p},d=c=>{const p=document.getElementById(c);p&&p.scrollIntoView({behavior:"smooth",block:"start"})};return Ht(()=>{ss(()=>{r(),window.addEventListener("scroll",a)})}),Vt(()=>{window.removeEventListener("scroll",a)}),Bt(s,()=>{ss(()=>r())}),(c,p)=>{const h=ls("RouterLink");return s.value?(U(),F("div",nd,[m("section",id,[m("div",ld,[q(h,{to:"/leadership",class:"article-detail-hero__back"},{default:ge(()=>[...p[1]||(p[1]=[ke(" ← 返回 Leadership ",-1)])]),_:1}),m("div",od,[(U(!0),F(ee,null,me(s.value.hashtags,_=>(U(),F("span",{key:_,class:"article-detail-hero__hashtag"}," #"+J(_),1))),128))]),m("h1",rd,J(s.value.title),1),m("p",ad,J(s.value.description),1),m("p",cd,J(s.value.date),1)])]),m("div",pd,[m("div",ud,[m("img",{src:Ce(mt)(s.value.cover),alt:s.value.title,class:"article-detail-cover__img"},null,8,dd)])]),m("section",fd,[m("div",hd,[m("div",{class:We(["article-toc-float",{"article-toc-float--open":o.value}])},[m("button",{class:"article-toc-float__toggle",onClick:p[0]||(p[0]=_=>o.value=!o.value),"aria-label":"目錄"},[...p[2]||(p[2]=[m("i",{class:"fa-solid fa-list"},null,-1)])]),m("div",_d,[p[3]||(p[3]=m("p",{class:"article-toc-float__title"},"目錄",-1)),m("ul",gd,[(U(!0),F(ee,null,me(n.value,_=>(U(),F("li",{key:_.id},[m("a",{onClick:Xs(C=>{d(_.id),o.value=!1},["prevent"]),href:"#"},J(_.text),9,md)]))),128))])])],2),m("aside",vd,[p[4]||(p[4]=m("p",{class:"article-toc-sidebar__title"},"目錄",-1)),m("ul",bd,[(U(!0),F(ee,null,me(n.value,_=>(U(),F("li",{key:_.id},[m("a",{onClick:Xs(C=>d(_.id),["prevent"]),href:"#",class:We(["article-toc-sidebar__link",{"article-toc-sidebar__link--active":i.value===_.id}])},J(_.text),11,yd)]))),128))])]),m("div",{class:"article-detail-content__body",ref_key:"contentRef",ref:l,innerHTML:s.value.content},null,8,Ad)])]),m("section",Sd,[m("div",Ed,[q(h,{to:"/leadership",class:"btn btn--secondary"},{default:ge(()=>[...p[5]||(p[5]=[ke(" ← 查看所有文章 ",-1)])]),_:1})])])])):(U(),F("div",Cd,[m("div",xd,[p[7]||(p[7]=m("h1",null,"找不到此文章",-1)),q(h,{to:"/leadership",class:"btn btn--primary"},{default:ge(()=>[...p[6]||(p[6]=[ke("返回 Leadership",-1)])]),_:1})])]))}}},wd={__name:"StoryCanvas",setup(e){const t=Me(null);let s=null;return Ht(()=>{const n=t.value,i=n.getContext("2d"),l=()=>{n.width=n.offsetWidth,n.height=n.offsetHeight};l(),window.addEventListener("resize",l);const o=2e3,r=800,a=()=>({x:(Math.random()-.5)*2,y:(Math.random()-.5)*2,z:Math.random()*r,pz:null}),d=Array.from({length:o},a);d.forEach(h=>{h.pz=h.z});const c=1.5,p=()=>{const h=n.width,_=n.height,C=h/2,E=_/2;i.fillStyle="rgba(10, 14, 26, 0.25)",i.fillRect(0,0,h,_),d.forEach(M=>{if(M.pz=M.z,M.z-=c,M.z<=1){Object.assign(M,a()),M.pz=M.z;return}const w=r/M.z,x=C+M.x*w*(h/2),$=E+M.y*w*(_/2),j=r/M.pz,G=C+M.x*j*(h/2),Y=E+M.y*j*(_/2),Q=1-M.z/r,Ae=Math.pow(Q,1.5),V=Math.max(.3,Q*2.2),X=i.createLinearGradient(G,Y,x,$);if(X.addColorStop(0,"rgba(100,160,255,0)"),X.addColorStop(1,`rgba(200,225,255,${Ae*.95})`),i.beginPath(),i.moveTo(G,Y),i.lineTo(x,$),i.strokeStyle=X,i.lineWidth=V,i.lineCap="round",i.stroke(),Q>.6){const re=(Q-.6)/.4;i.beginPath(),i.arc(x,$,V*1.2,0,Math.PI*2),i.fillStyle=`rgba(220,235,255,${re*.9})`,i.fill()}}),s=requestAnimationFrame(p)};Vt(()=>{cancelAnimationFrame(s),window.removeEventListener("resize",l)}),p()}),(n,i)=>(U(),F("canvas",{ref_key:"canvasRef",ref:t,class:"story-canvas"},null,512))}},Pd=cn(wd,[["__scopeId","data-v-3f74bc40"]]),Rd={class:"about-page"},Td={class:"about-hero section"},jd={class:"container about-hero__inner"},Od={class:"about-hero__image"},Md=["src"],$d={class:"about-experience section"},Dd={class:"container"},Nd={class:"about-experience__list"},Ud={class:"about-experience__left"},kd={class:"about-experience__period"},Ld={class:"about-experience__right"},Bd={class:"about-experience__role"},Fd={class:"about-experience__company"},Hd={class:"about-experience__desc"},Vd={class:"about-story section"},Kd={class:"container"},Wd={class:"about-story__timeline"},Gd={class:"about-story__image"},qd=["src","alt"],Xd={class:"about-story__content"},zd={class:"about-story__period"},Jd={class:"about-story__role"},Qd={class:"about-story__tags"},Yd={class:"about-story__desc"},Zd={__name:"About",setup(e){const t=[{period:"2023 - 現在",role:"UIUX 設計主管",company:"某某科技公司",desc:"帶領設計團隊，負責產品設計策略制定、設計系統建立與跨部門協作。"},{period:"2021 - 2023",role:"UIUX 設計師",company:"MixerBox",desc:"負責 AI 產品的 UIUX 設計，主導多項 A/B 測試，成功提升訂閱轉換率 32%+。"},{period:"2019 - 2021",role:"前端工程師暨視覺設計師",company:"某某設計公司",desc:"負責網站前端切版與視覺設計，累積跨領域的設計與開發實務經驗。"}],s=[{period:"2016 - 2018",title:"視覺設計師",image:mt("/images/general/story/story-1.jpg"),tags:["品牌視覺","平面設計","美感養成"],desc:"從最基礎的視覺語言出發，學會如何用顏色、字型、排版傳達品牌個性。這個階段讓我建立了扎實的美感基礎，也讓我開始對「設計如何影響使用者感受」產生好奇。"},{period:"2018 - 2020",title:"UI 設計師",image:mt("/images/general/story/story-2.jpg"),tags:["介面設計","設計系統","跨部門協作"],desc:"開始接觸數位產品設計，學習如何在螢幕上建立清晰的視覺層次。與工程師合作的過程中，我意識到設計不只是好看，更要能被實作，這驅動我學習前端切版。"},{period:"2020 - 2022",title:"UIUX 設計師",image:mt("/images/general/story/story-3.jpg"),tags:["使用者研究","A/B 測試","數據驅動設計"],desc:"真正走進使用者的世界。透過訪談、測試、數據分析來驗證設計決策，讓我理解「好設計」的定義不是設計師說了算，而是使用者用腳投票的結果。"},{period:"2022 - 現在",title:"設計主管",image:mt("/images/general/story/story-4.jpg"),tags:["團隊管理","設計策略","跨部門影響力"],desc:"角色轉換讓我重新定義「貢獻」的意義。從做好一個設計，到讓整個團隊都能做好設計。管理是一門全新的學問，但也是我目前覺得最有意義的挑戰。"}];return(n,i)=>(U(),F("div",Rd,[m("section",Td,[m("div",jd,[i[0]||(i[0]=es('<div class="about-hero__content"><p class="about-hero__label">About Me</p><h1 class="about-hero__title">嗨，我是 Nomis！</h1><p class="about-hero__desc"> 我是一位橫跨 UIUX 設計、前端切版與設計管理的複合型設計師。 我相信好的設計不只是好看，而是能解決真實問題、創造可量化的商業價值。 </p><p class="about-hero__desc"> 目前專注於 AI 產品設計領域，對於如何在 AI 時代設計出讓使用者信任、願意使用的產品體驗，有深入的研究與實踐。 </p></div>',1)),m("div",Od,[m("img",{src:Ce(mt)("/images/general/avatar.jpg"),alt:"Nomis",class:"about-hero__avatar"},null,8,Md)])])]),m("section",$d,[m("div",Dd,[i[1]||(i[1]=m("h2",{class:"about-experience__title"},"工作經驗",-1)),m("div",Nd,[(U(),F(ee,null,me(t,l=>m("div",{key:l.company,class:"about-experience__item"},[m("div",Ud,[m("p",kd,J(l.period),1)]),m("div",Ld,[m("h3",Bd,J(l.role),1),m("p",Fd,J(l.company),1),m("p",Hd,J(l.desc),1)])])),64))])])]),m("section",Vd,[q(Pd),m("div",Kd,[i[2]||(i[2]=m("p",{class:"about-story__label"},"My Story",-1)),i[3]||(i[3]=m("h2",{class:"about-story__title"},"我如何成為 UIUX 設計師暨設計主管",-1)),i[4]||(i[4]=m("p",{class:"about-story__intro"}," 我的設計之路從視覺出發，一路走向 UIUX、前端，再到帶領設計團隊。 每個階段都讓我對「設計」這件事有更深的理解。 ",-1)),m("div",Wd,[(U(),F(ee,null,me(s,l=>m("div",{class:"about-story__item",key:l.title},[m("div",Gd,[m("img",{src:l.image,alt:l.title},null,8,qd)]),m("div",Xd,[m("p",zd,J(l.period),1),m("h3",Jd,J(l.title),1),m("div",Qd,[(U(!0),F(ee,null,me(l.tags,o=>(U(),F("span",{key:o,class:"about-story__tag"},J(o),1))),128))]),m("p",Yd,J(l.desc),1)])])),64))])])])]))}},ef=Ep({history:sp(),routes:[{path:"/",name:"home",component:au},{path:"/projects",name:"projects",component:gu},{path:"/projects/:id",name:"project-detail",component:Bu},{path:"/leadership",name:"leadership",component:sd},{path:"/leadership/:id",name:"article-detail",component:Id},{path:"/about",name:"about",component:Zd}],scrollBehavior(e,t,s){return s||{top:0}}}),Vo=_c($p);Vo.use(ef);Vo.mount("#app");
