(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))n(i);new MutationObserver(i=>{for(const o of i)if(o.type==="childList")for(const r of o.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&n(r)}).observe(document,{childList:!0,subtree:!0});function s(i){const o={};return i.integrity&&(o.integrity=i.integrity),i.referrerPolicy&&(o.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?o.credentials="include":i.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function n(i){if(i.ep)return;i.ep=!0;const o=s(i);fetch(i.href,o)}})();function Hn(e){const t=Object.create(null);for(const s of e.split(","))t[s]=1;return s=>s in t}const fe={},Qt=[],at=()=>{},go=()=>!1,zs=e=>e.charCodeAt(0)===111&&e.charCodeAt(1)===110&&(e.charCodeAt(2)>122||e.charCodeAt(2)<97),Js=e=>e.startsWith("onUpdate:"),Ae=Object.assign,Vn=(e,t)=>{const s=e.indexOf(t);s>-1&&e.splice(s,1)},Vr=Object.prototype.hasOwnProperty,oe=(e,t)=>Vr.call(e,t),H=Array.isArray,Yt=e=>Rs(e)==="[object Map]",ho=e=>Rs(e)==="[object Set]",gi=e=>Rs(e)==="[object Date]",q=e=>typeof e=="function",he=e=>typeof e=="string",pt=e=>typeof e=="symbol",re=e=>e!==null&&typeof e=="object",_o=e=>(re(e)||q(e))&&q(e.then)&&q(e.catch),mo=Object.prototype.toString,Rs=e=>mo.call(e),Kr=e=>Rs(e).slice(8,-1),vo=e=>Rs(e)==="[object Object]",Kn=e=>he(e)&&e!=="NaN"&&e[0]!=="-"&&""+parseInt(e,10)===e,ds=Hn(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),Qs=e=>{const t=Object.create(null);return(s=>t[s]||(t[s]=e(s)))},Wr=/-\w/g,Me=Qs(e=>e.replace(Wr,t=>t.slice(1).toUpperCase())),qr=/\B([A-Z])/g,Ht=Qs(e=>e.replace(qr,"-$1").toLowerCase()),Ys=Qs(e=>e.charAt(0).toUpperCase()+e.slice(1)),pn=Qs(e=>e?`on${Ys(e)}`:""),rt=(e,t)=>!Object.is(e,t),un=(e,...t)=>{for(let s=0;s<e.length;s++)e[s](...t)},bo=(e,t,s,n=!1)=>{Object.defineProperty(e,t,{configurable:!0,enumerable:!1,writable:n,value:s})},Gr=e=>{const t=parseFloat(e);return isNaN(t)?e:t},Xr=e=>{const t=he(e)?Number(e):NaN;return isNaN(t)?e:t};let hi;const Zs=()=>hi||(hi=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});function Wn(e){if(H(e)){const t={};for(let s=0;s<e.length;s++){const n=e[s],i=he(n)?Yr(n):Wn(n);if(i)for(const o in i)t[o]=i[o]}return t}else if(he(e)||re(e))return e}const zr=/;(?![^(]*\))/g,Jr=/:([^]+)/,Qr=/\/\*[^]*?\*\//g;function Yr(e){const t={};return e.replace(Qr,"").split(zr).forEach(s=>{if(s){const n=s.split(Jr);n.length>1&&(t[n[0].trim()]=n[1].trim())}}),t}function We(e){let t="";if(he(e))t=e;else if(H(e))for(let s=0;s<e.length;s++){const n=We(e[s]);n&&(t+=n+" ")}else if(re(e))for(const s in e)e[s]&&(t+=s+" ");return t.trim()}const Zr="itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly",el=Hn(Zr);function yo(e){return!!e||e===""}function tl(e,t){if(e.length!==t.length)return!1;let s=!0;for(let n=0;s&&n<e.length;n++)s=qn(e[n],t[n]);return s}function qn(e,t){if(e===t)return!0;let s=gi(e),n=gi(t);if(s||n)return s&&n?e.getTime()===t.getTime():!1;if(s=pt(e),n=pt(t),s||n)return e===t;if(s=H(e),n=H(t),s||n)return s&&n?tl(e,t):!1;if(s=re(e),n=re(t),s||n){if(!s||!n)return!1;const i=Object.keys(e).length,o=Object.keys(t).length;if(i!==o)return!1;for(const r in e){const l=e.hasOwnProperty(r),a=t.hasOwnProperty(r);if(l&&!a||!l&&a||!qn(e[r],t[r]))return!1}}return String(e)===String(t)}const Ao=e=>!!(e&&e.__v_isRef===!0),X=e=>he(e)?e:e==null?"":H(e)||re(e)&&(e.toString===mo||!q(e.toString))?Ao(e)?X(e.value):JSON.stringify(e,So,2):String(e),So=(e,t)=>Ao(t)?So(e,t.value):Yt(t)?{[`Map(${t.size})`]:[...t.entries()].reduce((s,[n,i],o)=>(s[dn(n,o)+" =>"]=i,s),{})}:ho(t)?{[`Set(${t.size})`]:[...t.values()].map(s=>dn(s))}:pt(t)?dn(t):re(t)&&!H(t)&&!vo(t)?String(t):t,dn=(e,t="")=>{var s;return pt(e)?`Symbol(${(s=e.description)!=null?s:t})`:e};let Ne;class sl{constructor(t=!1){this.detached=t,this._active=!0,this._on=0,this.effects=[],this.cleanups=[],this._isPaused=!1,this.__v_skip=!0,this.parent=Ne,!t&&Ne&&(this.index=(Ne.scopes||(Ne.scopes=[])).push(this)-1)}get active(){return this._active}pause(){if(this._active){this._isPaused=!0;let t,s;if(this.scopes)for(t=0,s=this.scopes.length;t<s;t++)this.scopes[t].pause();for(t=0,s=this.effects.length;t<s;t++)this.effects[t].pause()}}resume(){if(this._active&&this._isPaused){this._isPaused=!1;let t,s;if(this.scopes)for(t=0,s=this.scopes.length;t<s;t++)this.scopes[t].resume();for(t=0,s=this.effects.length;t<s;t++)this.effects[t].resume()}}run(t){if(this._active){const s=Ne;try{return Ne=this,t()}finally{Ne=s}}}on(){++this._on===1&&(this.prevScope=Ne,Ne=this)}off(){this._on>0&&--this._on===0&&(Ne=this.prevScope,this.prevScope=void 0)}stop(t){if(this._active){this._active=!1;let s,n;for(s=0,n=this.effects.length;s<n;s++)this.effects[s].stop();for(this.effects.length=0,s=0,n=this.cleanups.length;s<n;s++)this.cleanups[s]();if(this.cleanups.length=0,this.scopes){for(s=0,n=this.scopes.length;s<n;s++)this.scopes[s].stop(!0);this.scopes.length=0}if(!this.detached&&this.parent&&!t){const i=this.parent.scopes.pop();i&&i!==this&&(this.parent.scopes[this.index]=i,i.index=this.index)}this.parent=void 0}}}function nl(){return Ne}let de;const fn=new WeakSet;class Eo{constructor(t){this.fn=t,this.deps=void 0,this.depsTail=void 0,this.flags=5,this.next=void 0,this.cleanup=void 0,this.scheduler=void 0,Ne&&Ne.active&&Ne.effects.push(this)}pause(){this.flags|=64}resume(){this.flags&64&&(this.flags&=-65,fn.has(this)&&(fn.delete(this),this.trigger()))}notify(){this.flags&2&&!(this.flags&32)||this.flags&8||xo(this)}run(){if(!(this.flags&1))return this.fn();this.flags|=2,_i(this),Io(this);const t=de,s=Ge;de=this,Ge=!0;try{return this.fn()}finally{wo(this),de=t,Ge=s,this.flags&=-3}}stop(){if(this.flags&1){for(let t=this.deps;t;t=t.nextDep)zn(t);this.deps=this.depsTail=void 0,_i(this),this.onStop&&this.onStop(),this.flags&=-2}}trigger(){this.flags&64?fn.add(this):this.scheduler?this.scheduler():this.runIfDirty()}runIfDirty(){In(this)&&this.run()}get dirty(){return In(this)}}let Co=0,fs,gs;function xo(e,t=!1){if(e.flags|=8,t){e.next=gs,gs=e;return}e.next=fs,fs=e}function Gn(){Co++}function Xn(){if(--Co>0)return;if(gs){let t=gs;for(gs=void 0;t;){const s=t.next;t.next=void 0,t.flags&=-9,t=s}}let e;for(;fs;){let t=fs;for(fs=void 0;t;){const s=t.next;if(t.next=void 0,t.flags&=-9,t.flags&1)try{t.trigger()}catch(n){e||(e=n)}t=s}}if(e)throw e}function Io(e){for(let t=e.deps;t;t=t.nextDep)t.version=-1,t.prevActiveLink=t.dep.activeLink,t.dep.activeLink=t}function wo(e){let t,s=e.depsTail,n=s;for(;n;){const i=n.prevDep;n.version===-1?(n===s&&(s=i),zn(n),il(n)):t=n,n.dep.activeLink=n.prevActiveLink,n.prevActiveLink=void 0,n=i}e.deps=t,e.depsTail=s}function In(e){for(let t=e.deps;t;t=t.nextDep)if(t.dep.version!==t.version||t.dep.computed&&(Po(t.dep.computed)||t.dep.version!==t.version))return!0;return!!e._dirty}function Po(e){if(e.flags&4&&!(e.flags&16)||(e.flags&=-17,e.globalVersion===As)||(e.globalVersion=As,!e.isSSR&&e.flags&128&&(!e.deps&&!e._dirty||!In(e))))return;e.flags|=2;const t=e.dep,s=de,n=Ge;de=e,Ge=!0;try{Io(e);const i=e.fn(e._value);(t.version===0||rt(i,e._value))&&(e.flags|=128,e._value=i,t.version++)}catch(i){throw t.version++,i}finally{de=s,Ge=n,wo(e),e.flags&=-3}}function zn(e,t=!1){const{dep:s,prevSub:n,nextSub:i}=e;if(n&&(n.nextSub=i,e.prevSub=void 0),i&&(i.prevSub=n,e.nextSub=void 0),s.subs===e&&(s.subs=n,!n&&s.computed)){s.computed.flags&=-5;for(let o=s.computed.deps;o;o=o.nextDep)zn(o,!0)}!t&&!--s.sc&&s.map&&s.map.delete(s.key)}function il(e){const{prevDep:t,nextDep:s}=e;t&&(t.nextDep=s,e.prevDep=void 0),s&&(s.prevDep=t,e.nextDep=void 0)}let Ge=!0;const Ro=[];function vt(){Ro.push(Ge),Ge=!1}function bt(){const e=Ro.pop();Ge=e===void 0?!0:e}function _i(e){const{cleanup:t}=e;if(e.cleanup=void 0,t){const s=de;de=void 0;try{t()}finally{de=s}}}let As=0;class ol{constructor(t,s){this.sub=t,this.dep=s,this.version=s.version,this.nextDep=this.prevDep=this.nextSub=this.prevSub=this.prevActiveLink=void 0}}class Jn{constructor(t){this.computed=t,this.version=0,this.activeLink=void 0,this.subs=void 0,this.map=void 0,this.key=void 0,this.sc=0,this.__v_skip=!0}track(t){if(!de||!Ge||de===this.computed)return;let s=this.activeLink;if(s===void 0||s.sub!==de)s=this.activeLink=new ol(de,this),de.deps?(s.prevDep=de.depsTail,de.depsTail.nextDep=s,de.depsTail=s):de.deps=de.depsTail=s,ko(s);else if(s.version===-1&&(s.version=this.version,s.nextDep)){const n=s.nextDep;n.prevDep=s.prevDep,s.prevDep&&(s.prevDep.nextDep=n),s.prevDep=de.depsTail,s.nextDep=void 0,de.depsTail.nextDep=s,de.depsTail=s,de.deps===s&&(de.deps=n)}return s}trigger(t){this.version++,As++,this.notify(t)}notify(t){Gn();try{for(let s=this.subs;s;s=s.prevSub)s.sub.notify()&&s.sub.dep.notify()}finally{Xn()}}}function ko(e){if(e.dep.sc++,e.sub.flags&4){const t=e.dep.computed;if(t&&!e.dep.subs){t.flags|=20;for(let n=t.deps;n;n=n.nextDep)ko(n)}const s=e.dep.subs;s!==e&&(e.prevSub=s,s&&(s.nextSub=e)),e.dep.subs=e}}const wn=new WeakMap,Lt=Symbol(""),Pn=Symbol(""),Ss=Symbol("");function Ie(e,t,s){if(Ge&&de){let n=wn.get(e);n||wn.set(e,n=new Map);let i=n.get(s);i||(n.set(s,i=new Jn),i.map=n,i.key=s),i.track()}}function mt(e,t,s,n,i,o){const r=wn.get(e);if(!r){As++;return}const l=a=>{a&&a.trigger()};if(Gn(),t==="clear")r.forEach(l);else{const a=H(e),d=a&&Kn(s);if(a&&s==="length"){const c=Number(n);r.forEach((p,h)=>{(h==="length"||h===Ss||!pt(h)&&h>=c)&&l(p)})}else switch((s!==void 0||r.has(void 0))&&l(r.get(s)),d&&l(r.get(Ss)),t){case"add":a?d&&l(r.get("length")):(l(r.get(Lt)),Yt(e)&&l(r.get(Pn)));break;case"delete":a||(l(r.get(Lt)),Yt(e)&&l(r.get(Pn)));break;case"set":Yt(e)&&l(r.get(Lt));break}}Xn()}function Gt(e){const t=te(e);return t===e?t:(Ie(t,"iterate",Ss),Ke(e)?t:t.map(Xe))}function en(e){return Ie(e=te(e),"iterate",Ss),e}function it(e,t){return yt(e)?ss(Bt(e)?Xe(t):t):Xe(t)}const rl={__proto__:null,[Symbol.iterator](){return gn(this,Symbol.iterator,e=>it(this,e))},concat(...e){return Gt(this).concat(...e.map(t=>H(t)?Gt(t):t))},entries(){return gn(this,"entries",e=>(e[1]=it(this,e[1]),e))},every(e,t){return dt(this,"every",e,t,void 0,arguments)},filter(e,t){return dt(this,"filter",e,t,s=>s.map(n=>it(this,n)),arguments)},find(e,t){return dt(this,"find",e,t,s=>it(this,s),arguments)},findIndex(e,t){return dt(this,"findIndex",e,t,void 0,arguments)},findLast(e,t){return dt(this,"findLast",e,t,s=>it(this,s),arguments)},findLastIndex(e,t){return dt(this,"findLastIndex",e,t,void 0,arguments)},forEach(e,t){return dt(this,"forEach",e,t,void 0,arguments)},includes(...e){return hn(this,"includes",e)},indexOf(...e){return hn(this,"indexOf",e)},join(e){return Gt(this).join(e)},lastIndexOf(...e){return hn(this,"lastIndexOf",e)},map(e,t){return dt(this,"map",e,t,void 0,arguments)},pop(){return ls(this,"pop")},push(...e){return ls(this,"push",e)},reduce(e,...t){return mi(this,"reduce",e,t)},reduceRight(e,...t){return mi(this,"reduceRight",e,t)},shift(){return ls(this,"shift")},some(e,t){return dt(this,"some",e,t,void 0,arguments)},splice(...e){return ls(this,"splice",e)},toReversed(){return Gt(this).toReversed()},toSorted(e){return Gt(this).toSorted(e)},toSpliced(...e){return Gt(this).toSpliced(...e)},unshift(...e){return ls(this,"unshift",e)},values(){return gn(this,"values",e=>it(this,e))}};function gn(e,t,s){const n=en(e),i=n[t]();return n!==e&&!Ke(e)&&(i._next=i.next,i.next=()=>{const o=i._next();return o.done||(o.value=s(o.value)),o}),i}const ll=Array.prototype;function dt(e,t,s,n,i,o){const r=en(e),l=r!==e&&!Ke(e),a=r[t];if(a!==ll[t]){const p=a.apply(e,o);return l?Xe(p):p}let d=s;r!==e&&(l?d=function(p,h){return s.call(this,it(e,p),h,e)}:s.length>2&&(d=function(p,h){return s.call(this,p,h,e)}));const c=a.call(r,d,n);return l&&i?i(c):c}function mi(e,t,s,n){const i=en(e),o=i!==e&&!Ke(e);let r=s,l=!1;i!==e&&(o?(l=n.length===0,r=function(d,c,p){return l&&(l=!1,d=it(e,d)),s.call(this,d,it(e,c),p,e)}):s.length>3&&(r=function(d,c,p){return s.call(this,d,c,p,e)}));const a=i[t](r,...n);return l?it(e,a):a}function hn(e,t,s){const n=te(e);Ie(n,"iterate",Ss);const i=n[t](...s);return(i===-1||i===!1)&&Zn(s[0])?(s[0]=te(s[0]),n[t](...s)):i}function ls(e,t,s=[]){vt(),Gn();const n=te(e)[t].apply(e,s);return Xn(),bt(),n}const al=Hn("__proto__,__v_isRef,__isVue"),To=new Set(Object.getOwnPropertyNames(Symbol).filter(e=>e!=="arguments"&&e!=="caller").map(e=>Symbol[e]).filter(pt));function cl(e){pt(e)||(e=String(e));const t=te(this);return Ie(t,"has",e),t.hasOwnProperty(e)}class Oo{constructor(t=!1,s=!1){this._isReadonly=t,this._isShallow=s}get(t,s,n){if(s==="__v_skip")return t.__v_skip;const i=this._isReadonly,o=this._isShallow;if(s==="__v_isReactive")return!i;if(s==="__v_isReadonly")return i;if(s==="__v_isShallow")return o;if(s==="__v_raw")return n===(i?o?bl:Do:o?Mo:$o).get(t)||Object.getPrototypeOf(t)===Object.getPrototypeOf(n)?t:void 0;const r=H(t);if(!i){let a;if(r&&(a=rl[s]))return a;if(s==="hasOwnProperty")return cl}const l=Reflect.get(t,s,Pe(t)?t:n);if((pt(s)?To.has(s):al(s))||(i||Ie(t,"get",s),o))return l;if(Pe(l)){const a=r&&Kn(s)?l:l.value;return i&&re(a)?kn(a):a}return re(l)?i?kn(l):tn(l):l}}class jo extends Oo{constructor(t=!1){super(!1,t)}set(t,s,n,i){let o=t[s];const r=H(t)&&Kn(s);if(!this._isShallow){const d=yt(o);if(!Ke(n)&&!yt(n)&&(o=te(o),n=te(n)),!r&&Pe(o)&&!Pe(n))return d||(o.value=n),!0}const l=r?Number(s)<t.length:oe(t,s),a=Reflect.set(t,s,n,Pe(t)?t:i);return t===te(i)&&(l?rt(n,o)&&mt(t,"set",s,n):mt(t,"add",s,n)),a}deleteProperty(t,s){const n=oe(t,s);t[s];const i=Reflect.deleteProperty(t,s);return i&&n&&mt(t,"delete",s,void 0),i}has(t,s){const n=Reflect.has(t,s);return(!pt(s)||!To.has(s))&&Ie(t,"has",s),n}ownKeys(t){return Ie(t,"iterate",H(t)?"length":Lt),Reflect.ownKeys(t)}}class pl extends Oo{constructor(t=!1){super(!0,t)}set(t,s){return!0}deleteProperty(t,s){return!0}}const ul=new jo,dl=new pl,fl=new jo(!0);const Rn=e=>e,Os=e=>Reflect.getPrototypeOf(e);function gl(e,t,s){return function(...n){const i=this.__v_raw,o=te(i),r=Yt(o),l=e==="entries"||e===Symbol.iterator&&r,a=e==="keys"&&r,d=i[e](...n),c=s?Rn:t?ss:Xe;return!t&&Ie(o,"iterate",a?Pn:Lt),Ae(Object.create(d),{next(){const{value:p,done:h}=d.next();return h?{value:p,done:h}:{value:l?[c(p[0]),c(p[1])]:c(p),done:h}}})}}function js(e){return function(...t){return e==="delete"?!1:e==="clear"?void 0:this}}function hl(e,t){const s={get(i){const o=this.__v_raw,r=te(o),l=te(i);e||(rt(i,l)&&Ie(r,"get",i),Ie(r,"get",l));const{has:a}=Os(r),d=t?Rn:e?ss:Xe;if(a.call(r,i))return d(o.get(i));if(a.call(r,l))return d(o.get(l));o!==r&&o.get(i)},get size(){const i=this.__v_raw;return!e&&Ie(te(i),"iterate",Lt),i.size},has(i){const o=this.__v_raw,r=te(o),l=te(i);return e||(rt(i,l)&&Ie(r,"has",i),Ie(r,"has",l)),i===l?o.has(i):o.has(i)||o.has(l)},forEach(i,o){const r=this,l=r.__v_raw,a=te(l),d=t?Rn:e?ss:Xe;return!e&&Ie(a,"iterate",Lt),l.forEach((c,p)=>i.call(o,d(c),d(p),r))}};return Ae(s,e?{add:js("add"),set:js("set"),delete:js("delete"),clear:js("clear")}:{add(i){const o=te(this),r=Os(o),l=te(i),a=!t&&!Ke(i)&&!yt(i)?l:i;return r.has.call(o,a)||rt(i,a)&&r.has.call(o,i)||rt(l,a)&&r.has.call(o,l)||(o.add(a),mt(o,"add",a,a)),this},set(i,o){!t&&!Ke(o)&&!yt(o)&&(o=te(o));const r=te(this),{has:l,get:a}=Os(r);let d=l.call(r,i);d||(i=te(i),d=l.call(r,i));const c=a.call(r,i);return r.set(i,o),d?rt(o,c)&&mt(r,"set",i,o):mt(r,"add",i,o),this},delete(i){const o=te(this),{has:r,get:l}=Os(o);let a=r.call(o,i);a||(i=te(i),a=r.call(o,i)),l&&l.call(o,i);const d=o.delete(i);return a&&mt(o,"delete",i,void 0),d},clear(){const i=te(this),o=i.size!==0,r=i.clear();return o&&mt(i,"clear",void 0,void 0),r}}),["keys","values","entries",Symbol.iterator].forEach(i=>{s[i]=gl(i,e,t)}),s}function Qn(e,t){const s=hl(e,t);return(n,i,o)=>i==="__v_isReactive"?!e:i==="__v_isReadonly"?e:i==="__v_raw"?n:Reflect.get(oe(s,i)&&i in n?s:n,i,o)}const _l={get:Qn(!1,!1)},ml={get:Qn(!1,!0)},vl={get:Qn(!0,!1)};const $o=new WeakMap,Mo=new WeakMap,Do=new WeakMap,bl=new WeakMap;function yl(e){switch(e){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function Al(e){return e.__v_skip||!Object.isExtensible(e)?0:yl(Kr(e))}function tn(e){return yt(e)?e:Yn(e,!1,ul,_l,$o)}function Uo(e){return Yn(e,!1,fl,ml,Mo)}function kn(e){return Yn(e,!0,dl,vl,Do)}function Yn(e,t,s,n,i){if(!re(e)||e.__v_raw&&!(t&&e.__v_isReactive))return e;const o=Al(e);if(o===0)return e;const r=i.get(e);if(r)return r;const l=new Proxy(e,o===2?n:s);return i.set(e,l),l}function Bt(e){return yt(e)?Bt(e.__v_raw):!!(e&&e.__v_isReactive)}function yt(e){return!!(e&&e.__v_isReadonly)}function Ke(e){return!!(e&&e.__v_isShallow)}function Zn(e){return e?!!e.__v_raw:!1}function te(e){const t=e&&e.__v_raw;return t?te(t):e}function Sl(e){return!oe(e,"__v_skip")&&Object.isExtensible(e)&&bo(e,"__v_skip",!0),e}const Xe=e=>re(e)?tn(e):e,ss=e=>re(e)?kn(e):e;function Pe(e){return e?e.__v_isRef===!0:!1}function $e(e){return No(e,!1)}function El(e){return No(e,!0)}function No(e,t){return Pe(e)?e:new Cl(e,t)}class Cl{constructor(t,s){this.dep=new Jn,this.__v_isRef=!0,this.__v_isShallow=!1,this._rawValue=s?t:te(t),this._value=s?t:Xe(t),this.__v_isShallow=s}get value(){return this.dep.track(),this._value}set value(t){const s=this._rawValue,n=this.__v_isShallow||Ke(t)||yt(t);t=n?t:te(t),rt(t,s)&&(this._rawValue=t,this._value=n?t:Xe(t),this.dep.trigger())}}function Ce(e){return Pe(e)?e.value:e}const xl={get:(e,t,s)=>t==="__v_raw"?e:Ce(Reflect.get(e,t,s)),set:(e,t,s,n)=>{const i=e[t];return Pe(i)&&!Pe(s)?(i.value=s,!0):Reflect.set(e,t,s,n)}};function Lo(e){return Bt(e)?e:new Proxy(e,xl)}class Il{constructor(t,s,n){this.fn=t,this.setter=s,this._value=void 0,this.dep=new Jn(this),this.__v_isRef=!0,this.deps=void 0,this.depsTail=void 0,this.flags=16,this.globalVersion=As-1,this.next=void 0,this.effect=this,this.__v_isReadonly=!s,this.isSSR=n}notify(){if(this.flags|=16,!(this.flags&8)&&de!==this)return xo(this,!0),!0}get value(){const t=this.dep.track();return Po(this),t&&(t.version=this.dep.version),this._value}set value(t){this.setter&&this.setter(t)}}function wl(e,t,s=!1){let n,i;return q(e)?n=e:(n=e.get,i=e.set),new Il(n,i,s)}const $s={},Bs=new WeakMap;let Dt;function Pl(e,t=!1,s=Dt){if(s){let n=Bs.get(s);n||Bs.set(s,n=[]),n.push(e)}}function Rl(e,t,s=fe){const{immediate:n,deep:i,once:o,scheduler:r,augmentJob:l,call:a}=s,d=T=>i?T:Ke(T)||i===!1||i===0?wt(T,1):wt(T);let c,p,h,_,C=!1,E=!1;if(Pe(e)?(p=()=>e.value,C=Ke(e)):Bt(e)?(p=()=>d(e),C=!0):H(e)?(E=!0,C=e.some(T=>Bt(T)||Ke(T)),p=()=>e.map(T=>{if(Pe(T))return T.value;if(Bt(T))return d(T);if(q(T))return a?a(T,2):T()})):q(e)?t?p=a?()=>a(e,2):e:p=()=>{if(h){vt();try{h()}finally{bt()}}const T=Dt;Dt=c;try{return a?a(e,3,[_]):e(_)}finally{Dt=T}}:p=at,t&&i){const T=p,G=i===!0?1/0:i;p=()=>wt(T(),G)}const j=nl(),w=()=>{c.stop(),j&&j.active&&Vn(j.effects,c)};if(o&&t){const T=t;t=(...G)=>{T(...G),w()}}let x=E?new Array(e.length).fill($s):$s;const $=T=>{if(!(!(c.flags&1)||!c.dirty&&!T))if(t){const G=c.run();if(i||C||(E?G.some((Y,Q)=>rt(Y,x[Q])):rt(G,x))){h&&h();const Y=Dt;Dt=c;try{const Q=[G,x===$s?void 0:E&&x[0]===$s?[]:x,_];x=G,a?a(t,3,Q):t(...Q)}finally{Dt=Y}}}else c.run()};return l&&l($),c=new Eo(p),c.scheduler=r?()=>r($,!1):$,_=T=>Pl(T,!1,c),h=c.onStop=()=>{const T=Bs.get(c);if(T){if(a)a(T,4);else for(const G of T)G();Bs.delete(c)}},t?n?$(!0):x=c.run():r?r($.bind(null,!0),!0):c.run(),w.pause=c.pause.bind(c),w.resume=c.resume.bind(c),w.stop=w,w}function wt(e,t=1/0,s){if(t<=0||!re(e)||e.__v_skip||(s=s||new Map,(s.get(e)||0)>=t))return e;if(s.set(e,t),t--,Pe(e))wt(e.value,t,s);else if(H(e))for(let n=0;n<e.length;n++)wt(e[n],t,s);else if(ho(e)||Yt(e))e.forEach(n=>{wt(n,t,s)});else if(vo(e)){for(const n in e)wt(e[n],t,s);for(const n of Object.getOwnPropertySymbols(e))Object.prototype.propertyIsEnumerable.call(e,n)&&wt(e[n],t,s)}return e}function ks(e,t,s,n){try{return n?e(...n):e()}catch(i){sn(i,t,s)}}function ze(e,t,s,n){if(q(e)){const i=ks(e,t,s,n);return i&&_o(i)&&i.catch(o=>{sn(o,t,s)}),i}if(H(e)){const i=[];for(let o=0;o<e.length;o++)i.push(ze(e[o],t,s,n));return i}}function sn(e,t,s,n=!0){const i=t?t.vnode:null,{errorHandler:o,throwUnhandledErrorInProduction:r}=t&&t.appContext.config||fe;if(t){let l=t.parent;const a=t.proxy,d=`https://vuejs.org/error-reference/#runtime-${s}`;for(;l;){const c=l.ec;if(c){for(let p=0;p<c.length;p++)if(c[p](e,a,d)===!1)return}l=l.parent}if(o){vt(),ks(o,null,10,[e,a,d]),bt();return}}kl(e,s,i,n,r)}function kl(e,t,s,n=!0,i=!1){if(i)throw e;console.error(e)}const Te=[];let st=-1;const Zt=[];let xt=null,Xt=0;const Bo=Promise.resolve();let Fs=null;function ns(e){const t=Fs||Bo;return e?t.then(this?e.bind(this):e):t}function Tl(e){let t=st+1,s=Te.length;for(;t<s;){const n=t+s>>>1,i=Te[n],o=Es(i);o<e||o===e&&i.flags&2?t=n+1:s=n}return t}function ei(e){if(!(e.flags&1)){const t=Es(e),s=Te[Te.length-1];!s||!(e.flags&2)&&t>=Es(s)?Te.push(e):Te.splice(Tl(t),0,e),e.flags|=1,Fo()}}function Fo(){Fs||(Fs=Bo.then(Vo))}function Ol(e){H(e)?Zt.push(...e):xt&&e.id===-1?xt.splice(Xt+1,0,e):e.flags&1||(Zt.push(e),e.flags|=1),Fo()}function vi(e,t,s=st+1){for(;s<Te.length;s++){const n=Te[s];if(n&&n.flags&2){if(e&&n.id!==e.uid)continue;Te.splice(s,1),s--,n.flags&4&&(n.flags&=-2),n(),n.flags&4||(n.flags&=-2)}}}function Ho(e){if(Zt.length){const t=[...new Set(Zt)].sort((s,n)=>Es(s)-Es(n));if(Zt.length=0,xt){xt.push(...t);return}for(xt=t,Xt=0;Xt<xt.length;Xt++){const s=xt[Xt];s.flags&4&&(s.flags&=-2),s.flags&8||s(),s.flags&=-2}xt=null,Xt=0}}const Es=e=>e.id==null?e.flags&2?-1:1/0:e.id;function Vo(e){try{for(st=0;st<Te.length;st++){const t=Te[st];t&&!(t.flags&8)&&(t.flags&4&&(t.flags&=-2),ks(t,t.i,t.i?15:14),t.flags&4||(t.flags&=-2))}}finally{for(;st<Te.length;st++){const t=Te[st];t&&(t.flags&=-2)}st=-1,Te.length=0,Ho(),Fs=null,(Te.length||Zt.length)&&Vo()}}let qe=null,Ko=null;function Hs(e){const t=qe;return qe=e,Ko=e&&e.type.__scopeId||null,t}function le(e,t=qe,s){if(!t||e._n)return e;const n=(...i)=>{n._d&&Ws(-1);const o=Hs(t);let r;try{r=e(...i)}finally{Hs(o),n._d&&Ws(1)}return r};return n._n=!0,n._c=!0,n._d=!0,n}function Ot(e,t,s,n){const i=e.dirs,o=t&&t.dirs;for(let r=0;r<i.length;r++){const l=i[r];o&&(l.oldValue=o[r].value);let a=l.dir[n];a&&(vt(),ze(a,s,8,[e.el,l,e,t]),bt())}}function Ms(e,t){if(we){let s=we.provides;const n=we.parent&&we.parent.provides;n===s&&(s=we.provides=Object.create(n)),s[e]=t}}function ct(e,t,s=!1){const n=xr();if(n||es){let i=es?es._context.provides:n?n.parent==null||n.ce?n.vnode.appContext&&n.vnode.appContext.provides:n.parent.provides:void 0;if(i&&e in i)return i[e];if(arguments.length>1)return s&&q(t)?t.call(n&&n.proxy):t}}const jl=Symbol.for("v-scx"),$l=()=>ct(jl);function Ft(e,t,s){return Wo(e,t,s)}function Wo(e,t,s=fe){const{immediate:n,deep:i,flush:o,once:r}=s,l=Ae({},s),a=t&&n||!t&&o!=="post";let d;if(Is){if(o==="sync"){const _=$l();d=_.__watcherHandles||(_.__watcherHandles=[])}else if(!a){const _=()=>{};return _.stop=at,_.resume=at,_.pause=at,_}}const c=we;l.call=(_,C,E)=>ze(_,c,C,E);let p=!1;o==="post"?l.scheduler=_=>{Ue(_,c&&c.suspense)}:o!=="sync"&&(p=!0,l.scheduler=(_,C)=>{C?_():ei(_)}),l.augmentJob=_=>{t&&(_.flags|=4),p&&(_.flags|=2,c&&(_.id=c.uid,_.i=c))};const h=Rl(e,t,l);return Is&&(d?d.push(h):a&&h()),h}function Ml(e,t,s){const n=this.proxy,i=he(e)?e.includes(".")?qo(n,e):()=>n[e]:e.bind(n,n);let o;q(t)?o=t:(o=t.handler,s=t);const r=Ts(this),l=Wo(i,o.bind(n),s);return r(),l}function qo(e,t){const s=t.split(".");return()=>{let n=e;for(let i=0;i<s.length&&n;i++)n=n[s[i]];return n}}const Dl=Symbol("_vte"),Go=e=>e.__isTeleport,nt=Symbol("_leaveCb"),as=Symbol("_enterCb");function Ul(){const e={isMounted:!1,isLeaving:!1,isUnmounting:!1,leavingVNodes:new Map};return Rt(()=>{e.isMounted=!0}),sr(()=>{e.isUnmounting=!0}),e}const Ve=[Function,Array],Xo={mode:String,appear:Boolean,persisted:Boolean,onBeforeEnter:Ve,onEnter:Ve,onAfterEnter:Ve,onEnterCancelled:Ve,onBeforeLeave:Ve,onLeave:Ve,onAfterLeave:Ve,onLeaveCancelled:Ve,onBeforeAppear:Ve,onAppear:Ve,onAfterAppear:Ve,onAppearCancelled:Ve},zo=e=>{const t=e.subTree;return t.component?zo(t.component):t},Nl={name:"BaseTransition",props:Xo,setup(e,{slots:t}){const s=xr(),n=Ul();return()=>{const i=t.default&&Yo(t.default(),!0);if(!i||!i.length)return;const o=Jo(i),r=te(e),{mode:l}=r;if(n.isLeaving)return _n(o);const a=bi(o);if(!a)return _n(o);let d=Tn(a,r,n,s,p=>d=p);a.type!==Oe&&Cs(a,d);let c=s.subTree&&bi(s.subTree);if(c&&c.type!==Oe&&!Ut(c,a)&&zo(s).type!==Oe){let p=Tn(c,r,n,s);if(Cs(c,p),l==="out-in"&&a.type!==Oe)return n.isLeaving=!0,p.afterLeave=()=>{n.isLeaving=!1,s.job.flags&8||s.update(),delete p.afterLeave,c=void 0},_n(o);l==="in-out"&&a.type!==Oe?p.delayLeave=(h,_,C)=>{const E=Qo(n,c);E[String(c.key)]=c,h[nt]=()=>{_(),h[nt]=void 0,delete d.delayedLeave,c=void 0},d.delayedLeave=()=>{C(),delete d.delayedLeave,c=void 0}}:c=void 0}else c&&(c=void 0);return o}}};function Jo(e){let t=e[0];if(e.length>1){for(const s of e)if(s.type!==Oe){t=s;break}}return t}const Ll=Nl;function Qo(e,t){const{leavingVNodes:s}=e;let n=s.get(t.type);return n||(n=Object.create(null),s.set(t.type,n)),n}function Tn(e,t,s,n,i){const{appear:o,mode:r,persisted:l=!1,onBeforeEnter:a,onEnter:d,onAfterEnter:c,onEnterCancelled:p,onBeforeLeave:h,onLeave:_,onAfterLeave:C,onLeaveCancelled:E,onBeforeAppear:j,onAppear:w,onAfterAppear:x,onAppearCancelled:$}=t,T=String(e.key),G=Qo(s,e),Y=(V,z)=>{V&&ze(V,n,9,z)},Q=(V,z)=>{const ae=z[1];Y(V,z),H(V)?V.every(M=>M.length<=1)&&ae():V.length<=1&&ae()},Se={mode:r,persisted:l,beforeEnter(V){let z=a;if(!s.isMounted)if(o)z=j||a;else return;V[nt]&&V[nt](!0);const ae=G[T];ae&&Ut(e,ae)&&ae.el[nt]&&ae.el[nt](),Y(z,[V])},enter(V){if(G[T]===e)return;let z=d,ae=c,M=p;if(!s.isMounted)if(o)z=w||d,ae=x||c,M=$||p;else return;let se=!1;V[as]=Le=>{se||(se=!0,Le?Y(M,[V]):Y(ae,[V]),Se.delayedLeave&&Se.delayedLeave(),V[as]=void 0)};const Ee=V[as].bind(null,!1);z?Q(z,[V,Ee]):Ee()},leave(V,z){const ae=String(e.key);if(V[as]&&V[as](!0),s.isUnmounting)return z();Y(h,[V]);let M=!1;V[nt]=Ee=>{M||(M=!0,z(),Ee?Y(E,[V]):Y(C,[V]),V[nt]=void 0,G[ae]===e&&delete G[ae])};const se=V[nt].bind(null,!1);G[ae]=e,_?Q(_,[V,se]):se()},clone(V){const z=Tn(V,t,s,n,i);return i&&i(z),z}};return Se}function _n(e){if(nn(e))return e=Pt(e),e.children=null,e}function bi(e){if(!nn(e))return Go(e.type)&&e.children?Jo(e.children):e;if(e.component)return e.component.subTree;const{shapeFlag:t,children:s}=e;if(s){if(t&16)return s[0];if(t&32&&q(s.default))return s.default()}}function Cs(e,t){e.shapeFlag&6&&e.component?(e.transition=t,Cs(e.component.subTree,t)):e.shapeFlag&128?(e.ssContent.transition=t.clone(e.ssContent),e.ssFallback.transition=t.clone(e.ssFallback)):e.transition=t}function Yo(e,t=!1,s){let n=[],i=0;for(let o=0;o<e.length;o++){let r=e[o];const l=s==null?r.key:String(s)+String(r.key!=null?r.key:o);r.type===ee?(r.patchFlag&128&&i++,n=n.concat(Yo(r.children,t,l))):(t||r.type!==Oe)&&n.push(l!=null?Pt(r,{key:l}):r)}if(i>1)for(let o=0;o<n.length;o++)n[o].patchFlag=-2;return n}function Zo(e,t){return q(e)?Ae({name:e.name},t,{setup:e}):e}function er(e){e.ids=[e.ids[0]+e.ids[2]+++"-",0,0]}function yi(e,t){let s;return!!((s=Object.getOwnPropertyDescriptor(e,t))&&!s.configurable)}const Vs=new WeakMap;function hs(e,t,s,n,i=!1){if(H(e)){e.forEach((E,j)=>hs(E,t&&(H(t)?t[j]:t),s,n,i));return}if(_s(n)&&!i){n.shapeFlag&512&&n.type.__asyncResolved&&n.component.subTree.component&&hs(e,t,s,n.component.subTree);return}const o=n.shapeFlag&4?oi(n.component):n.el,r=i?null:o,{i:l,r:a}=e,d=t&&t.r,c=l.refs===fe?l.refs={}:l.refs,p=l.setupState,h=te(p),_=p===fe?go:E=>yi(c,E)?!1:oe(h,E),C=(E,j)=>!(j&&yi(c,j));if(d!=null&&d!==a){if(Ai(t),he(d))c[d]=null,_(d)&&(p[d]=null);else if(Pe(d)){const E=t;C(d,E.k)&&(d.value=null),E.k&&(c[E.k]=null)}}if(q(a))ks(a,l,12,[r,c]);else{const E=he(a),j=Pe(a);if(E||j){const w=()=>{if(e.f){const x=E?_(a)?p[a]:c[a]:C()||!e.k?a.value:c[e.k];if(i)H(x)&&Vn(x,o);else if(H(x))x.includes(o)||x.push(o);else if(E)c[a]=[o],_(a)&&(p[a]=c[a]);else{const $=[o];C(a,e.k)&&(a.value=$),e.k&&(c[e.k]=$)}}else E?(c[a]=r,_(a)&&(p[a]=r)):j&&(C(a,e.k)&&(a.value=r),e.k&&(c[e.k]=r))};if(r){const x=()=>{w(),Vs.delete(e)};x.id=-1,Vs.set(e,x),Ue(x,s)}else Ai(e),w()}}}function Ai(e){const t=Vs.get(e);t&&(t.flags|=8,Vs.delete(e))}Zs().requestIdleCallback;Zs().cancelIdleCallback;const _s=e=>!!e.type.__asyncLoader,nn=e=>e.type.__isKeepAlive;function Bl(e,t){tr(e,"a",t)}function Fl(e,t){tr(e,"da",t)}function tr(e,t,s=we){const n=e.__wdc||(e.__wdc=()=>{let i=s;for(;i;){if(i.isDeactivated)return;i=i.parent}return e()});if(on(t,n,s),s){let i=s.parent;for(;i&&i.parent;)nn(i.parent.vnode)&&Hl(n,t,s,i),i=i.parent}}function Hl(e,t,s,n){const i=on(t,e,n,!0);Vt(()=>{Vn(n[t],i)},s)}function on(e,t,s=we,n=!1){if(s){const i=s[e]||(s[e]=[]),o=t.__weh||(t.__weh=(...r)=>{vt();const l=Ts(s),a=ze(t,s,e,r);return l(),bt(),a});return n?i.unshift(o):i.push(o),o}}const At=e=>(t,s=we)=>{(!Is||e==="sp")&&on(e,(...n)=>t(...n),s)},Vl=At("bm"),Rt=At("m"),Kl=At("bu"),Wl=At("u"),sr=At("bum"),Vt=At("um"),ql=At("sp"),Gl=At("rtg"),Xl=At("rtc");function zl(e,t=we){on("ec",e,t)}const nr="components";function Kt(e,t){return or(nr,e,!0,t)||e}const ir=Symbol.for("v-ndc");function Jl(e){return he(e)?or(nr,e,!1)||e:e||ir}function or(e,t,s=!0,n=!1){const i=qe||we;if(i){const o=i.type;{const l=$a(o,!1);if(l&&(l===t||l===Me(t)||l===Ys(Me(t))))return o}const r=Si(i[e]||o[e],t)||Si(i.appContext[e],t);return!r&&n?o:r}}function Si(e,t){return e&&(e[t]||e[Me(t)]||e[Ys(Me(t))])}function ve(e,t,s,n){let i;const o=s,r=H(e);if(r||he(e)){const l=r&&Bt(e);let a=!1,d=!1;l&&(a=!Ke(e),d=yt(e),e=en(e)),i=new Array(e.length);for(let c=0,p=e.length;c<p;c++)i[c]=t(a?d?ss(Xe(e[c])):Xe(e[c]):e[c],c,void 0,o)}else if(typeof e=="number"){i=new Array(e);for(let l=0;l<e;l++)i[l]=t(l+1,l,void 0,o)}else if(re(e))if(e[Symbol.iterator])i=Array.from(e,(l,a)=>t(l,a,void 0,o));else{const l=Object.keys(e);i=new Array(l.length);for(let a=0,d=l.length;a<d;a++){const c=l[a];i[a]=t(e[c],c,a,o)}}else i=[];return i}const On=e=>e?Ir(e)?oi(e):On(e.parent):null,ms=Ae(Object.create(null),{$:e=>e,$el:e=>e.vnode.el,$data:e=>e.data,$props:e=>e.props,$attrs:e=>e.attrs,$slots:e=>e.slots,$refs:e=>e.refs,$parent:e=>On(e.parent),$root:e=>On(e.root),$host:e=>e.ce,$emit:e=>e.emit,$options:e=>lr(e),$forceUpdate:e=>e.f||(e.f=()=>{ei(e.update)}),$nextTick:e=>e.n||(e.n=ns.bind(e.proxy)),$watch:e=>Ml.bind(e)}),mn=(e,t)=>e!==fe&&!e.__isScriptSetup&&oe(e,t),Ql={get({_:e},t){if(t==="__v_skip")return!0;const{ctx:s,setupState:n,data:i,props:o,accessCache:r,type:l,appContext:a}=e;if(t[0]!=="$"){const h=r[t];if(h!==void 0)switch(h){case 1:return n[t];case 2:return i[t];case 4:return s[t];case 3:return o[t]}else{if(mn(n,t))return r[t]=1,n[t];if(i!==fe&&oe(i,t))return r[t]=2,i[t];if(oe(o,t))return r[t]=3,o[t];if(s!==fe&&oe(s,t))return r[t]=4,s[t];jn&&(r[t]=0)}}const d=ms[t];let c,p;if(d)return t==="$attrs"&&Ie(e.attrs,"get",""),d(e);if((c=l.__cssModules)&&(c=c[t]))return c;if(s!==fe&&oe(s,t))return r[t]=4,s[t];if(p=a.config.globalProperties,oe(p,t))return p[t]},set({_:e},t,s){const{data:n,setupState:i,ctx:o}=e;return mn(i,t)?(i[t]=s,!0):n!==fe&&oe(n,t)?(n[t]=s,!0):oe(e.props,t)||t[0]==="$"&&t.slice(1)in e?!1:(o[t]=s,!0)},has({_:{data:e,setupState:t,accessCache:s,ctx:n,appContext:i,props:o,type:r}},l){let a;return!!(s[l]||e!==fe&&l[0]!=="$"&&oe(e,l)||mn(t,l)||oe(o,l)||oe(n,l)||oe(ms,l)||oe(i.config.globalProperties,l)||(a=r.__cssModules)&&a[l])},defineProperty(e,t,s){return s.get!=null?e._.accessCache[t]=0:oe(s,"value")&&this.set(e,t,s.value,null),Reflect.defineProperty(e,t,s)}};function Ei(e){return H(e)?e.reduce((t,s)=>(t[s]=null,t),{}):e}let jn=!0;function Yl(e){const t=lr(e),s=e.proxy,n=e.ctx;jn=!1,t.beforeCreate&&Ci(t.beforeCreate,e,"bc");const{data:i,computed:o,methods:r,watch:l,provide:a,inject:d,created:c,beforeMount:p,mounted:h,beforeUpdate:_,updated:C,activated:E,deactivated:j,beforeDestroy:w,beforeUnmount:x,destroyed:$,unmounted:T,render:G,renderTracked:Y,renderTriggered:Q,errorCaptured:Se,serverPrefetch:V,expose:z,inheritAttrs:ae,components:M,directives:se,filters:Ee}=t;if(d&&Zl(d,n,null),r)for(const ce in r){const ne=r[ce];q(ne)&&(n[ce]=ne.bind(s))}if(i){const ce=i.call(s,s);re(ce)&&(e.data=tn(ce))}if(jn=!0,o)for(const ce in o){const ne=o[ce],ut=q(ne)?ne.bind(s,s):q(ne.get)?ne.get.bind(s,s):at,St=!q(ne)&&q(ne.set)?ne.set.bind(s):at,Qe=je({get:ut,set:St});Object.defineProperty(n,ce,{enumerable:!0,configurable:!0,get:()=>Qe.value,set:De=>Qe.value=De})}if(l)for(const ce in l)rr(l[ce],n,s,ce);if(a){const ce=q(a)?a.call(s):a;Reflect.ownKeys(ce).forEach(ne=>{Ms(ne,ce[ne])})}c&&Ci(c,e,"c");function _e(ce,ne){H(ne)?ne.forEach(ut=>ce(ut.bind(s))):ne&&ce(ne.bind(s))}if(_e(Vl,p),_e(Rt,h),_e(Kl,_),_e(Wl,C),_e(Bl,E),_e(Fl,j),_e(zl,Se),_e(Xl,Y),_e(Gl,Q),_e(sr,x),_e(Vt,T),_e(ql,V),H(z))if(z.length){const ce=e.exposed||(e.exposed={});z.forEach(ne=>{Object.defineProperty(ce,ne,{get:()=>s[ne],set:ut=>s[ne]=ut,enumerable:!0})})}else e.exposed||(e.exposed={});G&&e.render===at&&(e.render=G),ae!=null&&(e.inheritAttrs=ae),M&&(e.components=M),se&&(e.directives=se),V&&er(e)}function Zl(e,t,s=at){H(e)&&(e=$n(e));for(const n in e){const i=e[n];let o;re(i)?"default"in i?o=ct(i.from||n,i.default,!0):o=ct(i.from||n):o=ct(i),Pe(o)?Object.defineProperty(t,n,{enumerable:!0,configurable:!0,get:()=>o.value,set:r=>o.value=r}):t[n]=o}}function Ci(e,t,s){ze(H(e)?e.map(n=>n.bind(t.proxy)):e.bind(t.proxy),t,s)}function rr(e,t,s,n){let i=n.includes(".")?qo(s,n):()=>s[n];if(he(e)){const o=t[e];q(o)&&Ft(i,o)}else if(q(e))Ft(i,e.bind(s));else if(re(e))if(H(e))e.forEach(o=>rr(o,t,s,n));else{const o=q(e.handler)?e.handler.bind(s):t[e.handler];q(o)&&Ft(i,o,e)}}function lr(e){const t=e.type,{mixins:s,extends:n}=t,{mixins:i,optionsCache:o,config:{optionMergeStrategies:r}}=e.appContext,l=o.get(t);let a;return l?a=l:!i.length&&!s&&!n?a=t:(a={},i.length&&i.forEach(d=>Ks(a,d,r,!0)),Ks(a,t,r)),re(t)&&o.set(t,a),a}function Ks(e,t,s,n=!1){const{mixins:i,extends:o}=t;o&&Ks(e,o,s,!0),i&&i.forEach(r=>Ks(e,r,s,!0));for(const r in t)if(!(n&&r==="expose")){const l=ea[r]||s&&s[r];e[r]=l?l(e[r],t[r]):t[r]}return e}const ea={data:xi,props:Ii,emits:Ii,methods:us,computed:us,beforeCreate:Re,created:Re,beforeMount:Re,mounted:Re,beforeUpdate:Re,updated:Re,beforeDestroy:Re,beforeUnmount:Re,destroyed:Re,unmounted:Re,activated:Re,deactivated:Re,errorCaptured:Re,serverPrefetch:Re,components:us,directives:us,watch:sa,provide:xi,inject:ta};function xi(e,t){return t?e?function(){return Ae(q(e)?e.call(this,this):e,q(t)?t.call(this,this):t)}:t:e}function ta(e,t){return us($n(e),$n(t))}function $n(e){if(H(e)){const t={};for(let s=0;s<e.length;s++)t[e[s]]=e[s];return t}return e}function Re(e,t){return e?[...new Set([].concat(e,t))]:t}function us(e,t){return e?Ae(Object.create(null),e,t):t}function Ii(e,t){return e?H(e)&&H(t)?[...new Set([...e,...t])]:Ae(Object.create(null),Ei(e),Ei(t??{})):t}function sa(e,t){if(!e)return t;if(!t)return e;const s=Ae(Object.create(null),e);for(const n in t)s[n]=Re(e[n],t[n]);return s}function ar(){return{app:null,config:{isNativeTag:go,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let na=0;function ia(e,t){return function(n,i=null){q(n)||(n=Ae({},n)),i!=null&&!re(i)&&(i=null);const o=ar(),r=new WeakSet,l=[];let a=!1;const d=o.app={_uid:na++,_component:n,_props:i,_container:null,_context:o,_instance:null,version:Da,get config(){return o.config},set config(c){},use(c,...p){return r.has(c)||(c&&q(c.install)?(r.add(c),c.install(d,...p)):q(c)&&(r.add(c),c(d,...p))),d},mixin(c){return o.mixins.includes(c)||o.mixins.push(c),d},component(c,p){return p?(o.components[c]=p,d):o.components[c]},directive(c,p){return p?(o.directives[c]=p,d):o.directives[c]},mount(c,p,h){if(!a){const _=d._ceVNode||W(n,i);return _.appContext=o,h===!0?h="svg":h===!1&&(h=void 0),e(_,c,h),a=!0,d._container=c,c.__vue_app__=d,oi(_.component)}},onUnmount(c){l.push(c)},unmount(){a&&(ze(l,d._instance,16),e(null,d._container),delete d._container.__vue_app__)},provide(c,p){return o.provides[c]=p,d},runWithContext(c){const p=es;es=d;try{return c()}finally{es=p}}};return d}}let es=null;const oa=(e,t)=>t==="modelValue"||t==="model-value"?e.modelModifiers:e[`${t}Modifiers`]||e[`${Me(t)}Modifiers`]||e[`${Ht(t)}Modifiers`];function ra(e,t,...s){if(e.isUnmounted)return;const n=e.vnode.props||fe;let i=s;const o=t.startsWith("update:"),r=o&&oa(n,t.slice(7));r&&(r.trim&&(i=s.map(c=>he(c)?c.trim():c)),r.number&&(i=s.map(Gr)));let l,a=n[l=pn(t)]||n[l=pn(Me(t))];!a&&o&&(a=n[l=pn(Ht(t))]),a&&ze(a,e,6,i);const d=n[l+"Once"];if(d){if(!e.emitted)e.emitted={};else if(e.emitted[l])return;e.emitted[l]=!0,ze(d,e,6,i)}}const la=new WeakMap;function cr(e,t,s=!1){const n=s?la:t.emitsCache,i=n.get(e);if(i!==void 0)return i;const o=e.emits;let r={},l=!1;if(!q(e)){const a=d=>{const c=cr(d,t,!0);c&&(l=!0,Ae(r,c))};!s&&t.mixins.length&&t.mixins.forEach(a),e.extends&&a(e.extends),e.mixins&&e.mixins.forEach(a)}return!o&&!l?(re(e)&&n.set(e,null),null):(H(o)?o.forEach(a=>r[a]=null):Ae(r,o),re(e)&&n.set(e,r),r)}function rn(e,t){return!e||!zs(t)?!1:(t=t.slice(2).replace(/Once$/,""),oe(e,t[0].toLowerCase()+t.slice(1))||oe(e,Ht(t))||oe(e,t))}function wi(e){const{type:t,vnode:s,proxy:n,withProxy:i,propsOptions:[o],slots:r,attrs:l,emit:a,render:d,renderCache:c,props:p,data:h,setupState:_,ctx:C,inheritAttrs:E}=e,j=Hs(e);let w,x;try{if(s.shapeFlag&4){const T=i||n,G=T;w=ot(d.call(G,T,c,p,_,h,C)),x=l}else{const T=t;w=ot(T.length>1?T(p,{attrs:l,slots:r,emit:a}):T(p,null)),x=t.props?l:aa(l)}}catch(T){vs.length=0,sn(T,e,1),w=W(Oe)}let $=w;if(x&&E!==!1){const T=Object.keys(x),{shapeFlag:G}=$;T.length&&G&7&&(o&&T.some(Js)&&(x=ca(x,o)),$=Pt($,x,!1,!0))}return s.dirs&&($=Pt($,null,!1,!0),$.dirs=$.dirs?$.dirs.concat(s.dirs):s.dirs),s.transition&&Cs($,s.transition),w=$,Hs(j),w}const aa=e=>{let t;for(const s in e)(s==="class"||s==="style"||zs(s))&&((t||(t={}))[s]=e[s]);return t},ca=(e,t)=>{const s={};for(const n in e)(!Js(n)||!(n.slice(9)in t))&&(s[n]=e[n]);return s};function pa(e,t,s){const{props:n,children:i,component:o}=e,{props:r,children:l,patchFlag:a}=t,d=o.emitsOptions;if(t.dirs||t.transition)return!0;if(s&&a>=0){if(a&1024)return!0;if(a&16)return n?Pi(n,r,d):!!r;if(a&8){const c=t.dynamicProps;for(let p=0;p<c.length;p++){const h=c[p];if(pr(r,n,h)&&!rn(d,h))return!0}}}else return(i||l)&&(!l||!l.$stable)?!0:n===r?!1:n?r?Pi(n,r,d):!0:!!r;return!1}function Pi(e,t,s){const n=Object.keys(t);if(n.length!==Object.keys(e).length)return!0;for(let i=0;i<n.length;i++){const o=n[i];if(pr(t,e,o)&&!rn(s,o))return!0}return!1}function pr(e,t,s){const n=e[s],i=t[s];return s==="style"&&re(n)&&re(i)?!qn(n,i):n!==i}function ua({vnode:e,parent:t,suspense:s},n){for(;t;){const i=t.subTree;if(i.suspense&&i.suspense.activeBranch===e&&(i.suspense.vnode.el=i.el=n,e=i),i===e)(e=t.vnode).el=n,t=t.parent;else break}s&&s.activeBranch===e&&(s.vnode.el=n)}const ur={},dr=()=>Object.create(ur),fr=e=>Object.getPrototypeOf(e)===ur;function da(e,t,s,n=!1){const i={},o=dr();e.propsDefaults=Object.create(null),gr(e,t,i,o);for(const r in e.propsOptions[0])r in i||(i[r]=void 0);s?e.props=n?i:Uo(i):e.type.props?e.props=i:e.props=o,e.attrs=o}function fa(e,t,s,n){const{props:i,attrs:o,vnode:{patchFlag:r}}=e,l=te(i),[a]=e.propsOptions;let d=!1;if((n||r>0)&&!(r&16)){if(r&8){const c=e.vnode.dynamicProps;for(let p=0;p<c.length;p++){let h=c[p];if(rn(e.emitsOptions,h))continue;const _=t[h];if(a)if(oe(o,h))_!==o[h]&&(o[h]=_,d=!0);else{const C=Me(h);i[C]=Mn(a,l,C,_,e,!1)}else _!==o[h]&&(o[h]=_,d=!0)}}}else{gr(e,t,i,o)&&(d=!0);let c;for(const p in l)(!t||!oe(t,p)&&((c=Ht(p))===p||!oe(t,c)))&&(a?s&&(s[p]!==void 0||s[c]!==void 0)&&(i[p]=Mn(a,l,p,void 0,e,!0)):delete i[p]);if(o!==l)for(const p in o)(!t||!oe(t,p))&&(delete o[p],d=!0)}d&&mt(e.attrs,"set","")}function gr(e,t,s,n){const[i,o]=e.propsOptions;let r=!1,l;if(t)for(let a in t){if(ds(a))continue;const d=t[a];let c;i&&oe(i,c=Me(a))?!o||!o.includes(c)?s[c]=d:(l||(l={}))[c]=d:rn(e.emitsOptions,a)||(!(a in n)||d!==n[a])&&(n[a]=d,r=!0)}if(o){const a=te(s),d=l||fe;for(let c=0;c<o.length;c++){const p=o[c];s[p]=Mn(i,a,p,d[p],e,!oe(d,p))}}return r}function Mn(e,t,s,n,i,o){const r=e[s];if(r!=null){const l=oe(r,"default");if(l&&n===void 0){const a=r.default;if(r.type!==Function&&!r.skipFactory&&q(a)){const{propsDefaults:d}=i;if(s in d)n=d[s];else{const c=Ts(i);n=d[s]=a.call(null,t),c()}}else n=a;i.ce&&i.ce._setProp(s,n)}r[0]&&(o&&!l?n=!1:r[1]&&(n===""||n===Ht(s))&&(n=!0))}return n}const ga=new WeakMap;function hr(e,t,s=!1){const n=s?ga:t.propsCache,i=n.get(e);if(i)return i;const o=e.props,r={},l=[];let a=!1;if(!q(e)){const c=p=>{a=!0;const[h,_]=hr(p,t,!0);Ae(r,h),_&&l.push(..._)};!s&&t.mixins.length&&t.mixins.forEach(c),e.extends&&c(e.extends),e.mixins&&e.mixins.forEach(c)}if(!o&&!a)return re(e)&&n.set(e,Qt),Qt;if(H(o))for(let c=0;c<o.length;c++){const p=Me(o[c]);Ri(p)&&(r[p]=fe)}else if(o)for(const c in o){const p=Me(c);if(Ri(p)){const h=o[c],_=r[p]=H(h)||q(h)?{type:h}:Ae({},h),C=_.type;let E=!1,j=!0;if(H(C))for(let w=0;w<C.length;++w){const x=C[w],$=q(x)&&x.name;if($==="Boolean"){E=!0;break}else $==="String"&&(j=!1)}else E=q(C)&&C.name==="Boolean";_[0]=E,_[1]=j,(E||oe(_,"default"))&&l.push(p)}}const d=[r,l];return re(e)&&n.set(e,d),d}function Ri(e){return e[0]!=="$"&&!ds(e)}const ti=e=>e==="_"||e==="_ctx"||e==="$stable",si=e=>H(e)?e.map(ot):[ot(e)],ha=(e,t,s)=>{if(t._n)return t;const n=le((...i)=>si(t(...i)),s);return n._c=!1,n},_r=(e,t,s)=>{const n=e._ctx;for(const i in e){if(ti(i))continue;const o=e[i];if(q(o))t[i]=ha(i,o,n);else if(o!=null){const r=si(o);t[i]=()=>r}}},mr=(e,t)=>{const s=si(t);e.slots.default=()=>s},vr=(e,t,s)=>{for(const n in t)(s||!ti(n))&&(e[n]=t[n])},_a=(e,t,s)=>{const n=e.slots=dr();if(e.vnode.shapeFlag&32){const i=t._;i?(vr(n,t,s),s&&bo(n,"_",i,!0)):_r(t,n)}else t&&mr(e,t)},ma=(e,t,s)=>{const{vnode:n,slots:i}=e;let o=!0,r=fe;if(n.shapeFlag&32){const l=t._;l?s&&l===1?o=!1:vr(i,t,s):(o=!t.$stable,_r(t,i)),r=t}else t&&(mr(e,t),r={default:1});if(o)for(const l in i)!ti(l)&&r[l]==null&&delete i[l]},Ue=Sa;function va(e){return ba(e)}function ba(e,t){const s=Zs();s.__VUE__=!0;const{insert:n,remove:i,patchProp:o,createElement:r,createText:l,createComment:a,setText:d,setElementText:c,parentNode:p,nextSibling:h,setScopeId:_=at,insertStaticContent:C}=e,E=(u,f,m,v=null,A=null,b=null,R=void 0,P=null,I=!!f.dynamicChildren)=>{if(u===f)return;u&&!Ut(u,f)&&(v=y(u),De(u,A,b,!0),u=null),f.patchFlag===-2&&(I=!1,f.dynamicChildren=null);const{type:S,ref:F,shapeFlag:O}=f;switch(S){case ln:j(u,f,m,v);break;case Oe:w(u,f,m,v);break;case Ds:u==null&&x(f,m,v,R);break;case ee:M(u,f,m,v,A,b,R,P,I);break;default:O&1?G(u,f,m,v,A,b,R,P,I):O&6?se(u,f,m,v,A,b,R,P,I):(O&64||O&128)&&S.process(u,f,m,v,A,b,R,P,I,N)}F!=null&&A?hs(F,u&&u.ref,b,f||u,!f):F==null&&u&&u.ref!=null&&hs(u.ref,null,b,u,!0)},j=(u,f,m,v)=>{if(u==null)n(f.el=l(f.children),m,v);else{const A=f.el=u.el;f.children!==u.children&&d(A,f.children)}},w=(u,f,m,v)=>{u==null?n(f.el=a(f.children||""),m,v):f.el=u.el},x=(u,f,m,v)=>{[u.el,u.anchor]=C(u.children,f,m,v,u.el,u.anchor)},$=({el:u,anchor:f},m,v)=>{let A;for(;u&&u!==f;)A=h(u),n(u,m,v),u=A;n(f,m,v)},T=({el:u,anchor:f})=>{let m;for(;u&&u!==f;)m=h(u),i(u),u=m;i(f)},G=(u,f,m,v,A,b,R,P,I)=>{if(f.type==="svg"?R="svg":f.type==="math"&&(R="mathml"),u==null)Y(f,m,v,A,b,R,P,I);else{const S=u.el&&u.el._isVueCE?u.el:null;try{S&&S._beginPatch(),V(u,f,A,b,R,P,I)}finally{S&&S._endPatch()}}},Y=(u,f,m,v,A,b,R,P)=>{let I,S;const{props:F,shapeFlag:O,transition:L,dirs:K}=u;if(I=u.el=r(u.type,b,F&&F.is,F),O&8?c(I,u.children):O&16&&Se(u.children,I,null,v,A,vn(u,b),R,P),K&&Ot(u,null,v,"created"),Q(I,u,u.scopeId,R,v),F){for(const pe in F)pe!=="value"&&!ds(pe)&&o(I,pe,null,F[pe],b,v);"value"in F&&o(I,"value",null,F.value,b),(S=F.onVnodeBeforeMount)&&tt(S,v,u)}K&&Ot(u,null,v,"beforeMount");const Z=ya(A,L);Z&&L.beforeEnter(I),n(I,f,m),((S=F&&F.onVnodeMounted)||Z||K)&&Ue(()=>{S&&tt(S,v,u),Z&&L.enter(I),K&&Ot(u,null,v,"mounted")},A)},Q=(u,f,m,v,A)=>{if(m&&_(u,m),v)for(let b=0;b<v.length;b++)_(u,v[b]);if(A){let b=A.subTree;if(f===b||Sr(b.type)&&(b.ssContent===f||b.ssFallback===f)){const R=A.vnode;Q(u,R,R.scopeId,R.slotScopeIds,A.parent)}}},Se=(u,f,m,v,A,b,R,P,I=0)=>{for(let S=I;S<u.length;S++){const F=u[S]=P?_t(u[S]):ot(u[S]);E(null,F,f,m,v,A,b,R,P)}},V=(u,f,m,v,A,b,R)=>{const P=f.el=u.el;let{patchFlag:I,dynamicChildren:S,dirs:F}=f;I|=u.patchFlag&16;const O=u.props||fe,L=f.props||fe;let K;if(m&&jt(m,!1),(K=L.onVnodeBeforeUpdate)&&tt(K,m,f,u),F&&Ot(f,u,m,"beforeUpdate"),m&&jt(m,!0),(O.innerHTML&&L.innerHTML==null||O.textContent&&L.textContent==null)&&c(P,""),S?z(u.dynamicChildren,S,P,m,v,vn(f,A),b):R||ne(u,f,P,null,m,v,vn(f,A),b,!1),I>0){if(I&16)ae(P,O,L,m,A);else if(I&2&&O.class!==L.class&&o(P,"class",null,L.class,A),I&4&&o(P,"style",O.style,L.style,A),I&8){const Z=f.dynamicProps;for(let pe=0;pe<Z.length;pe++){const ue=Z[pe],be=O[ue],xe=L[ue];(xe!==be||ue==="value")&&o(P,ue,be,xe,A,m)}}I&1&&u.children!==f.children&&c(P,f.children)}else!R&&S==null&&ae(P,O,L,m,A);((K=L.onVnodeUpdated)||F)&&Ue(()=>{K&&tt(K,m,f,u),F&&Ot(f,u,m,"updated")},v)},z=(u,f,m,v,A,b,R)=>{for(let P=0;P<f.length;P++){const I=u[P],S=f[P],F=I.el&&(I.type===ee||!Ut(I,S)||I.shapeFlag&198)?p(I.el):m;E(I,S,F,null,v,A,b,R,!0)}},ae=(u,f,m,v,A)=>{if(f!==m){if(f!==fe)for(const b in f)!ds(b)&&!(b in m)&&o(u,b,f[b],null,A,v);for(const b in m){if(ds(b))continue;const R=m[b],P=f[b];R!==P&&b!=="value"&&o(u,b,P,R,A,v)}"value"in m&&o(u,"value",f.value,m.value,A)}},M=(u,f,m,v,A,b,R,P,I)=>{const S=f.el=u?u.el:l(""),F=f.anchor=u?u.anchor:l("");let{patchFlag:O,dynamicChildren:L,slotScopeIds:K}=f;K&&(P=P?P.concat(K):K),u==null?(n(S,m,v),n(F,m,v),Se(f.children||[],m,F,A,b,R,P,I)):O>0&&O&64&&L&&u.dynamicChildren&&u.dynamicChildren.length===L.length?(z(u.dynamicChildren,L,m,A,b,R,P),(f.key!=null||A&&f===A.subTree)&&br(u,f,!0)):ne(u,f,m,F,A,b,R,P,I)},se=(u,f,m,v,A,b,R,P,I)=>{f.slotScopeIds=P,u==null?f.shapeFlag&512?A.ctx.activate(f,m,v,R,I):Ee(f,m,v,A,b,R,I):Le(u,f,I)},Ee=(u,f,m,v,A,b,R)=>{const P=u.component=Ra(u,v,A);if(nn(u)&&(P.ctx.renderer=N),ka(P,!1,R),P.asyncDep){if(A&&A.registerDep(P,_e,R),!u.el){const I=P.subTree=W(Oe);w(null,I,f,m),u.placeholder=I.el}}else _e(P,u,f,m,A,b,R)},Le=(u,f,m)=>{const v=f.component=u.component;if(pa(u,f,m))if(v.asyncDep&&!v.asyncResolved){ce(v,f,m);return}else v.next=f,v.update();else f.el=u.el,v.vnode=f},_e=(u,f,m,v,A,b,R)=>{const P=()=>{if(u.isMounted){let{next:O,bu:L,u:K,parent:Z,vnode:pe}=u;{const Ze=yr(u);if(Ze){O&&(O.el=pe.el,ce(u,O,R)),Ze.asyncDep.then(()=>{Ue(()=>{u.isUnmounted||S()},A)});return}}let ue=O,be;jt(u,!1),O?(O.el=pe.el,ce(u,O,R)):O=pe,L&&un(L),(be=O.props&&O.props.onVnodeBeforeUpdate)&&tt(be,Z,O,pe),jt(u,!0);const xe=wi(u),Ye=u.subTree;u.subTree=xe,E(Ye,xe,p(Ye.el),y(Ye),u,A,b),O.el=xe.el,ue===null&&ua(u,xe.el),K&&Ue(K,A),(be=O.props&&O.props.onVnodeUpdated)&&Ue(()=>tt(be,Z,O,pe),A)}else{let O;const{el:L,props:K}=f,{bm:Z,m:pe,parent:ue,root:be,type:xe}=u,Ye=_s(f);jt(u,!1),Z&&un(Z),!Ye&&(O=K&&K.onVnodeBeforeMount)&&tt(O,ue,f),jt(u,!0);{be.ce&&be.ce._hasShadowRoot()&&be.ce._injectChildStyle(xe,u.parent?u.parent.type:void 0);const Ze=u.subTree=wi(u);E(null,Ze,m,v,u,A,b),f.el=Ze.el}if(pe&&Ue(pe,A),!Ye&&(O=K&&K.onVnodeMounted)){const Ze=f;Ue(()=>tt(O,ue,Ze),A)}(f.shapeFlag&256||ue&&_s(ue.vnode)&&ue.vnode.shapeFlag&256)&&u.a&&Ue(u.a,A),u.isMounted=!0,f=m=v=null}};u.scope.on();const I=u.effect=new Eo(P);u.scope.off();const S=u.update=I.run.bind(I),F=u.job=I.runIfDirty.bind(I);F.i=u,F.id=u.uid,I.scheduler=()=>ei(F),jt(u,!0),S()},ce=(u,f,m)=>{f.component=u;const v=u.vnode.props;u.vnode=f,u.next=null,fa(u,f.props,v,m),ma(u,f.children,m),vt(),vi(u),bt()},ne=(u,f,m,v,A,b,R,P,I=!1)=>{const S=u&&u.children,F=u?u.shapeFlag:0,O=f.children,{patchFlag:L,shapeFlag:K}=f;if(L>0){if(L&128){St(S,O,m,v,A,b,R,P,I);return}else if(L&256){ut(S,O,m,v,A,b,R,P,I);return}}K&8?(F&16&&He(S,A,b),O!==S&&c(m,O)):F&16?K&16?St(S,O,m,v,A,b,R,P,I):He(S,A,b,!0):(F&8&&c(m,""),K&16&&Se(O,m,v,A,b,R,P,I))},ut=(u,f,m,v,A,b,R,P,I)=>{u=u||Qt,f=f||Qt;const S=u.length,F=f.length,O=Math.min(S,F);let L;for(L=0;L<O;L++){const K=f[L]=I?_t(f[L]):ot(f[L]);E(u[L],K,m,null,A,b,R,P,I)}S>F?He(u,A,b,!0,!1,O):Se(f,m,v,A,b,R,P,I,O)},St=(u,f,m,v,A,b,R,P,I)=>{let S=0;const F=f.length;let O=u.length-1,L=F-1;for(;S<=O&&S<=L;){const K=u[S],Z=f[S]=I?_t(f[S]):ot(f[S]);if(Ut(K,Z))E(K,Z,m,null,A,b,R,P,I);else break;S++}for(;S<=O&&S<=L;){const K=u[O],Z=f[L]=I?_t(f[L]):ot(f[L]);if(Ut(K,Z))E(K,Z,m,null,A,b,R,P,I);else break;O--,L--}if(S>O){if(S<=L){const K=L+1,Z=K<F?f[K].el:v;for(;S<=L;)E(null,f[S]=I?_t(f[S]):ot(f[S]),m,Z,A,b,R,P,I),S++}}else if(S>L)for(;S<=O;)De(u[S],A,b,!0),S++;else{const K=S,Z=S,pe=new Map;for(S=Z;S<=L;S++){const Be=f[S]=I?_t(f[S]):ot(f[S]);Be.key!=null&&pe.set(Be.key,S)}let ue,be=0;const xe=L-Z+1;let Ye=!1,Ze=0;const rs=new Array(xe);for(S=0;S<xe;S++)rs[S]=0;for(S=K;S<=O;S++){const Be=u[S];if(be>=xe){De(Be,A,b,!0);continue}let et;if(Be.key!=null)et=pe.get(Be.key);else for(ue=Z;ue<=L;ue++)if(rs[ue-Z]===0&&Ut(Be,f[ue])){et=ue;break}et===void 0?De(Be,A,b,!0):(rs[et-Z]=S+1,et>=Ze?Ze=et:Ye=!0,E(Be,f[et],m,null,A,b,R,P,I),be++)}const ui=Ye?Aa(rs):Qt;for(ue=ui.length-1,S=xe-1;S>=0;S--){const Be=Z+S,et=f[Be],di=f[Be+1],fi=Be+1<F?di.el||Ar(di):v;rs[S]===0?E(null,et,m,fi,A,b,R,P,I):Ye&&(ue<0||S!==ui[ue]?Qe(et,m,fi,2):ue--)}}},Qe=(u,f,m,v,A=null)=>{const{el:b,type:R,transition:P,children:I,shapeFlag:S}=u;if(S&6){Qe(u.component.subTree,f,m,v);return}if(S&128){u.suspense.move(f,m,v);return}if(S&64){R.move(u,f,m,N);return}if(R===ee){n(b,f,m);for(let O=0;O<I.length;O++)Qe(I[O],f,m,v);n(u.anchor,f,m);return}if(R===Ds){$(u,f,m);return}if(v!==2&&S&1&&P)if(v===0)P.beforeEnter(b),n(b,f,m),Ue(()=>P.enter(b),A);else{const{leave:O,delayLeave:L,afterLeave:K}=P,Z=()=>{u.ctx.isUnmounted?i(b):n(b,f,m)},pe=()=>{b._isLeaving&&b[nt](!0),O(b,()=>{Z(),K&&K()})};L?L(b,Z,pe):pe()}else n(b,f,m)},De=(u,f,m,v=!1,A=!1)=>{const{type:b,props:R,ref:P,children:I,dynamicChildren:S,shapeFlag:F,patchFlag:O,dirs:L,cacheIndex:K,memo:Z}=u;if(O===-2&&(A=!1),P!=null&&(vt(),hs(P,null,m,u,!0),bt()),K!=null&&(f.renderCache[K]=void 0),F&256){f.ctx.deactivate(u);return}const pe=F&1&&L,ue=!_s(u);let be;if(ue&&(be=R&&R.onVnodeBeforeUnmount)&&tt(be,f,u),F&6)Tt(u.component,m,v);else{if(F&128){u.suspense.unmount(m,v);return}pe&&Ot(u,null,f,"beforeUnmount"),F&64?u.type.remove(u,f,m,N,v):S&&!S.hasOnce&&(b!==ee||O>0&&O&64)?He(S,f,m,!1,!0):(b===ee&&O&384||!A&&F&16)&&He(I,f,m),v&&Wt(u)}const xe=Z!=null&&K==null;(ue&&(be=R&&R.onVnodeUnmounted)||pe||xe)&&Ue(()=>{be&&tt(be,f,u),pe&&Ot(u,null,f,"unmounted"),xe&&(u.el=null)},m)},Wt=u=>{const{type:f,el:m,anchor:v,transition:A}=u;if(f===ee){qt(m,v);return}if(f===Ds){T(u);return}const b=()=>{i(m),A&&!A.persisted&&A.afterLeave&&A.afterLeave()};if(u.shapeFlag&1&&A&&!A.persisted){const{leave:R,delayLeave:P}=A,I=()=>R(m,b);P?P(u.el,b,I):I()}else b()},qt=(u,f)=>{let m;for(;u!==f;)m=h(u),i(u),u=m;i(f)},Tt=(u,f,m)=>{const{bum:v,scope:A,job:b,subTree:R,um:P,m:I,a:S}=u;ki(I),ki(S),v&&un(v),A.stop(),b&&(b.flags|=8,De(R,u,f,m)),P&&Ue(P,f),Ue(()=>{u.isUnmounted=!0},f)},He=(u,f,m,v=!1,A=!1,b=0)=>{for(let R=b;R<u.length;R++)De(u[R],f,m,v,A)},y=u=>{if(u.shapeFlag&6)return y(u.component.subTree);if(u.shapeFlag&128)return u.suspense.next();const f=h(u.anchor||u.el),m=f&&f[Dl];return m?h(m):f};let D=!1;const k=(u,f,m)=>{let v;u==null?f._vnode&&(De(f._vnode,null,null,!0),v=f._vnode.component):E(f._vnode||null,u,f,null,null,null,m),f._vnode=u,D||(D=!0,vi(v),Ho(),D=!1)},N={p:E,um:De,m:Qe,r:Wt,mt:Ee,mc:Se,pc:ne,pbc:z,n:y,o:e};return{render:k,hydrate:void 0,createApp:ia(k)}}function vn({type:e,props:t},s){return s==="svg"&&e==="foreignObject"||s==="mathml"&&e==="annotation-xml"&&t&&t.encoding&&t.encoding.includes("html")?void 0:s}function jt({effect:e,job:t},s){s?(e.flags|=32,t.flags|=4):(e.flags&=-33,t.flags&=-5)}function ya(e,t){return(!e||e&&!e.pendingBranch)&&t&&!t.persisted}function br(e,t,s=!1){const n=e.children,i=t.children;if(H(n)&&H(i))for(let o=0;o<n.length;o++){const r=n[o];let l=i[o];l.shapeFlag&1&&!l.dynamicChildren&&((l.patchFlag<=0||l.patchFlag===32)&&(l=i[o]=_t(i[o]),l.el=r.el),!s&&l.patchFlag!==-2&&br(r,l)),l.type===ln&&(l.patchFlag===-1&&(l=i[o]=_t(l)),l.el=r.el),l.type===Oe&&!l.el&&(l.el=r.el)}}function Aa(e){const t=e.slice(),s=[0];let n,i,o,r,l;const a=e.length;for(n=0;n<a;n++){const d=e[n];if(d!==0){if(i=s[s.length-1],e[i]<d){t[n]=i,s.push(n);continue}for(o=0,r=s.length-1;o<r;)l=o+r>>1,e[s[l]]<d?o=l+1:r=l;d<e[s[o]]&&(o>0&&(t[n]=s[o-1]),s[o]=n)}}for(o=s.length,r=s[o-1];o-- >0;)s[o]=r,r=t[r];return s}function yr(e){const t=e.subTree.component;if(t)return t.asyncDep&&!t.asyncResolved?t:yr(t)}function ki(e){if(e)for(let t=0;t<e.length;t++)e[t].flags|=8}function Ar(e){if(e.placeholder)return e.placeholder;const t=e.component;return t?Ar(t.subTree):null}const Sr=e=>e.__isSuspense;function Sa(e,t){t&&t.pendingBranch?H(e)?t.effects.push(...e):t.effects.push(e):Ol(e)}const ee=Symbol.for("v-fgt"),ln=Symbol.for("v-txt"),Oe=Symbol.for("v-cmt"),Ds=Symbol.for("v-stc"),vs=[];let Fe=null;function U(e=!1){vs.push(Fe=e?null:[])}function Ea(){vs.pop(),Fe=vs[vs.length-1]||null}let xs=1;function Ws(e,t=!1){xs+=e,e<0&&Fe&&t&&(Fe.hasOnce=!0)}function Er(e){return e.dynamicChildren=xs>0?Fe||Qt:null,Ea(),xs>0&&Fe&&Fe.push(e),e}function B(e,t,s,n,i,o){return Er(g(e,t,s,n,i,o,!0))}function kt(e,t,s,n,i){return Er(W(e,t,s,n,i,!0))}function qs(e){return e?e.__v_isVNode===!0:!1}function Ut(e,t){return e.type===t.type&&e.key===t.key}const Cr=({key:e})=>e??null,Us=({ref:e,ref_key:t,ref_for:s})=>(typeof e=="number"&&(e=""+e),e!=null?he(e)||Pe(e)||q(e)?{i:qe,r:e,k:t,f:!!s}:e:null);function g(e,t=null,s=null,n=0,i=null,o=e===ee?0:1,r=!1,l=!1){const a={__v_isVNode:!0,__v_skip:!0,type:e,props:t,key:t&&Cr(t),ref:t&&Us(t),scopeId:Ko,slotScopeIds:null,children:s,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetStart:null,targetAnchor:null,staticCount:0,shapeFlag:o,patchFlag:n,dynamicProps:i,dynamicChildren:null,appContext:null,ctx:qe};return l?(ii(a,s),o&128&&e.normalize(a)):s&&(a.shapeFlag|=he(s)?8:16),xs>0&&!r&&Fe&&(a.patchFlag>0||o&6)&&a.patchFlag!==32&&Fe.push(a),a}const W=Ca;function Ca(e,t=null,s=null,n=0,i=null,o=!1){if((!e||e===ir)&&(e=Oe),qs(e)){const l=Pt(e,t,!0);return s&&ii(l,s),xs>0&&!o&&Fe&&(l.shapeFlag&6?Fe[Fe.indexOf(e)]=l:Fe.push(l)),l.patchFlag=-2,l}if(Ma(e)&&(e=e.__vccOpts),t){t=xa(t);let{class:l,style:a}=t;l&&!he(l)&&(t.class=We(l)),re(a)&&(Zn(a)&&!H(a)&&(a=Ae({},a)),t.style=Wn(a))}const r=he(e)?1:Sr(e)?128:Go(e)?64:re(e)?4:q(e)?2:0;return g(e,t,s,n,i,r,o,!0)}function xa(e){return e?Zn(e)||fr(e)?Ae({},e):e:null}function Pt(e,t,s=!1,n=!1){const{props:i,ref:o,patchFlag:r,children:l,transition:a}=e,d=t?Ia(i||{},t):i,c={__v_isVNode:!0,__v_skip:!0,type:e.type,props:d,key:d&&Cr(d),ref:t&&t.ref?s&&o?H(o)?o.concat(Us(t)):[o,Us(t)]:Us(t):o,scopeId:e.scopeId,slotScopeIds:e.slotScopeIds,children:l,target:e.target,targetStart:e.targetStart,targetAnchor:e.targetAnchor,staticCount:e.staticCount,shapeFlag:e.shapeFlag,patchFlag:t&&e.type!==ee?r===-1?16:r|16:r,dynamicProps:e.dynamicProps,dynamicChildren:e.dynamicChildren,appContext:e.appContext,dirs:e.dirs,transition:a,component:e.component,suspense:e.suspense,ssContent:e.ssContent&&Pt(e.ssContent),ssFallback:e.ssFallback&&Pt(e.ssFallback),placeholder:e.placeholder,el:e.el,anchor:e.anchor,ctx:e.ctx,ce:e.ce};return a&&n&&Cs(c,a.clone(c)),c}function me(e=" ",t=0){return W(ln,null,e,t)}function ts(e,t){const s=W(Ds,null,e);return s.staticCount=t,s}function ni(e="",t=!1){return t?(U(),kt(Oe,null,e)):W(Oe,null,e)}function ot(e){return e==null||typeof e=="boolean"?W(Oe):H(e)?W(ee,null,e.slice()):qs(e)?_t(e):W(ln,null,String(e))}function _t(e){return e.el===null&&e.patchFlag!==-1||e.memo?e:Pt(e)}function ii(e,t){let s=0;const{shapeFlag:n}=e;if(t==null)t=null;else if(H(t))s=16;else if(typeof t=="object")if(n&65){const i=t.default;i&&(i._c&&(i._d=!1),ii(e,i()),i._c&&(i._d=!0));return}else{s=32;const i=t._;!i&&!fr(t)?t._ctx=qe:i===3&&qe&&(qe.slots._===1?t._=1:(t._=2,e.patchFlag|=1024))}else q(t)?(t={default:t,_ctx:qe},s=32):(t=String(t),n&64?(s=16,t=[me(t)]):s=8);e.children=t,e.shapeFlag|=s}function Ia(...e){const t={};for(let s=0;s<e.length;s++){const n=e[s];for(const i in n)if(i==="class")t.class!==n.class&&(t.class=We([t.class,n.class]));else if(i==="style")t.style=Wn([t.style,n.style]);else if(zs(i)){const o=t[i],r=n[i];r&&o!==r&&!(H(o)&&o.includes(r))?t[i]=o?[].concat(o,r):r:r==null&&o==null&&!Js(i)&&(t[i]=r)}else i!==""&&(t[i]=n[i])}return t}function tt(e,t,s,n=null){ze(e,t,7,[s,n])}const wa=ar();let Pa=0;function Ra(e,t,s){const n=e.type,i=(t?t.appContext:e.appContext)||wa,o={uid:Pa++,vnode:e,type:n,parent:t,appContext:i,root:null,next:null,subTree:null,effect:null,update:null,job:null,scope:new sl(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:t?t.provides:Object.create(i.provides),ids:t?t.ids:["",0,0],accessCache:null,renderCache:[],components:null,directives:null,propsOptions:hr(n,i),emitsOptions:cr(n,i),emit:null,emitted:null,propsDefaults:fe,inheritAttrs:n.inheritAttrs,ctx:fe,data:fe,props:fe,attrs:fe,slots:fe,refs:fe,setupState:fe,setupContext:null,suspense:s,suspenseId:s?s.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return o.ctx={_:o},o.root=t?t.root:o,o.emit=ra.bind(null,o),e.ce&&e.ce(o),o}let we=null;const xr=()=>we||qe;let Gs,Dn;{const e=Zs(),t=(s,n)=>{let i;return(i=e[s])||(i=e[s]=[]),i.push(n),o=>{i.length>1?i.forEach(r=>r(o)):i[0](o)}};Gs=t("__VUE_INSTANCE_SETTERS__",s=>we=s),Dn=t("__VUE_SSR_SETTERS__",s=>Is=s)}const Ts=e=>{const t=we;return Gs(e),e.scope.on(),()=>{e.scope.off(),Gs(t)}},Ti=()=>{we&&we.scope.off(),Gs(null)};function Ir(e){return e.vnode.shapeFlag&4}let Is=!1;function ka(e,t=!1,s=!1){t&&Dn(t);const{props:n,children:i}=e.vnode,o=Ir(e);da(e,n,o,t),_a(e,i,s||t);const r=o?Ta(e,t):void 0;return t&&Dn(!1),r}function Ta(e,t){const s=e.type;e.accessCache=Object.create(null),e.proxy=new Proxy(e.ctx,Ql);const{setup:n}=s;if(n){vt();const i=e.setupContext=n.length>1?ja(e):null,o=Ts(e),r=ks(n,e,0,[e.props,i]),l=_o(r);if(bt(),o(),(l||e.sp)&&!_s(e)&&er(e),l){if(r.then(Ti,Ti),t)return r.then(a=>{Oi(e,a)}).catch(a=>{sn(a,e,0)});e.asyncDep=r}else Oi(e,r)}else wr(e)}function Oi(e,t,s){q(t)?e.type.__ssrInlineRender?e.ssrRender=t:e.render=t:re(t)&&(e.setupState=Lo(t)),wr(e)}function wr(e,t,s){const n=e.type;e.render||(e.render=n.render||at);{const i=Ts(e);vt();try{Yl(e)}finally{bt(),i()}}}const Oa={get(e,t){return Ie(e,"get",""),e[t]}};function ja(e){const t=s=>{e.exposed=s||{}};return{attrs:new Proxy(e.attrs,Oa),slots:e.slots,emit:e.emit,expose:t}}function oi(e){return e.exposed?e.exposeProxy||(e.exposeProxy=new Proxy(Lo(Sl(e.exposed)),{get(t,s){if(s in t)return t[s];if(s in ms)return ms[s](e)},has(t,s){return s in t||s in ms}})):e.proxy}function $a(e,t=!0){return q(e)?e.displayName||e.name:e.name||t&&e.__name}function Ma(e){return q(e)&&"__vccOpts"in e}const je=(e,t)=>wl(e,t,Is);function ri(e,t,s){try{Ws(-1);const n=arguments.length;return n===2?re(t)&&!H(t)?qs(t)?W(e,null,[t]):W(e,t):W(e,null,t):(n>3?s=Array.prototype.slice.call(arguments,2):n===3&&qs(s)&&(s=[s]),W(e,t,s))}finally{Ws(1)}}const Da="3.5.31";let Un;const ji=typeof window<"u"&&window.trustedTypes;if(ji)try{Un=ji.createPolicy("vue",{createHTML:e=>e})}catch{}const Pr=Un?e=>Un.createHTML(e):e=>e,Ua="http://www.w3.org/2000/svg",Na="http://www.w3.org/1998/Math/MathML",ht=typeof document<"u"?document:null,$i=ht&&ht.createElement("template"),La={insert:(e,t,s)=>{t.insertBefore(e,s||null)},remove:e=>{const t=e.parentNode;t&&t.removeChild(e)},createElement:(e,t,s,n)=>{const i=t==="svg"?ht.createElementNS(Ua,e):t==="mathml"?ht.createElementNS(Na,e):s?ht.createElement(e,{is:s}):ht.createElement(e);return e==="select"&&n&&n.multiple!=null&&i.setAttribute("multiple",n.multiple),i},createText:e=>ht.createTextNode(e),createComment:e=>ht.createComment(e),setText:(e,t)=>{e.nodeValue=t},setElementText:(e,t)=>{e.textContent=t},parentNode:e=>e.parentNode,nextSibling:e=>e.nextSibling,querySelector:e=>ht.querySelector(e),setScopeId(e,t){e.setAttribute(t,"")},insertStaticContent(e,t,s,n,i,o){const r=s?s.previousSibling:t.lastChild;if(i&&(i===o||i.nextSibling))for(;t.insertBefore(i.cloneNode(!0),s),!(i===o||!(i=i.nextSibling)););else{$i.innerHTML=Pr(n==="svg"?`<svg>${e}</svg>`:n==="mathml"?`<math>${e}</math>`:e);const l=$i.content;if(n==="svg"||n==="mathml"){const a=l.firstChild;for(;a.firstChild;)l.appendChild(a.firstChild);l.removeChild(a)}t.insertBefore(l,s)}return[r?r.nextSibling:t.firstChild,s?s.previousSibling:t.lastChild]}},Et="transition",cs="animation",ws=Symbol("_vtc"),Rr={name:String,type:String,css:{type:Boolean,default:!0},duration:[String,Number,Object],enterFromClass:String,enterActiveClass:String,enterToClass:String,appearFromClass:String,appearActiveClass:String,appearToClass:String,leaveFromClass:String,leaveActiveClass:String,leaveToClass:String},Ba=Ae({},Xo,Rr),Fa=e=>(e.displayName="Transition",e.props=Ba,e),Ha=Fa((e,{slots:t})=>ri(Ll,Va(e),t)),$t=(e,t=[])=>{H(e)?e.forEach(s=>s(...t)):e&&e(...t)},Mi=e=>e?H(e)?e.some(t=>t.length>1):e.length>1:!1;function Va(e){const t={};for(const M in e)M in Rr||(t[M]=e[M]);if(e.css===!1)return t;const{name:s="v",type:n,duration:i,enterFromClass:o=`${s}-enter-from`,enterActiveClass:r=`${s}-enter-active`,enterToClass:l=`${s}-enter-to`,appearFromClass:a=o,appearActiveClass:d=r,appearToClass:c=l,leaveFromClass:p=`${s}-leave-from`,leaveActiveClass:h=`${s}-leave-active`,leaveToClass:_=`${s}-leave-to`}=e,C=Ka(i),E=C&&C[0],j=C&&C[1],{onBeforeEnter:w,onEnter:x,onEnterCancelled:$,onLeave:T,onLeaveCancelled:G,onBeforeAppear:Y=w,onAppear:Q=x,onAppearCancelled:Se=$}=t,V=(M,se,Ee,Le)=>{M._enterCancelled=Le,Mt(M,se?c:l),Mt(M,se?d:r),Ee&&Ee()},z=(M,se)=>{M._isLeaving=!1,Mt(M,p),Mt(M,_),Mt(M,h),se&&se()},ae=M=>(se,Ee)=>{const Le=M?Q:x,_e=()=>V(se,M,Ee);$t(Le,[se,_e]),Di(()=>{Mt(se,M?a:o),ft(se,M?c:l),Mi(Le)||Ui(se,n,E,_e)})};return Ae(t,{onBeforeEnter(M){$t(w,[M]),ft(M,o),ft(M,r)},onBeforeAppear(M){$t(Y,[M]),ft(M,a),ft(M,d)},onEnter:ae(!1),onAppear:ae(!0),onLeave(M,se){M._isLeaving=!0;const Ee=()=>z(M,se);ft(M,p),M._enterCancelled?(ft(M,h),Bi(M)):(Bi(M),ft(M,h)),Di(()=>{M._isLeaving&&(Mt(M,p),ft(M,_),Mi(T)||Ui(M,n,j,Ee))}),$t(T,[M,Ee])},onEnterCancelled(M){V(M,!1,void 0,!0),$t($,[M])},onAppearCancelled(M){V(M,!0,void 0,!0),$t(Se,[M])},onLeaveCancelled(M){z(M),$t(G,[M])}})}function Ka(e){if(e==null)return null;if(re(e))return[bn(e.enter),bn(e.leave)];{const t=bn(e);return[t,t]}}function bn(e){return Xr(e)}function ft(e,t){t.split(/\s+/).forEach(s=>s&&e.classList.add(s)),(e[ws]||(e[ws]=new Set)).add(t)}function Mt(e,t){t.split(/\s+/).forEach(n=>n&&e.classList.remove(n));const s=e[ws];s&&(s.delete(t),s.size||(e[ws]=void 0))}function Di(e){requestAnimationFrame(()=>{requestAnimationFrame(e)})}let Wa=0;function Ui(e,t,s,n){const i=e._endId=++Wa,o=()=>{i===e._endId&&n()};if(s!=null)return setTimeout(o,s);const{type:r,timeout:l,propCount:a}=qa(e,t);if(!r)return n();const d=r+"end";let c=0;const p=()=>{e.removeEventListener(d,h),o()},h=_=>{_.target===e&&++c>=a&&p()};setTimeout(()=>{c<a&&p()},l+1),e.addEventListener(d,h)}function qa(e,t){const s=window.getComputedStyle(e),n=C=>(s[C]||"").split(", "),i=n(`${Et}Delay`),o=n(`${Et}Duration`),r=Ni(i,o),l=n(`${cs}Delay`),a=n(`${cs}Duration`),d=Ni(l,a);let c=null,p=0,h=0;t===Et?r>0&&(c=Et,p=r,h=o.length):t===cs?d>0&&(c=cs,p=d,h=a.length):(p=Math.max(r,d),c=p>0?r>d?Et:cs:null,h=c?c===Et?o.length:a.length:0);const _=c===Et&&/\b(?:transform|all)(?:,|$)/.test(n(`${Et}Property`).toString());return{type:c,timeout:p,propCount:h,hasTransform:_}}function Ni(e,t){for(;e.length<t.length;)e=e.concat(e);return Math.max(...t.map((s,n)=>Li(s)+Li(e[n])))}function Li(e){return e==="auto"?0:Number(e.slice(0,-1).replace(",","."))*1e3}function Bi(e){return(e?e.ownerDocument:document).body.offsetHeight}function Ga(e,t,s){const n=e[ws];n&&(t=(t?[t,...n]:[...n]).join(" ")),t==null?e.removeAttribute("class"):s?e.setAttribute("class",t):e.className=t}const Fi=Symbol("_vod"),Xa=Symbol("_vsh"),za=Symbol(""),Ja=/(?:^|;)\s*display\s*:/;function Qa(e,t,s){const n=e.style,i=he(s);let o=!1;if(s&&!i){if(t)if(he(t))for(const r of t.split(";")){const l=r.slice(0,r.indexOf(":")).trim();s[l]==null&&Ns(n,l,"")}else for(const r in t)s[r]==null&&Ns(n,r,"");for(const r in s)r==="display"&&(o=!0),Ns(n,r,s[r])}else if(i){if(t!==s){const r=n[za];r&&(s+=";"+r),n.cssText=s,o=Ja.test(s)}}else t&&e.removeAttribute("style");Fi in e&&(e[Fi]=o?n.display:"",e[Xa]&&(n.display="none"))}const Hi=/\s*!important$/;function Ns(e,t,s){if(H(s))s.forEach(n=>Ns(e,t,n));else if(s==null&&(s=""),t.startsWith("--"))e.setProperty(t,s);else{const n=Ya(e,t);Hi.test(s)?e.setProperty(Ht(n),s.replace(Hi,""),"important"):e[n]=s}}const Vi=["Webkit","Moz","ms"],yn={};function Ya(e,t){const s=yn[t];if(s)return s;let n=Me(t);if(n!=="filter"&&n in e)return yn[t]=n;n=Ys(n);for(let i=0;i<Vi.length;i++){const o=Vi[i]+n;if(o in e)return yn[t]=o}return t}const Ki="http://www.w3.org/1999/xlink";function Wi(e,t,s,n,i,o=el(t)){n&&t.startsWith("xlink:")?s==null?e.removeAttributeNS(Ki,t.slice(6,t.length)):e.setAttributeNS(Ki,t,s):s==null||o&&!yo(s)?e.removeAttribute(t):e.setAttribute(t,o?"":pt(s)?String(s):s)}function qi(e,t,s,n,i){if(t==="innerHTML"||t==="textContent"){s!=null&&(e[t]=t==="innerHTML"?Pr(s):s);return}const o=e.tagName;if(t==="value"&&o!=="PROGRESS"&&!o.includes("-")){const l=o==="OPTION"?e.getAttribute("value")||"":e.value,a=s==null?e.type==="checkbox"?"on":"":String(s);(l!==a||!("_value"in e))&&(e.value=a),s==null&&e.removeAttribute(t),e._value=s;return}let r=!1;if(s===""||s==null){const l=typeof e[t];l==="boolean"?s=yo(s):s==null&&l==="string"?(s="",r=!0):l==="number"&&(s=0,r=!0)}try{e[t]=s}catch{}r&&e.removeAttribute(i||t)}function Za(e,t,s,n){e.addEventListener(t,s,n)}function ec(e,t,s,n){e.removeEventListener(t,s,n)}const Gi=Symbol("_vei");function tc(e,t,s,n,i=null){const o=e[Gi]||(e[Gi]={}),r=o[t];if(n&&r)r.value=n;else{const[l,a]=sc(t);if(n){const d=o[t]=oc(n,i);Za(e,l,d,a)}else r&&(ec(e,l,r,a),o[t]=void 0)}}const Xi=/(?:Once|Passive|Capture)$/;function sc(e){let t;if(Xi.test(e)){t={};let n;for(;n=e.match(Xi);)e=e.slice(0,e.length-n[0].length),t[n[0].toLowerCase()]=!0}return[e[2]===":"?e.slice(3):Ht(e.slice(2)),t]}let An=0;const nc=Promise.resolve(),ic=()=>An||(nc.then(()=>An=0),An=Date.now());function oc(e,t){const s=n=>{if(!n._vts)n._vts=Date.now();else if(n._vts<=s.attached)return;ze(rc(n,s.value),t,5,[n])};return s.value=e,s.attached=ic(),s}function rc(e,t){if(H(t)){const s=e.stopImmediatePropagation;return e.stopImmediatePropagation=()=>{s.call(e),e._stopped=!0},t.map(n=>i=>!i._stopped&&n&&n(i))}else return t}const zi=e=>e.charCodeAt(0)===111&&e.charCodeAt(1)===110&&e.charCodeAt(2)>96&&e.charCodeAt(2)<123,lc=(e,t,s,n,i,o)=>{const r=i==="svg";t==="class"?Ga(e,n,r):t==="style"?Qa(e,s,n):zs(t)?Js(t)||tc(e,t,s,n,o):(t[0]==="."?(t=t.slice(1),!0):t[0]==="^"?(t=t.slice(1),!1):ac(e,t,n,r))?(qi(e,t,n),!e.tagName.includes("-")&&(t==="value"||t==="checked"||t==="selected")&&Wi(e,t,n,r,o,t!=="value")):e._isVueCE&&(cc(e,t)||e._def.__asyncLoader&&(/[A-Z]/.test(t)||!he(n)))?qi(e,Me(t),n,o,t):(t==="true-value"?e._trueValue=n:t==="false-value"&&(e._falseValue=n),Wi(e,t,n,r))};function ac(e,t,s,n){if(n)return!!(t==="innerHTML"||t==="textContent"||t in e&&zi(t)&&q(s));if(t==="spellcheck"||t==="draggable"||t==="translate"||t==="autocorrect"||t==="sandbox"&&e.tagName==="IFRAME"||t==="form"||t==="list"&&e.tagName==="INPUT"||t==="type"&&e.tagName==="TEXTAREA")return!1;if(t==="width"||t==="height"){const i=e.tagName;if(i==="IMG"||i==="VIDEO"||i==="CANVAS"||i==="SOURCE")return!1}return zi(t)&&he(s)?!1:t in e}function cc(e,t){const s=e._def.props;if(!s)return!1;const n=Me(t);return Array.isArray(s)?s.some(i=>Me(i)===n):Object.keys(s).some(i=>Me(i)===n)}const pc=["ctrl","shift","alt","meta"],uc={stop:e=>e.stopPropagation(),prevent:e=>e.preventDefault(),self:e=>e.target!==e.currentTarget,ctrl:e=>!e.ctrlKey,shift:e=>!e.shiftKey,alt:e=>!e.altKey,meta:e=>!e.metaKey,left:e=>"button"in e&&e.button!==0,middle:e=>"button"in e&&e.button!==1,right:e=>"button"in e&&e.button!==2,exact:(e,t)=>pc.some(s=>e[`${s}Key`]&&!t.includes(s))},Xs=(e,t)=>{if(!e)return e;const s=e._withMods||(e._withMods={}),n=t.join(".");return s[n]||(s[n]=((i,...o)=>{for(let r=0;r<t.length;r++){const l=uc[t[r]];if(l&&l(i,t))return}return e(i,...o)}))},dc=Ae({patchProp:lc},La);let Ji;function fc(){return Ji||(Ji=va(dc))}const gc=((...e)=>{const t=fc().createApp(...e),{mount:s}=t;return t.mount=n=>{const i=_c(n);if(!i)return;const o=t._component;!q(o)&&!o.render&&!o.template&&(o.template=i.innerHTML),i.nodeType===1&&(i.textContent="");const r=s(i,!1,hc(i));return i instanceof Element&&(i.removeAttribute("v-cloak"),i.setAttribute("data-v-app","")),r},t});function hc(e){if(e instanceof SVGElement)return"svg";if(typeof MathMLElement=="function"&&e instanceof MathMLElement)return"mathml"}function _c(e){return he(e)?document.querySelector(e):e}const zt=typeof document<"u";function kr(e){return typeof e=="object"||"displayName"in e||"props"in e||"__vccOpts"in e}function mc(e){return e.__esModule||e[Symbol.toStringTag]==="Module"||e.default&&kr(e.default)}const ie=Object.assign;function Sn(e,t){const s={};for(const n in t){const i=t[n];s[n]=Je(i)?i.map(e):e(i)}return s}const bs=()=>{},Je=Array.isArray;function Qi(e,t){const s={};for(const n in e)s[n]=n in t?t[n]:e[n];return s}let ge=(function(e){return e[e.MATCHER_NOT_FOUND=1]="MATCHER_NOT_FOUND",e[e.NAVIGATION_GUARD_REDIRECT=2]="NAVIGATION_GUARD_REDIRECT",e[e.NAVIGATION_ABORTED=4]="NAVIGATION_ABORTED",e[e.NAVIGATION_CANCELLED=8]="NAVIGATION_CANCELLED",e[e.NAVIGATION_DUPLICATED=16]="NAVIGATION_DUPLICATED",e})({});const Tr=Symbol("");ge.MATCHER_NOT_FOUND+"",ge.NAVIGATION_GUARD_REDIRECT+"",ge.NAVIGATION_ABORTED+"",ge.NAVIGATION_CANCELLED+"",ge.NAVIGATION_DUPLICATED+"";function is(e,t){return ie(new Error,{type:e,[Tr]:!0},t)}function gt(e,t){return e instanceof Error&&Tr in e&&(t==null||!!(e.type&t))}const vc=["params","query","hash"];function bc(e){if(typeof e=="string")return e;if(e.path!=null)return e.path;const t={};for(const s of vc)s in e&&(t[s]=e[s]);return JSON.stringify(t,null,2)}const yc=Symbol(""),Yi=Symbol(""),li=Symbol(""),ai=Symbol(""),Nn=Symbol("");function ci(e){return ct(ai)}const Or=/#/g,Ac=/&/g,Sc=/\//g,Ec=/=/g,Cc=/\?/g,jr=/\+/g,xc=/%5B/g,Ic=/%5D/g,$r=/%5E/g,wc=/%60/g,Mr=/%7B/g,Pc=/%7C/g,Dr=/%7D/g,Rc=/%20/g;function pi(e){return e==null?"":encodeURI(""+e).replace(Pc,"|").replace(xc,"[").replace(Ic,"]")}function kc(e){return pi(e).replace(Mr,"{").replace(Dr,"}").replace($r,"^")}function Ln(e){return pi(e).replace(jr,"%2B").replace(Rc,"+").replace(Or,"%23").replace(Ac,"%26").replace(wc,"`").replace(Mr,"{").replace(Dr,"}").replace($r,"^")}function Tc(e){return Ln(e).replace(Ec,"%3D")}function Oc(e){return pi(e).replace(Or,"%23").replace(Cc,"%3F")}function jc(e){return Oc(e).replace(Sc,"%2F")}function Ps(e){if(e==null)return null;try{return decodeURIComponent(""+e)}catch{}return""+e}const $c=/\/$/,Mc=e=>e.replace($c,"");function En(e,t,s="/"){let n,i={},o="",r="";const l=t.indexOf("#");let a=t.indexOf("?");return a=l>=0&&a>l?-1:a,a>=0&&(n=t.slice(0,a),o=t.slice(a,l>0?l:t.length),i=e(o.slice(1))),l>=0&&(n=n||t.slice(0,l),r=t.slice(l,t.length)),n=Lc(n??t,s),{fullPath:n+o+r,path:n,query:i,hash:Ps(r)}}function Dc(e,t){const s=t.query?e(t.query):"";return t.path+(s&&"?")+s+(t.hash||"")}function Zi(e,t){return!t||!e.toLowerCase().startsWith(t.toLowerCase())?e:e.slice(t.length)||"/"}function Uc(e,t,s){const n=t.matched.length-1,i=s.matched.length-1;return n>-1&&n===i&&os(t.matched[n],s.matched[i])&&Ur(t.params,s.params)&&e(t.query)===e(s.query)&&t.hash===s.hash}function os(e,t){return(e.aliasOf||e)===(t.aliasOf||t)}function Ur(e,t){if(Object.keys(e).length!==Object.keys(t).length)return!1;for(var s in e)if(!Nc(e[s],t[s]))return!1;return!0}function Nc(e,t){return Je(e)?eo(e,t):Je(t)?eo(t,e):(e&&e.valueOf())===(t&&t.valueOf())}function eo(e,t){return Je(t)?e.length===t.length&&e.every((s,n)=>s===t[n]):e.length===1&&e[0]===t}function Lc(e,t){if(e.startsWith("/"))return e;if(!e)return t;const s=t.split("/"),n=e.split("/"),i=n[n.length-1];(i===".."||i===".")&&n.push("");let o=s.length-1,r,l;for(r=0;r<n.length;r++)if(l=n[r],l!==".")if(l==="..")o>1&&o--;else break;return s.slice(0,o).join("/")+"/"+n.slice(r).join("/")}const Ct={path:"/",name:void 0,params:{},query:{},hash:"",fullPath:"/",matched:[],meta:{},redirectedFrom:void 0};let Bn=(function(e){return e.pop="pop",e.push="push",e})({}),Cn=(function(e){return e.back="back",e.forward="forward",e.unknown="",e})({});function Bc(e){if(!e)if(zt){const t=document.querySelector("base");e=t&&t.getAttribute("href")||"/",e=e.replace(/^\w+:\/\/[^\/]+/,"")}else e="/";return e[0]!=="/"&&e[0]!=="#"&&(e="/"+e),Mc(e)}const Fc=/^[^#]+#/;function Hc(e,t){return e.replace(Fc,"#")+t}function Vc(e,t){const s=document.documentElement.getBoundingClientRect(),n=e.getBoundingClientRect();return{behavior:t.behavior,left:n.left-s.left-(t.left||0),top:n.top-s.top-(t.top||0)}}const an=()=>({left:window.scrollX,top:window.scrollY});function Kc(e){let t;if("el"in e){const s=e.el,n=typeof s=="string"&&s.startsWith("#"),i=typeof s=="string"?n?document.getElementById(s.slice(1)):document.querySelector(s):s;if(!i)return;t=Vc(i,e)}else t=e;"scrollBehavior"in document.documentElement.style?window.scrollTo(t):window.scrollTo(t.left!=null?t.left:window.scrollX,t.top!=null?t.top:window.scrollY)}function to(e,t){return(history.state?history.state.position-t:-1)+e}const Fn=new Map;function Wc(e,t){Fn.set(e,t)}function qc(e){const t=Fn.get(e);return Fn.delete(e),t}function Gc(e){return typeof e=="string"||e&&typeof e=="object"}function Nr(e){return typeof e=="string"||typeof e=="symbol"}function Xc(e){const t={};if(e===""||e==="?")return t;const s=(e[0]==="?"?e.slice(1):e).split("&");for(let n=0;n<s.length;++n){const i=s[n].replace(jr," "),o=i.indexOf("="),r=Ps(o<0?i:i.slice(0,o)),l=o<0?null:Ps(i.slice(o+1));if(r in t){let a=t[r];Je(a)||(a=t[r]=[a]),a.push(l)}else t[r]=l}return t}function so(e){let t="";for(let s in e){const n=e[s];if(s=Tc(s),n==null){n!==void 0&&(t+=(t.length?"&":"")+s);continue}(Je(n)?n.map(i=>i&&Ln(i)):[n&&Ln(n)]).forEach(i=>{i!==void 0&&(t+=(t.length?"&":"")+s,i!=null&&(t+="="+i))})}return t}function zc(e){const t={};for(const s in e){const n=e[s];n!==void 0&&(t[s]=Je(n)?n.map(i=>i==null?null:""+i):n==null?n:""+n)}return t}function ps(){let e=[];function t(n){return e.push(n),()=>{const i=e.indexOf(n);i>-1&&e.splice(i,1)}}function s(){e=[]}return{add:t,list:()=>e.slice(),reset:s}}function It(e,t,s,n,i,o=r=>r()){const r=n&&(n.enterCallbacks[i]=n.enterCallbacks[i]||[]);return()=>new Promise((l,a)=>{const d=h=>{h===!1?a(is(ge.NAVIGATION_ABORTED,{from:s,to:t})):h instanceof Error?a(h):Gc(h)?a(is(ge.NAVIGATION_GUARD_REDIRECT,{from:t,to:h})):(r&&n.enterCallbacks[i]===r&&typeof h=="function"&&r.push(h),l())},c=o(()=>e.call(n&&n.instances[i],t,s,d));let p=Promise.resolve(c);e.length<3&&(p=p.then(d)),p.catch(h=>a(h))})}function xn(e,t,s,n,i=o=>o()){const o=[];for(const r of e)for(const l in r.components){let a=r.components[l];if(!(t!=="beforeRouteEnter"&&!r.instances[l]))if(kr(a)){const d=(a.__vccOpts||a)[t];d&&o.push(It(d,s,n,r,l,i))}else{let d=a();o.push(()=>d.then(c=>{if(!c)throw new Error(`Couldn't resolve component "${l}" at "${r.path}"`);const p=mc(c)?c.default:c;r.mods[l]=c,r.components[l]=p;const h=(p.__vccOpts||p)[t];return h&&It(h,s,n,r,l,i)()}))}}return o}function Jc(e,t){const s=[],n=[],i=[],o=Math.max(t.matched.length,e.matched.length);for(let r=0;r<o;r++){const l=t.matched[r];l&&(e.matched.find(d=>os(d,l))?n.push(l):s.push(l));const a=e.matched[r];a&&(t.matched.find(d=>os(d,a))||i.push(a))}return[s,n,i]}let Qc=()=>location.protocol+"//"+location.host;function Lr(e,t){const{pathname:s,search:n,hash:i}=t,o=e.indexOf("#");if(o>-1){let r=i.includes(e.slice(o))?e.slice(o).length:1,l=i.slice(r);return l[0]!=="/"&&(l="/"+l),Zi(l,"")}return Zi(s,e)+n+i}function Yc(e,t,s,n){let i=[],o=[],r=null;const l=({state:h})=>{const _=Lr(e,location),C=s.value,E=t.value;let j=0;if(h){if(s.value=_,t.value=h,r&&r===C){r=null;return}j=E?h.position-E.position:0}else n(_);i.forEach(w=>{w(s.value,C,{delta:j,type:Bn.pop,direction:j?j>0?Cn.forward:Cn.back:Cn.unknown})})};function a(){r=s.value}function d(h){i.push(h);const _=()=>{const C=i.indexOf(h);C>-1&&i.splice(C,1)};return o.push(_),_}function c(){if(document.visibilityState==="hidden"){const{history:h}=window;if(!h.state)return;h.replaceState(ie({},h.state,{scroll:an()}),"")}}function p(){for(const h of o)h();o=[],window.removeEventListener("popstate",l),window.removeEventListener("pagehide",c),document.removeEventListener("visibilitychange",c)}return window.addEventListener("popstate",l),window.addEventListener("pagehide",c),document.addEventListener("visibilitychange",c),{pauseListeners:a,listen:d,destroy:p}}function no(e,t,s,n=!1,i=!1){return{back:e,current:t,forward:s,replaced:n,position:window.history.length,scroll:i?an():null}}function Zc(e){const{history:t,location:s}=window,n={value:Lr(e,s)},i={value:t.state};i.value||o(n.value,{back:null,current:n.value,forward:null,position:t.length-1,replaced:!0,scroll:null},!0);function o(a,d,c){const p=e.indexOf("#"),h=p>-1?(s.host&&document.querySelector("base")?e:e.slice(p))+a:Qc()+e+a;try{t[c?"replaceState":"pushState"](d,"",h),i.value=d}catch(_){console.error(_),s[c?"replace":"assign"](h)}}function r(a,d){o(a,ie({},t.state,no(i.value.back,a,i.value.forward,!0),d,{position:i.value.position}),!0),n.value=a}function l(a,d){const c=ie({},i.value,t.state,{forward:a,scroll:an()});o(c.current,c,!0),o(a,ie({},no(n.value,a,null),{position:c.position+1},d),!1),n.value=a}return{location:n,state:i,push:l,replace:r}}function ep(e){e=Bc(e);const t=Zc(e),s=Yc(e,t.state,t.location,t.replace);function n(o,r=!0){r||s.pauseListeners(),history.go(o)}const i=ie({location:"",base:e,go:n,createHref:Hc.bind(null,e)},t,s);return Object.defineProperty(i,"location",{enumerable:!0,get:()=>t.location.value}),Object.defineProperty(i,"state",{enumerable:!0,get:()=>t.state.value}),i}function tp(e){return e=location.host?e||location.pathname+location.search:"",e.includes("#")||(e+="#"),ep(e)}let Nt=(function(e){return e[e.Static=0]="Static",e[e.Param=1]="Param",e[e.Group=2]="Group",e})({});var ye=(function(e){return e[e.Static=0]="Static",e[e.Param=1]="Param",e[e.ParamRegExp=2]="ParamRegExp",e[e.ParamRegExpEnd=3]="ParamRegExpEnd",e[e.EscapeNext=4]="EscapeNext",e})(ye||{});const sp={type:Nt.Static,value:""},np=/[a-zA-Z0-9_]/;function ip(e){if(!e)return[[]];if(e==="/")return[[sp]];if(!e.startsWith("/"))throw new Error(`Invalid path "${e}"`);function t(_){throw new Error(`ERR (${s})/"${d}": ${_}`)}let s=ye.Static,n=s;const i=[];let o;function r(){o&&i.push(o),o=[]}let l=0,a,d="",c="";function p(){d&&(s===ye.Static?o.push({type:Nt.Static,value:d}):s===ye.Param||s===ye.ParamRegExp||s===ye.ParamRegExpEnd?(o.length>1&&(a==="*"||a==="+")&&t(`A repeatable param (${d}) must be alone in its segment. eg: '/:ids+.`),o.push({type:Nt.Param,value:d,regexp:c,repeatable:a==="*"||a==="+",optional:a==="*"||a==="?"})):t("Invalid state to consume buffer"),d="")}function h(){d+=a}for(;l<e.length;){if(a=e[l++],a==="\\"&&s!==ye.ParamRegExp){n=s,s=ye.EscapeNext;continue}switch(s){case ye.Static:a==="/"?(d&&p(),r()):a===":"?(p(),s=ye.Param):h();break;case ye.EscapeNext:h(),s=n;break;case ye.Param:a==="("?s=ye.ParamRegExp:np.test(a)?h():(p(),s=ye.Static,a!=="*"&&a!=="?"&&a!=="+"&&l--);break;case ye.ParamRegExp:a===")"?c[c.length-1]=="\\"?c=c.slice(0,-1)+a:s=ye.ParamRegExpEnd:c+=a;break;case ye.ParamRegExpEnd:p(),s=ye.Static,a!=="*"&&a!=="?"&&a!=="+"&&l--,c="";break;default:t("Unknown state");break}}return s===ye.ParamRegExp&&t(`Unfinished custom RegExp for param "${d}"`),p(),r(),i}const io="[^/]+?",op={sensitive:!1,strict:!1,start:!0,end:!0};var ke=(function(e){return e[e._multiplier=10]="_multiplier",e[e.Root=90]="Root",e[e.Segment=40]="Segment",e[e.SubSegment=30]="SubSegment",e[e.Static=40]="Static",e[e.Dynamic=20]="Dynamic",e[e.BonusCustomRegExp=10]="BonusCustomRegExp",e[e.BonusWildcard=-50]="BonusWildcard",e[e.BonusRepeatable=-20]="BonusRepeatable",e[e.BonusOptional=-8]="BonusOptional",e[e.BonusStrict=.7000000000000001]="BonusStrict",e[e.BonusCaseSensitive=.25]="BonusCaseSensitive",e})(ke||{});const rp=/[.+*?^${}()[\]/\\]/g;function lp(e,t){const s=ie({},op,t),n=[];let i=s.start?"^":"";const o=[];for(const d of e){const c=d.length?[]:[ke.Root];s.strict&&!d.length&&(i+="/");for(let p=0;p<d.length;p++){const h=d[p];let _=ke.Segment+(s.sensitive?ke.BonusCaseSensitive:0);if(h.type===Nt.Static)p||(i+="/"),i+=h.value.replace(rp,"\\$&"),_+=ke.Static;else if(h.type===Nt.Param){const{value:C,repeatable:E,optional:j,regexp:w}=h;o.push({name:C,repeatable:E,optional:j});const x=w||io;if(x!==io){_+=ke.BonusCustomRegExp;try{new RegExp(`(${x})`)}catch(T){throw new Error(`Invalid custom RegExp for param "${C}" (${x}): `+T.message)}}let $=E?`((?:${x})(?:/(?:${x}))*)`:`(${x})`;p||($=j&&d.length<2?`(?:/${$})`:"/"+$),j&&($+="?"),i+=$,_+=ke.Dynamic,j&&(_+=ke.BonusOptional),E&&(_+=ke.BonusRepeatable),x===".*"&&(_+=ke.BonusWildcard)}c.push(_)}n.push(c)}if(s.strict&&s.end){const d=n.length-1;n[d][n[d].length-1]+=ke.BonusStrict}s.strict||(i+="/?"),s.end?i+="$":s.strict&&!i.endsWith("/")&&(i+="(?:/|$)");const r=new RegExp(i,s.sensitive?"":"i");function l(d){const c=d.match(r),p={};if(!c)return null;for(let h=1;h<c.length;h++){const _=c[h]||"",C=o[h-1];p[C.name]=_&&C.repeatable?_.split("/"):_}return p}function a(d){let c="",p=!1;for(const h of e){(!p||!c.endsWith("/"))&&(c+="/"),p=!1;for(const _ of h)if(_.type===Nt.Static)c+=_.value;else if(_.type===Nt.Param){const{value:C,repeatable:E,optional:j}=_,w=C in d?d[C]:"";if(Je(w)&&!E)throw new Error(`Provided param "${C}" is an array but it is not repeatable (* or + modifiers)`);const x=Je(w)?w.join("/"):w;if(!x)if(j)h.length<2&&(c.endsWith("/")?c=c.slice(0,-1):p=!0);else throw new Error(`Missing required param "${C}"`);c+=x}}return c||"/"}return{re:r,score:n,keys:o,parse:l,stringify:a}}function ap(e,t){let s=0;for(;s<e.length&&s<t.length;){const n=t[s]-e[s];if(n)return n;s++}return e.length<t.length?e.length===1&&e[0]===ke.Static+ke.Segment?-1:1:e.length>t.length?t.length===1&&t[0]===ke.Static+ke.Segment?1:-1:0}function Br(e,t){let s=0;const n=e.score,i=t.score;for(;s<n.length&&s<i.length;){const o=ap(n[s],i[s]);if(o)return o;s++}if(Math.abs(i.length-n.length)===1){if(oo(n))return 1;if(oo(i))return-1}return i.length-n.length}function oo(e){const t=e[e.length-1];return e.length>0&&t[t.length-1]<0}const cp={strict:!1,end:!0,sensitive:!1};function pp(e,t,s){const n=lp(ip(e.path),s),i=ie(n,{record:e,parent:t,children:[],alias:[]});return t&&!i.record.aliasOf==!t.record.aliasOf&&t.children.push(i),i}function up(e,t){const s=[],n=new Map;t=Qi(cp,t);function i(p){return n.get(p)}function o(p,h,_){const C=!_,E=lo(p);E.aliasOf=_&&_.record;const j=Qi(t,p),w=[E];if("alias"in p){const T=typeof p.alias=="string"?[p.alias]:p.alias;for(const G of T)w.push(lo(ie({},E,{components:_?_.record.components:E.components,path:G,aliasOf:_?_.record:E})))}let x,$;for(const T of w){const{path:G}=T;if(h&&G[0]!=="/"){const Y=h.record.path,Q=Y[Y.length-1]==="/"?"":"/";T.path=h.record.path+(G&&Q+G)}if(x=pp(T,h,j),_?_.alias.push(x):($=$||x,$!==x&&$.alias.push(x),C&&p.name&&!ao(x)&&r(p.name)),Fr(x)&&a(x),E.children){const Y=E.children;for(let Q=0;Q<Y.length;Q++)o(Y[Q],x,_&&_.children[Q])}_=_||x}return $?()=>{r($)}:bs}function r(p){if(Nr(p)){const h=n.get(p);h&&(n.delete(p),s.splice(s.indexOf(h),1),h.children.forEach(r),h.alias.forEach(r))}else{const h=s.indexOf(p);h>-1&&(s.splice(h,1),p.record.name&&n.delete(p.record.name),p.children.forEach(r),p.alias.forEach(r))}}function l(){return s}function a(p){const h=gp(p,s);s.splice(h,0,p),p.record.name&&!ao(p)&&n.set(p.record.name,p)}function d(p,h){let _,C={},E,j;if("name"in p&&p.name){if(_=n.get(p.name),!_)throw is(ge.MATCHER_NOT_FOUND,{location:p});j=_.record.name,C=ie(ro(h.params,_.keys.filter($=>!$.optional).concat(_.parent?_.parent.keys.filter($=>$.optional):[]).map($=>$.name)),p.params&&ro(p.params,_.keys.map($=>$.name))),E=_.stringify(C)}else if(p.path!=null)E=p.path,_=s.find($=>$.re.test(E)),_&&(C=_.parse(E),j=_.record.name);else{if(_=h.name?n.get(h.name):s.find($=>$.re.test(h.path)),!_)throw is(ge.MATCHER_NOT_FOUND,{location:p,currentLocation:h});j=_.record.name,C=ie({},h.params,p.params),E=_.stringify(C)}const w=[];let x=_;for(;x;)w.unshift(x.record),x=x.parent;return{name:j,path:E,params:C,matched:w,meta:fp(w)}}e.forEach(p=>o(p));function c(){s.length=0,n.clear()}return{addRoute:o,resolve:d,removeRoute:r,clearRoutes:c,getRoutes:l,getRecordMatcher:i}}function ro(e,t){const s={};for(const n of t)n in e&&(s[n]=e[n]);return s}function lo(e){const t={path:e.path,redirect:e.redirect,name:e.name,meta:e.meta||{},aliasOf:e.aliasOf,beforeEnter:e.beforeEnter,props:dp(e),children:e.children||[],instances:{},leaveGuards:new Set,updateGuards:new Set,enterCallbacks:{},components:"components"in e?e.components||null:e.component&&{default:e.component}};return Object.defineProperty(t,"mods",{value:{}}),t}function dp(e){const t={},s=e.props||!1;if("component"in e)t.default=s;else for(const n in e.components)t[n]=typeof s=="object"?s[n]:s;return t}function ao(e){for(;e;){if(e.record.aliasOf)return!0;e=e.parent}return!1}function fp(e){return e.reduce((t,s)=>ie(t,s.meta),{})}function gp(e,t){let s=0,n=t.length;for(;s!==n;){const o=s+n>>1;Br(e,t[o])<0?n=o:s=o+1}const i=hp(e);return i&&(n=t.lastIndexOf(i,n-1)),n}function hp(e){let t=e;for(;t=t.parent;)if(Fr(t)&&Br(e,t)===0)return t}function Fr({record:e}){return!!(e.name||e.components&&Object.keys(e.components).length||e.redirect)}function co(e){const t=ct(li),s=ct(ai),n=je(()=>{const a=Ce(e.to);return t.resolve(a)}),i=je(()=>{const{matched:a}=n.value,{length:d}=a,c=a[d-1],p=s.matched;if(!c||!p.length)return-1;const h=p.findIndex(os.bind(null,c));if(h>-1)return h;const _=po(a[d-2]);return d>1&&po(c)===_&&p[p.length-1].path!==_?p.findIndex(os.bind(null,a[d-2])):h}),o=je(()=>i.value>-1&&bp(s.params,n.value.params)),r=je(()=>i.value>-1&&i.value===s.matched.length-1&&Ur(s.params,n.value.params));function l(a={}){if(vp(a)){const d=t[Ce(e.replace)?"replace":"push"](Ce(e.to)).catch(bs);return e.viewTransition&&typeof document<"u"&&"startViewTransition"in document&&document.startViewTransition(()=>d),d}return Promise.resolve()}return{route:n,href:je(()=>n.value.href),isActive:o,isExactActive:r,navigate:l}}function _p(e){return e.length===1?e[0]:e}const mp=Zo({name:"RouterLink",compatConfig:{MODE:3},props:{to:{type:[String,Object],required:!0},replace:Boolean,activeClass:String,exactActiveClass:String,custom:Boolean,ariaCurrentValue:{type:String,default:"page"},viewTransition:Boolean},useLink:co,setup(e,{slots:t}){const s=tn(co(e)),{options:n}=ct(li),i=je(()=>({[uo(e.activeClass,n.linkActiveClass,"router-link-active")]:s.isActive,[uo(e.exactActiveClass,n.linkExactActiveClass,"router-link-exact-active")]:s.isExactActive}));return()=>{const o=t.default&&_p(t.default(s));return e.custom?o:ri("a",{"aria-current":s.isExactActive?e.ariaCurrentValue:null,href:s.href,onClick:s.navigate,class:i.value},o)}}}),Jt=mp;function vp(e){if(!(e.metaKey||e.altKey||e.ctrlKey||e.shiftKey)&&!e.defaultPrevented&&!(e.button!==void 0&&e.button!==0)){if(e.currentTarget&&e.currentTarget.getAttribute){const t=e.currentTarget.getAttribute("target");if(/\b_blank\b/i.test(t))return}return e.preventDefault&&e.preventDefault(),!0}}function bp(e,t){for(const s in t){const n=t[s],i=e[s];if(typeof n=="string"){if(n!==i)return!1}else if(!Je(i)||i.length!==n.length||n.some((o,r)=>o.valueOf()!==i[r].valueOf()))return!1}return!0}function po(e){return e?e.aliasOf?e.aliasOf.path:e.path:""}const uo=(e,t,s)=>e??t??s,yp=Zo({name:"RouterView",inheritAttrs:!1,props:{name:{type:String,default:"default"},route:Object},compatConfig:{MODE:3},setup(e,{attrs:t,slots:s}){const n=ct(Nn),i=je(()=>e.route||n.value),o=ct(Yi,0),r=je(()=>{let d=Ce(o);const{matched:c}=i.value;let p;for(;(p=c[d])&&!p.components;)d++;return d}),l=je(()=>i.value.matched[r.value]);Ms(Yi,je(()=>r.value+1)),Ms(yc,l),Ms(Nn,i);const a=$e();return Ft(()=>[a.value,l.value,e.name],([d,c,p],[h,_,C])=>{c&&(c.instances[p]=d,_&&_!==c&&d&&d===h&&(c.leaveGuards.size||(c.leaveGuards=_.leaveGuards),c.updateGuards.size||(c.updateGuards=_.updateGuards))),d&&c&&(!_||!os(c,_)||!h)&&(c.enterCallbacks[p]||[]).forEach(E=>E(d))},{flush:"post"}),()=>{const d=i.value,c=e.name,p=l.value,h=p&&p.components[c];if(!h)return fo(s.default,{Component:h,route:d});const _=p.props[c],C=_?_===!0?d.params:typeof _=="function"?_(d):_:null,j=ri(h,ie({},C,t,{onVnodeUnmounted:w=>{w.component.isUnmounted&&(p.instances[c]=null)},ref:a}));return fo(s.default,{Component:j,route:d})||j}}});function fo(e,t){if(!e)return null;const s=e(t);return s.length===1?s[0]:s}const Ap=yp;function Sp(e){const t=up(e.routes,e),s=e.parseQuery||Xc,n=e.stringifyQuery||so,i=e.history,o=ps(),r=ps(),l=ps(),a=El(Ct);let d=Ct;zt&&e.scrollBehavior&&"scrollRestoration"in history&&(history.scrollRestoration="manual");const c=Sn.bind(null,y=>""+y),p=Sn.bind(null,jc),h=Sn.bind(null,Ps);function _(y,D){let k,N;return Nr(y)?(k=t.getRecordMatcher(y),N=D):N=y,t.addRoute(N,k)}function C(y){const D=t.getRecordMatcher(y);D&&t.removeRoute(D)}function E(){return t.getRoutes().map(y=>y.record)}function j(y){return!!t.getRecordMatcher(y)}function w(y,D){if(D=ie({},D||a.value),typeof y=="string"){const m=En(s,y,D.path),v=t.resolve({path:m.path},D),A=i.createHref(m.fullPath);return ie(m,v,{params:h(v.params),hash:Ps(m.hash),redirectedFrom:void 0,href:A})}let k;if(y.path!=null)k=ie({},y,{path:En(s,y.path,D.path).path});else{const m=ie({},y.params);for(const v in m)m[v]==null&&delete m[v];k=ie({},y,{params:p(m)}),D.params=p(D.params)}const N=t.resolve(k,D),J=y.hash||"";N.params=c(h(N.params));const u=Dc(n,ie({},y,{hash:kc(J),path:N.path})),f=i.createHref(u);return ie({fullPath:u,hash:J,query:n===so?zc(y.query):y.query||{}},N,{redirectedFrom:void 0,href:f})}function x(y){return typeof y=="string"?En(s,y,a.value.path):ie({},y)}function $(y,D){if(d!==y)return is(ge.NAVIGATION_CANCELLED,{from:D,to:y})}function T(y){return Q(y)}function G(y){return T(ie(x(y),{replace:!0}))}function Y(y,D){const k=y.matched[y.matched.length-1];if(k&&k.redirect){const{redirect:N}=k;let J=typeof N=="function"?N(y,D):N;return typeof J=="string"&&(J=J.includes("?")||J.includes("#")?J=x(J):{path:J},J.params={}),ie({query:y.query,hash:y.hash,params:J.path!=null?{}:y.params},J)}}function Q(y,D){const k=d=w(y),N=a.value,J=y.state,u=y.force,f=y.replace===!0,m=Y(k,N);if(m)return Q(ie(x(m),{state:typeof m=="object"?ie({},J,m.state):J,force:u,replace:f}),D||k);const v=k;v.redirectedFrom=D;let A;return!u&&Uc(n,N,k)&&(A=is(ge.NAVIGATION_DUPLICATED,{to:v,from:N}),Qe(N,N,!0,!1)),(A?Promise.resolve(A):z(v,N)).catch(b=>gt(b)?gt(b,ge.NAVIGATION_GUARD_REDIRECT)?b:St(b):ne(b,v,N)).then(b=>{if(b){if(gt(b,ge.NAVIGATION_GUARD_REDIRECT))return Q(ie({replace:f},x(b.to),{state:typeof b.to=="object"?ie({},J,b.to.state):J,force:u}),D||v)}else b=M(v,N,!0,f,J);return ae(v,N,b),b})}function Se(y,D){const k=$(y,D);return k?Promise.reject(k):Promise.resolve()}function V(y){const D=qt.values().next().value;return D&&typeof D.runWithContext=="function"?D.runWithContext(y):y()}function z(y,D){let k;const[N,J,u]=Jc(y,D);k=xn(N.reverse(),"beforeRouteLeave",y,D);for(const m of N)m.leaveGuards.forEach(v=>{k.push(It(v,y,D))});const f=Se.bind(null,y,D);return k.push(f),He(k).then(()=>{k=[];for(const m of o.list())k.push(It(m,y,D));return k.push(f),He(k)}).then(()=>{k=xn(J,"beforeRouteUpdate",y,D);for(const m of J)m.updateGuards.forEach(v=>{k.push(It(v,y,D))});return k.push(f),He(k)}).then(()=>{k=[];for(const m of u)if(m.beforeEnter)if(Je(m.beforeEnter))for(const v of m.beforeEnter)k.push(It(v,y,D));else k.push(It(m.beforeEnter,y,D));return k.push(f),He(k)}).then(()=>(y.matched.forEach(m=>m.enterCallbacks={}),k=xn(u,"beforeRouteEnter",y,D,V),k.push(f),He(k))).then(()=>{k=[];for(const m of r.list())k.push(It(m,y,D));return k.push(f),He(k)}).catch(m=>gt(m,ge.NAVIGATION_CANCELLED)?m:Promise.reject(m))}function ae(y,D,k){l.list().forEach(N=>V(()=>N(y,D,k)))}function M(y,D,k,N,J){const u=$(y,D);if(u)return u;const f=D===Ct,m=zt?history.state:{};k&&(N||f?i.replace(y.fullPath,ie({scroll:f&&m&&m.scroll},J)):i.push(y.fullPath,J)),a.value=y,Qe(y,D,k,f),St()}let se;function Ee(){se||(se=i.listen((y,D,k)=>{if(!Tt.listening)return;const N=w(y),J=Y(N,Tt.currentRoute.value);if(J){Q(ie(J,{replace:!0,force:!0}),N).catch(bs);return}d=N;const u=a.value;zt&&Wc(to(u.fullPath,k.delta),an()),z(N,u).catch(f=>gt(f,ge.NAVIGATION_ABORTED|ge.NAVIGATION_CANCELLED)?f:gt(f,ge.NAVIGATION_GUARD_REDIRECT)?(Q(ie(x(f.to),{force:!0}),N).then(m=>{gt(m,ge.NAVIGATION_ABORTED|ge.NAVIGATION_DUPLICATED)&&!k.delta&&k.type===Bn.pop&&i.go(-1,!1)}).catch(bs),Promise.reject()):(k.delta&&i.go(-k.delta,!1),ne(f,N,u))).then(f=>{f=f||M(N,u,!1),f&&(k.delta&&!gt(f,ge.NAVIGATION_CANCELLED)?i.go(-k.delta,!1):k.type===Bn.pop&&gt(f,ge.NAVIGATION_ABORTED|ge.NAVIGATION_DUPLICATED)&&i.go(-1,!1)),ae(N,u,f)}).catch(bs)}))}let Le=ps(),_e=ps(),ce;function ne(y,D,k){St(y);const N=_e.list();return N.length?N.forEach(J=>J(y,D,k)):console.error(y),Promise.reject(y)}function ut(){return ce&&a.value!==Ct?Promise.resolve():new Promise((y,D)=>{Le.add([y,D])})}function St(y){return ce||(ce=!y,Ee(),Le.list().forEach(([D,k])=>y?k(y):D()),Le.reset()),y}function Qe(y,D,k,N){const{scrollBehavior:J}=e;if(!zt||!J)return Promise.resolve();const u=!k&&qc(to(y.fullPath,0))||(N||!k)&&history.state&&history.state.scroll||null;return ns().then(()=>J(y,D,u)).then(f=>f&&Kc(f)).catch(f=>ne(f,y,D))}const De=y=>i.go(y);let Wt;const qt=new Set,Tt={currentRoute:a,listening:!0,addRoute:_,removeRoute:C,clearRoutes:t.clearRoutes,hasRoute:j,getRoutes:E,resolve:w,options:e,push:T,replace:G,go:De,back:()=>De(-1),forward:()=>De(1),beforeEach:o.add,beforeResolve:r.add,afterEach:l.add,onError:_e.add,isReady:ut,install(y){y.component("RouterLink",Jt),y.component("RouterView",Ap),y.config.globalProperties.$router=Tt,Object.defineProperty(y.config.globalProperties,"$route",{enumerable:!0,get:()=>Ce(a)}),zt&&!Wt&&a.value===Ct&&(Wt=!0,T(i.location).catch(N=>{}));const D={};for(const N in Ct)Object.defineProperty(D,N,{get:()=>a.value[N],enumerable:!0});y.provide(li,Tt),y.provide(ai,Uo(D)),y.provide(Nn,a);const k=y.unmount;qt.add(y),y.unmount=function(){qt.delete(y),qt.size<1&&(d=Ct,se&&se(),se=null,a.value=Ct,Wt=!1,ce=!1),k()}}};function He(y){return y.reduce((D,k)=>D.then(()=>V(k)),Promise.resolve())}return Tt}const Ep={class:"header"},Cp={class:"container header__inner"},xp=["aria-expanded"],Ip={__name:"Header",setup(e){const t=$e(!1),s=()=>{t.value=!t.value},n=()=>{t.value=!1};return Ft(t,i=>{document.body.style.overflow=i?"hidden":""}),(i,o)=>(U(),B("header",Ep,[g("div",Cp,[W(Ce(Jt),{to:"/",class:"header__logo",onClick:n},{default:le(()=>[...o[0]||(o[0]=[me(" Nomis ",-1)])]),_:1}),g("nav",{class:We(["header__nav",{"header__nav--open":t.value}])},[W(Ce(Jt),{to:"/",class:"header__nav-link",onClick:n},{default:le(()=>[...o[1]||(o[1]=[me("Home",-1)])]),_:1}),W(Ce(Jt),{to:"/projects",class:"header__nav-link",onClick:n},{default:le(()=>[...o[2]||(o[2]=[me("Projects",-1)])]),_:1}),W(Ce(Jt),{to:"/leadership",class:"header__nav-link",onClick:n},{default:le(()=>[...o[3]||(o[3]=[me("Leadership",-1)])]),_:1}),W(Ce(Jt),{to:"/about",class:"header__nav-link",onClick:n},{default:le(()=>[...o[4]||(o[4]=[me("About",-1)])]),_:1}),g("a",{href:"/resume.pdf",target:"_blank",class:"header__nav-link header__nav-link--resume",onClick:n},"Resume")],2),g("button",{class:We(["header__hamburger",{"header__hamburger--open":t.value}]),onClick:s,"aria-expanded":t.value},[...o[5]||(o[5]=[g("span",null,null,-1),g("span",null,null,-1),g("span",null,null,-1)])],10,xp)])]))}},cn=(e,t)=>{const s=e.__vccOpts||e;for(const[n,i]of t)s[n]=i;return s},wp={},Pp={class:"footer"};function Rp(e,t){return U(),B("footer",Pp,[...t[0]||(t[0]=[g("div",{class:"container footer__inner"},[g("p",{class:"footer__copy"},"© 2026 Nomis. All rights reserved."),g("a",{href:"mailto:nomis820710@gmail.com",class:"footer__email"},"nomis820710@gmail.com")],-1)])])}const kp=cn(wp,[["render",Rp]]),Tp={__name:"BackToTop",setup(e){const t=$e(!1),s=()=>{t.value=window.scrollY>400},n=()=>{window.scrollTo({top:0,behavior:"smooth"})};return Rt(()=>window.addEventListener("scroll",s)),Vt(()=>window.removeEventListener("scroll",s)),(i,o)=>(U(),B("button",{class:We(["back-to-top",{"back-to-top--visible":t.value}]),onClick:n,"aria-label":"回到頂部"},[...o[0]||(o[0]=[g("i",{class:"fa-solid fa-arrow-up"},null,-1)])],2))}},Op={__name:"App",setup(e){return(t,s)=>{const n=Kt("RouterView");return U(),B(ee,null,[W(Ip),g("main",null,[W(n,null,{default:le(({Component:i})=>[W(Ha,{name:"fade",mode:"out-in"},{default:le(()=>[(U(),kt(Jl(i)))]),_:2},1024)]),_:1})]),W(kp),W(Tp)],64)}}},jp=cn(Op,[["__scopeId","data-v-91c92250"]]),$p="/portfolio/images/general/hero-photo.jpg",Mp="/portfolio/images/general/avatar-chen.jpg",Dp="/portfolio/images/general/avatar-liao.jpg";function lt(e){return"/portfolio/"+e.replace(/^\//,"")}const Up={class:"project-card__cover"},Np=["src","alt"],Lp={class:"project-card__body"},Bp={class:"project-card__hashtags"},Fp={class:"project-card__title"},Hp={class:"project-card__desc"},Vp={class:"project-card__tags"},Kp={__name:"ProjectCard",props:{project:{type:Object,required:!0}},setup(e){return(t,s)=>{const n=Kt("RouterLink");return U(),kt(n,{to:`/projects/${e.project.id}`,class:"project-card"},{default:le(()=>[g("div",Up,[g("img",{src:Ce(lt)(e.project.cover),alt:e.project.title},null,8,Np)]),g("div",Lp,[g("div",Bp,[(U(!0),B(ee,null,ve(e.project.hashtags,i=>(U(),B("span",{key:i,class:"project-card__hashtag"}," #"+X(i),1))),128))]),g("h3",Fp,X(e.project.title),1),g("p",Hp,X(e.project.description),1),g("div",Vp,[(U(!0),B(ee,null,ve(e.project.tags,i=>(U(),B("span",{key:i,class:"project-card__tag"},X(i),1))),128))])]),s[0]||(s[0]=g("div",{class:"project-card__cta"}," 查看專案 → ",-1))]),_:1},8,["to"])}}},ys=[{id:"bd-portal-demo-report",title:"顛覆 Form 表單的邊界：獨立主導業務銷售工具 Demo Report 的從 0 到 1 設計",description:"業務團隊用 Xmind 整理客戶學習資訊，但心智圖輸出只是一張圖檔，資料無法被內部系統收回再利用。我在 PM 資源幾乎缺席的情況下，獨立完成 UX 研究、UI 設計、Prototype 與切版，並透過業務銷售流程的深度研究，將原始需求從「心智圖系統」重新定位為陪伴業務完整銷售旅程的數位報告工具，更首創將 Form 表單與心智圖操作邏輯融合的後台設計，讓大主管直呼「從來沒想過 Form 表單可以做成這樣」。",cover:"/images/projects/bd-portal-demo-report/cover.png",hashtags:["研究驅動設計","產品重新定位","創新互動設計"],tags:["UIUX","Research","Frontend","Cross-functional"],category:["uiux","frontend"],content:`
    <!-- 角色資訊 -->
    <div class="pd-info">
  ...
  `}],Wp={__name:"HeroCanvas",setup(e){const t=$e(null);let s=null;return Rt(()=>{const n=t.value,i=n.getContext("2d"),o=()=>{n.width=n.offsetWidth,n.height=n.offsetHeight};o(),window.addEventListener("resize",o);const l=Array.from({length:80},()=>({x:Math.random()*n.width,y:Math.random()*n.height,vx:(Math.random()-.5)*.3,vy:(Math.random()-.5)*.3,r:Math.random()*2+1}));let a=0;const d=()=>{n.width=n.offsetWidth,n.height=n.offsetHeight;const c=n.width,p=n.height;i.clearRect(0,0,c,p),a+=.005;const h=(Math.sin(a)+1)/2,_=i.createRadialGradient(c*.15,p*.5,0,c*.15,p*.5,c*.55);_.addColorStop(0,`rgba(79,142,247,${.25+h*.12})`),_.addColorStop(1,"transparent"),i.fillStyle=_,i.fillRect(0,0,c,p);const C=i.createRadialGradient(c*.85,p*.2,0,c*.85,p*.2,c*.45);C.addColorStop(0,`rgba(124,95,247,${.15+h*.1})`),C.addColorStop(1,"transparent"),i.fillStyle=C,i.fillRect(0,0,c,p);const E=i.createRadialGradient(c*.6,p*.8,0,c*.6,p*.8,c*.3);E.addColorStop(0,`rgba(79,142,247,${.08+h*.06})`),E.addColorStop(1,"transparent"),i.fillStyle=E,i.fillRect(0,0,c,p),l.forEach(w=>{w.x+=w.vx,w.y+=w.vy,(w.x<0||w.x>c)&&(w.vx*=-1),(w.y<0||w.y>p)&&(w.vy*=-1)});const j=130;for(let w=0;w<l.length;w++)for(let x=w+1;x<l.length;x++){const $=l[w].x-l[x].x,T=l[w].y-l[x].y,G=Math.sqrt($*$+T*T);if(G<j){const Y=(1-G/j)*.35;i.beginPath(),i.moveTo(l[w].x,l[w].y),i.lineTo(l[x].x,l[x].y),i.strokeStyle=`rgba(79,142,247,${Y})`,i.lineWidth=.8,i.stroke()}}l.forEach(w=>{i.beginPath(),i.arc(w.x,w.y,w.r,0,Math.PI*2),i.fillStyle="rgba(79,142,247,0.65)",i.fill()}),s=requestAnimationFrame(d)};Vt(()=>{cancelAnimationFrame(s),window.removeEventListener("resize",o)}),d()}),(n,i)=>(U(),B("canvas",{ref_key:"canvasRef",ref:t,class:"hero-canvas"},null,512))}},qp=cn(Wp,[["__scopeId","data-v-92edd766"]]),Gp={class:"home"},Xp={class:"hero section"},zp={class:"projects-preview section"},Jp={class:"container"},Qp={class:"projects-preview__grid"},Yp={class:"projects-preview__cta"},Zp={class:"leadership-preview section"},eu={class:"container leadership-preview__inner"},tu={class:"leadership-preview__content"},su={class:"leadership-preview__articles"},nu={class:"skills section"},iu={class:"container"},ou={class:"skills__bento"},ru={class:"skills__bento-card skills__bento-card--hero"},lu={class:"skills__bento-card-inner"},au={class:"skills__bento-tags"},cu={class:"skills__bento-card skills__bento-card--medium skills__bento-card--medium-wide"},pu={class:"skills__bento-card-inner"},uu={class:"skills__bento-tags"},du={class:"skills__bento-card skills__bento-card--medium skills__bento-card--medium-narrow"},fu={class:"skills__bento-card-inner"},gu={class:"skills__bento-tags"},hu={class:"skills__bento-card skills__bento-card--small"},_u={class:"skills__bento-card-inner"},mu={class:"skills__bento-tags"},vu={class:"skills__bento-card skills__bento-card--small"},bu={class:"skills__bento-card-inner"},yu={class:"skills__bento-tags"},Au={class:"skills__bento-card skills__bento-card--small"},Su={class:"skills__bento-card-inner"},Eu={class:"skills__bento-tags"},Cu={__name:"Home",setup(e){return(t,s)=>{const n=Kt("RouterLink");return U(),B("div",Gp,[g("section",Xp,[W(qp),s[0]||(s[0]=ts('<div class="container hero__inner"><div class="hero__content"><h1 class="hero__title">嗨，我是 Nomis！</h1><p class="hero__subtitle">UIUX 設計師・前端切版・設計主管</p><p class="hero__desc"> 我相信設計師最大的競爭力，是跨越專業邊界的能力。<br> 橫跨 UIUX、前端與設計管理，擁有人資與社會心理學背景的我，<br> 習慣用數據驗證設計決策，也具備在資源不足的情況下，仍能獨立推進專案、讓成果落地的能力。 </p><div class="hero__cta"><a href="/portfolio/resume.pdf" target="_blank" class="btn btn--primary">下載履歷</a><a href="https://www.linkedin.com/in/nomis-yang/" target="_blank" class="btn btn--secondary">LinkedIn</a><a href="mailto:nomis820710@gmail.com" class="btn btn--secondary">聯絡我</a></div></div><div class="hero__photo"><img src="'+$p+'" alt="Nomis Yang"></div></div>',1))]),s[39]||(s[39]=ts('<section class="features section"><div class="container features__grid"><div class="features__item"><h3 class="features__title">跨領域設計能力</h3><p class="features__desc"> 橫跨 UIUX 設計、前端切版與設計管理，能從使用者研究、視覺設計到程式實作一手包辦。曾在 PM 幾乎缺席的情況下獨立完成 UX 研究、UI 設計、Prototype 與切版，確保設計落地不失真。 </p></div><div class="features__item"><h3 class="features__title">數據驅動的設計決策</h3><p class="features__desc"> 習慣在設計提案前先問「這解決了什麼問題」、上線後追問「它真的有效嗎」。曾透過使用者訪談發現需求被錯誤定義，主動將產品從「心智圖系統」重新定位為陪伴完整銷售旅程的數位報告工具。 </p></div><div class="features__item"><h3 class="features__title">跨部門協作與領導</h3><p class="features__desc"> 具備帶領設計團隊的實戰經驗，善於在產品、工程與商業目標之間建立共識。曾在兩週內拆解跨部門任務、同步推進四條工作線，帶領團隊準時交付一個 PM 規劃了一個月的專案。 </p></div></div></section>',1)),g("section",zp,[g("div",Jp,[g("div",Qp,[(U(!0),B(ee,null,ve(Ce(ys).slice(0,3),i=>(U(),kt(Kp,{key:i.id,project:i},null,8,["project"]))),128))]),g("div",Yp,[W(n,{to:"/projects",class:"btn btn--ghost"},{default:le(()=>[...s[1]||(s[1]=[me("查看全部專案 →",-1)])]),_:1})])])]),g("section",Zp,[g("div",eu,[g("div",tu,[s[3]||(s[3]=g("p",{class:"leadership-preview__label"},"Leadership",-1)),s[4]||(s[4]=g("h2",{class:"leadership-preview__title"},"設計領導力的實踐與反思",-1)),s[5]||(s[5]=g("p",{class:"leadership-preview__desc"}," 當上主管之後，我發現設計能力只是起點。這裡記錄的，是我如何用制度取代靠感覺、 用數據取代靠記憶、在資源不足的情況下，仍然讓團隊往前走的真實歷程。 ",-1)),W(n,{to:"/leadership",class:"btn btn--primary"},{default:le(()=>[...s[2]||(s[2]=[me(" 閱讀更多文章 → ",-1)])]),_:1})]),g("div",su,[W(n,{to:"/leadership/impossible-deadline-two-weeks",class:"leadership-preview__article"},{default:le(()=>[...s[6]||(s[6]=[g("p",{class:"leadership-preview__article-tag"},"專案決策過程",-1),g("h4",{class:"leadership-preview__article-title"},"我們如何在兩週內，完成一個不可能的任務",-1),g("p",{class:"leadership-preview__article-cta"},"閱讀文章 →",-1)])]),_:1}),W(n,{to:"/leadership/design-request-collaboration-guide",class:"leadership-preview__article"},{default:le(()=>[...s[7]||(s[7]=[g("p",{class:"leadership-preview__article-tag"},"帶團隊的方法論",-1),g("h4",{class:"leadership-preview__article-title"},"當全公司都把設計師當通靈師，我決定立一條規矩",-1),g("p",{class:"leadership-preview__article-cta"},"閱讀文章 →",-1)])]),_:1}),W(n,{to:"/leadership/design-team-okr-performance-system",class:"leadership-preview__article"},{default:le(()=>[...s[8]||(s[8]=[g("p",{class:"leadership-preview__article-tag"},"設計團隊管理心得",-1),g("h4",{class:"leadership-preview__article-title"},"當 KPI 無法衡量設計師：我如何為設計部打造一套 OKR 績效系統",-1),g("p",{class:"leadership-preview__article-cta"},"閱讀文章 →",-1)])]),_:1})])])]),g("section",nu,[g("div",iu,[s[37]||(s[37]=g("p",{class:"skills__label"},"Contribution",-1)),s[38]||(s[38]=g("h2",{class:"skills__title"},"我能為你的團隊帶來什麼",-1)),g("div",ou,[g("div",ru,[g("div",lu,[s[11]||(s[11]=g("p",{class:"skills__bento-eyebrow"},"核心能力",-1)),s[12]||(s[12]=g("h3",{class:"skills__bento-title"},"研究驅動的產品設計",-1)),s[13]||(s[13]=g("p",{class:"skills__bento-desc"},"從使用者訪談、數據分析到最終設計決策，我習慣讓證據說話，而不是靠直覺猜測使用者要什麼。",-1)),s[14]||(s[14]=g("ul",{class:"skills__bento-list"},[g("li",null,"使用者訪談 & 易用性測試"),g("li",null,"數據判讀 & A/B 測試規劃"),g("li",null,"競品分析 & 研究報告"),g("li",null,"從洞察到設計決策的完整流程")],-1)),g("div",au,[W(n,{to:"/projects?tag=UIUX",class:"skills__card-tag"},{default:le(()=>[...s[9]||(s[9]=[me("查看 UIUX 專案 →",-1)])]),_:1}),W(n,{to:"/projects?tag=Research",class:"skills__card-tag"},{default:le(()=>[...s[10]||(s[10]=[me("查看研究專案 →",-1)])]),_:1})])])]),g("div",cu,[g("div",pu,[s[16]||(s[16]=g("p",{class:"skills__bento-eyebrow"},"執行廣度",-1)),s[17]||(s[17]=g("h3",{class:"skills__bento-title"},"跨職能執行力",-1)),s[18]||(s[18]=g("p",{class:"skills__bento-desc"},"從 UX 研究、UI 設計到前端切版，能獨立一手包辦，確保設計落地不失真。",-1)),s[19]||(s[19]=g("ul",{class:"skills__bento-list"},[g("li",null,"資訊架構 & 互動設計"),g("li",null,"Vue.js / SCSS / RWD 切版"),g("li",null,"Prototype 製作與驗證")],-1)),g("div",uu,[W(n,{to:"/projects?tag=Frontend",class:"skills__card-tag"},{default:le(()=>[...s[15]||(s[15]=[me("查看切版專案 →",-1)])]),_:1})])])]),g("div",du,[g("div",fu,[s[21]||(s[21]=g("p",{class:"skills__bento-eyebrow"},"領導深度",-1)),s[22]||(s[22]=g("h3",{class:"skills__bento-title"},"設計領導與制度建立",-1)),s[23]||(s[23]=g("p",{class:"skills__bento-desc"},"不只帶人做事，更用制度取代靠感覺，讓設計團隊的運作可被量化、可被傳承。",-1)),s[24]||(s[24]=g("ul",{class:"skills__bento-list"},[g("li",null,"OKR 績效系統設計與落地"),g("li",null,"設計師職能模型建立"),g("li",null,"跨部門協作流程制度化")],-1)),g("div",gu,[W(n,{to:"/leadership",class:"skills__card-tag"},{default:le(()=>[...s[20]||(s[20]=[me("閱讀 Leadership 文章 →",-1)])]),_:1})])])]),g("div",hu,[g("div",_u,[s[26]||(s[26]=g("p",{class:"skills__bento-eyebrow"},"工具應用",-1)),s[27]||(s[27]=g("h3",{class:"skills__bento-title"},"AI 工作流",-1)),s[28]||(s[28]=g("p",{class:"skills__bento-desc"},"曾獨立以 AI 工具完成傳統需要整個製作團隊的動畫專案，成本降低 99.7%。",-1)),g("div",mu,[W(n,{to:"/projects?tag=AI",class:"skills__card-tag"},{default:le(()=>[...s[25]||(s[25]=[me("查看 AI 專案 →",-1)])]),_:1})])])]),g("div",vu,[g("div",bu,[s[30]||(s[30]=g("p",{class:"skills__bento-eyebrow"},"溝通能力",-1)),s[31]||(s[31]=g("h3",{class:"skills__bento-title"},"跨部門協作",-1)),s[32]||(s[32]=g("p",{class:"skills__bento-desc"},"善於在產品、工程與商業目標之間建立共識，推動設計決策被真正落地執行。",-1)),g("div",yu,[W(n,{to:"/projects?tag=Cross-functional",class:"skills__card-tag"},{default:le(()=>[...s[29]||(s[29]=[me("查看相關專案 →",-1)])]),_:1})])])]),g("div",Au,[g("div",Su,[s[34]||(s[34]=g("p",{class:"skills__bento-eyebrow"},"持續成長",-1)),s[35]||(s[35]=g("h3",{class:"skills__bento-title"},"自驅學習",-1)),s[36]||(s[36]=g("p",{class:"skills__bento-desc"},"主動研發 SCSS 工具、建立知識文件、在限制中找到更聰明的解法。",-1)),g("div",Eu,[W(n,{to:"/projects/osm-rwd-scss-function",class:"skills__card-tag"},{default:le(()=>[...s[33]||(s[33]=[me("查看實戰專案 →",-1)])]),_:1})])])])])])]),s[40]||(s[40]=ts('<section class="testimonials section"><div class="container"><p class="testimonials__label">Recommendations</p><h2 class="testimonials__title">他們這樣說</h2><div class="testimonials__grid"><div class="testimonials__card"><p class="testimonials__card-title">執行力與溝通能力超乎預期，對回饋保持開放</p><p class="testimonials__card-content"> Nomis 是一位充滿熱情的 UIUX 設計師，以創新思維和快速適應新挑戰的能力著稱。 她的執行速度與溝通品質持續超乎預期，是團隊中不可或缺的夥伴。 對回饋始終保持開放，持續尋求改進，對團隊的成功貢獻良多。 </p><div class="testimonials__card-author"><img src="'+Mp+'" alt="陳大明" class="testimonials__card-avatar"><div><p class="testimonials__card-name">陳大明</p><p class="testimonials__card-role">2024 年 5 月・iOS 工程師・直接主管</p></div></div></div><div class="testimonials__card"><p class="testimonials__card-title">能理解並轉化使用者需求為直覺且美觀的設計</p><p class="testimonials__card-content"> 與 Nomis 共事是非常愉快的經驗。他始終展現出理解並將使用者需求轉化為直覺且視覺吸引力設計的能力。 他的創意和解決問題的技巧在應對專案挑戰時發揮了關鍵作用。 支持性的個性與強大的溝通技巧營造了積極的協作環境，是可靠又具創新力的夥伴。 </p><div class="testimonials__card-author"><img src="'+Dp+'" alt="廖小華" class="testimonials__card-avatar"><div><p class="testimonials__card-name">廖小華</p><p class="testimonials__card-role">2024 年 6 月・產品經理・同團隊成員</p></div></div></div></div></div></section>',1))])}}},xu={class:"project-card-h__cover"},Iu=["src","alt"],wu={class:"project-card-h__body"},Pu={class:"project-card-h__hashtags"},Ru={class:"project-card-h__title"},ku={class:"project-card-h__desc"},Tu={class:"project-card-h__tags"},Ou={__name:"ProjectCardHorizontal",props:{project:{type:Object,required:!0}},setup(e){return(t,s)=>{const n=Kt("RouterLink");return U(),kt(n,{to:`/projects/${e.project.id}`,class:"project-card-h"},{default:le(()=>[g("div",xu,[g("img",{src:Ce(lt)(e.project.cover),alt:e.project.title},null,8,Iu)]),g("div",wu,[g("div",Pu,[(U(!0),B(ee,null,ve(e.project.hashtags,i=>(U(),B("span",{key:i,class:"project-card-h__hashtag"}," #"+X(i),1))),128))]),g("h3",Ru,X(e.project.title),1),g("p",ku,X(e.project.description),1),g("div",Tu,[(U(!0),B(ee,null,ve(e.project.tags,i=>(U(),B("span",{key:i,class:"project-card-h__tag"},X(i),1))),128))]),s[0]||(s[0]=g("div",{class:"project-card-h__cta"},"查看專案 →",-1))])]),_:1},8,["to"])}}},ju={class:"projects-page"},$u={class:"projects-list section"},Mu={class:"container"},Du={class:"projects-list__filters"},Uu=["onClick"],Nu={class:"projects-list__grid projects-list__grid--horizontal"},Lu={key:0,class:"projects-list__empty"},Bu={__name:"Projects",setup(e){const t=ci(),s=["All",...new Set(ys.flatMap(o=>o.tags))],n=$e("All");Rt(()=>{const o=t.query.tag;o&&s.includes(o)&&(n.value=o)});const i=je(()=>n.value==="All"?ys:ys.filter(o=>o.tags.includes(n.value)));return(o,r)=>(U(),B("div",ju,[r[0]||(r[0]=ts('<section class="projects-hero section"><div class="container"><p class="projects-hero__label">My Work</p><h1 class="projects-hero__title">Projects</h1><p class="projects-hero__desc"> 橫跨 UIUX 設計、前端切版與 AI 產品設計的實戰專案，每個專案都有可量化的成效與完整的設計思考過程。 </p></div></section>',1)),g("section",$u,[g("div",Mu,[g("div",Du,[(U(),B(ee,null,ve(s,l=>g("button",{key:l,class:We(["projects-list__filter",{"projects-list__filter--active":n.value===l}]),onClick:a=>n.value=l},X(l),11,Uu)),64))]),g("div",Nu,[(U(!0),B(ee,null,ve(i.value,l=>(U(),kt(Ou,{key:l.id,project:l},null,8,["project"]))),128))]),i.value.length===0?(U(),B("p",Lu," 目前沒有符合此分類的專案。 ")):ni("",!0)])])]))}},Fu={key:0,class:"project-detail"},Hu={class:"project-detail-hero section"},Vu={class:"container"},Ku={class:"project-detail-hero__hashtags"},Wu={class:"project-detail-hero__title"},qu={class:"project-detail-hero__desc"},Gu={class:"project-detail-hero__tags"},Xu={class:"project-detail-cover"},zu={class:"container"},Ju=["src","alt"],Qu={class:"project-detail-content section"},Yu={class:"container project-detail-content__layout"},Zu={class:"toc-float__panel"},ed={class:"toc-float__list"},td=["onClick"],sd={class:"toc-sidebar"},nd={class:"toc-sidebar__list"},id=["onClick"],od=["innerHTML"],rd={class:"project-detail-nav section"},ld={class:"container"},ad={key:1,class:"project-detail-notfound section"},cd={class:"container"},pd={__name:"ProjectDetail",setup(e){const t=ci(),s=je(()=>ys.find(c=>c.id===t.params.id)),n=$e([]),i=$e(""),o=$e(null),r=$e(!1),l=()=>{if(!o.value)return;const c=o.value.querySelectorAll("h2, h3");n.value=Array.from(c).map((p,h)=>{const _=`heading-${h}`;return p.id=_,{id:_,text:p.textContent,level:p.tagName}})},a=()=>{if(!o.value)return;const c=o.value.querySelectorAll("h2, h3");let p="";c.forEach(h=>{h.getBoundingClientRect().top<=350&&(p=h.id)}),i.value=p},d=c=>{const p=document.getElementById(c);p&&p.scrollIntoView({behavior:"smooth",block:"start"})};return Rt(()=>{ns(()=>{l(),window.addEventListener("scroll",a)})}),Vt(()=>{window.removeEventListener("scroll",a)}),Ft(s,()=>{ns(()=>l())}),(c,p)=>{const h=Kt("RouterLink");return s.value?(U(),B("div",Fu,[g("section",Hu,[g("div",Vu,[W(h,{to:"/projects",class:"project-detail-hero__back"},{default:le(()=>[...p[1]||(p[1]=[me("← 返回 Projects",-1)])]),_:1}),g("div",Ku,[(U(!0),B(ee,null,ve(s.value.hashtags,_=>(U(),B("span",{key:_,class:"project-detail-hero__hashtag"},"#"+X(_),1))),128))]),g("h1",Wu,X(s.value.title),1),g("p",qu,X(s.value.description),1),g("div",Gu,[(U(!0),B(ee,null,ve(s.value.tags,_=>(U(),B("span",{key:_,class:"project-detail-hero__tag"},X(_),1))),128))])])]),g("div",Xu,[g("div",zu,[g("img",{src:Ce(lt)(s.value.cover),alt:s.value.title,class:"project-detail-cover__img"},null,8,Ju)])]),g("section",Qu,[g("div",Yu,[g("div",{class:We(["toc-float",{"toc-float--open":r.value}])},[g("button",{class:"toc-float__toggle",onClick:p[0]||(p[0]=_=>r.value=!r.value),"aria-label":"目錄"},[...p[2]||(p[2]=[g("i",{class:"fa-solid fa-list"},null,-1)])]),g("div",Zu,[p[3]||(p[3]=g("p",{class:"toc-float__title"},"目錄",-1)),g("ul",ed,[(U(!0),B(ee,null,ve(n.value,_=>(U(),B("li",{key:_.id},[g("a",{onClick:Xs(C=>{d(_.id),r.value=!1},["prevent"]),href:"#"},X(_.text),9,td)]))),128))])])],2),g("aside",sd,[p[4]||(p[4]=g("p",{class:"toc-sidebar__title"},"目錄",-1)),g("ul",nd,[(U(!0),B(ee,null,ve(n.value,_=>(U(),B("li",{key:_.id,class:"toc-sidebar__item"},[g("a",{onClick:Xs(C=>d(_.id),["prevent"]),href:"#",class:We(["toc-sidebar__link",{"toc-sidebar__link--active":i.value===_.id}])},X(_.text),11,id)]))),128))])]),g("div",{class:"project-detail-content__body",ref_key:"contentRef",ref:o,innerHTML:s.value.content},null,8,od)])]),g("section",rd,[g("div",ld,[W(h,{to:"/projects",class:"btn btn--secondary"},{default:le(()=>[...p[5]||(p[5]=[me("← 查看所有專案",-1)])]),_:1})])])])):(U(),B("div",ad,[g("div",cd,[p[7]||(p[7]=g("h1",null,"找不到此專案",-1)),W(h,{to:"/projects",class:"btn btn--primary"},{default:le(()=>[...p[6]||(p[6]=[me("返回 Projects",-1)])]),_:1})])]))}}},ud={class:"article-card__cover"},dd=["src","alt"],fd={class:"article-card__body"},gd={class:"article-card__hashtags"},hd={class:"article-card__title"},_d={class:"article-card__desc"},md={class:"article-card__date"},vd={__name:"ArticleCard",props:{article:{type:Object,required:!0}},setup(e){return(t,s)=>{const n=Kt("RouterLink");return U(),kt(n,{to:`/leadership/${e.article.id}`,class:"article-card"},{default:le(()=>[g("div",ud,[g("img",{src:Ce(lt)(e.article.cover),alt:e.article.title},null,8,dd)]),g("div",fd,[g("div",gd,[(U(!0),B(ee,null,ve(e.article.hashtags,i=>(U(),B("span",{key:i,class:"article-card__hashtag"}," #"+X(i),1))),128))]),g("h3",hd,X(e.article.title),1),g("p",_d,X(e.article.description),1),g("p",md,X(e.article.date),1)]),s[0]||(s[0]=g("div",{class:"article-card__cta"}," 閱讀文章 → ",-1))]),_:1},8,["to"])}}},Ls=[{id:"equal-treatment-trap",title:"我以為一視同仁是公平，這機會卻差點壓垮了她",description:"把同一份標準套在每個人身上，不一定是公平，有時候是一種忽視。這篇文章分享我如何在一個新手設計師的第一個獨立 UIUX 專案中，從「太晚發現問題」到「找到適合她的工作方式」。",cover:"/images/articles/equal-treatment-trap/cover.png",hashtags:["工作拆解","因材施教","設計師成長"],tags:["個人成長反思","設計團隊管理心得","專案決策過程"],date:"2026-02-06",content:`
  ...
  `},{id:"impossible-deadline-two-weeks",title:"我們如何在兩週內，完成一個不可能的任務",description:"老闆踩死的 deadline、PM 規劃一個月才丟來的需求，但最後設計部不只準時交付，還讓我看見一件更重要的事：真正讓任務得以完成的力量，早在這個專案之前就已經存在了。",cover:"/images/articles/impossible-deadline-two-weeks/cover.png",hashtags:["任務拆解與同步推進","自主分工設計","長期信任感積累"],tags:["帶團隊的方法論","專案決策過程"],date:"2025-02-24",content:`
    ...
    <p>我何德何能，有這樣一群夥伴。</p>
  `}],bd={class:"leadership-page"},yd={class:"leadership-list section"},Ad={class:"container"},Sd={class:"leadership-list__filters"},Ed=["onClick"],Cd={class:"leadership-list__grid"},xd={key:0,class:"leadership-list__empty"},Id={__name:"Leadership",setup(e){const t=["All",...new Set(Ls.flatMap(i=>i.tags))],s=$e("All"),n=je(()=>s.value==="All"?Ls:Ls.filter(i=>i.tags.includes(s.value)));return(i,o)=>(U(),B("div",bd,[o[0]||(o[0]=ts('<section class="leadership-hero section"><div class="container"><p class="leadership-hero__label">My Thoughts</p><h1 class="leadership-hero__title">Leadership</h1><p class="leadership-hero__desc"> 記錄我在設計管理路上真實發生的事：那些摸索過的方法論、踩過的決策、帶人時的觀察，以及在過程中慢慢長出來的反思。 </p></div></section>',1)),g("section",yd,[g("div",Ad,[g("div",Sd,[(U(),B(ee,null,ve(t,r=>g("button",{key:r,class:We(["leadership-list__filter",{"leadership-list__filter--active":s.value===r}]),onClick:l=>s.value=r},X(r),11,Ed)),64))]),g("div",Cd,[(U(!0),B(ee,null,ve(n.value,r=>(U(),kt(vd,{key:r.id,article:r},null,8,["article"]))),128))]),n.value.length===0?(U(),B("p",xd," 目前沒有符合此分類的文章。 ")):ni("",!0)])])]))}},wd={key:0,class:"article-detail"},Pd={class:"article-detail-hero section"},Rd={class:"container"},kd={class:"article-detail-hero__hashtags"},Td={class:"article-detail-hero__title"},Od={class:"article-detail-hero__desc"},jd={class:"article-detail-hero__date"},$d={class:"article-detail-cover"},Md={class:"container"},Dd=["src","alt"],Ud={class:"article-detail-content section"},Nd={class:"container article-detail-content__layout"},Ld={class:"article-toc-float__panel"},Bd={class:"article-toc-float__list"},Fd=["onClick"],Hd={class:"article-toc-sidebar"},Vd={class:"article-toc-sidebar__list"},Kd=["onClick"],Wd=["innerHTML"],qd={class:"article-detail-nav section"},Gd={class:"container"},Xd={key:1,class:"article-detail-notfound section"},zd={class:"container"},Jd={__name:"ArticleDetail",setup(e){const t=ci(),s=je(()=>Ls.find(c=>c.id===t.params.id)),n=$e([]),i=$e(""),o=$e(null),r=$e(!1),l=()=>{if(!o.value)return;const c=o.value.querySelectorAll("h2, h3");n.value=Array.from(c).map((p,h)=>{const _=`article-heading-${h}`;return p.id=_,{id:_,text:p.textContent,level:p.tagName}})},a=()=>{if(!o.value)return;const c=o.value.querySelectorAll("h2, h3");let p="";c.forEach(h=>{h.getBoundingClientRect().top<=350&&(p=h.id)}),i.value=p},d=c=>{const p=document.getElementById(c);p&&p.scrollIntoView({behavior:"smooth",block:"start"})};return Rt(()=>{ns(()=>{l(),window.addEventListener("scroll",a)})}),Vt(()=>{window.removeEventListener("scroll",a)}),Ft(s,()=>{ns(()=>l())}),(c,p)=>{const h=Kt("RouterLink");return s.value?(U(),B("div",wd,[g("section",Pd,[g("div",Rd,[W(h,{to:"/leadership",class:"article-detail-hero__back"},{default:le(()=>[...p[1]||(p[1]=[me(" ← 返回 Leadership ",-1)])]),_:1}),g("div",kd,[(U(!0),B(ee,null,ve(s.value.hashtags,_=>(U(),B("span",{key:_,class:"article-detail-hero__hashtag"}," #"+X(_),1))),128))]),g("h1",Td,X(s.value.title),1),g("p",Od,X(s.value.description),1),g("p",jd,X(s.value.date),1)])]),g("div",$d,[g("div",Md,[g("img",{src:Ce(lt)(s.value.cover),alt:s.value.title,class:"article-detail-cover__img"},null,8,Dd)])]),g("section",Ud,[g("div",Nd,[g("div",{class:We(["article-toc-float",{"article-toc-float--open":r.value}])},[g("button",{class:"article-toc-float__toggle",onClick:p[0]||(p[0]=_=>r.value=!r.value),"aria-label":"目錄"},[...p[2]||(p[2]=[g("i",{class:"fa-solid fa-list"},null,-1)])]),g("div",Ld,[p[3]||(p[3]=g("p",{class:"article-toc-float__title"},"目錄",-1)),g("ul",Bd,[(U(!0),B(ee,null,ve(n.value,_=>(U(),B("li",{key:_.id},[g("a",{onClick:Xs(C=>{d(_.id),r.value=!1},["prevent"]),href:"#"},X(_.text),9,Fd)]))),128))])])],2),g("aside",Hd,[p[4]||(p[4]=g("p",{class:"article-toc-sidebar__title"},"目錄",-1)),g("ul",Vd,[(U(!0),B(ee,null,ve(n.value,_=>(U(),B("li",{key:_.id},[g("a",{onClick:Xs(C=>d(_.id),["prevent"]),href:"#",class:We(["article-toc-sidebar__link",{"article-toc-sidebar__link--active":i.value===_.id}])},X(_.text),11,Kd)]))),128))])]),g("div",{class:"article-detail-content__body",ref_key:"contentRef",ref:o,innerHTML:s.value.content},null,8,Wd)])]),g("section",qd,[g("div",Gd,[W(h,{to:"/leadership",class:"btn btn--secondary"},{default:le(()=>[...p[5]||(p[5]=[me(" ← 查看所有文章 ",-1)])]),_:1})])])])):(U(),B("div",Xd,[g("div",zd,[p[7]||(p[7]=g("h1",null,"找不到此文章",-1)),W(h,{to:"/leadership",class:"btn btn--primary"},{default:le(()=>[...p[6]||(p[6]=[me("返回 Leadership",-1)])]),_:1})])]))}}},Qd={__name:"StoryCanvas",setup(e){const t=$e(null);let s=null;return Rt(()=>{const n=t.value,i=n.getContext("2d"),o=()=>{n.width=n.offsetWidth,n.height=n.offsetHeight};o(),window.addEventListener("resize",o);const r=2e3,l=800,a=()=>({x:(Math.random()-.5)*2,y:(Math.random()-.5)*2,z:Math.random()*l,pz:null}),d=Array.from({length:r},a);d.forEach(h=>{h.pz=h.z});const c=1.5,p=()=>{const h=n.width,_=n.height,C=h/2,E=_/2;i.fillStyle="rgba(10, 14, 26, 0.25)",i.fillRect(0,0,h,_),d.forEach(j=>{if(j.pz=j.z,j.z-=c,j.z<=1){Object.assign(j,a()),j.pz=j.z;return}const w=l/j.z,x=C+j.x*w*(h/2),$=E+j.y*w*(_/2),T=l/j.pz,G=C+j.x*T*(h/2),Y=E+j.y*T*(_/2),Q=1-j.z/l,Se=Math.pow(Q,1.5),V=Math.max(.3,Q*2.2),z=i.createLinearGradient(G,Y,x,$);if(z.addColorStop(0,"rgba(100,160,255,0)"),z.addColorStop(1,`rgba(200,225,255,${Se*.95})`),i.beginPath(),i.moveTo(G,Y),i.lineTo(x,$),i.strokeStyle=z,i.lineWidth=V,i.lineCap="round",i.stroke(),Q>.6){const ae=(Q-.6)/.4;i.beginPath(),i.arc(x,$,V*1.2,0,Math.PI*2),i.fillStyle=`rgba(220,235,255,${ae*.9})`,i.fill()}}),s=requestAnimationFrame(p)};Vt(()=>{cancelAnimationFrame(s),window.removeEventListener("resize",o)}),p()}),(n,i)=>(U(),B("canvas",{ref_key:"canvasRef",ref:t,class:"story-canvas"},null,512))}},Yd=cn(Qd,[["__scopeId","data-v-3f74bc40"]]),Zd={class:"about-page"},ef={class:"about-hero section"},tf={class:"container about-hero__inner"},sf={class:"about-hero__image"},nf=["src"],of={class:"about-experience section"},rf={class:"container"},lf={class:"about-experience__list"},af={class:"about-experience__left"},cf={class:"about-experience__period"},pf={class:"about-experience__right"},uf={class:"about-experience__role"},df={class:"about-experience__company"},ff={class:"about-experience__desc"},gf={key:0,class:"about-experience__highlights"},hf={class:"about-story section"},_f={class:"container"},mf={class:"about-story__timeline"},vf={class:"about-story__image"},bf=["src","alt"],yf={class:"about-story__content"},Af={class:"about-story__period"},Sf={class:"about-story__role"},Ef={class:"about-story__tags"},Cf={class:"about-story__desc"},xf={__name:"About",setup(e){const t=[{period:"2024.06 - 現在",role:"設計主管",company:"三貝德數位文創股份有限公司",desc:"帶領設計團隊，負責公司多項 B2B、B2C 教育產品（Web、App、AI 應用）的體驗品質、設計策略與跨部門協作，並主導設計系統建立與流程制度化。",highlights:["團隊管理與人才培育：建立 OKR 績效系統、UIUX 職涯發展階梯與 1:1 教練式輔導機制，系統化提升團隊產能與個人成長路徑。","產品體驗統籌：主導多項 Web / App 數位產品的使用者體驗品質，以數據驅動推動體驗優化，AI 學習目標改版後客服需求降低 80%。","設計系統與流程制度化：建置公司級 Design System，並制定跨部門協作規範，標準化設計交付流程。","跨部門協作：在嚴峻時程下統籌多線並行的設計任務，與產品、工程、測試團隊建立高效協作模式。"]},{period:"2023.03 - 2024.05",role:"UIUX 設計師",company:"三貝德數位文創股份有限公司",desc:"負責平台教育產品的 UI/UX 設計、前端切版與教材流程優化，打造一致且可延展的產品體驗。",highlights:["產品設計：獨立主導多項功能從 0 到 1 的完整設計流程，涵蓋 UX 研究、資訊架構、UI 設計與 Prototype，並透過使用者訪談與數據分析驅動設計決策。","前端切版：Vue.js 環境支援切版、RWD 與 API 串接，自研 SCSS 工具提升開發效率，並建立 EPUB 量產系統將手工排版轉為半自動化流程。","跨職能協作：在 PM 資源不足的情況下獨立承擔前期研究到交付的全流程，並跨部門推動設計規格落地。"]},{period:"2021.06 - 2021.11",role:"培訓專員",company:"啟誠科技有限公司",desc:"支援公司整體人才發展與服務品質提升，規劃並授課內部溝通課程，分析營運數據並協助主管提出改善方案。",highlights:["自行開發並講授《有效提升溝通力》課程，滿意度達 5/5 滿分。","每日維護 500+ 則文字記錄與 50+ 通電話，確保服務品質並找出改善方向。"]},{period:"2020.09 - 2021.06",role:"人資專員",company:"啟諾科技有限公司",desc:"負責全流程人力資源作業，涵蓋招募、新人職前、EAP 員工協助、教育訓練與勞資會議。",highlights:["一個月內成功招募 12 位新人，支援年度人力需求。","規劃內訓課程，培育並成為內部講師，協助開發課程內容與授課技巧。"]},{period:"2019.09 - 2020.07",role:"專案管理師",company:"鉅微管理顧問股份有限公司",desc:"負責逾 40 家國內外企業客戶的年度專案，包括教育訓練、紓壓課程與 EAP 專案等。",highlights:["企劃並執行大型企業教育訓練與活動，涵蓋知名外商與上市企業。","協助陌生開發與簡報提案，推動新業務開展。"]},{period:"2017.07 - 2019.08",role:"行政會計專員",company:"伊甸社會福利基金會（大龍養護中心）",desc:"負責財會、人事行政、政府補助專案與整理行政管理。",highlights:["獨立負責 5 件以上政府專案的申請與執行追蹤。","管理 35 名員工的薪酬、差勤與福利事務。","管理 1000+ 件中心財產，協助組織資源與修繕。"]},{period:"2016.09 - 2017.01",role:"主管特別助理",company:"六星集股份有限公司",desc:"協助總經理行程管理、跨部門協作、商務會議與大型活動規劃。",highlights:["規劃並協助總經理之商務行程與會議。","參與籌備逾 400 人以上的大型年度尾牙。"]}],s=[{period:"2016 - 2018",title:"視覺設計師",image:lt("/images/general/story/story-1.jpg"),tags:["品牌視覺","平面設計","美感養成"],desc:"從最基礎的視覺語言出發，學會如何用顏色、字型、排版傳達品牌個性。這個階段讓我建立了扎實的美感基礎，也讓我開始對「設計如何影響使用者感受」產生好奇。"},{period:"2018 - 2020",title:"UI 設計師",image:lt("/images/general/story/story-2.jpg"),tags:["介面設計","設計系統","跨部門協作"],desc:"開始接觸數位產品設計，學習如何在螢幕上建立清晰的視覺層次。與工程師合作的過程中，我意識到設計不只是好看，更要能被實作，這驅動我學習前端切版。"},{period:"2020 - 2022",title:"UIUX 設計師",image:lt("/images/general/story/story-3.jpg"),tags:["使用者研究","A/B 測試","數據驅動設計"],desc:"真正走進使用者的世界。透過訪談、測試、數據分析來驗證設計決策，讓我理解「好設計」的定義不是設計師說了算，而是使用者用腳投票的結果。"},{period:"2022 - 現在",title:"設計主管",image:lt("/images/general/story/story-4.jpg"),tags:["團隊管理","設計策略","跨部門影響力"],desc:"角色轉換讓我重新定義「貢獻」的意義。從做好一個設計，到讓整個團隊都能做好設計。管理是一門全新的學問，但也是我目前覺得最有意義的挑戰。"}];return(n,i)=>(U(),B("div",Zd,[g("section",ef,[g("div",tf,[i[0]||(i[0]=ts('<div class="about-hero__content"><p class="about-hero__label">About Me</p><h1 class="about-hero__title">嗨，我是 Nomis！</h1><p class="about-hero__desc"> 我是一位橫跨 <strong>UIUX 設計、前端切版與設計管理</strong>的複合型設計師。入行前做過人資、讀過社會心理、跑過企業培訓，這些跨領域的歷程不是繞路，而是讓我在每一個設計決策裡，都能同時看見使用者、團隊與商業三個層面。 </p><p class="about-hero__desc"> 在三貝德擔任設計師期間，我能在資源不足的情況下獨立推進：PM 缺席時獨立完成從 UX 研究到前端切版的全流程；工具不夠用時自己研發 SCSS 工具、建立 EPUB 量產系統。<strong>我相信設計師最大的競爭力，不是工具用得多熟，而是在限制裡找到更多可能與更聰明的解法。</strong></p><p class="about-hero__desc"> 晉升設計主管後，我把同樣的系統性思維用在領導上：建立 OKR 績效系統、UIUX 職涯發展階梯、設計需求協作指南，<strong>讓團隊的運作不再靠感覺，而是有制度可以依循、有數據可以追蹤。</strong>這是我目前覺得最有意義的事，也是我最想繼續做的事。 </p></div>',1)),g("div",sf,[g("img",{src:Ce(lt)("/images/general/avatar.png"),alt:"Nomis",class:"about-hero__avatar"},null,8,nf)])])]),g("section",of,[g("div",rf,[i[1]||(i[1]=g("h2",{class:"about-experience__title"},"工作經驗",-1)),g("div",lf,[(U(),B(ee,null,ve(t,o=>g("div",{key:o.company+o.role,class:"about-experience__item"},[g("div",af,[g("p",cf,X(o.period),1)]),g("div",pf,[g("h3",uf,X(o.role),1),g("p",df,X(o.company),1),g("p",ff,X(o.desc),1),o.highlights?(U(),B("ul",gf,[(U(!0),B(ee,null,ve(o.highlights,r=>(U(),B("li",{key:r},X(r),1))),128))])):ni("",!0)])])),64))])])]),g("section",hf,[W(Yd),g("div",_f,[i[2]||(i[2]=g("p",{class:"about-story__label"},"My Story",-1)),i[3]||(i[3]=g("h2",{class:"about-story__title"},"我如何成為 UIUX 設計師暨設計主管",-1)),i[4]||(i[4]=g("p",{class:"about-story__intro"}," 我的設計之路從視覺出發，一路走向 UIUX、前端，再到帶領設計團隊。 每個階段都讓我對「設計」這件事有更深的理解。 ",-1)),g("div",mf,[(U(),B(ee,null,ve(s,o=>g("div",{class:"about-story__item",key:o.title},[g("div",vf,[g("img",{src:o.image,alt:o.title},null,8,bf)]),g("div",yf,[g("p",Af,X(o.period),1),g("h3",Sf,X(o.title),1),g("div",Ef,[(U(!0),B(ee,null,ve(o.tags,r=>(U(),B("span",{key:r,class:"about-story__tag"},X(r),1))),128))]),g("p",Cf,X(o.desc),1)])])),64))])])])]))}},If=Sp({history:tp(),routes:[{path:"/",name:"home",component:Cu},{path:"/projects",name:"projects",component:Bu},{path:"/projects/:id",name:"project-detail",component:pd},{path:"/leadership",name:"leadership",component:Id},{path:"/leadership/:id",name:"article-detail",component:Jd},{path:"/about",name:"about",component:xf}],scrollBehavior(e,t,s){return s||{top:0}}}),Hr=gc(jp);Hr.use(If);Hr.mount("#app");
