(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))n(i);new MutationObserver(i=>{for(const o of i)if(o.type==="childList")for(const r of o.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&n(r)}).observe(document,{childList:!0,subtree:!0});function s(i){const o={};return i.integrity&&(o.integrity=i.integrity),i.referrerPolicy&&(o.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?o.credentials="include":i.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function n(i){if(i.ep)return;i.ep=!0;const o=s(i);fetch(i.href,o)}})();function Hn(e){const t=Object.create(null);for(const s of e.split(","))t[s]=1;return s=>s in t}const de={},Jt=[],lt=()=>{},uo=()=>!1,zs=e=>e.charCodeAt(0)===111&&e.charCodeAt(1)===110&&(e.charCodeAt(2)>122||e.charCodeAt(2)<97),Js=e=>e.startsWith("onUpdate:"),ye=Object.assign,Vn=(e,t)=>{const s=e.indexOf(t);s>-1&&e.splice(s,1)},Kr=Object.prototype.hasOwnProperty,oe=(e,t)=>Kr.call(e,t),H=Array.isArray,Qt=e=>Rs(e)==="[object Map]",fo=e=>Rs(e)==="[object Set]",di=e=>Rs(e)==="[object Date]",W=e=>typeof e=="function",he=e=>typeof e=="string",ct=e=>typeof e=="symbol",re=e=>e!==null&&typeof e=="object",ho=e=>(re(e)||W(e))&&W(e.then)&&W(e.catch),_o=Object.prototype.toString,Rs=e=>_o.call(e),Wr=e=>Rs(e).slice(8,-1),go=e=>Rs(e)==="[object Object]",Kn=e=>he(e)&&e!=="NaN"&&e[0]!=="-"&&""+parseInt(e,10)===e,ds=Hn(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),Qs=e=>{const t=Object.create(null);return(s=>t[s]||(t[s]=e(s)))},qr=/-\w/g,De=Qs(e=>e.replace(qr,t=>t.slice(1).toUpperCase())),Gr=/\B([A-Z])/g,Ft=Qs(e=>e.replace(Gr,"-$1").toLowerCase()),Ys=Qs(e=>e.charAt(0).toUpperCase()+e.slice(1)),pn=Qs(e=>e?`on${Ys(e)}`:""),rt=(e,t)=>!Object.is(e,t),un=(e,...t)=>{for(let s=0;s<e.length;s++)e[s](...t)},mo=(e,t,s,n=!1)=>{Object.defineProperty(e,t,{configurable:!0,enumerable:!1,writable:n,value:s})},Xr=e=>{const t=parseFloat(e);return isNaN(t)?e:t},zr=e=>{const t=he(e)?Number(e):NaN;return isNaN(t)?e:t};let fi;const Zs=()=>fi||(fi=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});function Wn(e){if(H(e)){const t={};for(let s=0;s<e.length;s++){const n=e[s],i=he(n)?Zr(n):Wn(n);if(i)for(const o in i)t[o]=i[o]}return t}else if(he(e)||re(e))return e}const Jr=/;(?![^(]*\))/g,Qr=/:([^]+)/,Yr=/\/\*[^]*?\*\//g;function Zr(e){const t={};return e.replace(Yr,"").split(Jr).forEach(s=>{if(s){const n=s.split(Qr);n.length>1&&(t[n[0].trim()]=n[1].trim())}}),t}function We(e){let t="";if(he(e))t=e;else if(H(e))for(let s=0;s<e.length;s++){const n=We(e[s]);n&&(t+=n+" ")}else if(re(e))for(const s in e)e[s]&&(t+=s+" ");return t.trim()}const el="itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly",tl=Hn(el);function vo(e){return!!e||e===""}function sl(e,t){if(e.length!==t.length)return!1;let s=!0;for(let n=0;s&&n<e.length;n++)s=qn(e[n],t[n]);return s}function qn(e,t){if(e===t)return!0;let s=di(e),n=di(t);if(s||n)return s&&n?e.getTime()===t.getTime():!1;if(s=ct(e),n=ct(t),s||n)return e===t;if(s=H(e),n=H(t),s||n)return s&&n?sl(e,t):!1;if(s=re(e),n=re(t),s||n){if(!s||!n)return!1;const i=Object.keys(e).length,o=Object.keys(t).length;if(i!==o)return!1;for(const r in e){const l=e.hasOwnProperty(r),a=t.hasOwnProperty(r);if(l&&!a||!l&&a||!qn(e[r],t[r]))return!1}}return String(e)===String(t)}const bo=e=>!!(e&&e.__v_isRef===!0),J=e=>he(e)?e:e==null?"":H(e)||re(e)&&(e.toString===_o||!W(e.toString))?bo(e)?J(e.value):JSON.stringify(e,yo,2):String(e),yo=(e,t)=>bo(t)?yo(e,t.value):Qt(t)?{[`Map(${t.size})`]:[...t.entries()].reduce((s,[n,i],o)=>(s[dn(n,o)+" =>"]=i,s),{})}:fo(t)?{[`Set(${t.size})`]:[...t.values()].map(s=>dn(s))}:ct(t)?dn(t):re(t)&&!H(t)&&!go(t)?String(t):t,dn=(e,t="")=>{var s;return ct(e)?`Symbol(${(s=e.description)!=null?s:t})`:e};let ke;class nl{constructor(t=!1){this.detached=t,this._active=!0,this._on=0,this.effects=[],this.cleanups=[],this._isPaused=!1,this.__v_skip=!0,this.parent=ke,!t&&ke&&(this.index=(ke.scopes||(ke.scopes=[])).push(this)-1)}get active(){return this._active}pause(){if(this._active){this._isPaused=!0;let t,s;if(this.scopes)for(t=0,s=this.scopes.length;t<s;t++)this.scopes[t].pause();for(t=0,s=this.effects.length;t<s;t++)this.effects[t].pause()}}resume(){if(this._active&&this._isPaused){this._isPaused=!1;let t,s;if(this.scopes)for(t=0,s=this.scopes.length;t<s;t++)this.scopes[t].resume();for(t=0,s=this.effects.length;t<s;t++)this.effects[t].resume()}}run(t){if(this._active){const s=ke;try{return ke=this,t()}finally{ke=s}}}on(){++this._on===1&&(this.prevScope=ke,ke=this)}off(){this._on>0&&--this._on===0&&(ke=this.prevScope,this.prevScope=void 0)}stop(t){if(this._active){this._active=!1;let s,n;for(s=0,n=this.effects.length;s<n;s++)this.effects[s].stop();for(this.effects.length=0,s=0,n=this.cleanups.length;s<n;s++)this.cleanups[s]();if(this.cleanups.length=0,this.scopes){for(s=0,n=this.scopes.length;s<n;s++)this.scopes[s].stop(!0);this.scopes.length=0}if(!this.detached&&this.parent&&!t){const i=this.parent.scopes.pop();i&&i!==this&&(this.parent.scopes[this.index]=i,i.index=this.index)}this.parent=void 0}}}function il(){return ke}let ue;const fn=new WeakSet;class Ao{constructor(t){this.fn=t,this.deps=void 0,this.depsTail=void 0,this.flags=5,this.next=void 0,this.cleanup=void 0,this.scheduler=void 0,ke&&ke.active&&ke.effects.push(this)}pause(){this.flags|=64}resume(){this.flags&64&&(this.flags&=-65,fn.has(this)&&(fn.delete(this),this.trigger()))}notify(){this.flags&2&&!(this.flags&32)||this.flags&8||Eo(this)}run(){if(!(this.flags&1))return this.fn();this.flags|=2,hi(this),Co(this);const t=ue,s=Ge;ue=this,Ge=!0;try{return this.fn()}finally{xo(this),ue=t,Ge=s,this.flags&=-3}}stop(){if(this.flags&1){for(let t=this.deps;t;t=t.nextDep)zn(t);this.deps=this.depsTail=void 0,hi(this),this.onStop&&this.onStop(),this.flags&=-2}}trigger(){this.flags&64?fn.add(this):this.scheduler?this.scheduler():this.runIfDirty()}runIfDirty(){In(this)&&this.run()}get dirty(){return In(this)}}let So=0,fs,hs;function Eo(e,t=!1){if(e.flags|=8,t){e.next=hs,hs=e;return}e.next=fs,fs=e}function Gn(){So++}function Xn(){if(--So>0)return;if(hs){let t=hs;for(hs=void 0;t;){const s=t.next;t.next=void 0,t.flags&=-9,t=s}}let e;for(;fs;){let t=fs;for(fs=void 0;t;){const s=t.next;if(t.next=void 0,t.flags&=-9,t.flags&1)try{t.trigger()}catch(n){e||(e=n)}t=s}}if(e)throw e}function Co(e){for(let t=e.deps;t;t=t.nextDep)t.version=-1,t.prevActiveLink=t.dep.activeLink,t.dep.activeLink=t}function xo(e){let t,s=e.depsTail,n=s;for(;n;){const i=n.prevDep;n.version===-1?(n===s&&(s=i),zn(n),ol(n)):t=n,n.dep.activeLink=n.prevActiveLink,n.prevActiveLink=void 0,n=i}e.deps=t,e.depsTail=s}function In(e){for(let t=e.deps;t;t=t.nextDep)if(t.dep.version!==t.version||t.dep.computed&&(Io(t.dep.computed)||t.dep.version!==t.version))return!0;return!!e._dirty}function Io(e){if(e.flags&4&&!(e.flags&16)||(e.flags&=-17,e.globalVersion===As)||(e.globalVersion=As,!e.isSSR&&e.flags&128&&(!e.deps&&!e._dirty||!In(e))))return;e.flags|=2;const t=e.dep,s=ue,n=Ge;ue=e,Ge=!0;try{Co(e);const i=e.fn(e._value);(t.version===0||rt(i,e._value))&&(e.flags|=128,e._value=i,t.version++)}catch(i){throw t.version++,i}finally{ue=s,Ge=n,xo(e),e.flags&=-3}}function zn(e,t=!1){const{dep:s,prevSub:n,nextSub:i}=e;if(n&&(n.nextSub=i,e.prevSub=void 0),i&&(i.prevSub=n,e.nextSub=void 0),s.subs===e&&(s.subs=n,!n&&s.computed)){s.computed.flags&=-5;for(let o=s.computed.deps;o;o=o.nextDep)zn(o,!0)}!t&&!--s.sc&&s.map&&s.map.delete(s.key)}function ol(e){const{prevDep:t,nextDep:s}=e;t&&(t.nextDep=s,e.prevDep=void 0),s&&(s.prevDep=t,e.nextDep=void 0)}let Ge=!0;const wo=[];function vt(){wo.push(Ge),Ge=!1}function bt(){const e=wo.pop();Ge=e===void 0?!0:e}function hi(e){const{cleanup:t}=e;if(e.cleanup=void 0,t){const s=ue;ue=void 0;try{t()}finally{ue=s}}}let As=0;class rl{constructor(t,s){this.sub=t,this.dep=s,this.version=s.version,this.nextDep=this.prevDep=this.nextSub=this.prevSub=this.prevActiveLink=void 0}}class Jn{constructor(t){this.computed=t,this.version=0,this.activeLink=void 0,this.subs=void 0,this.map=void 0,this.key=void 0,this.sc=0,this.__v_skip=!0}track(t){if(!ue||!Ge||ue===this.computed)return;let s=this.activeLink;if(s===void 0||s.sub!==ue)s=this.activeLink=new rl(ue,this),ue.deps?(s.prevDep=ue.depsTail,ue.depsTail.nextDep=s,ue.depsTail=s):ue.deps=ue.depsTail=s,Po(s);else if(s.version===-1&&(s.version=this.version,s.nextDep)){const n=s.nextDep;n.prevDep=s.prevDep,s.prevDep&&(s.prevDep.nextDep=n),s.prevDep=ue.depsTail,s.nextDep=void 0,ue.depsTail.nextDep=s,ue.depsTail=s,ue.deps===s&&(ue.deps=n)}return s}trigger(t){this.version++,As++,this.notify(t)}notify(t){Gn();try{for(let s=this.subs;s;s=s.prevSub)s.sub.notify()&&s.sub.dep.notify()}finally{Xn()}}}function Po(e){if(e.dep.sc++,e.sub.flags&4){const t=e.dep.computed;if(t&&!e.dep.subs){t.flags|=20;for(let n=t.deps;n;n=n.nextDep)Po(n)}const s=e.dep.subs;s!==e&&(e.prevSub=s,s&&(s.nextSub=e)),e.dep.subs=e}}const wn=new WeakMap,Ut=Symbol(""),Pn=Symbol(""),Ss=Symbol("");function xe(e,t,s){if(Ge&&ue){let n=wn.get(e);n||wn.set(e,n=new Map);let i=n.get(s);i||(n.set(s,i=new Jn),i.map=n,i.key=s),i.track()}}function gt(e,t,s,n,i,o){const r=wn.get(e);if(!r){As++;return}const l=a=>{a&&a.trigger()};if(Gn(),t==="clear")r.forEach(l);else{const a=H(e),d=a&&Kn(s);if(a&&s==="length"){const c=Number(n);r.forEach((p,h)=>{(h==="length"||h===Ss||!ct(h)&&h>=c)&&l(p)})}else switch((s!==void 0||r.has(void 0))&&l(r.get(s)),d&&l(r.get(Ss)),t){case"add":a?d&&l(r.get("length")):(l(r.get(Ut)),Qt(e)&&l(r.get(Pn)));break;case"delete":a||(l(r.get(Ut)),Qt(e)&&l(r.get(Pn)));break;case"set":Qt(e)&&l(r.get(Ut));break}}Xn()}function qt(e){const t=te(e);return t===e?t:(xe(t,"iterate",Ss),Ke(e)?t:t.map(Xe))}function en(e){return xe(e=te(e),"iterate",Ss),e}function it(e,t){return yt(e)?ts(Lt(e)?Xe(t):t):Xe(t)}const ll={__proto__:null,[Symbol.iterator](){return hn(this,Symbol.iterator,e=>it(this,e))},concat(...e){return qt(this).concat(...e.map(t=>H(t)?qt(t):t))},entries(){return hn(this,"entries",e=>(e[1]=it(this,e[1]),e))},every(e,t){return ut(this,"every",e,t,void 0,arguments)},filter(e,t){return ut(this,"filter",e,t,s=>s.map(n=>it(this,n)),arguments)},find(e,t){return ut(this,"find",e,t,s=>it(this,s),arguments)},findIndex(e,t){return ut(this,"findIndex",e,t,void 0,arguments)},findLast(e,t){return ut(this,"findLast",e,t,s=>it(this,s),arguments)},findLastIndex(e,t){return ut(this,"findLastIndex",e,t,void 0,arguments)},forEach(e,t){return ut(this,"forEach",e,t,void 0,arguments)},includes(...e){return _n(this,"includes",e)},indexOf(...e){return _n(this,"indexOf",e)},join(e){return qt(this).join(e)},lastIndexOf(...e){return _n(this,"lastIndexOf",e)},map(e,t){return ut(this,"map",e,t,void 0,arguments)},pop(){return ls(this,"pop")},push(...e){return ls(this,"push",e)},reduce(e,...t){return _i(this,"reduce",e,t)},reduceRight(e,...t){return _i(this,"reduceRight",e,t)},shift(){return ls(this,"shift")},some(e,t){return ut(this,"some",e,t,void 0,arguments)},splice(...e){return ls(this,"splice",e)},toReversed(){return qt(this).toReversed()},toSorted(e){return qt(this).toSorted(e)},toSpliced(...e){return qt(this).toSpliced(...e)},unshift(...e){return ls(this,"unshift",e)},values(){return hn(this,"values",e=>it(this,e))}};function hn(e,t,s){const n=en(e),i=n[t]();return n!==e&&!Ke(e)&&(i._next=i.next,i.next=()=>{const o=i._next();return o.done||(o.value=s(o.value)),o}),i}const al=Array.prototype;function ut(e,t,s,n,i,o){const r=en(e),l=r!==e&&!Ke(e),a=r[t];if(a!==al[t]){const p=a.apply(e,o);return l?Xe(p):p}let d=s;r!==e&&(l?d=function(p,h){return s.call(this,it(e,p),h,e)}:s.length>2&&(d=function(p,h){return s.call(this,p,h,e)}));const c=a.call(r,d,n);return l&&i?i(c):c}function _i(e,t,s,n){const i=en(e),o=i!==e&&!Ke(e);let r=s,l=!1;i!==e&&(o?(l=n.length===0,r=function(d,c,p){return l&&(l=!1,d=it(e,d)),s.call(this,d,it(e,c),p,e)}):s.length>3&&(r=function(d,c,p){return s.call(this,d,c,p,e)}));const a=i[t](r,...n);return l?it(e,a):a}function _n(e,t,s){const n=te(e);xe(n,"iterate",Ss);const i=n[t](...s);return(i===-1||i===!1)&&Zn(s[0])?(s[0]=te(s[0]),n[t](...s)):i}function ls(e,t,s=[]){vt(),Gn();const n=te(e)[t].apply(e,s);return Xn(),bt(),n}const cl=Hn("__proto__,__v_isRef,__isVue"),Ro=new Set(Object.getOwnPropertyNames(Symbol).filter(e=>e!=="arguments"&&e!=="caller").map(e=>Symbol[e]).filter(ct));function pl(e){ct(e)||(e=String(e));const t=te(this);return xe(t,"has",e),t.hasOwnProperty(e)}class To{constructor(t=!1,s=!1){this._isReadonly=t,this._isShallow=s}get(t,s,n){if(s==="__v_skip")return t.__v_skip;const i=this._isReadonly,o=this._isShallow;if(s==="__v_isReactive")return!i;if(s==="__v_isReadonly")return i;if(s==="__v_isShallow")return o;if(s==="__v_raw")return n===(i?o?yl:Do:o?Mo:jo).get(t)||Object.getPrototypeOf(t)===Object.getPrototypeOf(n)?t:void 0;const r=H(t);if(!i){let a;if(r&&(a=ll[s]))return a;if(s==="hasOwnProperty")return pl}const l=Reflect.get(t,s,we(t)?t:n);if((ct(s)?Ro.has(s):cl(s))||(i||xe(t,"get",s),o))return l;if(we(l)){const a=r&&Kn(s)?l:l.value;return i&&re(a)?Tn(a):a}return re(l)?i?Tn(l):tn(l):l}}class Oo extends To{constructor(t=!1){super(!1,t)}set(t,s,n,i){let o=t[s];const r=H(t)&&Kn(s);if(!this._isShallow){const d=yt(o);if(!Ke(n)&&!yt(n)&&(o=te(o),n=te(n)),!r&&we(o)&&!we(n))return d||(o.value=n),!0}const l=r?Number(s)<t.length:oe(t,s),a=Reflect.set(t,s,n,we(t)?t:i);return t===te(i)&&(l?rt(n,o)&&gt(t,"set",s,n):gt(t,"add",s,n)),a}deleteProperty(t,s){const n=oe(t,s);t[s];const i=Reflect.deleteProperty(t,s);return i&&n&&gt(t,"delete",s,void 0),i}has(t,s){const n=Reflect.has(t,s);return(!ct(s)||!Ro.has(s))&&xe(t,"has",s),n}ownKeys(t){return xe(t,"iterate",H(t)?"length":Ut),Reflect.ownKeys(t)}}class ul extends To{constructor(t=!1){super(!0,t)}set(t,s){return!0}deleteProperty(t,s){return!0}}const dl=new Oo,fl=new ul,hl=new Oo(!0);const Rn=e=>e,js=e=>Reflect.getPrototypeOf(e);function _l(e,t,s){return function(...n){const i=this.__v_raw,o=te(i),r=Qt(o),l=e==="entries"||e===Symbol.iterator&&r,a=e==="keys"&&r,d=i[e](...n),c=s?Rn:t?ts:Xe;return!t&&xe(o,"iterate",a?Pn:Ut),ye(Object.create(d),{next(){const{value:p,done:h}=d.next();return h?{value:p,done:h}:{value:l?[c(p[0]),c(p[1])]:c(p),done:h}}})}}function Ms(e){return function(...t){return e==="delete"?!1:e==="clear"?void 0:this}}function gl(e,t){const s={get(i){const o=this.__v_raw,r=te(o),l=te(i);e||(rt(i,l)&&xe(r,"get",i),xe(r,"get",l));const{has:a}=js(r),d=t?Rn:e?ts:Xe;if(a.call(r,i))return d(o.get(i));if(a.call(r,l))return d(o.get(l));o!==r&&o.get(i)},get size(){const i=this.__v_raw;return!e&&xe(te(i),"iterate",Ut),i.size},has(i){const o=this.__v_raw,r=te(o),l=te(i);return e||(rt(i,l)&&xe(r,"has",i),xe(r,"has",l)),i===l?o.has(i):o.has(i)||o.has(l)},forEach(i,o){const r=this,l=r.__v_raw,a=te(l),d=t?Rn:e?ts:Xe;return!e&&xe(a,"iterate",Ut),l.forEach((c,p)=>i.call(o,d(c),d(p),r))}};return ye(s,e?{add:Ms("add"),set:Ms("set"),delete:Ms("delete"),clear:Ms("clear")}:{add(i){const o=te(this),r=js(o),l=te(i),a=!t&&!Ke(i)&&!yt(i)?l:i;return r.has.call(o,a)||rt(i,a)&&r.has.call(o,i)||rt(l,a)&&r.has.call(o,l)||(o.add(a),gt(o,"add",a,a)),this},set(i,o){!t&&!Ke(o)&&!yt(o)&&(o=te(o));const r=te(this),{has:l,get:a}=js(r);let d=l.call(r,i);d||(i=te(i),d=l.call(r,i));const c=a.call(r,i);return r.set(i,o),d?rt(o,c)&&gt(r,"set",i,o):gt(r,"add",i,o),this},delete(i){const o=te(this),{has:r,get:l}=js(o);let a=r.call(o,i);a||(i=te(i),a=r.call(o,i)),l&&l.call(o,i);const d=o.delete(i);return a&&gt(o,"delete",i,void 0),d},clear(){const i=te(this),o=i.size!==0,r=i.clear();return o&&gt(i,"clear",void 0,void 0),r}}),["keys","values","entries",Symbol.iterator].forEach(i=>{s[i]=_l(i,e,t)}),s}function Qn(e,t){const s=gl(e,t);return(n,i,o)=>i==="__v_isReactive"?!e:i==="__v_isReadonly"?e:i==="__v_raw"?n:Reflect.get(oe(s,i)&&i in n?s:n,i,o)}const ml={get:Qn(!1,!1)},vl={get:Qn(!1,!0)},bl={get:Qn(!0,!1)};const jo=new WeakMap,Mo=new WeakMap,Do=new WeakMap,yl=new WeakMap;function Al(e){switch(e){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function Sl(e){return e.__v_skip||!Object.isExtensible(e)?0:Al(Wr(e))}function tn(e){return yt(e)?e:Yn(e,!1,dl,ml,jo)}function $o(e){return Yn(e,!1,hl,vl,Mo)}function Tn(e){return Yn(e,!0,fl,bl,Do)}function Yn(e,t,s,n,i){if(!re(e)||e.__v_raw&&!(t&&e.__v_isReactive))return e;const o=Sl(e);if(o===0)return e;const r=i.get(e);if(r)return r;const l=new Proxy(e,o===2?n:s);return i.set(e,l),l}function Lt(e){return yt(e)?Lt(e.__v_raw):!!(e&&e.__v_isReactive)}function yt(e){return!!(e&&e.__v_isReadonly)}function Ke(e){return!!(e&&e.__v_isShallow)}function Zn(e){return e?!!e.__v_raw:!1}function te(e){const t=e&&e.__v_raw;return t?te(t):e}function El(e){return!oe(e,"__v_skip")&&Object.isExtensible(e)&&mo(e,"__v_skip",!0),e}const Xe=e=>re(e)?tn(e):e,ts=e=>re(e)?Tn(e):e;function we(e){return e?e.__v_isRef===!0:!1}function Me(e){return No(e,!1)}function Cl(e){return No(e,!0)}function No(e,t){return we(e)?e:new xl(e,t)}class xl{constructor(t,s){this.dep=new Jn,this.__v_isRef=!0,this.__v_isShallow=!1,this._rawValue=s?t:te(t),this._value=s?t:Xe(t),this.__v_isShallow=s}get value(){return this.dep.track(),this._value}set value(t){const s=this._rawValue,n=this.__v_isShallow||Ke(t)||yt(t);t=n?t:te(t),rt(t,s)&&(this._rawValue=t,this._value=n?t:Xe(t),this.dep.trigger())}}function Ce(e){return we(e)?e.value:e}const Il={get:(e,t,s)=>t==="__v_raw"?e:Ce(Reflect.get(e,t,s)),set:(e,t,s,n)=>{const i=e[t];return we(i)&&!we(s)?(i.value=s,!0):Reflect.set(e,t,s,n)}};function ko(e){return Lt(e)?e:new Proxy(e,Il)}class wl{constructor(t,s,n){this.fn=t,this.setter=s,this._value=void 0,this.dep=new Jn(this),this.__v_isRef=!0,this.deps=void 0,this.depsTail=void 0,this.flags=16,this.globalVersion=As-1,this.next=void 0,this.effect=this,this.__v_isReadonly=!s,this.isSSR=n}notify(){if(this.flags|=16,!(this.flags&8)&&ue!==this)return Eo(this,!0),!0}get value(){const t=this.dep.track();return Io(this),t&&(t.version=this.dep.version),this._value}set value(t){this.setter&&this.setter(t)}}function Pl(e,t,s=!1){let n,i;return W(e)?n=e:(n=e.get,i=e.set),new wl(n,i,s)}const Ds={},Bs=new WeakMap;let $t;function Rl(e,t=!1,s=$t){if(s){let n=Bs.get(s);n||Bs.set(s,n=[]),n.push(e)}}function Tl(e,t,s=de){const{immediate:n,deep:i,once:o,scheduler:r,augmentJob:l,call:a}=s,d=O=>i?O:Ke(O)||i===!1||i===0?wt(O,1):wt(O);let c,p,h,_,C=!1,E=!1;if(we(e)?(p=()=>e.value,C=Ke(e)):Lt(e)?(p=()=>d(e),C=!0):H(e)?(E=!0,C=e.some(O=>Lt(O)||Ke(O)),p=()=>e.map(O=>{if(we(O))return O.value;if(Lt(O))return d(O);if(W(O))return a?a(O,2):O()})):W(e)?t?p=a?()=>a(e,2):e:p=()=>{if(h){vt();try{h()}finally{bt()}}const O=$t;$t=c;try{return a?a(e,3,[_]):e(_)}finally{$t=O}}:p=lt,t&&i){const O=p,q=i===!0?1/0:i;p=()=>wt(O(),q)}const M=il(),w=()=>{c.stop(),M&&M.active&&Vn(M.effects,c)};if(o&&t){const O=t;t=(...q)=>{O(...q),w()}}let x=E?new Array(e.length).fill(Ds):Ds;const D=O=>{if(!(!(c.flags&1)||!c.dirty&&!O))if(t){const q=c.run();if(i||C||(E?q.some((Y,Q)=>rt(Y,x[Q])):rt(q,x))){h&&h();const Y=$t;$t=c;try{const Q=[q,x===Ds?void 0:E&&x[0]===Ds?[]:x,_];x=q,a?a(t,3,Q):t(...Q)}finally{$t=Y}}}else c.run()};return l&&l(D),c=new Ao(p),c.scheduler=r?()=>r(D,!1):D,_=O=>Rl(O,!1,c),h=c.onStop=()=>{const O=Bs.get(c);if(O){if(a)a(O,4);else for(const q of O)q();Bs.delete(c)}},t?n?D(!0):x=c.run():r?r(D.bind(null,!0),!0):c.run(),w.pause=c.pause.bind(c),w.resume=c.resume.bind(c),w.stop=w,w}function wt(e,t=1/0,s){if(t<=0||!re(e)||e.__v_skip||(s=s||new Map,(s.get(e)||0)>=t))return e;if(s.set(e,t),t--,we(e))wt(e.value,t,s);else if(H(e))for(let n=0;n<e.length;n++)wt(e[n],t,s);else if(fo(e)||Qt(e))e.forEach(n=>{wt(n,t,s)});else if(go(e)){for(const n in e)wt(e[n],t,s);for(const n of Object.getOwnPropertySymbols(e))Object.prototype.propertyIsEnumerable.call(e,n)&&wt(e[n],t,s)}return e}function Ts(e,t,s,n){try{return n?e(...n):e()}catch(i){sn(i,t,s)}}function ze(e,t,s,n){if(W(e)){const i=Ts(e,t,s,n);return i&&ho(i)&&i.catch(o=>{sn(o,t,s)}),i}if(H(e)){const i=[];for(let o=0;o<e.length;o++)i.push(ze(e[o],t,s,n));return i}}function sn(e,t,s,n=!0){const i=t?t.vnode:null,{errorHandler:o,throwUnhandledErrorInProduction:r}=t&&t.appContext.config||de;if(t){let l=t.parent;const a=t.proxy,d=`https://vuejs.org/error-reference/#runtime-${s}`;for(;l;){const c=l.ec;if(c){for(let p=0;p<c.length;p++)if(c[p](e,a,d)===!1)return}l=l.parent}if(o){vt(),Ts(o,null,10,[e,a,d]),bt();return}}Ol(e,s,i,n,r)}function Ol(e,t,s,n=!0,i=!1){if(i)throw e;console.error(e)}const Te=[];let st=-1;const Yt=[];let xt=null,Gt=0;const Uo=Promise.resolve();let Fs=null;function ss(e){const t=Fs||Uo;return e?t.then(this?e.bind(this):e):t}function jl(e){let t=st+1,s=Te.length;for(;t<s;){const n=t+s>>>1,i=Te[n],o=Es(i);o<e||o===e&&i.flags&2?t=n+1:s=n}return t}function ei(e){if(!(e.flags&1)){const t=Es(e),s=Te[Te.length-1];!s||!(e.flags&2)&&t>=Es(s)?Te.push(e):Te.splice(jl(t),0,e),e.flags|=1,Lo()}}function Lo(){Fs||(Fs=Uo.then(Fo))}function Ml(e){H(e)?Yt.push(...e):xt&&e.id===-1?xt.splice(Gt+1,0,e):e.flags&1||(Yt.push(e),e.flags|=1),Lo()}function gi(e,t,s=st+1){for(;s<Te.length;s++){const n=Te[s];if(n&&n.flags&2){if(e&&n.id!==e.uid)continue;Te.splice(s,1),s--,n.flags&4&&(n.flags&=-2),n(),n.flags&4||(n.flags&=-2)}}}function Bo(e){if(Yt.length){const t=[...new Set(Yt)].sort((s,n)=>Es(s)-Es(n));if(Yt.length=0,xt){xt.push(...t);return}for(xt=t,Gt=0;Gt<xt.length;Gt++){const s=xt[Gt];s.flags&4&&(s.flags&=-2),s.flags&8||s(),s.flags&=-2}xt=null,Gt=0}}const Es=e=>e.id==null?e.flags&2?-1:1/0:e.id;function Fo(e){try{for(st=0;st<Te.length;st++){const t=Te[st];t&&!(t.flags&8)&&(t.flags&4&&(t.flags&=-2),Ts(t,t.i,t.i?15:14),t.flags&4||(t.flags&=-2))}}finally{for(;st<Te.length;st++){const t=Te[st];t&&(t.flags&=-2)}st=-1,Te.length=0,Bo(),Fs=null,(Te.length||Yt.length)&&Fo()}}let qe=null,Ho=null;function Hs(e){const t=qe;return qe=e,Ho=e&&e.type.__scopeId||null,t}function ge(e,t=qe,s){if(!t||e._n)return e;const n=(...i)=>{n._d&&Ws(-1);const o=Hs(t);let r;try{r=e(...i)}finally{Hs(o),n._d&&Ws(1)}return r};return n._n=!0,n._c=!0,n._d=!0,n}function Ot(e,t,s,n){const i=e.dirs,o=t&&t.dirs;for(let r=0;r<i.length;r++){const l=i[r];o&&(l.oldValue=o[r].value);let a=l.dir[n];a&&(vt(),ze(a,s,8,[e.el,l,e,t]),bt())}}function $s(e,t){if(Ie){let s=Ie.provides;const n=Ie.parent&&Ie.parent.provides;n===s&&(s=Ie.provides=Object.create(n)),s[e]=t}}function at(e,t,s=!1){const n=Cr();if(n||Zt){let i=Zt?Zt._context.provides:n?n.parent==null||n.ce?n.vnode.appContext&&n.vnode.appContext.provides:n.parent.provides:void 0;if(i&&e in i)return i[e];if(arguments.length>1)return s&&W(t)?t.call(n&&n.proxy):t}}const Dl=Symbol.for("v-scx"),$l=()=>at(Dl);function Bt(e,t,s){return Vo(e,t,s)}function Vo(e,t,s=de){const{immediate:n,deep:i,flush:o,once:r}=s,l=ye({},s),a=t&&n||!t&&o!=="post";let d;if(Is){if(o==="sync"){const _=$l();d=_.__watcherHandles||(_.__watcherHandles=[])}else if(!a){const _=()=>{};return _.stop=lt,_.resume=lt,_.pause=lt,_}}const c=Ie;l.call=(_,C,E)=>ze(_,c,C,E);let p=!1;o==="post"?l.scheduler=_=>{Ne(_,c&&c.suspense)}:o!=="sync"&&(p=!0,l.scheduler=(_,C)=>{C?_():ei(_)}),l.augmentJob=_=>{t&&(_.flags|=4),p&&(_.flags|=2,c&&(_.id=c.uid,_.i=c))};const h=Tl(e,t,l);return Is&&(d?d.push(h):a&&h()),h}function Nl(e,t,s){const n=this.proxy,i=he(e)?e.includes(".")?Ko(n,e):()=>n[e]:e.bind(n,n);let o;W(t)?o=t:(o=t.handler,s=t);const r=Os(this),l=Vo(i,o.bind(n),s);return r(),l}function Ko(e,t){const s=t.split(".");return()=>{let n=e;for(let i=0;i<s.length&&n;i++)n=n[s[i]];return n}}const kl=Symbol("_vte"),Wo=e=>e.__isTeleport,nt=Symbol("_leaveCb"),as=Symbol("_enterCb");function Ul(){const e={isMounted:!1,isLeaving:!1,isUnmounting:!1,leavingVNodes:new Map};return Ht(()=>{e.isMounted=!0}),er(()=>{e.isUnmounting=!0}),e}const Ve=[Function,Array],qo={mode:String,appear:Boolean,persisted:Boolean,onBeforeEnter:Ve,onEnter:Ve,onAfterEnter:Ve,onEnterCancelled:Ve,onBeforeLeave:Ve,onLeave:Ve,onAfterLeave:Ve,onLeaveCancelled:Ve,onBeforeAppear:Ve,onAppear:Ve,onAfterAppear:Ve,onAppearCancelled:Ve},Go=e=>{const t=e.subTree;return t.component?Go(t.component):t},Ll={name:"BaseTransition",props:qo,setup(e,{slots:t}){const s=Cr(),n=Ul();return()=>{const i=t.default&&Jo(t.default(),!0);if(!i||!i.length)return;const o=Xo(i),r=te(e),{mode:l}=r;if(n.isLeaving)return gn(o);const a=mi(o);if(!a)return gn(o);let d=On(a,r,n,s,p=>d=p);a.type!==Oe&&Cs(a,d);let c=s.subTree&&mi(s.subTree);if(c&&c.type!==Oe&&!Nt(c,a)&&Go(s).type!==Oe){let p=On(c,r,n,s);if(Cs(c,p),l==="out-in"&&a.type!==Oe)return n.isLeaving=!0,p.afterLeave=()=>{n.isLeaving=!1,s.job.flags&8||s.update(),delete p.afterLeave,c=void 0},gn(o);l==="in-out"&&a.type!==Oe?p.delayLeave=(h,_,C)=>{const E=zo(n,c);E[String(c.key)]=c,h[nt]=()=>{_(),h[nt]=void 0,delete d.delayedLeave,c=void 0},d.delayedLeave=()=>{C(),delete d.delayedLeave,c=void 0}}:c=void 0}else c&&(c=void 0);return o}}};function Xo(e){let t=e[0];if(e.length>1){for(const s of e)if(s.type!==Oe){t=s;break}}return t}const Bl=Ll;function zo(e,t){const{leavingVNodes:s}=e;let n=s.get(t.type);return n||(n=Object.create(null),s.set(t.type,n)),n}function On(e,t,s,n,i){const{appear:o,mode:r,persisted:l=!1,onBeforeEnter:a,onEnter:d,onAfterEnter:c,onEnterCancelled:p,onBeforeLeave:h,onLeave:_,onAfterLeave:C,onLeaveCancelled:E,onBeforeAppear:M,onAppear:w,onAfterAppear:x,onAppearCancelled:D}=t,O=String(e.key),q=zo(s,e),Y=(V,X)=>{V&&ze(V,n,9,X)},Q=(V,X)=>{const le=X[1];Y(V,X),H(V)?V.every($=>$.length<=1)&&le():V.length<=1&&le()},Ae={mode:r,persisted:l,beforeEnter(V){let X=a;if(!s.isMounted)if(o)X=M||a;else return;V[nt]&&V[nt](!0);const le=q[O];le&&Nt(e,le)&&le.el[nt]&&le.el[nt](),Y(X,[V])},enter(V){if(q[O]===e)return;let X=d,le=c,$=p;if(!s.isMounted)if(o)X=w||d,le=x||c,$=D||p;else return;let se=!1;V[as]=Le=>{se||(se=!0,Le?Y($,[V]):Y(le,[V]),Ae.delayedLeave&&Ae.delayedLeave(),V[as]=void 0)};const Se=V[as].bind(null,!1);X?Q(X,[V,Se]):Se()},leave(V,X){const le=String(e.key);if(V[as]&&V[as](!0),s.isUnmounting)return X();Y(h,[V]);let $=!1;V[nt]=Se=>{$||($=!0,X(),Se?Y(E,[V]):Y(C,[V]),V[nt]=void 0,q[le]===e&&delete q[le])};const se=V[nt].bind(null,!1);q[le]=e,_?Q(_,[V,se]):se()},clone(V){const X=On(V,t,s,n,i);return i&&i(X),X}};return Ae}function gn(e){if(nn(e))return e=Rt(e),e.children=null,e}function mi(e){if(!nn(e))return Wo(e.type)&&e.children?Xo(e.children):e;if(e.component)return e.component.subTree;const{shapeFlag:t,children:s}=e;if(s){if(t&16)return s[0];if(t&32&&W(s.default))return s.default()}}function Cs(e,t){e.shapeFlag&6&&e.component?(e.transition=t,Cs(e.component.subTree,t)):e.shapeFlag&128?(e.ssContent.transition=t.clone(e.ssContent),e.ssFallback.transition=t.clone(e.ssFallback)):e.transition=t}function Jo(e,t=!1,s){let n=[],i=0;for(let o=0;o<e.length;o++){let r=e[o];const l=s==null?r.key:String(s)+String(r.key!=null?r.key:o);r.type===ee?(r.patchFlag&128&&i++,n=n.concat(Jo(r.children,t,l))):(t||r.type!==Oe)&&n.push(l!=null?Rt(r,{key:l}):r)}if(i>1)for(let o=0;o<n.length;o++)n[o].patchFlag=-2;return n}function Qo(e,t){return W(e)?ye({name:e.name},t,{setup:e}):e}function Yo(e){e.ids=[e.ids[0]+e.ids[2]+++"-",0,0]}function vi(e,t){let s;return!!((s=Object.getOwnPropertyDescriptor(e,t))&&!s.configurable)}const Vs=new WeakMap;function _s(e,t,s,n,i=!1){if(H(e)){e.forEach((E,M)=>_s(E,t&&(H(t)?t[M]:t),s,n,i));return}if(gs(n)&&!i){n.shapeFlag&512&&n.type.__asyncResolved&&n.component.subTree.component&&_s(e,t,s,n.component.subTree);return}const o=n.shapeFlag&4?ii(n.component):n.el,r=i?null:o,{i:l,r:a}=e,d=t&&t.r,c=l.refs===de?l.refs={}:l.refs,p=l.setupState,h=te(p),_=p===de?uo:E=>vi(c,E)?!1:oe(h,E),C=(E,M)=>!(M&&vi(c,M));if(d!=null&&d!==a){if(bi(t),he(d))c[d]=null,_(d)&&(p[d]=null);else if(we(d)){const E=t;C(d,E.k)&&(d.value=null),E.k&&(c[E.k]=null)}}if(W(a))Ts(a,l,12,[r,c]);else{const E=he(a),M=we(a);if(E||M){const w=()=>{if(e.f){const x=E?_(a)?p[a]:c[a]:C()||!e.k?a.value:c[e.k];if(i)H(x)&&Vn(x,o);else if(H(x))x.includes(o)||x.push(o);else if(E)c[a]=[o],_(a)&&(p[a]=c[a]);else{const D=[o];C(a,e.k)&&(a.value=D),e.k&&(c[e.k]=D)}}else E?(c[a]=r,_(a)&&(p[a]=r)):M&&(C(a,e.k)&&(a.value=r),e.k&&(c[e.k]=r))};if(r){const x=()=>{w(),Vs.delete(e)};x.id=-1,Vs.set(e,x),Ne(x,s)}else bi(e),w()}}}function bi(e){const t=Vs.get(e);t&&(t.flags|=8,Vs.delete(e))}Zs().requestIdleCallback;Zs().cancelIdleCallback;const gs=e=>!!e.type.__asyncLoader,nn=e=>e.type.__isKeepAlive;function Fl(e,t){Zo(e,"a",t)}function Hl(e,t){Zo(e,"da",t)}function Zo(e,t,s=Ie){const n=e.__wdc||(e.__wdc=()=>{let i=s;for(;i;){if(i.isDeactivated)return;i=i.parent}return e()});if(on(t,n,s),s){let i=s.parent;for(;i&&i.parent;)nn(i.parent.vnode)&&Vl(n,t,s,i),i=i.parent}}function Vl(e,t,s,n){const i=on(t,e,n,!0);Vt(()=>{Vn(n[t],i)},s)}function on(e,t,s=Ie,n=!1){if(s){const i=s[e]||(s[e]=[]),o=t.__weh||(t.__weh=(...r)=>{vt();const l=Os(s),a=ze(t,s,e,r);return l(),bt(),a});return n?i.unshift(o):i.push(o),o}}const At=e=>(t,s=Ie)=>{(!Is||e==="sp")&&on(e,(...n)=>t(...n),s)},Kl=At("bm"),Ht=At("m"),Wl=At("bu"),ql=At("u"),er=At("bum"),Vt=At("um"),Gl=At("sp"),Xl=At("rtg"),zl=At("rtc");function Jl(e,t=Ie){on("ec",e,t)}const tr="components";function os(e,t){return nr(tr,e,!0,t)||e}const sr=Symbol.for("v-ndc");function Ql(e){return he(e)?nr(tr,e,!1)||e:e||sr}function nr(e,t,s=!0,n=!1){const i=qe||Ie;if(i){const o=i.type;{const l=$a(o,!1);if(l&&(l===t||l===De(t)||l===Ys(De(t))))return o}const r=yi(i[e]||o[e],t)||yi(i.appContext[e],t);return!r&&n?o:r}}function yi(e,t){return e&&(e[t]||e[De(t)]||e[Ys(De(t))])}function me(e,t,s,n){let i;const o=s,r=H(e);if(r||he(e)){const l=r&&Lt(e);let a=!1,d=!1;l&&(a=!Ke(e),d=yt(e),e=en(e)),i=new Array(e.length);for(let c=0,p=e.length;c<p;c++)i[c]=t(a?d?ts(Xe(e[c])):Xe(e[c]):e[c],c,void 0,o)}else if(typeof e=="number"){i=new Array(e);for(let l=0;l<e;l++)i[l]=t(l+1,l,void 0,o)}else if(re(e))if(e[Symbol.iterator])i=Array.from(e,(l,a)=>t(l,a,void 0,o));else{const l=Object.keys(e);i=new Array(l.length);for(let a=0,d=l.length;a<d;a++){const c=l[a];i[a]=t(e[c],c,a,o)}}else i=[];return i}const jn=e=>e?xr(e)?ii(e):jn(e.parent):null,ms=ye(Object.create(null),{$:e=>e,$el:e=>e.vnode.el,$data:e=>e.data,$props:e=>e.props,$attrs:e=>e.attrs,$slots:e=>e.slots,$refs:e=>e.refs,$parent:e=>jn(e.parent),$root:e=>jn(e.root),$host:e=>e.ce,$emit:e=>e.emit,$options:e=>or(e),$forceUpdate:e=>e.f||(e.f=()=>{ei(e.update)}),$nextTick:e=>e.n||(e.n=ss.bind(e.proxy)),$watch:e=>Nl.bind(e)}),mn=(e,t)=>e!==de&&!e.__isScriptSetup&&oe(e,t),Yl={get({_:e},t){if(t==="__v_skip")return!0;const{ctx:s,setupState:n,data:i,props:o,accessCache:r,type:l,appContext:a}=e;if(t[0]!=="$"){const h=r[t];if(h!==void 0)switch(h){case 1:return n[t];case 2:return i[t];case 4:return s[t];case 3:return o[t]}else{if(mn(n,t))return r[t]=1,n[t];if(i!==de&&oe(i,t))return r[t]=2,i[t];if(oe(o,t))return r[t]=3,o[t];if(s!==de&&oe(s,t))return r[t]=4,s[t];Mn&&(r[t]=0)}}const d=ms[t];let c,p;if(d)return t==="$attrs"&&xe(e.attrs,"get",""),d(e);if((c=l.__cssModules)&&(c=c[t]))return c;if(s!==de&&oe(s,t))return r[t]=4,s[t];if(p=a.config.globalProperties,oe(p,t))return p[t]},set({_:e},t,s){const{data:n,setupState:i,ctx:o}=e;return mn(i,t)?(i[t]=s,!0):n!==de&&oe(n,t)?(n[t]=s,!0):oe(e.props,t)||t[0]==="$"&&t.slice(1)in e?!1:(o[t]=s,!0)},has({_:{data:e,setupState:t,accessCache:s,ctx:n,appContext:i,props:o,type:r}},l){let a;return!!(s[l]||e!==de&&l[0]!=="$"&&oe(e,l)||mn(t,l)||oe(o,l)||oe(n,l)||oe(ms,l)||oe(i.config.globalProperties,l)||(a=r.__cssModules)&&a[l])},defineProperty(e,t,s){return s.get!=null?e._.accessCache[t]=0:oe(s,"value")&&this.set(e,t,s.value,null),Reflect.defineProperty(e,t,s)}};function Ai(e){return H(e)?e.reduce((t,s)=>(t[s]=null,t),{}):e}let Mn=!0;function Zl(e){const t=or(e),s=e.proxy,n=e.ctx;Mn=!1,t.beforeCreate&&Si(t.beforeCreate,e,"bc");const{data:i,computed:o,methods:r,watch:l,provide:a,inject:d,created:c,beforeMount:p,mounted:h,beforeUpdate:_,updated:C,activated:E,deactivated:M,beforeDestroy:w,beforeUnmount:x,destroyed:D,unmounted:O,render:q,renderTracked:Y,renderTriggered:Q,errorCaptured:Ae,serverPrefetch:V,expose:X,inheritAttrs:le,components:$,directives:se,filters:Se}=t;if(d&&ea(d,n,null),r)for(const ae in r){const ne=r[ae];W(ne)&&(n[ae]=ne.bind(s))}if(i){const ae=i.call(s,s);re(ae)&&(e.data=tn(ae))}if(Mn=!0,o)for(const ae in o){const ne=o[ae],pt=W(ne)?ne.bind(s,s):W(ne.get)?ne.get.bind(s,s):lt,St=!W(ne)&&W(ne.set)?ne.set.bind(s):lt,Qe=je({get:pt,set:St});Object.defineProperty(n,ae,{enumerable:!0,configurable:!0,get:()=>Qe.value,set:$e=>Qe.value=$e})}if(l)for(const ae in l)ir(l[ae],n,s,ae);if(a){const ae=W(a)?a.call(s):a;Reflect.ownKeys(ae).forEach(ne=>{$s(ne,ae[ne])})}c&&Si(c,e,"c");function _e(ae,ne){H(ne)?ne.forEach(pt=>ae(pt.bind(s))):ne&&ae(ne.bind(s))}if(_e(Kl,p),_e(Ht,h),_e(Wl,_),_e(ql,C),_e(Fl,E),_e(Hl,M),_e(Jl,Ae),_e(zl,Y),_e(Xl,Q),_e(er,x),_e(Vt,O),_e(Gl,V),H(X))if(X.length){const ae=e.exposed||(e.exposed={});X.forEach(ne=>{Object.defineProperty(ae,ne,{get:()=>s[ne],set:pt=>s[ne]=pt,enumerable:!0})})}else e.exposed||(e.exposed={});q&&e.render===lt&&(e.render=q),le!=null&&(e.inheritAttrs=le),$&&(e.components=$),se&&(e.directives=se),V&&Yo(e)}function ea(e,t,s=lt){H(e)&&(e=Dn(e));for(const n in e){const i=e[n];let o;re(i)?"default"in i?o=at(i.from||n,i.default,!0):o=at(i.from||n):o=at(i),we(o)?Object.defineProperty(t,n,{enumerable:!0,configurable:!0,get:()=>o.value,set:r=>o.value=r}):t[n]=o}}function Si(e,t,s){ze(H(e)?e.map(n=>n.bind(t.proxy)):e.bind(t.proxy),t,s)}function ir(e,t,s,n){let i=n.includes(".")?Ko(s,n):()=>s[n];if(he(e)){const o=t[e];W(o)&&Bt(i,o)}else if(W(e))Bt(i,e.bind(s));else if(re(e))if(H(e))e.forEach(o=>ir(o,t,s,n));else{const o=W(e.handler)?e.handler.bind(s):t[e.handler];W(o)&&Bt(i,o,e)}}function or(e){const t=e.type,{mixins:s,extends:n}=t,{mixins:i,optionsCache:o,config:{optionMergeStrategies:r}}=e.appContext,l=o.get(t);let a;return l?a=l:!i.length&&!s&&!n?a=t:(a={},i.length&&i.forEach(d=>Ks(a,d,r,!0)),Ks(a,t,r)),re(t)&&o.set(t,a),a}function Ks(e,t,s,n=!1){const{mixins:i,extends:o}=t;o&&Ks(e,o,s,!0),i&&i.forEach(r=>Ks(e,r,s,!0));for(const r in t)if(!(n&&r==="expose")){const l=ta[r]||s&&s[r];e[r]=l?l(e[r],t[r]):t[r]}return e}const ta={data:Ei,props:Ci,emits:Ci,methods:us,computed:us,beforeCreate:Pe,created:Pe,beforeMount:Pe,mounted:Pe,beforeUpdate:Pe,updated:Pe,beforeDestroy:Pe,beforeUnmount:Pe,destroyed:Pe,unmounted:Pe,activated:Pe,deactivated:Pe,errorCaptured:Pe,serverPrefetch:Pe,components:us,directives:us,watch:na,provide:Ei,inject:sa};function Ei(e,t){return t?e?function(){return ye(W(e)?e.call(this,this):e,W(t)?t.call(this,this):t)}:t:e}function sa(e,t){return us(Dn(e),Dn(t))}function Dn(e){if(H(e)){const t={};for(let s=0;s<e.length;s++)t[e[s]]=e[s];return t}return e}function Pe(e,t){return e?[...new Set([].concat(e,t))]:t}function us(e,t){return e?ye(Object.create(null),e,t):t}function Ci(e,t){return e?H(e)&&H(t)?[...new Set([...e,...t])]:ye(Object.create(null),Ai(e),Ai(t??{})):t}function na(e,t){if(!e)return t;if(!t)return e;const s=ye(Object.create(null),e);for(const n in t)s[n]=Pe(e[n],t[n]);return s}function rr(){return{app:null,config:{isNativeTag:uo,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let ia=0;function oa(e,t){return function(n,i=null){W(n)||(n=ye({},n)),i!=null&&!re(i)&&(i=null);const o=rr(),r=new WeakSet,l=[];let a=!1;const d=o.app={_uid:ia++,_component:n,_props:i,_container:null,_context:o,_instance:null,version:ka,get config(){return o.config},set config(c){},use(c,...p){return r.has(c)||(c&&W(c.install)?(r.add(c),c.install(d,...p)):W(c)&&(r.add(c),c(d,...p))),d},mixin(c){return o.mixins.includes(c)||o.mixins.push(c),d},component(c,p){return p?(o.components[c]=p,d):o.components[c]},directive(c,p){return p?(o.directives[c]=p,d):o.directives[c]},mount(c,p,h){if(!a){const _=d._ceVNode||G(n,i);return _.appContext=o,h===!0?h="svg":h===!1&&(h=void 0),e(_,c,h),a=!0,d._container=c,c.__vue_app__=d,ii(_.component)}},onUnmount(c){l.push(c)},unmount(){a&&(ze(l,d._instance,16),e(null,d._container),delete d._container.__vue_app__)},provide(c,p){return o.provides[c]=p,d},runWithContext(c){const p=Zt;Zt=d;try{return c()}finally{Zt=p}}};return d}}let Zt=null;const ra=(e,t)=>t==="modelValue"||t==="model-value"?e.modelModifiers:e[`${t}Modifiers`]||e[`${De(t)}Modifiers`]||e[`${Ft(t)}Modifiers`];function la(e,t,...s){if(e.isUnmounted)return;const n=e.vnode.props||de;let i=s;const o=t.startsWith("update:"),r=o&&ra(n,t.slice(7));r&&(r.trim&&(i=s.map(c=>he(c)?c.trim():c)),r.number&&(i=s.map(Xr)));let l,a=n[l=pn(t)]||n[l=pn(De(t))];!a&&o&&(a=n[l=pn(Ft(t))]),a&&ze(a,e,6,i);const d=n[l+"Once"];if(d){if(!e.emitted)e.emitted={};else if(e.emitted[l])return;e.emitted[l]=!0,ze(d,e,6,i)}}const aa=new WeakMap;function lr(e,t,s=!1){const n=s?aa:t.emitsCache,i=n.get(e);if(i!==void 0)return i;const o=e.emits;let r={},l=!1;if(!W(e)){const a=d=>{const c=lr(d,t,!0);c&&(l=!0,ye(r,c))};!s&&t.mixins.length&&t.mixins.forEach(a),e.extends&&a(e.extends),e.mixins&&e.mixins.forEach(a)}return!o&&!l?(re(e)&&n.set(e,null),null):(H(o)?o.forEach(a=>r[a]=null):ye(r,o),re(e)&&n.set(e,r),r)}function rn(e,t){return!e||!zs(t)?!1:(t=t.slice(2).replace(/Once$/,""),oe(e,t[0].toLowerCase()+t.slice(1))||oe(e,Ft(t))||oe(e,t))}function xi(e){const{type:t,vnode:s,proxy:n,withProxy:i,propsOptions:[o],slots:r,attrs:l,emit:a,render:d,renderCache:c,props:p,data:h,setupState:_,ctx:C,inheritAttrs:E}=e,M=Hs(e);let w,x;try{if(s.shapeFlag&4){const O=i||n,q=O;w=ot(d.call(q,O,c,p,_,h,C)),x=l}else{const O=t;w=ot(O.length>1?O(p,{attrs:l,slots:r,emit:a}):O(p,null)),x=t.props?l:ca(l)}}catch(O){vs.length=0,sn(O,e,1),w=G(Oe)}let D=w;if(x&&E!==!1){const O=Object.keys(x),{shapeFlag:q}=D;O.length&&q&7&&(o&&O.some(Js)&&(x=pa(x,o)),D=Rt(D,x,!1,!0))}return s.dirs&&(D=Rt(D,null,!1,!0),D.dirs=D.dirs?D.dirs.concat(s.dirs):s.dirs),s.transition&&Cs(D,s.transition),w=D,Hs(M),w}const ca=e=>{let t;for(const s in e)(s==="class"||s==="style"||zs(s))&&((t||(t={}))[s]=e[s]);return t},pa=(e,t)=>{const s={};for(const n in e)(!Js(n)||!(n.slice(9)in t))&&(s[n]=e[n]);return s};function ua(e,t,s){const{props:n,children:i,component:o}=e,{props:r,children:l,patchFlag:a}=t,d=o.emitsOptions;if(t.dirs||t.transition)return!0;if(s&&a>=0){if(a&1024)return!0;if(a&16)return n?Ii(n,r,d):!!r;if(a&8){const c=t.dynamicProps;for(let p=0;p<c.length;p++){const h=c[p];if(ar(r,n,h)&&!rn(d,h))return!0}}}else return(i||l)&&(!l||!l.$stable)?!0:n===r?!1:n?r?Ii(n,r,d):!0:!!r;return!1}function Ii(e,t,s){const n=Object.keys(t);if(n.length!==Object.keys(e).length)return!0;for(let i=0;i<n.length;i++){const o=n[i];if(ar(t,e,o)&&!rn(s,o))return!0}return!1}function ar(e,t,s){const n=e[s],i=t[s];return s==="style"&&re(n)&&re(i)?!qn(n,i):n!==i}function da({vnode:e,parent:t,suspense:s},n){for(;t;){const i=t.subTree;if(i.suspense&&i.suspense.activeBranch===e&&(i.suspense.vnode.el=i.el=n,e=i),i===e)(e=t.vnode).el=n,t=t.parent;else break}s&&s.activeBranch===e&&(s.vnode.el=n)}const cr={},pr=()=>Object.create(cr),ur=e=>Object.getPrototypeOf(e)===cr;function fa(e,t,s,n=!1){const i={},o=pr();e.propsDefaults=Object.create(null),dr(e,t,i,o);for(const r in e.propsOptions[0])r in i||(i[r]=void 0);s?e.props=n?i:$o(i):e.type.props?e.props=i:e.props=o,e.attrs=o}function ha(e,t,s,n){const{props:i,attrs:o,vnode:{patchFlag:r}}=e,l=te(i),[a]=e.propsOptions;let d=!1;if((n||r>0)&&!(r&16)){if(r&8){const c=e.vnode.dynamicProps;for(let p=0;p<c.length;p++){let h=c[p];if(rn(e.emitsOptions,h))continue;const _=t[h];if(a)if(oe(o,h))_!==o[h]&&(o[h]=_,d=!0);else{const C=De(h);i[C]=$n(a,l,C,_,e,!1)}else _!==o[h]&&(o[h]=_,d=!0)}}}else{dr(e,t,i,o)&&(d=!0);let c;for(const p in l)(!t||!oe(t,p)&&((c=Ft(p))===p||!oe(t,c)))&&(a?s&&(s[p]!==void 0||s[c]!==void 0)&&(i[p]=$n(a,l,p,void 0,e,!0)):delete i[p]);if(o!==l)for(const p in o)(!t||!oe(t,p))&&(delete o[p],d=!0)}d&&gt(e.attrs,"set","")}function dr(e,t,s,n){const[i,o]=e.propsOptions;let r=!1,l;if(t)for(let a in t){if(ds(a))continue;const d=t[a];let c;i&&oe(i,c=De(a))?!o||!o.includes(c)?s[c]=d:(l||(l={}))[c]=d:rn(e.emitsOptions,a)||(!(a in n)||d!==n[a])&&(n[a]=d,r=!0)}if(o){const a=te(s),d=l||de;for(let c=0;c<o.length;c++){const p=o[c];s[p]=$n(i,a,p,d[p],e,!oe(d,p))}}return r}function $n(e,t,s,n,i,o){const r=e[s];if(r!=null){const l=oe(r,"default");if(l&&n===void 0){const a=r.default;if(r.type!==Function&&!r.skipFactory&&W(a)){const{propsDefaults:d}=i;if(s in d)n=d[s];else{const c=Os(i);n=d[s]=a.call(null,t),c()}}else n=a;i.ce&&i.ce._setProp(s,n)}r[0]&&(o&&!l?n=!1:r[1]&&(n===""||n===Ft(s))&&(n=!0))}return n}const _a=new WeakMap;function fr(e,t,s=!1){const n=s?_a:t.propsCache,i=n.get(e);if(i)return i;const o=e.props,r={},l=[];let a=!1;if(!W(e)){const c=p=>{a=!0;const[h,_]=fr(p,t,!0);ye(r,h),_&&l.push(..._)};!s&&t.mixins.length&&t.mixins.forEach(c),e.extends&&c(e.extends),e.mixins&&e.mixins.forEach(c)}if(!o&&!a)return re(e)&&n.set(e,Jt),Jt;if(H(o))for(let c=0;c<o.length;c++){const p=De(o[c]);wi(p)&&(r[p]=de)}else if(o)for(const c in o){const p=De(c);if(wi(p)){const h=o[c],_=r[p]=H(h)||W(h)?{type:h}:ye({},h),C=_.type;let E=!1,M=!0;if(H(C))for(let w=0;w<C.length;++w){const x=C[w],D=W(x)&&x.name;if(D==="Boolean"){E=!0;break}else D==="String"&&(M=!1)}else E=W(C)&&C.name==="Boolean";_[0]=E,_[1]=M,(E||oe(_,"default"))&&l.push(p)}}const d=[r,l];return re(e)&&n.set(e,d),d}function wi(e){return e[0]!=="$"&&!ds(e)}const ti=e=>e==="_"||e==="_ctx"||e==="$stable",si=e=>H(e)?e.map(ot):[ot(e)],ga=(e,t,s)=>{if(t._n)return t;const n=ge((...i)=>si(t(...i)),s);return n._c=!1,n},hr=(e,t,s)=>{const n=e._ctx;for(const i in e){if(ti(i))continue;const o=e[i];if(W(o))t[i]=ga(i,o,n);else if(o!=null){const r=si(o);t[i]=()=>r}}},_r=(e,t)=>{const s=si(t);e.slots.default=()=>s},gr=(e,t,s)=>{for(const n in t)(s||!ti(n))&&(e[n]=t[n])},ma=(e,t,s)=>{const n=e.slots=pr();if(e.vnode.shapeFlag&32){const i=t._;i?(gr(n,t,s),s&&mo(n,"_",i,!0)):hr(t,n)}else t&&_r(e,t)},va=(e,t,s)=>{const{vnode:n,slots:i}=e;let o=!0,r=de;if(n.shapeFlag&32){const l=t._;l?s&&l===1?o=!1:gr(i,t,s):(o=!t.$stable,hr(t,i)),r=t}else t&&(_r(e,t),r={default:1});if(o)for(const l in i)!ti(l)&&r[l]==null&&delete i[l]},Ne=Ea;function ba(e){return ya(e)}function ya(e,t){const s=Zs();s.__VUE__=!0;const{insert:n,remove:i,patchProp:o,createElement:r,createText:l,createComment:a,setText:d,setElementText:c,parentNode:p,nextSibling:h,setScopeId:_=lt,insertStaticContent:C}=e,E=(u,f,g,v=null,A=null,b=null,R=void 0,P=null,I=!!f.dynamicChildren)=>{if(u===f)return;u&&!Nt(u,f)&&(v=y(u),$e(u,A,b,!0),u=null),f.patchFlag===-2&&(I=!1,f.dynamicChildren=null);const{type:S,ref:B,shapeFlag:j}=f;switch(S){case ln:M(u,f,g,v);break;case Oe:w(u,f,g,v);break;case Ns:u==null&&x(f,g,v,R);break;case ee:$(u,f,g,v,A,b,R,P,I);break;default:j&1?q(u,f,g,v,A,b,R,P,I):j&6?se(u,f,g,v,A,b,R,P,I):(j&64||j&128)&&S.process(u,f,g,v,A,b,R,P,I,U)}B!=null&&A?_s(B,u&&u.ref,b,f||u,!f):B==null&&u&&u.ref!=null&&_s(u.ref,null,b,u,!0)},M=(u,f,g,v)=>{if(u==null)n(f.el=l(f.children),g,v);else{const A=f.el=u.el;f.children!==u.children&&d(A,f.children)}},w=(u,f,g,v)=>{u==null?n(f.el=a(f.children||""),g,v):f.el=u.el},x=(u,f,g,v)=>{[u.el,u.anchor]=C(u.children,f,g,v,u.el,u.anchor)},D=({el:u,anchor:f},g,v)=>{let A;for(;u&&u!==f;)A=h(u),n(u,g,v),u=A;n(f,g,v)},O=({el:u,anchor:f})=>{let g;for(;u&&u!==f;)g=h(u),i(u),u=g;i(f)},q=(u,f,g,v,A,b,R,P,I)=>{if(f.type==="svg"?R="svg":f.type==="math"&&(R="mathml"),u==null)Y(f,g,v,A,b,R,P,I);else{const S=u.el&&u.el._isVueCE?u.el:null;try{S&&S._beginPatch(),V(u,f,A,b,R,P,I)}finally{S&&S._endPatch()}}},Y=(u,f,g,v,A,b,R,P)=>{let I,S;const{props:B,shapeFlag:j,transition:L,dirs:K}=u;if(I=u.el=r(u.type,b,B&&B.is,B),j&8?c(I,u.children):j&16&&Ae(u.children,I,null,v,A,vn(u,b),R,P),K&&Ot(u,null,v,"created"),Q(I,u,u.scopeId,R,v),B){for(const ce in B)ce!=="value"&&!ds(ce)&&o(I,ce,null,B[ce],b,v);"value"in B&&o(I,"value",null,B.value,b),(S=B.onVnodeBeforeMount)&&tt(S,v,u)}K&&Ot(u,null,v,"beforeMount");const Z=Aa(A,L);Z&&L.beforeEnter(I),n(I,f,g),((S=B&&B.onVnodeMounted)||Z||K)&&Ne(()=>{S&&tt(S,v,u),Z&&L.enter(I),K&&Ot(u,null,v,"mounted")},A)},Q=(u,f,g,v,A)=>{if(g&&_(u,g),v)for(let b=0;b<v.length;b++)_(u,v[b]);if(A){let b=A.subTree;if(f===b||yr(b.type)&&(b.ssContent===f||b.ssFallback===f)){const R=A.vnode;Q(u,R,R.scopeId,R.slotScopeIds,A.parent)}}},Ae=(u,f,g,v,A,b,R,P,I=0)=>{for(let S=I;S<u.length;S++){const B=u[S]=P?_t(u[S]):ot(u[S]);E(null,B,f,g,v,A,b,R,P)}},V=(u,f,g,v,A,b,R)=>{const P=f.el=u.el;let{patchFlag:I,dynamicChildren:S,dirs:B}=f;I|=u.patchFlag&16;const j=u.props||de,L=f.props||de;let K;if(g&&jt(g,!1),(K=L.onVnodeBeforeUpdate)&&tt(K,g,f,u),B&&Ot(f,u,g,"beforeUpdate"),g&&jt(g,!0),(j.innerHTML&&L.innerHTML==null||j.textContent&&L.textContent==null)&&c(P,""),S?X(u.dynamicChildren,S,P,g,v,vn(f,A),b):R||ne(u,f,P,null,g,v,vn(f,A),b,!1),I>0){if(I&16)le(P,j,L,g,A);else if(I&2&&j.class!==L.class&&o(P,"class",null,L.class,A),I&4&&o(P,"style",j.style,L.style,A),I&8){const Z=f.dynamicProps;for(let ce=0;ce<Z.length;ce++){const pe=Z[ce],ve=j[pe],Ee=L[pe];(Ee!==ve||pe==="value")&&o(P,pe,ve,Ee,A,g)}}I&1&&u.children!==f.children&&c(P,f.children)}else!R&&S==null&&le(P,j,L,g,A);((K=L.onVnodeUpdated)||B)&&Ne(()=>{K&&tt(K,g,f,u),B&&Ot(f,u,g,"updated")},v)},X=(u,f,g,v,A,b,R)=>{for(let P=0;P<f.length;P++){const I=u[P],S=f[P],B=I.el&&(I.type===ee||!Nt(I,S)||I.shapeFlag&198)?p(I.el):g;E(I,S,B,null,v,A,b,R,!0)}},le=(u,f,g,v,A)=>{if(f!==g){if(f!==de)for(const b in f)!ds(b)&&!(b in g)&&o(u,b,f[b],null,A,v);for(const b in g){if(ds(b))continue;const R=g[b],P=f[b];R!==P&&b!=="value"&&o(u,b,P,R,A,v)}"value"in g&&o(u,"value",f.value,g.value,A)}},$=(u,f,g,v,A,b,R,P,I)=>{const S=f.el=u?u.el:l(""),B=f.anchor=u?u.anchor:l("");let{patchFlag:j,dynamicChildren:L,slotScopeIds:K}=f;K&&(P=P?P.concat(K):K),u==null?(n(S,g,v),n(B,g,v),Ae(f.children||[],g,B,A,b,R,P,I)):j>0&&j&64&&L&&u.dynamicChildren&&u.dynamicChildren.length===L.length?(X(u.dynamicChildren,L,g,A,b,R,P),(f.key!=null||A&&f===A.subTree)&&mr(u,f,!0)):ne(u,f,g,B,A,b,R,P,I)},se=(u,f,g,v,A,b,R,P,I)=>{f.slotScopeIds=P,u==null?f.shapeFlag&512?A.ctx.activate(f,g,v,R,I):Se(f,g,v,A,b,R,I):Le(u,f,I)},Se=(u,f,g,v,A,b,R)=>{const P=u.component=Ta(u,v,A);if(nn(u)&&(P.ctx.renderer=U),Oa(P,!1,R),P.asyncDep){if(A&&A.registerDep(P,_e,R),!u.el){const I=P.subTree=G(Oe);w(null,I,f,g),u.placeholder=I.el}}else _e(P,u,f,g,A,b,R)},Le=(u,f,g)=>{const v=f.component=u.component;if(ua(u,f,g))if(v.asyncDep&&!v.asyncResolved){ae(v,f,g);return}else v.next=f,v.update();else f.el=u.el,v.vnode=f},_e=(u,f,g,v,A,b,R)=>{const P=()=>{if(u.isMounted){let{next:j,bu:L,u:K,parent:Z,vnode:ce}=u;{const Ze=vr(u);if(Ze){j&&(j.el=ce.el,ae(u,j,R)),Ze.asyncDep.then(()=>{Ne(()=>{u.isUnmounted||S()},A)});return}}let pe=j,ve;jt(u,!1),j?(j.el=ce.el,ae(u,j,R)):j=ce,L&&un(L),(ve=j.props&&j.props.onVnodeBeforeUpdate)&&tt(ve,Z,j,ce),jt(u,!0);const Ee=xi(u),Ye=u.subTree;u.subTree=Ee,E(Ye,Ee,p(Ye.el),y(Ye),u,A,b),j.el=Ee.el,pe===null&&da(u,Ee.el),K&&Ne(K,A),(ve=j.props&&j.props.onVnodeUpdated)&&Ne(()=>tt(ve,Z,j,ce),A)}else{let j;const{el:L,props:K}=f,{bm:Z,m:ce,parent:pe,root:ve,type:Ee}=u,Ye=gs(f);jt(u,!1),Z&&un(Z),!Ye&&(j=K&&K.onVnodeBeforeMount)&&tt(j,pe,f),jt(u,!0);{ve.ce&&ve.ce._hasShadowRoot()&&ve.ce._injectChildStyle(Ee,u.parent?u.parent.type:void 0);const Ze=u.subTree=xi(u);E(null,Ze,g,v,u,A,b),f.el=Ze.el}if(ce&&Ne(ce,A),!Ye&&(j=K&&K.onVnodeMounted)){const Ze=f;Ne(()=>tt(j,pe,Ze),A)}(f.shapeFlag&256||pe&&gs(pe.vnode)&&pe.vnode.shapeFlag&256)&&u.a&&Ne(u.a,A),u.isMounted=!0,f=g=v=null}};u.scope.on();const I=u.effect=new Ao(P);u.scope.off();const S=u.update=I.run.bind(I),B=u.job=I.runIfDirty.bind(I);B.i=u,B.id=u.uid,I.scheduler=()=>ei(B),jt(u,!0),S()},ae=(u,f,g)=>{f.component=u;const v=u.vnode.props;u.vnode=f,u.next=null,ha(u,f.props,v,g),va(u,f.children,g),vt(),gi(u),bt()},ne=(u,f,g,v,A,b,R,P,I=!1)=>{const S=u&&u.children,B=u?u.shapeFlag:0,j=f.children,{patchFlag:L,shapeFlag:K}=f;if(L>0){if(L&128){St(S,j,g,v,A,b,R,P,I);return}else if(L&256){pt(S,j,g,v,A,b,R,P,I);return}}K&8?(B&16&&He(S,A,b),j!==S&&c(g,j)):B&16?K&16?St(S,j,g,v,A,b,R,P,I):He(S,A,b,!0):(B&8&&c(g,""),K&16&&Ae(j,g,v,A,b,R,P,I))},pt=(u,f,g,v,A,b,R,P,I)=>{u=u||Jt,f=f||Jt;const S=u.length,B=f.length,j=Math.min(S,B);let L;for(L=0;L<j;L++){const K=f[L]=I?_t(f[L]):ot(f[L]);E(u[L],K,g,null,A,b,R,P,I)}S>B?He(u,A,b,!0,!1,j):Ae(f,g,v,A,b,R,P,I,j)},St=(u,f,g,v,A,b,R,P,I)=>{let S=0;const B=f.length;let j=u.length-1,L=B-1;for(;S<=j&&S<=L;){const K=u[S],Z=f[S]=I?_t(f[S]):ot(f[S]);if(Nt(K,Z))E(K,Z,g,null,A,b,R,P,I);else break;S++}for(;S<=j&&S<=L;){const K=u[j],Z=f[L]=I?_t(f[L]):ot(f[L]);if(Nt(K,Z))E(K,Z,g,null,A,b,R,P,I);else break;j--,L--}if(S>j){if(S<=L){const K=L+1,Z=K<B?f[K].el:v;for(;S<=L;)E(null,f[S]=I?_t(f[S]):ot(f[S]),g,Z,A,b,R,P,I),S++}}else if(S>L)for(;S<=j;)$e(u[S],A,b,!0),S++;else{const K=S,Z=S,ce=new Map;for(S=Z;S<=L;S++){const Be=f[S]=I?_t(f[S]):ot(f[S]);Be.key!=null&&ce.set(Be.key,S)}let pe,ve=0;const Ee=L-Z+1;let Ye=!1,Ze=0;const rs=new Array(Ee);for(S=0;S<Ee;S++)rs[S]=0;for(S=K;S<=j;S++){const Be=u[S];if(ve>=Ee){$e(Be,A,b,!0);continue}let et;if(Be.key!=null)et=ce.get(Be.key);else for(pe=Z;pe<=L;pe++)if(rs[pe-Z]===0&&Nt(Be,f[pe])){et=pe;break}et===void 0?$e(Be,A,b,!0):(rs[et-Z]=S+1,et>=Ze?Ze=et:Ye=!0,E(Be,f[et],g,null,A,b,R,P,I),ve++)}const ci=Ye?Sa(rs):Jt;for(pe=ci.length-1,S=Ee-1;S>=0;S--){const Be=Z+S,et=f[Be],pi=f[Be+1],ui=Be+1<B?pi.el||br(pi):v;rs[S]===0?E(null,et,g,ui,A,b,R,P,I):Ye&&(pe<0||S!==ci[pe]?Qe(et,g,ui,2):pe--)}}},Qe=(u,f,g,v,A=null)=>{const{el:b,type:R,transition:P,children:I,shapeFlag:S}=u;if(S&6){Qe(u.component.subTree,f,g,v);return}if(S&128){u.suspense.move(f,g,v);return}if(S&64){R.move(u,f,g,U);return}if(R===ee){n(b,f,g);for(let j=0;j<I.length;j++)Qe(I[j],f,g,v);n(u.anchor,f,g);return}if(R===Ns){D(u,f,g);return}if(v!==2&&S&1&&P)if(v===0)P.beforeEnter(b),n(b,f,g),Ne(()=>P.enter(b),A);else{const{leave:j,delayLeave:L,afterLeave:K}=P,Z=()=>{u.ctx.isUnmounted?i(b):n(b,f,g)},ce=()=>{b._isLeaving&&b[nt](!0),j(b,()=>{Z(),K&&K()})};L?L(b,Z,ce):ce()}else n(b,f,g)},$e=(u,f,g,v=!1,A=!1)=>{const{type:b,props:R,ref:P,children:I,dynamicChildren:S,shapeFlag:B,patchFlag:j,dirs:L,cacheIndex:K,memo:Z}=u;if(j===-2&&(A=!1),P!=null&&(vt(),_s(P,null,g,u,!0),bt()),K!=null&&(f.renderCache[K]=void 0),B&256){f.ctx.deactivate(u);return}const ce=B&1&&L,pe=!gs(u);let ve;if(pe&&(ve=R&&R.onVnodeBeforeUnmount)&&tt(ve,f,u),B&6)Tt(u.component,g,v);else{if(B&128){u.suspense.unmount(g,v);return}ce&&Ot(u,null,f,"beforeUnmount"),B&64?u.type.remove(u,f,g,U,v):S&&!S.hasOnce&&(b!==ee||j>0&&j&64)?He(S,f,g,!1,!0):(b===ee&&j&384||!A&&B&16)&&He(I,f,g),v&&Kt(u)}const Ee=Z!=null&&K==null;(pe&&(ve=R&&R.onVnodeUnmounted)||ce||Ee)&&Ne(()=>{ve&&tt(ve,f,u),ce&&Ot(u,null,f,"unmounted"),Ee&&(u.el=null)},g)},Kt=u=>{const{type:f,el:g,anchor:v,transition:A}=u;if(f===ee){Wt(g,v);return}if(f===Ns){O(u);return}const b=()=>{i(g),A&&!A.persisted&&A.afterLeave&&A.afterLeave()};if(u.shapeFlag&1&&A&&!A.persisted){const{leave:R,delayLeave:P}=A,I=()=>R(g,b);P?P(u.el,b,I):I()}else b()},Wt=(u,f)=>{let g;for(;u!==f;)g=h(u),i(u),u=g;i(f)},Tt=(u,f,g)=>{const{bum:v,scope:A,job:b,subTree:R,um:P,m:I,a:S}=u;Pi(I),Pi(S),v&&un(v),A.stop(),b&&(b.flags|=8,$e(R,u,f,g)),P&&Ne(P,f),Ne(()=>{u.isUnmounted=!0},f)},He=(u,f,g,v=!1,A=!1,b=0)=>{for(let R=b;R<u.length;R++)$e(u[R],f,g,v,A)},y=u=>{if(u.shapeFlag&6)return y(u.component.subTree);if(u.shapeFlag&128)return u.suspense.next();const f=h(u.anchor||u.el),g=f&&f[kl];return g?h(g):f};let N=!1;const T=(u,f,g)=>{let v;u==null?f._vnode&&($e(f._vnode,null,null,!0),v=f._vnode.component):E(f._vnode||null,u,f,null,null,null,g),f._vnode=u,N||(N=!0,gi(v),Bo(),N=!1)},U={p:E,um:$e,m:Qe,r:Kt,mt:Se,mc:Ae,pc:ne,pbc:X,n:y,o:e};return{render:T,hydrate:void 0,createApp:oa(T)}}function vn({type:e,props:t},s){return s==="svg"&&e==="foreignObject"||s==="mathml"&&e==="annotation-xml"&&t&&t.encoding&&t.encoding.includes("html")?void 0:s}function jt({effect:e,job:t},s){s?(e.flags|=32,t.flags|=4):(e.flags&=-33,t.flags&=-5)}function Aa(e,t){return(!e||e&&!e.pendingBranch)&&t&&!t.persisted}function mr(e,t,s=!1){const n=e.children,i=t.children;if(H(n)&&H(i))for(let o=0;o<n.length;o++){const r=n[o];let l=i[o];l.shapeFlag&1&&!l.dynamicChildren&&((l.patchFlag<=0||l.patchFlag===32)&&(l=i[o]=_t(i[o]),l.el=r.el),!s&&l.patchFlag!==-2&&mr(r,l)),l.type===ln&&(l.patchFlag===-1&&(l=i[o]=_t(l)),l.el=r.el),l.type===Oe&&!l.el&&(l.el=r.el)}}function Sa(e){const t=e.slice(),s=[0];let n,i,o,r,l;const a=e.length;for(n=0;n<a;n++){const d=e[n];if(d!==0){if(i=s[s.length-1],e[i]<d){t[n]=i,s.push(n);continue}for(o=0,r=s.length-1;o<r;)l=o+r>>1,e[s[l]]<d?o=l+1:r=l;d<e[s[o]]&&(o>0&&(t[n]=s[o-1]),s[o]=n)}}for(o=s.length,r=s[o-1];o-- >0;)s[o]=r,r=t[r];return s}function vr(e){const t=e.subTree.component;if(t)return t.asyncDep&&!t.asyncResolved?t:vr(t)}function Pi(e){if(e)for(let t=0;t<e.length;t++)e[t].flags|=8}function br(e){if(e.placeholder)return e.placeholder;const t=e.component;return t?br(t.subTree):null}const yr=e=>e.__isSuspense;function Ea(e,t){t&&t.pendingBranch?H(e)?t.effects.push(...e):t.effects.push(e):Ml(e)}const ee=Symbol.for("v-fgt"),ln=Symbol.for("v-txt"),Oe=Symbol.for("v-cmt"),Ns=Symbol.for("v-stc"),vs=[];let Fe=null;function k(e=!1){vs.push(Fe=e?null:[])}function Ca(){vs.pop(),Fe=vs[vs.length-1]||null}let xs=1;function Ws(e,t=!1){xs+=e,e<0&&Fe&&t&&(Fe.hasOnce=!0)}function Ar(e){return e.dynamicChildren=xs>0?Fe||Jt:null,Ca(),xs>0&&Fe&&Fe.push(e),e}function F(e,t,s,n,i,o){return Ar(m(e,t,s,n,i,o,!0))}function Pt(e,t,s,n,i){return Ar(G(e,t,s,n,i,!0))}function qs(e){return e?e.__v_isVNode===!0:!1}function Nt(e,t){return e.type===t.type&&e.key===t.key}const Sr=({key:e})=>e??null,ks=({ref:e,ref_key:t,ref_for:s})=>(typeof e=="number"&&(e=""+e),e!=null?he(e)||we(e)||W(e)?{i:qe,r:e,k:t,f:!!s}:e:null);function m(e,t=null,s=null,n=0,i=null,o=e===ee?0:1,r=!1,l=!1){const a={__v_isVNode:!0,__v_skip:!0,type:e,props:t,key:t&&Sr(t),ref:t&&ks(t),scopeId:Ho,slotScopeIds:null,children:s,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetStart:null,targetAnchor:null,staticCount:0,shapeFlag:o,patchFlag:n,dynamicProps:i,dynamicChildren:null,appContext:null,ctx:qe};return l?(ni(a,s),o&128&&e.normalize(a)):s&&(a.shapeFlag|=he(s)?8:16),xs>0&&!r&&Fe&&(a.patchFlag>0||o&6)&&a.patchFlag!==32&&Fe.push(a),a}const G=xa;function xa(e,t=null,s=null,n=0,i=null,o=!1){if((!e||e===sr)&&(e=Oe),qs(e)){const l=Rt(e,t,!0);return s&&ni(l,s),xs>0&&!o&&Fe&&(l.shapeFlag&6?Fe[Fe.indexOf(e)]=l:Fe.push(l)),l.patchFlag=-2,l}if(Na(e)&&(e=e.__vccOpts),t){t=Ia(t);let{class:l,style:a}=t;l&&!he(l)&&(t.class=We(l)),re(a)&&(Zn(a)&&!H(a)&&(a=ye({},a)),t.style=Wn(a))}const r=he(e)?1:yr(e)?128:Wo(e)?64:re(e)?4:W(e)?2:0;return m(e,t,s,n,i,r,o,!0)}function Ia(e){return e?Zn(e)||ur(e)?ye({},e):e:null}function Rt(e,t,s=!1,n=!1){const{props:i,ref:o,patchFlag:r,children:l,transition:a}=e,d=t?wa(i||{},t):i,c={__v_isVNode:!0,__v_skip:!0,type:e.type,props:d,key:d&&Sr(d),ref:t&&t.ref?s&&o?H(o)?o.concat(ks(t)):[o,ks(t)]:ks(t):o,scopeId:e.scopeId,slotScopeIds:e.slotScopeIds,children:l,target:e.target,targetStart:e.targetStart,targetAnchor:e.targetAnchor,staticCount:e.staticCount,shapeFlag:e.shapeFlag,patchFlag:t&&e.type!==ee?r===-1?16:r|16:r,dynamicProps:e.dynamicProps,dynamicChildren:e.dynamicChildren,appContext:e.appContext,dirs:e.dirs,transition:a,component:e.component,suspense:e.suspense,ssContent:e.ssContent&&Rt(e.ssContent),ssFallback:e.ssFallback&&Rt(e.ssFallback),placeholder:e.placeholder,el:e.el,anchor:e.anchor,ctx:e.ctx,ce:e.ce};return a&&n&&Cs(c,a.clone(c)),c}function Ue(e=" ",t=0){return G(ln,null,e,t)}function es(e,t){const s=G(Ns,null,e);return s.staticCount=t,s}function Er(e="",t=!1){return t?(k(),Pt(Oe,null,e)):G(Oe,null,e)}function ot(e){return e==null||typeof e=="boolean"?G(Oe):H(e)?G(ee,null,e.slice()):qs(e)?_t(e):G(ln,null,String(e))}function _t(e){return e.el===null&&e.patchFlag!==-1||e.memo?e:Rt(e)}function ni(e,t){let s=0;const{shapeFlag:n}=e;if(t==null)t=null;else if(H(t))s=16;else if(typeof t=="object")if(n&65){const i=t.default;i&&(i._c&&(i._d=!1),ni(e,i()),i._c&&(i._d=!0));return}else{s=32;const i=t._;!i&&!ur(t)?t._ctx=qe:i===3&&qe&&(qe.slots._===1?t._=1:(t._=2,e.patchFlag|=1024))}else W(t)?(t={default:t,_ctx:qe},s=32):(t=String(t),n&64?(s=16,t=[Ue(t)]):s=8);e.children=t,e.shapeFlag|=s}function wa(...e){const t={};for(let s=0;s<e.length;s++){const n=e[s];for(const i in n)if(i==="class")t.class!==n.class&&(t.class=We([t.class,n.class]));else if(i==="style")t.style=Wn([t.style,n.style]);else if(zs(i)){const o=t[i],r=n[i];r&&o!==r&&!(H(o)&&o.includes(r))?t[i]=o?[].concat(o,r):r:r==null&&o==null&&!Js(i)&&(t[i]=r)}else i!==""&&(t[i]=n[i])}return t}function tt(e,t,s,n=null){ze(e,t,7,[s,n])}const Pa=rr();let Ra=0;function Ta(e,t,s){const n=e.type,i=(t?t.appContext:e.appContext)||Pa,o={uid:Ra++,vnode:e,type:n,parent:t,appContext:i,root:null,next:null,subTree:null,effect:null,update:null,job:null,scope:new nl(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:t?t.provides:Object.create(i.provides),ids:t?t.ids:["",0,0],accessCache:null,renderCache:[],components:null,directives:null,propsOptions:fr(n,i),emitsOptions:lr(n,i),emit:null,emitted:null,propsDefaults:de,inheritAttrs:n.inheritAttrs,ctx:de,data:de,props:de,attrs:de,slots:de,refs:de,setupState:de,setupContext:null,suspense:s,suspenseId:s?s.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return o.ctx={_:o},o.root=t?t.root:o,o.emit=la.bind(null,o),e.ce&&e.ce(o),o}let Ie=null;const Cr=()=>Ie||qe;let Gs,Nn;{const e=Zs(),t=(s,n)=>{let i;return(i=e[s])||(i=e[s]=[]),i.push(n),o=>{i.length>1?i.forEach(r=>r(o)):i[0](o)}};Gs=t("__VUE_INSTANCE_SETTERS__",s=>Ie=s),Nn=t("__VUE_SSR_SETTERS__",s=>Is=s)}const Os=e=>{const t=Ie;return Gs(e),e.scope.on(),()=>{e.scope.off(),Gs(t)}},Ri=()=>{Ie&&Ie.scope.off(),Gs(null)};function xr(e){return e.vnode.shapeFlag&4}let Is=!1;function Oa(e,t=!1,s=!1){t&&Nn(t);const{props:n,children:i}=e.vnode,o=xr(e);fa(e,n,o,t),ma(e,i,s||t);const r=o?ja(e,t):void 0;return t&&Nn(!1),r}function ja(e,t){const s=e.type;e.accessCache=Object.create(null),e.proxy=new Proxy(e.ctx,Yl);const{setup:n}=s;if(n){vt();const i=e.setupContext=n.length>1?Da(e):null,o=Os(e),r=Ts(n,e,0,[e.props,i]),l=ho(r);if(bt(),o(),(l||e.sp)&&!gs(e)&&Yo(e),l){if(r.then(Ri,Ri),t)return r.then(a=>{Ti(e,a)}).catch(a=>{sn(a,e,0)});e.asyncDep=r}else Ti(e,r)}else Ir(e)}function Ti(e,t,s){W(t)?e.type.__ssrInlineRender?e.ssrRender=t:e.render=t:re(t)&&(e.setupState=ko(t)),Ir(e)}function Ir(e,t,s){const n=e.type;e.render||(e.render=n.render||lt);{const i=Os(e);vt();try{Zl(e)}finally{bt(),i()}}}const Ma={get(e,t){return xe(e,"get",""),e[t]}};function Da(e){const t=s=>{e.exposed=s||{}};return{attrs:new Proxy(e.attrs,Ma),slots:e.slots,emit:e.emit,expose:t}}function ii(e){return e.exposed?e.exposeProxy||(e.exposeProxy=new Proxy(ko(El(e.exposed)),{get(t,s){if(s in t)return t[s];if(s in ms)return ms[s](e)},has(t,s){return s in t||s in ms}})):e.proxy}function $a(e,t=!0){return W(e)?e.displayName||e.name:e.name||t&&e.__name}function Na(e){return W(e)&&"__vccOpts"in e}const je=(e,t)=>Pl(e,t,Is);function oi(e,t,s){try{Ws(-1);const n=arguments.length;return n===2?re(t)&&!H(t)?qs(t)?G(e,null,[t]):G(e,t):G(e,null,t):(n>3?s=Array.prototype.slice.call(arguments,2):n===3&&qs(s)&&(s=[s]),G(e,t,s))}finally{Ws(1)}}const ka="3.5.31";let kn;const Oi=typeof window<"u"&&window.trustedTypes;if(Oi)try{kn=Oi.createPolicy("vue",{createHTML:e=>e})}catch{}const wr=kn?e=>kn.createHTML(e):e=>e,Ua="http://www.w3.org/2000/svg",La="http://www.w3.org/1998/Math/MathML",ht=typeof document<"u"?document:null,ji=ht&&ht.createElement("template"),Ba={insert:(e,t,s)=>{t.insertBefore(e,s||null)},remove:e=>{const t=e.parentNode;t&&t.removeChild(e)},createElement:(e,t,s,n)=>{const i=t==="svg"?ht.createElementNS(Ua,e):t==="mathml"?ht.createElementNS(La,e):s?ht.createElement(e,{is:s}):ht.createElement(e);return e==="select"&&n&&n.multiple!=null&&i.setAttribute("multiple",n.multiple),i},createText:e=>ht.createTextNode(e),createComment:e=>ht.createComment(e),setText:(e,t)=>{e.nodeValue=t},setElementText:(e,t)=>{e.textContent=t},parentNode:e=>e.parentNode,nextSibling:e=>e.nextSibling,querySelector:e=>ht.querySelector(e),setScopeId(e,t){e.setAttribute(t,"")},insertStaticContent(e,t,s,n,i,o){const r=s?s.previousSibling:t.lastChild;if(i&&(i===o||i.nextSibling))for(;t.insertBefore(i.cloneNode(!0),s),!(i===o||!(i=i.nextSibling)););else{ji.innerHTML=wr(n==="svg"?`<svg>${e}</svg>`:n==="mathml"?`<math>${e}</math>`:e);const l=ji.content;if(n==="svg"||n==="mathml"){const a=l.firstChild;for(;a.firstChild;)l.appendChild(a.firstChild);l.removeChild(a)}t.insertBefore(l,s)}return[r?r.nextSibling:t.firstChild,s?s.previousSibling:t.lastChild]}},Et="transition",cs="animation",ws=Symbol("_vtc"),Pr={name:String,type:String,css:{type:Boolean,default:!0},duration:[String,Number,Object],enterFromClass:String,enterActiveClass:String,enterToClass:String,appearFromClass:String,appearActiveClass:String,appearToClass:String,leaveFromClass:String,leaveActiveClass:String,leaveToClass:String},Fa=ye({},qo,Pr),Ha=e=>(e.displayName="Transition",e.props=Fa,e),Va=Ha((e,{slots:t})=>oi(Bl,Ka(e),t)),Mt=(e,t=[])=>{H(e)?e.forEach(s=>s(...t)):e&&e(...t)},Mi=e=>e?H(e)?e.some(t=>t.length>1):e.length>1:!1;function Ka(e){const t={};for(const $ in e)$ in Pr||(t[$]=e[$]);if(e.css===!1)return t;const{name:s="v",type:n,duration:i,enterFromClass:o=`${s}-enter-from`,enterActiveClass:r=`${s}-enter-active`,enterToClass:l=`${s}-enter-to`,appearFromClass:a=o,appearActiveClass:d=r,appearToClass:c=l,leaveFromClass:p=`${s}-leave-from`,leaveActiveClass:h=`${s}-leave-active`,leaveToClass:_=`${s}-leave-to`}=e,C=Wa(i),E=C&&C[0],M=C&&C[1],{onBeforeEnter:w,onEnter:x,onEnterCancelled:D,onLeave:O,onLeaveCancelled:q,onBeforeAppear:Y=w,onAppear:Q=x,onAppearCancelled:Ae=D}=t,V=($,se,Se,Le)=>{$._enterCancelled=Le,Dt($,se?c:l),Dt($,se?d:r),Se&&Se()},X=($,se)=>{$._isLeaving=!1,Dt($,p),Dt($,_),Dt($,h),se&&se()},le=$=>(se,Se)=>{const Le=$?Q:x,_e=()=>V(se,$,Se);Mt(Le,[se,_e]),Di(()=>{Dt(se,$?a:o),dt(se,$?c:l),Mi(Le)||$i(se,n,E,_e)})};return ye(t,{onBeforeEnter($){Mt(w,[$]),dt($,o),dt($,r)},onBeforeAppear($){Mt(Y,[$]),dt($,a),dt($,d)},onEnter:le(!1),onAppear:le(!0),onLeave($,se){$._isLeaving=!0;const Se=()=>X($,se);dt($,p),$._enterCancelled?(dt($,h),Ui($)):(Ui($),dt($,h)),Di(()=>{$._isLeaving&&(Dt($,p),dt($,_),Mi(O)||$i($,n,M,Se))}),Mt(O,[$,Se])},onEnterCancelled($){V($,!1,void 0,!0),Mt(D,[$])},onAppearCancelled($){V($,!0,void 0,!0),Mt(Ae,[$])},onLeaveCancelled($){X($),Mt(q,[$])}})}function Wa(e){if(e==null)return null;if(re(e))return[bn(e.enter),bn(e.leave)];{const t=bn(e);return[t,t]}}function bn(e){return zr(e)}function dt(e,t){t.split(/\s+/).forEach(s=>s&&e.classList.add(s)),(e[ws]||(e[ws]=new Set)).add(t)}function Dt(e,t){t.split(/\s+/).forEach(n=>n&&e.classList.remove(n));const s=e[ws];s&&(s.delete(t),s.size||(e[ws]=void 0))}function Di(e){requestAnimationFrame(()=>{requestAnimationFrame(e)})}let qa=0;function $i(e,t,s,n){const i=e._endId=++qa,o=()=>{i===e._endId&&n()};if(s!=null)return setTimeout(o,s);const{type:r,timeout:l,propCount:a}=Ga(e,t);if(!r)return n();const d=r+"end";let c=0;const p=()=>{e.removeEventListener(d,h),o()},h=_=>{_.target===e&&++c>=a&&p()};setTimeout(()=>{c<a&&p()},l+1),e.addEventListener(d,h)}function Ga(e,t){const s=window.getComputedStyle(e),n=C=>(s[C]||"").split(", "),i=n(`${Et}Delay`),o=n(`${Et}Duration`),r=Ni(i,o),l=n(`${cs}Delay`),a=n(`${cs}Duration`),d=Ni(l,a);let c=null,p=0,h=0;t===Et?r>0&&(c=Et,p=r,h=o.length):t===cs?d>0&&(c=cs,p=d,h=a.length):(p=Math.max(r,d),c=p>0?r>d?Et:cs:null,h=c?c===Et?o.length:a.length:0);const _=c===Et&&/\b(?:transform|all)(?:,|$)/.test(n(`${Et}Property`).toString());return{type:c,timeout:p,propCount:h,hasTransform:_}}function Ni(e,t){for(;e.length<t.length;)e=e.concat(e);return Math.max(...t.map((s,n)=>ki(s)+ki(e[n])))}function ki(e){return e==="auto"?0:Number(e.slice(0,-1).replace(",","."))*1e3}function Ui(e){return(e?e.ownerDocument:document).body.offsetHeight}function Xa(e,t,s){const n=e[ws];n&&(t=(t?[t,...n]:[...n]).join(" ")),t==null?e.removeAttribute("class"):s?e.setAttribute("class",t):e.className=t}const Li=Symbol("_vod"),za=Symbol("_vsh"),Ja=Symbol(""),Qa=/(?:^|;)\s*display\s*:/;function Ya(e,t,s){const n=e.style,i=he(s);let o=!1;if(s&&!i){if(t)if(he(t))for(const r of t.split(";")){const l=r.slice(0,r.indexOf(":")).trim();s[l]==null&&Us(n,l,"")}else for(const r in t)s[r]==null&&Us(n,r,"");for(const r in s)r==="display"&&(o=!0),Us(n,r,s[r])}else if(i){if(t!==s){const r=n[Ja];r&&(s+=";"+r),n.cssText=s,o=Qa.test(s)}}else t&&e.removeAttribute("style");Li in e&&(e[Li]=o?n.display:"",e[za]&&(n.display="none"))}const Bi=/\s*!important$/;function Us(e,t,s){if(H(s))s.forEach(n=>Us(e,t,n));else if(s==null&&(s=""),t.startsWith("--"))e.setProperty(t,s);else{const n=Za(e,t);Bi.test(s)?e.setProperty(Ft(n),s.replace(Bi,""),"important"):e[n]=s}}const Fi=["Webkit","Moz","ms"],yn={};function Za(e,t){const s=yn[t];if(s)return s;let n=De(t);if(n!=="filter"&&n in e)return yn[t]=n;n=Ys(n);for(let i=0;i<Fi.length;i++){const o=Fi[i]+n;if(o in e)return yn[t]=o}return t}const Hi="http://www.w3.org/1999/xlink";function Vi(e,t,s,n,i,o=tl(t)){n&&t.startsWith("xlink:")?s==null?e.removeAttributeNS(Hi,t.slice(6,t.length)):e.setAttributeNS(Hi,t,s):s==null||o&&!vo(s)?e.removeAttribute(t):e.setAttribute(t,o?"":ct(s)?String(s):s)}function Ki(e,t,s,n,i){if(t==="innerHTML"||t==="textContent"){s!=null&&(e[t]=t==="innerHTML"?wr(s):s);return}const o=e.tagName;if(t==="value"&&o!=="PROGRESS"&&!o.includes("-")){const l=o==="OPTION"?e.getAttribute("value")||"":e.value,a=s==null?e.type==="checkbox"?"on":"":String(s);(l!==a||!("_value"in e))&&(e.value=a),s==null&&e.removeAttribute(t),e._value=s;return}let r=!1;if(s===""||s==null){const l=typeof e[t];l==="boolean"?s=vo(s):s==null&&l==="string"?(s="",r=!0):l==="number"&&(s=0,r=!0)}try{e[t]=s}catch{}r&&e.removeAttribute(i||t)}function ec(e,t,s,n){e.addEventListener(t,s,n)}function tc(e,t,s,n){e.removeEventListener(t,s,n)}const Wi=Symbol("_vei");function sc(e,t,s,n,i=null){const o=e[Wi]||(e[Wi]={}),r=o[t];if(n&&r)r.value=n;else{const[l,a]=nc(t);if(n){const d=o[t]=rc(n,i);ec(e,l,d,a)}else r&&(tc(e,l,r,a),o[t]=void 0)}}const qi=/(?:Once|Passive|Capture)$/;function nc(e){let t;if(qi.test(e)){t={};let n;for(;n=e.match(qi);)e=e.slice(0,e.length-n[0].length),t[n[0].toLowerCase()]=!0}return[e[2]===":"?e.slice(3):Ft(e.slice(2)),t]}let An=0;const ic=Promise.resolve(),oc=()=>An||(ic.then(()=>An=0),An=Date.now());function rc(e,t){const s=n=>{if(!n._vts)n._vts=Date.now();else if(n._vts<=s.attached)return;ze(lc(n,s.value),t,5,[n])};return s.value=e,s.attached=oc(),s}function lc(e,t){if(H(t)){const s=e.stopImmediatePropagation;return e.stopImmediatePropagation=()=>{s.call(e),e._stopped=!0},t.map(n=>i=>!i._stopped&&n&&n(i))}else return t}const Gi=e=>e.charCodeAt(0)===111&&e.charCodeAt(1)===110&&e.charCodeAt(2)>96&&e.charCodeAt(2)<123,ac=(e,t,s,n,i,o)=>{const r=i==="svg";t==="class"?Xa(e,n,r):t==="style"?Ya(e,s,n):zs(t)?Js(t)||sc(e,t,s,n,o):(t[0]==="."?(t=t.slice(1),!0):t[0]==="^"?(t=t.slice(1),!1):cc(e,t,n,r))?(Ki(e,t,n),!e.tagName.includes("-")&&(t==="value"||t==="checked"||t==="selected")&&Vi(e,t,n,r,o,t!=="value")):e._isVueCE&&(pc(e,t)||e._def.__asyncLoader&&(/[A-Z]/.test(t)||!he(n)))?Ki(e,De(t),n,o,t):(t==="true-value"?e._trueValue=n:t==="false-value"&&(e._falseValue=n),Vi(e,t,n,r))};function cc(e,t,s,n){if(n)return!!(t==="innerHTML"||t==="textContent"||t in e&&Gi(t)&&W(s));if(t==="spellcheck"||t==="draggable"||t==="translate"||t==="autocorrect"||t==="sandbox"&&e.tagName==="IFRAME"||t==="form"||t==="list"&&e.tagName==="INPUT"||t==="type"&&e.tagName==="TEXTAREA")return!1;if(t==="width"||t==="height"){const i=e.tagName;if(i==="IMG"||i==="VIDEO"||i==="CANVAS"||i==="SOURCE")return!1}return Gi(t)&&he(s)?!1:t in e}function pc(e,t){const s=e._def.props;if(!s)return!1;const n=De(t);return Array.isArray(s)?s.some(i=>De(i)===n):Object.keys(s).some(i=>De(i)===n)}const uc=["ctrl","shift","alt","meta"],dc={stop:e=>e.stopPropagation(),prevent:e=>e.preventDefault(),self:e=>e.target!==e.currentTarget,ctrl:e=>!e.ctrlKey,shift:e=>!e.shiftKey,alt:e=>!e.altKey,meta:e=>!e.metaKey,left:e=>"button"in e&&e.button!==0,middle:e=>"button"in e&&e.button!==1,right:e=>"button"in e&&e.button!==2,exact:(e,t)=>uc.some(s=>e[`${s}Key`]&&!t.includes(s))},Xs=(e,t)=>{if(!e)return e;const s=e._withMods||(e._withMods={}),n=t.join(".");return s[n]||(s[n]=((i,...o)=>{for(let r=0;r<t.length;r++){const l=dc[t[r]];if(l&&l(i,t))return}return e(i,...o)}))},fc=ye({patchProp:ac},Ba);let Xi;function hc(){return Xi||(Xi=ba(fc))}const _c=((...e)=>{const t=hc().createApp(...e),{mount:s}=t;return t.mount=n=>{const i=mc(n);if(!i)return;const o=t._component;!W(o)&&!o.render&&!o.template&&(o.template=i.innerHTML),i.nodeType===1&&(i.textContent="");const r=s(i,!1,gc(i));return i instanceof Element&&(i.removeAttribute("v-cloak"),i.setAttribute("data-v-app","")),r},t});function gc(e){if(e instanceof SVGElement)return"svg";if(typeof MathMLElement=="function"&&e instanceof MathMLElement)return"mathml"}function mc(e){return he(e)?document.querySelector(e):e}const Xt=typeof document<"u";function Rr(e){return typeof e=="object"||"displayName"in e||"props"in e||"__vccOpts"in e}function vc(e){return e.__esModule||e[Symbol.toStringTag]==="Module"||e.default&&Rr(e.default)}const ie=Object.assign;function Sn(e,t){const s={};for(const n in t){const i=t[n];s[n]=Je(i)?i.map(e):e(i)}return s}const bs=()=>{},Je=Array.isArray;function zi(e,t){const s={};for(const n in e)s[n]=n in t?t[n]:e[n];return s}let fe=(function(e){return e[e.MATCHER_NOT_FOUND=1]="MATCHER_NOT_FOUND",e[e.NAVIGATION_GUARD_REDIRECT=2]="NAVIGATION_GUARD_REDIRECT",e[e.NAVIGATION_ABORTED=4]="NAVIGATION_ABORTED",e[e.NAVIGATION_CANCELLED=8]="NAVIGATION_CANCELLED",e[e.NAVIGATION_DUPLICATED=16]="NAVIGATION_DUPLICATED",e})({});const Tr=Symbol("");fe.MATCHER_NOT_FOUND+"",fe.NAVIGATION_GUARD_REDIRECT+"",fe.NAVIGATION_ABORTED+"",fe.NAVIGATION_CANCELLED+"",fe.NAVIGATION_DUPLICATED+"";function ns(e,t){return ie(new Error,{type:e,[Tr]:!0},t)}function ft(e,t){return e instanceof Error&&Tr in e&&(t==null||!!(e.type&t))}const bc=["params","query","hash"];function yc(e){if(typeof e=="string")return e;if(e.path!=null)return e.path;const t={};for(const s of bc)s in e&&(t[s]=e[s]);return JSON.stringify(t,null,2)}const Ac=Symbol(""),Ji=Symbol(""),ri=Symbol(""),li=Symbol(""),Un=Symbol("");function Or(e){return at(li)}const jr=/#/g,Sc=/&/g,Ec=/\//g,Cc=/=/g,xc=/\?/g,Mr=/\+/g,Ic=/%5B/g,wc=/%5D/g,Dr=/%5E/g,Pc=/%60/g,$r=/%7B/g,Rc=/%7C/g,Nr=/%7D/g,Tc=/%20/g;function ai(e){return e==null?"":encodeURI(""+e).replace(Rc,"|").replace(Ic,"[").replace(wc,"]")}function Oc(e){return ai(e).replace($r,"{").replace(Nr,"}").replace(Dr,"^")}function Ln(e){return ai(e).replace(Mr,"%2B").replace(Tc,"+").replace(jr,"%23").replace(Sc,"%26").replace(Pc,"`").replace($r,"{").replace(Nr,"}").replace(Dr,"^")}function jc(e){return Ln(e).replace(Cc,"%3D")}function Mc(e){return ai(e).replace(jr,"%23").replace(xc,"%3F")}function Dc(e){return Mc(e).replace(Ec,"%2F")}function Ps(e){if(e==null)return null;try{return decodeURIComponent(""+e)}catch{}return""+e}const $c=/\/$/,Nc=e=>e.replace($c,"");function En(e,t,s="/"){let n,i={},o="",r="";const l=t.indexOf("#");let a=t.indexOf("?");return a=l>=0&&a>l?-1:a,a>=0&&(n=t.slice(0,a),o=t.slice(a,l>0?l:t.length),i=e(o.slice(1))),l>=0&&(n=n||t.slice(0,l),r=t.slice(l,t.length)),n=Bc(n??t,s),{fullPath:n+o+r,path:n,query:i,hash:Ps(r)}}function kc(e,t){const s=t.query?e(t.query):"";return t.path+(s&&"?")+s+(t.hash||"")}function Qi(e,t){return!t||!e.toLowerCase().startsWith(t.toLowerCase())?e:e.slice(t.length)||"/"}function Uc(e,t,s){const n=t.matched.length-1,i=s.matched.length-1;return n>-1&&n===i&&is(t.matched[n],s.matched[i])&&kr(t.params,s.params)&&e(t.query)===e(s.query)&&t.hash===s.hash}function is(e,t){return(e.aliasOf||e)===(t.aliasOf||t)}function kr(e,t){if(Object.keys(e).length!==Object.keys(t).length)return!1;for(var s in e)if(!Lc(e[s],t[s]))return!1;return!0}function Lc(e,t){return Je(e)?Yi(e,t):Je(t)?Yi(t,e):(e&&e.valueOf())===(t&&t.valueOf())}function Yi(e,t){return Je(t)?e.length===t.length&&e.every((s,n)=>s===t[n]):e.length===1&&e[0]===t}function Bc(e,t){if(e.startsWith("/"))return e;if(!e)return t;const s=t.split("/"),n=e.split("/"),i=n[n.length-1];(i===".."||i===".")&&n.push("");let o=s.length-1,r,l;for(r=0;r<n.length;r++)if(l=n[r],l!==".")if(l==="..")o>1&&o--;else break;return s.slice(0,o).join("/")+"/"+n.slice(r).join("/")}const Ct={path:"/",name:void 0,params:{},query:{},hash:"",fullPath:"/",matched:[],meta:{},redirectedFrom:void 0};let Bn=(function(e){return e.pop="pop",e.push="push",e})({}),Cn=(function(e){return e.back="back",e.forward="forward",e.unknown="",e})({});function Fc(e){if(!e)if(Xt){const t=document.querySelector("base");e=t&&t.getAttribute("href")||"/",e=e.replace(/^\w+:\/\/[^\/]+/,"")}else e="/";return e[0]!=="/"&&e[0]!=="#"&&(e="/"+e),Nc(e)}const Hc=/^[^#]+#/;function Vc(e,t){return e.replace(Hc,"#")+t}function Kc(e,t){const s=document.documentElement.getBoundingClientRect(),n=e.getBoundingClientRect();return{behavior:t.behavior,left:n.left-s.left-(t.left||0),top:n.top-s.top-(t.top||0)}}const an=()=>({left:window.scrollX,top:window.scrollY});function Wc(e){let t;if("el"in e){const s=e.el,n=typeof s=="string"&&s.startsWith("#"),i=typeof s=="string"?n?document.getElementById(s.slice(1)):document.querySelector(s):s;if(!i)return;t=Kc(i,e)}else t=e;"scrollBehavior"in document.documentElement.style?window.scrollTo(t):window.scrollTo(t.left!=null?t.left:window.scrollX,t.top!=null?t.top:window.scrollY)}function Zi(e,t){return(history.state?history.state.position-t:-1)+e}const Fn=new Map;function qc(e,t){Fn.set(e,t)}function Gc(e){const t=Fn.get(e);return Fn.delete(e),t}function Xc(e){return typeof e=="string"||e&&typeof e=="object"}function Ur(e){return typeof e=="string"||typeof e=="symbol"}function zc(e){const t={};if(e===""||e==="?")return t;const s=(e[0]==="?"?e.slice(1):e).split("&");for(let n=0;n<s.length;++n){const i=s[n].replace(Mr," "),o=i.indexOf("="),r=Ps(o<0?i:i.slice(0,o)),l=o<0?null:Ps(i.slice(o+1));if(r in t){let a=t[r];Je(a)||(a=t[r]=[a]),a.push(l)}else t[r]=l}return t}function eo(e){let t="";for(let s in e){const n=e[s];if(s=jc(s),n==null){n!==void 0&&(t+=(t.length?"&":"")+s);continue}(Je(n)?n.map(i=>i&&Ln(i)):[n&&Ln(n)]).forEach(i=>{i!==void 0&&(t+=(t.length?"&":"")+s,i!=null&&(t+="="+i))})}return t}function Jc(e){const t={};for(const s in e){const n=e[s];n!==void 0&&(t[s]=Je(n)?n.map(i=>i==null?null:""+i):n==null?n:""+n)}return t}function ps(){let e=[];function t(n){return e.push(n),()=>{const i=e.indexOf(n);i>-1&&e.splice(i,1)}}function s(){e=[]}return{add:t,list:()=>e.slice(),reset:s}}function It(e,t,s,n,i,o=r=>r()){const r=n&&(n.enterCallbacks[i]=n.enterCallbacks[i]||[]);return()=>new Promise((l,a)=>{const d=h=>{h===!1?a(ns(fe.NAVIGATION_ABORTED,{from:s,to:t})):h instanceof Error?a(h):Xc(h)?a(ns(fe.NAVIGATION_GUARD_REDIRECT,{from:t,to:h})):(r&&n.enterCallbacks[i]===r&&typeof h=="function"&&r.push(h),l())},c=o(()=>e.call(n&&n.instances[i],t,s,d));let p=Promise.resolve(c);e.length<3&&(p=p.then(d)),p.catch(h=>a(h))})}function xn(e,t,s,n,i=o=>o()){const o=[];for(const r of e)for(const l in r.components){let a=r.components[l];if(!(t!=="beforeRouteEnter"&&!r.instances[l]))if(Rr(a)){const d=(a.__vccOpts||a)[t];d&&o.push(It(d,s,n,r,l,i))}else{let d=a();o.push(()=>d.then(c=>{if(!c)throw new Error(`Couldn't resolve component "${l}" at "${r.path}"`);const p=vc(c)?c.default:c;r.mods[l]=c,r.components[l]=p;const h=(p.__vccOpts||p)[t];return h&&It(h,s,n,r,l,i)()}))}}return o}function Qc(e,t){const s=[],n=[],i=[],o=Math.max(t.matched.length,e.matched.length);for(let r=0;r<o;r++){const l=t.matched[r];l&&(e.matched.find(d=>is(d,l))?n.push(l):s.push(l));const a=e.matched[r];a&&(t.matched.find(d=>is(d,a))||i.push(a))}return[s,n,i]}let Yc=()=>location.protocol+"//"+location.host;function Lr(e,t){const{pathname:s,search:n,hash:i}=t,o=e.indexOf("#");if(o>-1){let r=i.includes(e.slice(o))?e.slice(o).length:1,l=i.slice(r);return l[0]!=="/"&&(l="/"+l),Qi(l,"")}return Qi(s,e)+n+i}function Zc(e,t,s,n){let i=[],o=[],r=null;const l=({state:h})=>{const _=Lr(e,location),C=s.value,E=t.value;let M=0;if(h){if(s.value=_,t.value=h,r&&r===C){r=null;return}M=E?h.position-E.position:0}else n(_);i.forEach(w=>{w(s.value,C,{delta:M,type:Bn.pop,direction:M?M>0?Cn.forward:Cn.back:Cn.unknown})})};function a(){r=s.value}function d(h){i.push(h);const _=()=>{const C=i.indexOf(h);C>-1&&i.splice(C,1)};return o.push(_),_}function c(){if(document.visibilityState==="hidden"){const{history:h}=window;if(!h.state)return;h.replaceState(ie({},h.state,{scroll:an()}),"")}}function p(){for(const h of o)h();o=[],window.removeEventListener("popstate",l),window.removeEventListener("pagehide",c),document.removeEventListener("visibilitychange",c)}return window.addEventListener("popstate",l),window.addEventListener("pagehide",c),document.addEventListener("visibilitychange",c),{pauseListeners:a,listen:d,destroy:p}}function to(e,t,s,n=!1,i=!1){return{back:e,current:t,forward:s,replaced:n,position:window.history.length,scroll:i?an():null}}function ep(e){const{history:t,location:s}=window,n={value:Lr(e,s)},i={value:t.state};i.value||o(n.value,{back:null,current:n.value,forward:null,position:t.length-1,replaced:!0,scroll:null},!0);function o(a,d,c){const p=e.indexOf("#"),h=p>-1?(s.host&&document.querySelector("base")?e:e.slice(p))+a:Yc()+e+a;try{t[c?"replaceState":"pushState"](d,"",h),i.value=d}catch(_){console.error(_),s[c?"replace":"assign"](h)}}function r(a,d){o(a,ie({},t.state,to(i.value.back,a,i.value.forward,!0),d,{position:i.value.position}),!0),n.value=a}function l(a,d){const c=ie({},i.value,t.state,{forward:a,scroll:an()});o(c.current,c,!0),o(a,ie({},to(n.value,a,null),{position:c.position+1},d),!1),n.value=a}return{location:n,state:i,push:l,replace:r}}function tp(e){e=Fc(e);const t=ep(e),s=Zc(e,t.state,t.location,t.replace);function n(o,r=!0){r||s.pauseListeners(),history.go(o)}const i=ie({location:"",base:e,go:n,createHref:Vc.bind(null,e)},t,s);return Object.defineProperty(i,"location",{enumerable:!0,get:()=>t.location.value}),Object.defineProperty(i,"state",{enumerable:!0,get:()=>t.state.value}),i}function sp(e){return e=location.host?e||location.pathname+location.search:"",e.includes("#")||(e+="#"),tp(e)}let kt=(function(e){return e[e.Static=0]="Static",e[e.Param=1]="Param",e[e.Group=2]="Group",e})({});var be=(function(e){return e[e.Static=0]="Static",e[e.Param=1]="Param",e[e.ParamRegExp=2]="ParamRegExp",e[e.ParamRegExpEnd=3]="ParamRegExpEnd",e[e.EscapeNext=4]="EscapeNext",e})(be||{});const np={type:kt.Static,value:""},ip=/[a-zA-Z0-9_]/;function op(e){if(!e)return[[]];if(e==="/")return[[np]];if(!e.startsWith("/"))throw new Error(`Invalid path "${e}"`);function t(_){throw new Error(`ERR (${s})/"${d}": ${_}`)}let s=be.Static,n=s;const i=[];let o;function r(){o&&i.push(o),o=[]}let l=0,a,d="",c="";function p(){d&&(s===be.Static?o.push({type:kt.Static,value:d}):s===be.Param||s===be.ParamRegExp||s===be.ParamRegExpEnd?(o.length>1&&(a==="*"||a==="+")&&t(`A repeatable param (${d}) must be alone in its segment. eg: '/:ids+.`),o.push({type:kt.Param,value:d,regexp:c,repeatable:a==="*"||a==="+",optional:a==="*"||a==="?"})):t("Invalid state to consume buffer"),d="")}function h(){d+=a}for(;l<e.length;){if(a=e[l++],a==="\\"&&s!==be.ParamRegExp){n=s,s=be.EscapeNext;continue}switch(s){case be.Static:a==="/"?(d&&p(),r()):a===":"?(p(),s=be.Param):h();break;case be.EscapeNext:h(),s=n;break;case be.Param:a==="("?s=be.ParamRegExp:ip.test(a)?h():(p(),s=be.Static,a!=="*"&&a!=="?"&&a!=="+"&&l--);break;case be.ParamRegExp:a===")"?c[c.length-1]=="\\"?c=c.slice(0,-1)+a:s=be.ParamRegExpEnd:c+=a;break;case be.ParamRegExpEnd:p(),s=be.Static,a!=="*"&&a!=="?"&&a!=="+"&&l--,c="";break;default:t("Unknown state");break}}return s===be.ParamRegExp&&t(`Unfinished custom RegExp for param "${d}"`),p(),r(),i}const so="[^/]+?",rp={sensitive:!1,strict:!1,start:!0,end:!0};var Re=(function(e){return e[e._multiplier=10]="_multiplier",e[e.Root=90]="Root",e[e.Segment=40]="Segment",e[e.SubSegment=30]="SubSegment",e[e.Static=40]="Static",e[e.Dynamic=20]="Dynamic",e[e.BonusCustomRegExp=10]="BonusCustomRegExp",e[e.BonusWildcard=-50]="BonusWildcard",e[e.BonusRepeatable=-20]="BonusRepeatable",e[e.BonusOptional=-8]="BonusOptional",e[e.BonusStrict=.7000000000000001]="BonusStrict",e[e.BonusCaseSensitive=.25]="BonusCaseSensitive",e})(Re||{});const lp=/[.+*?^${}()[\]/\\]/g;function ap(e,t){const s=ie({},rp,t),n=[];let i=s.start?"^":"";const o=[];for(const d of e){const c=d.length?[]:[Re.Root];s.strict&&!d.length&&(i+="/");for(let p=0;p<d.length;p++){const h=d[p];let _=Re.Segment+(s.sensitive?Re.BonusCaseSensitive:0);if(h.type===kt.Static)p||(i+="/"),i+=h.value.replace(lp,"\\$&"),_+=Re.Static;else if(h.type===kt.Param){const{value:C,repeatable:E,optional:M,regexp:w}=h;o.push({name:C,repeatable:E,optional:M});const x=w||so;if(x!==so){_+=Re.BonusCustomRegExp;try{new RegExp(`(${x})`)}catch(O){throw new Error(`Invalid custom RegExp for param "${C}" (${x}): `+O.message)}}let D=E?`((?:${x})(?:/(?:${x}))*)`:`(${x})`;p||(D=M&&d.length<2?`(?:/${D})`:"/"+D),M&&(D+="?"),i+=D,_+=Re.Dynamic,M&&(_+=Re.BonusOptional),E&&(_+=Re.BonusRepeatable),x===".*"&&(_+=Re.BonusWildcard)}c.push(_)}n.push(c)}if(s.strict&&s.end){const d=n.length-1;n[d][n[d].length-1]+=Re.BonusStrict}s.strict||(i+="/?"),s.end?i+="$":s.strict&&!i.endsWith("/")&&(i+="(?:/|$)");const r=new RegExp(i,s.sensitive?"":"i");function l(d){const c=d.match(r),p={};if(!c)return null;for(let h=1;h<c.length;h++){const _=c[h]||"",C=o[h-1];p[C.name]=_&&C.repeatable?_.split("/"):_}return p}function a(d){let c="",p=!1;for(const h of e){(!p||!c.endsWith("/"))&&(c+="/"),p=!1;for(const _ of h)if(_.type===kt.Static)c+=_.value;else if(_.type===kt.Param){const{value:C,repeatable:E,optional:M}=_,w=C in d?d[C]:"";if(Je(w)&&!E)throw new Error(`Provided param "${C}" is an array but it is not repeatable (* or + modifiers)`);const x=Je(w)?w.join("/"):w;if(!x)if(M)h.length<2&&(c.endsWith("/")?c=c.slice(0,-1):p=!0);else throw new Error(`Missing required param "${C}"`);c+=x}}return c||"/"}return{re:r,score:n,keys:o,parse:l,stringify:a}}function cp(e,t){let s=0;for(;s<e.length&&s<t.length;){const n=t[s]-e[s];if(n)return n;s++}return e.length<t.length?e.length===1&&e[0]===Re.Static+Re.Segment?-1:1:e.length>t.length?t.length===1&&t[0]===Re.Static+Re.Segment?1:-1:0}function Br(e,t){let s=0;const n=e.score,i=t.score;for(;s<n.length&&s<i.length;){const o=cp(n[s],i[s]);if(o)return o;s++}if(Math.abs(i.length-n.length)===1){if(no(n))return 1;if(no(i))return-1}return i.length-n.length}function no(e){const t=e[e.length-1];return e.length>0&&t[t.length-1]<0}const pp={strict:!1,end:!0,sensitive:!1};function up(e,t,s){const n=ap(op(e.path),s),i=ie(n,{record:e,parent:t,children:[],alias:[]});return t&&!i.record.aliasOf==!t.record.aliasOf&&t.children.push(i),i}function dp(e,t){const s=[],n=new Map;t=zi(pp,t);function i(p){return n.get(p)}function o(p,h,_){const C=!_,E=oo(p);E.aliasOf=_&&_.record;const M=zi(t,p),w=[E];if("alias"in p){const O=typeof p.alias=="string"?[p.alias]:p.alias;for(const q of O)w.push(oo(ie({},E,{components:_?_.record.components:E.components,path:q,aliasOf:_?_.record:E})))}let x,D;for(const O of w){const{path:q}=O;if(h&&q[0]!=="/"){const Y=h.record.path,Q=Y[Y.length-1]==="/"?"":"/";O.path=h.record.path+(q&&Q+q)}if(x=up(O,h,M),_?_.alias.push(x):(D=D||x,D!==x&&D.alias.push(x),C&&p.name&&!ro(x)&&r(p.name)),Fr(x)&&a(x),E.children){const Y=E.children;for(let Q=0;Q<Y.length;Q++)o(Y[Q],x,_&&_.children[Q])}_=_||x}return D?()=>{r(D)}:bs}function r(p){if(Ur(p)){const h=n.get(p);h&&(n.delete(p),s.splice(s.indexOf(h),1),h.children.forEach(r),h.alias.forEach(r))}else{const h=s.indexOf(p);h>-1&&(s.splice(h,1),p.record.name&&n.delete(p.record.name),p.children.forEach(r),p.alias.forEach(r))}}function l(){return s}function a(p){const h=_p(p,s);s.splice(h,0,p),p.record.name&&!ro(p)&&n.set(p.record.name,p)}function d(p,h){let _,C={},E,M;if("name"in p&&p.name){if(_=n.get(p.name),!_)throw ns(fe.MATCHER_NOT_FOUND,{location:p});M=_.record.name,C=ie(io(h.params,_.keys.filter(D=>!D.optional).concat(_.parent?_.parent.keys.filter(D=>D.optional):[]).map(D=>D.name)),p.params&&io(p.params,_.keys.map(D=>D.name))),E=_.stringify(C)}else if(p.path!=null)E=p.path,_=s.find(D=>D.re.test(E)),_&&(C=_.parse(E),M=_.record.name);else{if(_=h.name?n.get(h.name):s.find(D=>D.re.test(h.path)),!_)throw ns(fe.MATCHER_NOT_FOUND,{location:p,currentLocation:h});M=_.record.name,C=ie({},h.params,p.params),E=_.stringify(C)}const w=[];let x=_;for(;x;)w.unshift(x.record),x=x.parent;return{name:M,path:E,params:C,matched:w,meta:hp(w)}}e.forEach(p=>o(p));function c(){s.length=0,n.clear()}return{addRoute:o,resolve:d,removeRoute:r,clearRoutes:c,getRoutes:l,getRecordMatcher:i}}function io(e,t){const s={};for(const n of t)n in e&&(s[n]=e[n]);return s}function oo(e){const t={path:e.path,redirect:e.redirect,name:e.name,meta:e.meta||{},aliasOf:e.aliasOf,beforeEnter:e.beforeEnter,props:fp(e),children:e.children||[],instances:{},leaveGuards:new Set,updateGuards:new Set,enterCallbacks:{},components:"components"in e?e.components||null:e.component&&{default:e.component}};return Object.defineProperty(t,"mods",{value:{}}),t}function fp(e){const t={},s=e.props||!1;if("component"in e)t.default=s;else for(const n in e.components)t[n]=typeof s=="object"?s[n]:s;return t}function ro(e){for(;e;){if(e.record.aliasOf)return!0;e=e.parent}return!1}function hp(e){return e.reduce((t,s)=>ie(t,s.meta),{})}function _p(e,t){let s=0,n=t.length;for(;s!==n;){const o=s+n>>1;Br(e,t[o])<0?n=o:s=o+1}const i=gp(e);return i&&(n=t.lastIndexOf(i,n-1)),n}function gp(e){let t=e;for(;t=t.parent;)if(Fr(t)&&Br(e,t)===0)return t}function Fr({record:e}){return!!(e.name||e.components&&Object.keys(e.components).length||e.redirect)}function lo(e){const t=at(ri),s=at(li),n=je(()=>{const a=Ce(e.to);return t.resolve(a)}),i=je(()=>{const{matched:a}=n.value,{length:d}=a,c=a[d-1],p=s.matched;if(!c||!p.length)return-1;const h=p.findIndex(is.bind(null,c));if(h>-1)return h;const _=ao(a[d-2]);return d>1&&ao(c)===_&&p[p.length-1].path!==_?p.findIndex(is.bind(null,a[d-2])):h}),o=je(()=>i.value>-1&&yp(s.params,n.value.params)),r=je(()=>i.value>-1&&i.value===s.matched.length-1&&kr(s.params,n.value.params));function l(a={}){if(bp(a)){const d=t[Ce(e.replace)?"replace":"push"](Ce(e.to)).catch(bs);return e.viewTransition&&typeof document<"u"&&"startViewTransition"in document&&document.startViewTransition(()=>d),d}return Promise.resolve()}return{route:n,href:je(()=>n.value.href),isActive:o,isExactActive:r,navigate:l}}function mp(e){return e.length===1?e[0]:e}const vp=Qo({name:"RouterLink",compatConfig:{MODE:3},props:{to:{type:[String,Object],required:!0},replace:Boolean,activeClass:String,exactActiveClass:String,custom:Boolean,ariaCurrentValue:{type:String,default:"page"},viewTransition:Boolean},useLink:lo,setup(e,{slots:t}){const s=tn(lo(e)),{options:n}=at(ri),i=je(()=>({[co(e.activeClass,n.linkActiveClass,"router-link-active")]:s.isActive,[co(e.exactActiveClass,n.linkExactActiveClass,"router-link-exact-active")]:s.isExactActive}));return()=>{const o=t.default&&mp(t.default(s));return e.custom?o:oi("a",{"aria-current":s.isExactActive?e.ariaCurrentValue:null,href:s.href,onClick:s.navigate,class:i.value},o)}}}),zt=vp;function bp(e){if(!(e.metaKey||e.altKey||e.ctrlKey||e.shiftKey)&&!e.defaultPrevented&&!(e.button!==void 0&&e.button!==0)){if(e.currentTarget&&e.currentTarget.getAttribute){const t=e.currentTarget.getAttribute("target");if(/\b_blank\b/i.test(t))return}return e.preventDefault&&e.preventDefault(),!0}}function yp(e,t){for(const s in t){const n=t[s],i=e[s];if(typeof n=="string"){if(n!==i)return!1}else if(!Je(i)||i.length!==n.length||n.some((o,r)=>o.valueOf()!==i[r].valueOf()))return!1}return!0}function ao(e){return e?e.aliasOf?e.aliasOf.path:e.path:""}const co=(e,t,s)=>e??t??s,Ap=Qo({name:"RouterView",inheritAttrs:!1,props:{name:{type:String,default:"default"},route:Object},compatConfig:{MODE:3},setup(e,{attrs:t,slots:s}){const n=at(Un),i=je(()=>e.route||n.value),o=at(Ji,0),r=je(()=>{let d=Ce(o);const{matched:c}=i.value;let p;for(;(p=c[d])&&!p.components;)d++;return d}),l=je(()=>i.value.matched[r.value]);$s(Ji,je(()=>r.value+1)),$s(Ac,l),$s(Un,i);const a=Me();return Bt(()=>[a.value,l.value,e.name],([d,c,p],[h,_,C])=>{c&&(c.instances[p]=d,_&&_!==c&&d&&d===h&&(c.leaveGuards.size||(c.leaveGuards=_.leaveGuards),c.updateGuards.size||(c.updateGuards=_.updateGuards))),d&&c&&(!_||!is(c,_)||!h)&&(c.enterCallbacks[p]||[]).forEach(E=>E(d))},{flush:"post"}),()=>{const d=i.value,c=e.name,p=l.value,h=p&&p.components[c];if(!h)return po(s.default,{Component:h,route:d});const _=p.props[c],C=_?_===!0?d.params:typeof _=="function"?_(d):_:null,M=oi(h,ie({},C,t,{onVnodeUnmounted:w=>{w.component.isUnmounted&&(p.instances[c]=null)},ref:a}));return po(s.default,{Component:M,route:d})||M}}});function po(e,t){if(!e)return null;const s=e(t);return s.length===1?s[0]:s}const Sp=Ap;function Ep(e){const t=dp(e.routes,e),s=e.parseQuery||zc,n=e.stringifyQuery||eo,i=e.history,o=ps(),r=ps(),l=ps(),a=Cl(Ct);let d=Ct;Xt&&e.scrollBehavior&&"scrollRestoration"in history&&(history.scrollRestoration="manual");const c=Sn.bind(null,y=>""+y),p=Sn.bind(null,Dc),h=Sn.bind(null,Ps);function _(y,N){let T,U;return Ur(y)?(T=t.getRecordMatcher(y),U=N):U=y,t.addRoute(U,T)}function C(y){const N=t.getRecordMatcher(y);N&&t.removeRoute(N)}function E(){return t.getRoutes().map(y=>y.record)}function M(y){return!!t.getRecordMatcher(y)}function w(y,N){if(N=ie({},N||a.value),typeof y=="string"){const g=En(s,y,N.path),v=t.resolve({path:g.path},N),A=i.createHref(g.fullPath);return ie(g,v,{params:h(v.params),hash:Ps(g.hash),redirectedFrom:void 0,href:A})}let T;if(y.path!=null)T=ie({},y,{path:En(s,y.path,N.path).path});else{const g=ie({},y.params);for(const v in g)g[v]==null&&delete g[v];T=ie({},y,{params:p(g)}),N.params=p(N.params)}const U=t.resolve(T,N),z=y.hash||"";U.params=c(h(U.params));const u=kc(n,ie({},y,{hash:Oc(z),path:U.path})),f=i.createHref(u);return ie({fullPath:u,hash:z,query:n===eo?Jc(y.query):y.query||{}},U,{redirectedFrom:void 0,href:f})}function x(y){return typeof y=="string"?En(s,y,a.value.path):ie({},y)}function D(y,N){if(d!==y)return ns(fe.NAVIGATION_CANCELLED,{from:N,to:y})}function O(y){return Q(y)}function q(y){return O(ie(x(y),{replace:!0}))}function Y(y,N){const T=y.matched[y.matched.length-1];if(T&&T.redirect){const{redirect:U}=T;let z=typeof U=="function"?U(y,N):U;return typeof z=="string"&&(z=z.includes("?")||z.includes("#")?z=x(z):{path:z},z.params={}),ie({query:y.query,hash:y.hash,params:z.path!=null?{}:y.params},z)}}function Q(y,N){const T=d=w(y),U=a.value,z=y.state,u=y.force,f=y.replace===!0,g=Y(T,U);if(g)return Q(ie(x(g),{state:typeof g=="object"?ie({},z,g.state):z,force:u,replace:f}),N||T);const v=T;v.redirectedFrom=N;let A;return!u&&Uc(n,U,T)&&(A=ns(fe.NAVIGATION_DUPLICATED,{to:v,from:U}),Qe(U,U,!0,!1)),(A?Promise.resolve(A):X(v,U)).catch(b=>ft(b)?ft(b,fe.NAVIGATION_GUARD_REDIRECT)?b:St(b):ne(b,v,U)).then(b=>{if(b){if(ft(b,fe.NAVIGATION_GUARD_REDIRECT))return Q(ie({replace:f},x(b.to),{state:typeof b.to=="object"?ie({},z,b.to.state):z,force:u}),N||v)}else b=$(v,U,!0,f,z);return le(v,U,b),b})}function Ae(y,N){const T=D(y,N);return T?Promise.reject(T):Promise.resolve()}function V(y){const N=Wt.values().next().value;return N&&typeof N.runWithContext=="function"?N.runWithContext(y):y()}function X(y,N){let T;const[U,z,u]=Qc(y,N);T=xn(U.reverse(),"beforeRouteLeave",y,N);for(const g of U)g.leaveGuards.forEach(v=>{T.push(It(v,y,N))});const f=Ae.bind(null,y,N);return T.push(f),He(T).then(()=>{T=[];for(const g of o.list())T.push(It(g,y,N));return T.push(f),He(T)}).then(()=>{T=xn(z,"beforeRouteUpdate",y,N);for(const g of z)g.updateGuards.forEach(v=>{T.push(It(v,y,N))});return T.push(f),He(T)}).then(()=>{T=[];for(const g of u)if(g.beforeEnter)if(Je(g.beforeEnter))for(const v of g.beforeEnter)T.push(It(v,y,N));else T.push(It(g.beforeEnter,y,N));return T.push(f),He(T)}).then(()=>(y.matched.forEach(g=>g.enterCallbacks={}),T=xn(u,"beforeRouteEnter",y,N,V),T.push(f),He(T))).then(()=>{T=[];for(const g of r.list())T.push(It(g,y,N));return T.push(f),He(T)}).catch(g=>ft(g,fe.NAVIGATION_CANCELLED)?g:Promise.reject(g))}function le(y,N,T){l.list().forEach(U=>V(()=>U(y,N,T)))}function $(y,N,T,U,z){const u=D(y,N);if(u)return u;const f=N===Ct,g=Xt?history.state:{};T&&(U||f?i.replace(y.fullPath,ie({scroll:f&&g&&g.scroll},z)):i.push(y.fullPath,z)),a.value=y,Qe(y,N,T,f),St()}let se;function Se(){se||(se=i.listen((y,N,T)=>{if(!Tt.listening)return;const U=w(y),z=Y(U,Tt.currentRoute.value);if(z){Q(ie(z,{replace:!0,force:!0}),U).catch(bs);return}d=U;const u=a.value;Xt&&qc(Zi(u.fullPath,T.delta),an()),X(U,u).catch(f=>ft(f,fe.NAVIGATION_ABORTED|fe.NAVIGATION_CANCELLED)?f:ft(f,fe.NAVIGATION_GUARD_REDIRECT)?(Q(ie(x(f.to),{force:!0}),U).then(g=>{ft(g,fe.NAVIGATION_ABORTED|fe.NAVIGATION_DUPLICATED)&&!T.delta&&T.type===Bn.pop&&i.go(-1,!1)}).catch(bs),Promise.reject()):(T.delta&&i.go(-T.delta,!1),ne(f,U,u))).then(f=>{f=f||$(U,u,!1),f&&(T.delta&&!ft(f,fe.NAVIGATION_CANCELLED)?i.go(-T.delta,!1):T.type===Bn.pop&&ft(f,fe.NAVIGATION_ABORTED|fe.NAVIGATION_DUPLICATED)&&i.go(-1,!1)),le(U,u,f)}).catch(bs)}))}let Le=ps(),_e=ps(),ae;function ne(y,N,T){St(y);const U=_e.list();return U.length?U.forEach(z=>z(y,N,T)):console.error(y),Promise.reject(y)}function pt(){return ae&&a.value!==Ct?Promise.resolve():new Promise((y,N)=>{Le.add([y,N])})}function St(y){return ae||(ae=!y,Se(),Le.list().forEach(([N,T])=>y?T(y):N()),Le.reset()),y}function Qe(y,N,T,U){const{scrollBehavior:z}=e;if(!Xt||!z)return Promise.resolve();const u=!T&&Gc(Zi(y.fullPath,0))||(U||!T)&&history.state&&history.state.scroll||null;return ss().then(()=>z(y,N,u)).then(f=>f&&Wc(f)).catch(f=>ne(f,y,N))}const $e=y=>i.go(y);let Kt;const Wt=new Set,Tt={currentRoute:a,listening:!0,addRoute:_,removeRoute:C,clearRoutes:t.clearRoutes,hasRoute:M,getRoutes:E,resolve:w,options:e,push:O,replace:q,go:$e,back:()=>$e(-1),forward:()=>$e(1),beforeEach:o.add,beforeResolve:r.add,afterEach:l.add,onError:_e.add,isReady:pt,install(y){y.component("RouterLink",zt),y.component("RouterView",Sp),y.config.globalProperties.$router=Tt,Object.defineProperty(y.config.globalProperties,"$route",{enumerable:!0,get:()=>Ce(a)}),Xt&&!Kt&&a.value===Ct&&(Kt=!0,O(i.location).catch(U=>{}));const N={};for(const U in Ct)Object.defineProperty(N,U,{get:()=>a.value[U],enumerable:!0});y.provide(ri,Tt),y.provide(li,$o(N)),y.provide(Un,a);const T=y.unmount;Wt.add(y),y.unmount=function(){Wt.delete(y),Wt.size<1&&(d=Ct,se&&se(),se=null,a.value=Ct,Kt=!1,ae=!1),T()}}};function He(y){return y.reduce((N,T)=>N.then(()=>V(T)),Promise.resolve())}return Tt}const Cp={class:"header"},xp={class:"container header__inner"},Ip=["aria-expanded"],wp={__name:"Header",setup(e){const t=Me(!1),s=()=>{t.value=!t.value},n=()=>{t.value=!1};return Bt(t,i=>{document.body.style.overflow=i?"hidden":""}),(i,o)=>(k(),F("header",Cp,[m("div",xp,[G(Ce(zt),{to:"/",class:"header__logo",onClick:n},{default:ge(()=>[...o[0]||(o[0]=[Ue(" Nomis ",-1)])]),_:1}),m("nav",{class:We(["header__nav",{"header__nav--open":t.value}])},[G(Ce(zt),{to:"/",class:"header__nav-link",onClick:n},{default:ge(()=>[...o[1]||(o[1]=[Ue("Home",-1)])]),_:1}),G(Ce(zt),{to:"/projects",class:"header__nav-link",onClick:n},{default:ge(()=>[...o[2]||(o[2]=[Ue("Projects",-1)])]),_:1}),G(Ce(zt),{to:"/leadership",class:"header__nav-link",onClick:n},{default:ge(()=>[...o[3]||(o[3]=[Ue("Leadership",-1)])]),_:1}),G(Ce(zt),{to:"/about",class:"header__nav-link",onClick:n},{default:ge(()=>[...o[4]||(o[4]=[Ue("About",-1)])]),_:1}),m("a",{href:"/resume.pdf",target:"_blank",class:"header__nav-link header__nav-link--resume",onClick:n},"Resume")],2),m("button",{class:We(["header__hamburger",{"header__hamburger--open":t.value}]),onClick:s,"aria-expanded":t.value},[...o[5]||(o[5]=[m("span",null,null,-1),m("span",null,null,-1),m("span",null,null,-1)])],10,Ip)])]))}},cn=(e,t)=>{const s=e.__vccOpts||e;for(const[n,i]of t)s[n]=i;return s},Pp={},Rp={class:"footer"};function Tp(e,t){return k(),F("footer",Rp,[...t[0]||(t[0]=[m("div",{class:"container footer__inner"},[m("p",{class:"footer__copy"},"© 2026 Nomis. All rights reserved."),m("a",{href:"mailto:nomis820710@gmail.com",class:"footer__email"},"nomis820710@gmail.com")],-1)])])}const Op=cn(Pp,[["render",Tp]]),jp={__name:"BackToTop",setup(e){const t=Me(!1),s=()=>{t.value=window.scrollY>400},n=()=>{window.scrollTo({top:0,behavior:"smooth"})};return Ht(()=>window.addEventListener("scroll",s)),Vt(()=>window.removeEventListener("scroll",s)),(i,o)=>(k(),F("button",{class:We(["back-to-top",{"back-to-top--visible":t.value}]),onClick:n,"aria-label":"回到頂部"},[...o[0]||(o[0]=[m("i",{class:"fa-solid fa-arrow-up"},null,-1)])],2))}},Mp={__name:"App",setup(e){return(t,s)=>{const n=os("RouterView");return k(),F(ee,null,[G(wp),m("main",null,[G(n,null,{default:ge(({Component:i})=>[G(Va,{name:"fade",mode:"out-in"},{default:ge(()=>[(k(),Pt(Ql(i)))]),_:2},1024)]),_:1})]),G(Op),G(jp)],64)}}},Dp=cn(Mp,[["__scopeId","data-v-91c92250"]]),$p="/portfolio/images/general/hero-photo.jpg",Np="/portfolio/images/general/avatar-chen.jpg",kp="/portfolio/images/general/avatar-liao.jpg";function mt(e){return"/portfolio/"+e.replace(/^\//,"")}const Up={class:"project-card__cover"},Lp=["src","alt"],Bp={class:"project-card__body"},Fp={class:"project-card__hashtags"},Hp={class:"project-card__title"},Vp={class:"project-card__desc"},Kp={class:"project-card__tags"},Hr={__name:"ProjectCard",props:{project:{type:Object,required:!0}},setup(e){return(t,s)=>{const n=os("RouterLink");return k(),Pt(n,{to:`/projects/${e.project.id}`,class:"project-card"},{default:ge(()=>[m("div",Up,[m("img",{src:Ce(mt)(e.project.cover),alt:e.project.title},null,8,Lp)]),m("div",Bp,[m("div",Fp,[(k(!0),F(ee,null,me(e.project.hashtags,i=>(k(),F("span",{key:i,class:"project-card__hashtag"}," #"+J(i),1))),128))]),m("h3",Hp,J(e.project.title),1),m("p",Vp,J(e.project.description),1),m("div",Kp,[(k(!0),F(ee,null,me(e.project.tags,i=>(k(),F("span",{key:i,class:"project-card__tag"},J(i),1))),128))])]),s[0]||(s[0]=m("div",{class:"project-card__cta"}," 查看專案 → ",-1))]),_:1},8,["to"])}}},ys=[{id:"elementary-king-ai-mv",title:"成本降低 99.7%：一人 15 天用 AI 完成傳統團隊 120 萬的動畫 MV",description:"公司尾牙業務表揚大會需要造勢影片，我在無預算、無團隊、無動畫背景的條件下，自主規劃 12 階段 AI 製作流程，獨立完成一部含 6 個角色的 3D 動畫 MV。影片現場引爆掌聲，董事長當場轉發集團主管群，並直接強化公司全面導入 AI 工具的決策。",cover:"/images/projects/elementary-king-ai-mv/cover.png",hashtags:["AI-Native Workflow","跨職能執行力","ROI 極大化"],tags:["AI","Cross-functional"],category:["ai"],content:`
    <!-- 成效數字 -->
  ...
  `}],Wp={__name:"HeroCanvas",setup(e){const t=Me(null);let s=null;return Ht(()=>{const n=t.value,i=n.getContext("2d"),o=()=>{n.width=n.offsetWidth,n.height=n.offsetHeight};o(),window.addEventListener("resize",o);const l=Array.from({length:80},()=>({x:Math.random()*n.width,y:Math.random()*n.height,vx:(Math.random()-.5)*.3,vy:(Math.random()-.5)*.3,r:Math.random()*2+1}));let a=0;const d=()=>{n.width=n.offsetWidth,n.height=n.offsetHeight;const c=n.width,p=n.height;i.clearRect(0,0,c,p),a+=.005;const h=(Math.sin(a)+1)/2,_=i.createRadialGradient(c*.15,p*.5,0,c*.15,p*.5,c*.55);_.addColorStop(0,`rgba(79,142,247,${.25+h*.12})`),_.addColorStop(1,"transparent"),i.fillStyle=_,i.fillRect(0,0,c,p);const C=i.createRadialGradient(c*.85,p*.2,0,c*.85,p*.2,c*.45);C.addColorStop(0,`rgba(124,95,247,${.15+h*.1})`),C.addColorStop(1,"transparent"),i.fillStyle=C,i.fillRect(0,0,c,p);const E=i.createRadialGradient(c*.6,p*.8,0,c*.6,p*.8,c*.3);E.addColorStop(0,`rgba(79,142,247,${.08+h*.06})`),E.addColorStop(1,"transparent"),i.fillStyle=E,i.fillRect(0,0,c,p),l.forEach(w=>{w.x+=w.vx,w.y+=w.vy,(w.x<0||w.x>c)&&(w.vx*=-1),(w.y<0||w.y>p)&&(w.vy*=-1)});const M=130;for(let w=0;w<l.length;w++)for(let x=w+1;x<l.length;x++){const D=l[w].x-l[x].x,O=l[w].y-l[x].y,q=Math.sqrt(D*D+O*O);if(q<M){const Y=(1-q/M)*.35;i.beginPath(),i.moveTo(l[w].x,l[w].y),i.lineTo(l[x].x,l[x].y),i.strokeStyle=`rgba(79,142,247,${Y})`,i.lineWidth=.8,i.stroke()}}l.forEach(w=>{i.beginPath(),i.arc(w.x,w.y,w.r,0,Math.PI*2),i.fillStyle="rgba(79,142,247,0.65)",i.fill()}),s=requestAnimationFrame(d)};Vt(()=>{cancelAnimationFrame(s),window.removeEventListener("resize",o)}),d()}),(n,i)=>(k(),F("canvas",{ref_key:"canvasRef",ref:t,class:"hero-canvas"},null,512))}},qp=cn(Wp,[["__scopeId","data-v-92edd766"]]),Gp={class:"home"},Xp={class:"hero section"},zp={class:"projects-preview section"},Jp={class:"container"},Qp={class:"projects-preview__grid"},Yp={class:"leadership-preview section"},Zp={class:"container leadership-preview__inner"},eu={class:"leadership-preview__content"},tu={class:"leadership-preview__articles"},su={class:"skills section"},nu={class:"container"},iu={class:"skills__grid"},ou={class:"skills__card-title"},ru={class:"skills__card-list"},lu={class:"skills__card-tags"},au={__name:"Home",setup(e){const t=[{title:"UIUX 設計",items:["使用者研究","資訊架構","互動設計","視覺設計"],tags:[{label:"查看 UIUX 專案",link:"/projects?tag=UIUX"}]},{title:"前端切版",items:["Vue.js","HTML / CSS","RWD","SCSS"],tags:[{label:"查看切版專案",link:"/projects?tag=Frontend"}]},{title:"設計策略",items:["競品分析","A/B 測試","數據分析","設計系統"],tags:[{label:"查看相關專案",link:"/projects?tag=Growth Design"}]},{title:"設計領導",items:["團隊管理","跨部門協作","設計評審","人才培育"],tags:[{label:"閱讀 Leadership 文章",link:"/leadership"}]},{title:"AI 產品設計",items:["AI 框架制定","AI 互動設計","信任設計","Prompt 設計"],tags:[{label:"查看 AI 專案",link:"/projects?tag=AI"}]},{title:"溝通與協作",items:["利害關係人溝通","設計提案","跨文化協作","衝突處理"],tags:[{label:"閱讀 Leadership 文章",link:"/leadership"}]},{title:"使用者研究",items:["使用者訪談","易用性測試","問卷設計","研究報告"],tags:[{label:"查看研究相關專案",link:"/projects?tag=Research"}]},{title:"數據驅動設計",items:["數據判讀","A/B 測試規劃","轉換率優化","成效追蹤"],tags:[{label:"查看相關專案",link:"/projects?tag=A/B Testing"}]},{title:"成長心態",items:["快速學習","主動解決問題","接受回饋","持續優化"],tags:[{label:"閱讀我的反思文章",link:"/leadership"}]}];return(s,n)=>{const i=os("RouterLink");return k(),F("div",Gp,[m("section",Xp,[G(qp),n[0]||(n[0]=es('<div class="container hero__inner"><div class="hero__content"><h1 class="hero__title">嗨，我是 Nomis！</h1><p class="hero__subtitle">UIUX 設計師・前端工程師・設計主管</p><p class="hero__desc"> 擅長以數據驅動設計決策，打造以使用者為中心的產品體驗，跨文化協作與跨部門溝通是我的強項。 </p><div class="hero__cta"><a href="/portfolio/resume.pdf" target="_blank" class="btn btn--primary">下載履歷</a><a href="https://www.linkedin.com/in/" target="_blank" class="btn btn--secondary">LinkedIn</a><a href="mailto:nomis820710@gmail.com" class="btn btn--secondary">聯絡我</a></div></div><div class="hero__photo"><img src="'+$p+'" alt="Nomis Yang"></div></div>',1))]),n[10]||(n[10]=es('<section class="features section"><div class="container features__grid"><div class="features__item"><h3 class="features__title">跨領域設計能力</h3><p class="features__desc"> 橫跨 UIUX 設計、前端切版與設計管理，能從使用者研究、視覺設計到程式實作一手包辦，確保設計落地不失真。 </p></div><div class="features__item"><h3 class="features__title">數據驅動的設計決策</h3><p class="features__desc"> 習慣以數據佐證設計方向，透過 A/B 測試、使用者訪談與競品分析，持續優化產品體驗並創造可量化的成效。 </p></div><div class="features__item"><h3 class="features__title">跨部門協作與領導</h3><p class="features__desc"> 具備帶領設計團隊的實戰經驗，善於在產品、工程與商業目標之間建立共識，推動專案從 0 到 1 順利落地。 </p></div></div></section>',1)),m("section",zp,[m("div",Jp,[m("div",Qp,[(k(!0),F(ee,null,me(Ce(ys),o=>(k(),Pt(Hr,{key:o.id,project:o},null,8,["project"]))),128))])])]),m("section",Yp,[m("div",Zp,[m("div",eu,[n[2]||(n[2]=m("p",{class:"leadership-preview__label"},"Leadership",-1)),n[3]||(n[3]=m("h2",{class:"leadership-preview__title"},"設計領導力的實踐與反思",-1)),n[4]||(n[4]=m("p",{class:"leadership-preview__desc"}," 從個人貢獻者到帶領團隊，我持續記錄在設計管理路上的觀察與學習。 包含團隊管理心得、專案決策過程、帶人的方法論，以及個人成長反思。 ",-1)),G(i,{to:"/leadership",class:"btn btn--primary"},{default:ge(()=>[...n[1]||(n[1]=[Ue(" 閱讀更多文章 → ",-1)])]),_:1})]),m("div",tu,[G(i,{to:"/leadership/psychological-safety",class:"leadership-preview__article"},{default:ge(()=>[...n[5]||(n[5]=[m("p",{class:"leadership-preview__article-tag"},"帶團隊的方法論",-1),m("h4",{class:"leadership-preview__article-title"},"如何在設計評審中建立心理安全感",-1),m("p",{class:"leadership-preview__article-cta"},"閱讀文章 →",-1)])]),_:1}),G(i,{to:"/leadership/design-vs-business",class:"leadership-preview__article"},{default:ge(()=>[...n[6]||(n[6]=[m("p",{class:"leadership-preview__article-tag"},"專案決策過程",-1),m("h4",{class:"leadership-preview__article-title"},"當設計目標與商業目標衝突時，我怎麼做決定",-1),m("p",{class:"leadership-preview__article-cta"},"閱讀文章 →",-1)])]),_:1}),G(i,{to:"/leadership/designer-to-lead",class:"leadership-preview__article"},{default:ge(()=>[...n[7]||(n[7]=[m("p",{class:"leadership-preview__article-tag"},"個人成長反思",-1),m("h4",{class:"leadership-preview__article-title"},"從設計師到設計主管：角色轉換的第一年",-1),m("p",{class:"leadership-preview__article-cta"},"閱讀文章 →",-1)])]),_:1})])])]),m("section",su,[m("div",nu,[n[8]||(n[8]=m("p",{class:"skills__label"},"How I Contribute",-1)),n[9]||(n[9]=m("h2",{class:"skills__title"},"我如何用專業技能貢獻",-1)),m("div",iu,[(k(),F(ee,null,me(t,o=>m("div",{key:o.title,class:"skills__card"},[m("h4",ou,J(o.title),1),m("ul",ru,[(k(!0),F(ee,null,me(o.items,r=>(k(),F("li",{key:r},J(r),1))),128))]),m("div",lu,[(k(!0),F(ee,null,me(o.tags,r=>(k(),Pt(i,{key:r.label,to:r.link,class:"skills__card-tag"},{default:ge(()=>[Ue(J(r.label),1)]),_:2},1032,["to"]))),128))])])),64))])])]),n[11]||(n[11]=es('<section class="testimonials section"><div class="container"><p class="testimonials__label">Recommendations</p><h2 class="testimonials__title">他們這樣說</h2><div class="testimonials__grid"><div class="testimonials__card"><p class="testimonials__card-title">執行力與溝通能力超乎預期，對回饋保持開放</p><p class="testimonials__card-content"> Nomis 是一位充滿熱情的 UIUX 設計師，以創新思維和快速適應新挑戰的能力著稱。 她的執行速度與溝通品質持續超乎預期，是團隊中不可或缺的夥伴。 對回饋始終保持開放，持續尋求改進，對團隊的成功貢獻良多。 </p><div class="testimonials__card-author"><img src="'+Np+'" alt="陳大明" class="testimonials__card-avatar"><div><p class="testimonials__card-name">陳大明</p><p class="testimonials__card-role">2024年6月・iOS 工程師・直接主管</p></div></div></div><div class="testimonials__card"><p class="testimonials__card-title">能理解並轉化使用者需求為直覺且美觀的設計</p><p class="testimonials__card-content"> 與 Nomis 共事是非常愉快的經驗。她始終展現出理解並將使用者需求轉化為直覺且視覺吸引力設計的能力。 她的創意和解決問題的技巧在應對專案挑戰時發揮了關鍵作用。 支持性的個性與強大的溝通技巧營造了積極的協作環境，是可靠又具創新力的夥伴。 </p><div class="testimonials__card-author"><img src="'+kp+'" alt="廖小華" class="testimonials__card-avatar"><div><p class="testimonials__card-name">廖小華</p><p class="testimonials__card-role">2024年6月・產品經理・同團隊成員</p></div></div></div></div></div></section>',1))])}}},cu={class:"projects-page"},pu={class:"projects-list section"},uu={class:"container"},du={class:"projects-list__filters"},fu=["onClick"],hu={class:"projects-list__grid"},_u={key:0,class:"projects-list__empty"},gu={__name:"Projects",setup(e){const t=["All",...new Set(ys.flatMap(i=>i.tags))],s=Me("All"),n=je(()=>s.value==="All"?ys:ys.filter(i=>i.tags.includes(s.value)));return(i,o)=>(k(),F("div",cu,[o[0]||(o[0]=es('<section class="projects-hero section"><div class="container"><p class="projects-hero__label">My Work</p><h1 class="projects-hero__title">Projects</h1><p class="projects-hero__desc"> 橫跨 UIUX 設計、前端切版與 AI 產品設計的實戰專案，每個專案都有可量化的成效與完整的設計思考過程。 </p></div></section>',1)),m("section",pu,[m("div",uu,[m("div",du,[(k(),F(ee,null,me(t,r=>m("button",{key:r,class:We(["projects-list__filter",{"projects-list__filter--active":s.value===r}]),onClick:l=>s.value=r},J(r),11,fu)),64))]),m("div",hu,[(k(!0),F(ee,null,me(n.value,r=>(k(),Pt(Hr,{key:r.id,project:r},null,8,["project"]))),128))]),n.value.length===0?(k(),F("p",_u," 目前沒有符合此分類的專案。 ")):Er("",!0)])])]))}},mu={key:0,class:"project-detail"},vu={class:"project-detail-hero section"},bu={class:"container"},yu={class:"project-detail-hero__hashtags"},Au={class:"project-detail-hero__title"},Su={class:"project-detail-hero__desc"},Eu={class:"project-detail-hero__tags"},Cu={class:"project-detail-cover"},xu={class:"container"},Iu=["src","alt"],wu={class:"project-detail-content section"},Pu={class:"container project-detail-content__layout"},Ru={class:"toc-float__panel"},Tu={class:"toc-float__list"},Ou=["onClick"],ju={class:"toc-sidebar"},Mu={class:"toc-sidebar__list"},Du=["onClick"],$u=["innerHTML"],Nu={class:"project-detail-nav section"},ku={class:"container"},Uu={key:1,class:"project-detail-notfound section"},Lu={class:"container"},Bu={__name:"ProjectDetail",setup(e){const t=Or(),s=je(()=>ys.find(c=>c.id===t.params.id)),n=Me([]),i=Me(""),o=Me(null),r=Me(!1),l=()=>{if(!o.value)return;const c=o.value.querySelectorAll("h2, h3");n.value=Array.from(c).map((p,h)=>{const _=`heading-${h}`;return p.id=_,{id:_,text:p.textContent,level:p.tagName}})},a=()=>{if(!o.value)return;const c=o.value.querySelectorAll("h2, h3");let p="";c.forEach(h=>{h.getBoundingClientRect().top<=350&&(p=h.id)}),i.value=p},d=c=>{const p=document.getElementById(c);p&&p.scrollIntoView({behavior:"smooth",block:"start"})};return Ht(()=>{ss(()=>{l(),window.addEventListener("scroll",a)})}),Vt(()=>{window.removeEventListener("scroll",a)}),Bt(s,()=>{ss(()=>l())}),(c,p)=>{const h=os("RouterLink");return s.value?(k(),F("div",mu,[m("section",vu,[m("div",bu,[G(h,{to:"/projects",class:"project-detail-hero__back"},{default:ge(()=>[...p[1]||(p[1]=[Ue("← 返回 Projects",-1)])]),_:1}),m("div",yu,[(k(!0),F(ee,null,me(s.value.hashtags,_=>(k(),F("span",{key:_,class:"project-detail-hero__hashtag"},"#"+J(_),1))),128))]),m("h1",Au,J(s.value.title),1),m("p",Su,J(s.value.description),1),m("div",Eu,[(k(!0),F(ee,null,me(s.value.tags,_=>(k(),F("span",{key:_,class:"project-detail-hero__tag"},J(_),1))),128))])])]),m("div",Cu,[m("div",xu,[m("img",{src:Ce(mt)(s.value.cover),alt:s.value.title,class:"project-detail-cover__img"},null,8,Iu)])]),m("section",wu,[m("div",Pu,[m("div",{class:We(["toc-float",{"toc-float--open":r.value}])},[m("button",{class:"toc-float__toggle",onClick:p[0]||(p[0]=_=>r.value=!r.value),"aria-label":"目錄"},[...p[2]||(p[2]=[m("i",{class:"fa-solid fa-list"},null,-1)])]),m("div",Ru,[p[3]||(p[3]=m("p",{class:"toc-float__title"},"目錄",-1)),m("ul",Tu,[(k(!0),F(ee,null,me(n.value,_=>(k(),F("li",{key:_.id},[m("a",{onClick:Xs(C=>{d(_.id),r.value=!1},["prevent"]),href:"#"},J(_.text),9,Ou)]))),128))])])],2),m("aside",ju,[p[4]||(p[4]=m("p",{class:"toc-sidebar__title"},"目錄",-1)),m("ul",Mu,[(k(!0),F(ee,null,me(n.value,_=>(k(),F("li",{key:_.id,class:"toc-sidebar__item"},[m("a",{onClick:Xs(C=>d(_.id),["prevent"]),href:"#",class:We(["toc-sidebar__link",{"toc-sidebar__link--active":i.value===_.id}])},J(_.text),11,Du)]))),128))])]),m("div",{class:"project-detail-content__body",ref_key:"contentRef",ref:o,innerHTML:s.value.content},null,8,$u)])]),m("section",Nu,[m("div",ku,[G(h,{to:"/projects",class:"btn btn--secondary"},{default:ge(()=>[...p[5]||(p[5]=[Ue("← 查看所有專案",-1)])]),_:1})])])])):(k(),F("div",Uu,[m("div",Lu,[p[7]||(p[7]=m("h1",null,"找不到此專案",-1)),G(h,{to:"/projects",class:"btn btn--primary"},{default:ge(()=>[...p[6]||(p[6]=[Ue("返回 Projects",-1)])]),_:1})])]))}}},Fu={class:"article-card__cover"},Hu=["src","alt"],Vu={class:"article-card__body"},Ku={class:"article-card__hashtags"},Wu={class:"article-card__title"},qu={class:"article-card__desc"},Gu={class:"article-card__date"},Xu={__name:"ArticleCard",props:{article:{type:Object,required:!0}},setup(e){return(t,s)=>{const n=os("RouterLink");return k(),Pt(n,{to:`/leadership/${e.article.id}`,class:"article-card"},{default:ge(()=>[m("div",Fu,[m("img",{src:Ce(mt)(e.article.cover),alt:e.article.title},null,8,Hu)]),m("div",Vu,[m("div",Ku,[(k(!0),F(ee,null,me(e.article.hashtags,i=>(k(),F("span",{key:i,class:"article-card__hashtag"}," #"+J(i),1))),128))]),m("h3",Wu,J(e.article.title),1),m("p",qu,J(e.article.description),1),m("p",Gu,J(e.article.date),1)]),s[0]||(s[0]=m("div",{class:"article-card__cta"}," 閱讀文章 → ",-1))]),_:1},8,["to"])}}},Ls=[{id:"equal-treatment-trap",title:"我以為一視同仁是公平，這機會卻差點壓垮了她",description:"把同一份標準套在每個人身上，不一定是公平，有時候是一種忽視。這篇文章分享我如何在一個新手設計師的第一個獨立 UIUX 專案中，從「太晚發現問題」到「找到適合她的工作方式」。",cover:"/images/articles/article-1.jpg",hashtags:["工作拆解","因材施教","設計師成長"],tags:["個人成長反思","設計團隊管理心得","專案決策過程"],date:"2026-02-06",content:`
    <p>我在帶設計團隊的過程中，一直有一個原則：對每個人用同樣的標準。不偏心、不特例、不因為誰資深就放寬、因為誰資淺就降低期待。</p>

    <p>我以為這是公平，直到有一天，我意識到自己用這份「公平」，差點壓垮了一個正在努力的人。</p>
    ...
    <p>在我接手設計主管這個角色之後，我一直有一個想法：我希望每位設計師，都能在這間公司至少留下一個屬於自己的代表作。</p>
    ...
    <p>我要求她先畫 Wireframe，黑白、簡單就好，不需要處理任何視覺。這個階段只有一個任務：想清楚架構、操作邏輯，以及不同裝置斷點下的呈現方式。Wireframe 畫完，先開會過稿、修改確認，再進入 UI、處理視覺。</p>

    <p>這份排程，就是這樣產生的。每個模組分開列，標記 Wireframe 和 UI 的時間區間，並且插入幾個固定的會議節點，作為確認進度的檢查點。</p>

    <img src="/images/articles/equal-treatment-trap/design-schedule.jpg" alt="為設計師重新規劃的 Design Schedule，包含 Wireframe 與 UI 兩個階段" />
    ...
    <p>她說：「這樣分確實清楚多了」。我幫她看清了她自己的盲點，用一個適合她的方式重新安排工作，反而讓她成長得更快。</p>

    <p>但最讓我意想不到的，是後來發生的事。</p>
    ...
    <p>如果要說這件事讓我最大的收穫是什麼，不是「我幫她解決了問題」，而是我更清楚看到自己身為主管的責任邊界在哪裡。</p>

    <p>我在這件事上表現出來的，不是很厲害的管理技巧，而是一些其實很基本、但我差點忽略的事：用心聽她說了什麼、理解她的處境而不是急著評判、在專案時程允許的範圍內，找到一個對她和對專案都說得過去的平衡點。</p>

    <p>溝通也是。她在那場對話裡是帶著情緒的，有點自我懷疑，有點疲憊，也有點不確定我會怎麼反應。我沒有急著給建議，而是先讓她說完，讓她知道我理解她的難處，然後我們才一起想怎麼走下去。</p>

    <p>但我也有很清楚的自責：我應該更早介入。</p>
    ...
    <p>我現在會更常問自己：我給的是「對大家都一樣的東西」，還是<strong>「這個人現在真正需要的東西」</strong>？這兩個問題，聽起來很像，但答案往往差很遠。</p>
  `},{id:"design-team-okr-performance-system",title:"當 KPI 無法衡量設計師：我如何為設計部打造一套 OKR 績效系統",description:"我發現公司的 KPI 制度無法真正衡量設計師的工作表現，所以我決定主動做出改變。這篇文章記錄了我從發現問題、提案、到實際落地一整套 OKR 績效系統的完整歷程。",cover:"/images/articles/article-2.jpg",hashtags:["績效制度設計","行為指標量化","管理成本優化"],tags:["設計團隊管理心得","帶團隊的方法論"],date:"2026-01-31",content:`
  ...
  `},{id:"team-feedback-letter",title:"我用 360 度評核，給團隊夥伴寄了一封信",description:"當了主管之後，我報名了一堂管理課，不是因為不會，而是想驗證自己走的路是否正確。這篇文章關於我如何用 360 度評核的概念，做了一件讓整個團隊都沒預料到的事。",cover:"/images/articles/article-3.jpg",hashtags:["360度回饋機制","匿名問卷設計","團隊正向文化"],tags:["設計團隊管理心得","帶團隊的方法論"],date:"2025-07-25",content:`
    ...
    <p>我在日常相處中觀察到，其實每個夥伴對自己的標準都很高，往往很清楚別人哪裡好，卻很少看到自己的優點。我希望這份問卷，能讓每個人得到一份「別人眼中的我」。</p>
    ...
    <p>大家一開始都愣住了，她們覺得好精緻、好有儀式感。信封還沒拆，大家就紛紛拿出手機拍照，然後我們拍了一張合照，紀念這個時刻。</p>

    <img src="/images/articles/team-feedback-letter/unboxing.jpg" alt="設計團隊收到信封的合照" />
    ...
    <p>我沒想到她們這樣看我，我以為我只是在努力不讓事情失控，但<strong>在她們眼中，那叫做穩定、那叫做領導</strong>。這個落差，讓我重新思考了一件事：有時候，你以為自己只是在「撐著」，但對團隊來說，那就是一種安全感的來源。</p>

    <h2>讓我意外的，是那場雙週會</h2>

    <p>拆信之後，我們自發地做了一件事：大家以某位夥伴為主角，其他人輪流說出欣賞這位夥伴的地方，問她一些心路歷程，或者討教某個能力是怎麼培養的，然後換下一位。</p>
  ...
  `},{id:"design-request-collaboration-guide",title:"當全公司都把設計師當通靈師，我決定立一條規矩",description:"設計師不是不夠專業，是需求方從來不知道怎麼給需求。這篇文章記錄了我如何從一張拖了一週才結案的 DM，決定用一份正式指南改變整個公司的設計協作文化。",cover:"/images/articles/article-1.jpg",hashtags:["需求規格制度化","跨部門協作重建","設計資源保護"],tags:["帶團隊的方法論","專案決策過程"],date:"2025-06-01",content:`
    <p>有一段時間，設計部幾乎每個禮拜都有「急件」。</p>

    <p>不是公司的業務真的那麼緊迫，而是需求方在最後一刻才想到設計這件事，然後拿著「很急，明天就要」這句話，要求設計師排開手上所有案子、優先處理。</p>

    <p>我後來意識到，這不是個人素質的問題，而是一個<strong>系統性的漏洞</strong>：整個公司沒有人告訴大家，設計需求應該怎麼給、需要哪些資訊、設計師需要多少時間。在這個框架不存在的情況下，一切都靠設計師自己吸收。</p>

    <h2>從 UIUX 團隊，到全公司的設計部</h2>

    <p>2023 年 3 月，設計部成立時，我們接收到的定位很清楚：隸屬於研發資訊處，主力是數位產品的 UIUX 設計，偶爾協助行銷 Landing Page、活動 Banner 或海報、產品包裝...等平面設計需求，是可接受的範圍。</p>

    <p>但大約在 2024 年下半年，一切開始改變。設計部從研發底下獨立出來，升格為全公司的設計部。需求的來源更多，類型更雜：線下活動主視覺、活動輸出物、展場帳篷設計、遊樂設施列車外觀、IP 人物三視圖、Unity 3D 環境美術、各種場合的簡報製作......幾乎什麼都有。</p>

    <p>知道這個消息時，我是憂喜參半的：設計部能見度變高、代表成長空間變大；但隱約也知道，這會帶來很多我們還沒準備好的東西。</p>

    <p>果然，隨著需求量增加，問題也跟著浮現：需求往往經過很多手傳遞，資訊在每一層都被稀釋，最後落到設計師手上時，幾乎什麼都沒有。最讓我印象深刻的，是公司與產品 Logo 的重新設計案。老闆說要重做，但品牌新方向是什麼、期待什麼風格、想傳遞什麼感覺，層層問下去都問不出答案，得到的只有「你們先自由發揮，出三版再說」。那個案子從 2025 年初啟動，到我寫這篇文章為止，我們已經做了快 12 款 Logo，還沒結案。</p>
    ...
    <p>身為主管的我，無法接受的不是需求本身的修改，而是<strong>這種工作方式在扯整個設計部的後腿，也在扯公司的後腿</strong>。</p>

    <h2>對比：同一個時期，另一個「很急」的案子</h2>

    <p>幾乎就在同一段時間，行銷部發來一個需求：一週內完成一份 20 頁的產品介紹文宣。</p>

    <p>但他們給需求的方式完全不同，他們用一份 Google Slide 把每一頁的文案、風格期待、排版參考、視覺方向，完完整整整理好，一次交給設計部。我當時派了兩位設計師，一人負責 10 頁並行推進，結果不只準時完成，還提前一天交付。</p>
    ...
    <p>但效果有限，口頭說說，隔一個案子又回到原點。我慢慢意識到，這件事需要被提升到<strong>「內部規範」</strong>的層次，才會被真正重視，才有機會改變整個協作文化。</p>

    <h2>把「好的協作方式」變成一份正式文件</h2>

    <p>我花了一段時間，把設計部對需求方的期待，整理成一份《設計需求提交合作指南》。</p>
    ...
    <h2>一年後，設計師說：焦慮變少了</h2>

    <p>指南上線後，變化是慢慢發生的。</p>

    <p>2025 年下半年，設計師們開始反映，急件變少了。各單位在開 Jira 工單前，會先來找我討論需求的組成，確認還缺什麼資訊，甚至開始嘗試理解設計師的語言，問我「需求這樣給，設計師方便作業嗎？」。</p>
  ...
  `},{id:"uiux-designer-competency-map",title:"當設計師問我「我該往哪裡走」，我決定親手畫一張地圖",description:"設計師不是能力不夠，而是從來沒有人告訴他們，自己站在哪裡？一個半路出家的設計主管，如何用人資背景為團隊建立職能模型，讓成長這件事變得有憑有據。",cover:"/images/articles/article-2.jpg",hashtags:["職能模型建立","能力可視化","人資思維跨界應用"],tags:["個人成長反思","帶團隊的方法論"],date:"2025-03-15",content:`
  ...
  `},{id:"impossible-deadline-two-weeks",title:"我們如何在兩週內，完成一個不可能的任務",description:"老闆踩死的 deadline、PM 規劃一個月才丟來的需求，但最後設計部不只準時交付，還讓我看見一件更重要的事：真正讓任務得以完成的力量，早在這個專案之前就已經存在了。",cover:"/images/articles/article-3.jpg",hashtags:["任務拆解與同步推進","自主分工設計","長期信任感積累"],tags:["帶團隊的方法論","專案決策過程"],date:"2025-02-24",content:`
    ...
    <p>我何德何能，有這樣一群夥伴。</p>
  `}],zu={class:"leadership-page"},Ju={class:"leadership-list section"},Qu={class:"container"},Yu={class:"leadership-list__filters"},Zu=["onClick"],ed={class:"leadership-list__grid"},td={key:0,class:"leadership-list__empty"},sd={__name:"Leadership",setup(e){const t=["All",...new Set(Ls.flatMap(i=>i.tags))],s=Me("All"),n=je(()=>s.value==="All"?Ls:Ls.filter(i=>i.tags.includes(s.value)));return(i,o)=>(k(),F("div",zu,[o[0]||(o[0]=es('<section class="leadership-hero section"><div class="container"><p class="leadership-hero__label">My Thoughts</p><h1 class="leadership-hero__title">Leadership</h1><p class="leadership-hero__desc"> 記錄我在設計管理路上真實發生的事：那些摸索過的方法論、踩過的決策、帶人時的觀察，以及在過程中慢慢長出來的反思。 </p></div></section>',1)),m("section",Ju,[m("div",Qu,[m("div",Yu,[(k(),F(ee,null,me(t,r=>m("button",{key:r,class:We(["leadership-list__filter",{"leadership-list__filter--active":s.value===r}]),onClick:l=>s.value=r},J(r),11,Zu)),64))]),m("div",ed,[(k(!0),F(ee,null,me(n.value,r=>(k(),Pt(Xu,{key:r.id,article:r},null,8,["article"]))),128))]),n.value.length===0?(k(),F("p",td," 目前沒有符合此分類的文章。 ")):Er("",!0)])])]))}},nd={key:0,class:"article-detail"},id={class:"article-detail-hero section"},od={class:"container"},rd={class:"article-detail-hero__hashtags"},ld={class:"article-detail-hero__title"},ad={class:"article-detail-hero__desc"},cd={class:"article-detail-hero__date"},pd={class:"article-detail-cover"},ud={class:"container"},dd=["src","alt"],fd={class:"article-detail-content section"},hd={class:"container article-detail-content__layout"},_d={class:"article-toc-float__panel"},gd={class:"article-toc-float__list"},md=["onClick"],vd={class:"article-toc-sidebar"},bd={class:"article-toc-sidebar__list"},yd=["onClick"],Ad=["innerHTML"],Sd={class:"article-detail-nav section"},Ed={class:"container"},Cd={key:1,class:"article-detail-notfound section"},xd={class:"container"},Id={__name:"ArticleDetail",setup(e){const t=Or(),s=je(()=>Ls.find(c=>c.id===t.params.id)),n=Me([]),i=Me(""),o=Me(null),r=Me(!1),l=()=>{if(!o.value)return;const c=o.value.querySelectorAll("h2, h3");n.value=Array.from(c).map((p,h)=>{const _=`article-heading-${h}`;return p.id=_,{id:_,text:p.textContent,level:p.tagName}})},a=()=>{if(!o.value)return;const c=o.value.querySelectorAll("h2, h3");let p="";c.forEach(h=>{h.getBoundingClientRect().top<=350&&(p=h.id)}),i.value=p},d=c=>{const p=document.getElementById(c);p&&p.scrollIntoView({behavior:"smooth",block:"start"})};return Ht(()=>{ss(()=>{l(),window.addEventListener("scroll",a)})}),Vt(()=>{window.removeEventListener("scroll",a)}),Bt(s,()=>{ss(()=>l())}),(c,p)=>{const h=os("RouterLink");return s.value?(k(),F("div",nd,[m("section",id,[m("div",od,[G(h,{to:"/leadership",class:"article-detail-hero__back"},{default:ge(()=>[...p[1]||(p[1]=[Ue(" ← 返回 Leadership ",-1)])]),_:1}),m("div",rd,[(k(!0),F(ee,null,me(s.value.hashtags,_=>(k(),F("span",{key:_,class:"article-detail-hero__hashtag"}," #"+J(_),1))),128))]),m("h1",ld,J(s.value.title),1),m("p",ad,J(s.value.description),1),m("p",cd,J(s.value.date),1)])]),m("div",pd,[m("div",ud,[m("img",{src:Ce(mt)(s.value.cover),alt:s.value.title,class:"article-detail-cover__img"},null,8,dd)])]),m("section",fd,[m("div",hd,[m("div",{class:We(["article-toc-float",{"article-toc-float--open":r.value}])},[m("button",{class:"article-toc-float__toggle",onClick:p[0]||(p[0]=_=>r.value=!r.value),"aria-label":"目錄"},[...p[2]||(p[2]=[m("i",{class:"fa-solid fa-list"},null,-1)])]),m("div",_d,[p[3]||(p[3]=m("p",{class:"article-toc-float__title"},"目錄",-1)),m("ul",gd,[(k(!0),F(ee,null,me(n.value,_=>(k(),F("li",{key:_.id},[m("a",{onClick:Xs(C=>{d(_.id),r.value=!1},["prevent"]),href:"#"},J(_.text),9,md)]))),128))])])],2),m("aside",vd,[p[4]||(p[4]=m("p",{class:"article-toc-sidebar__title"},"目錄",-1)),m("ul",bd,[(k(!0),F(ee,null,me(n.value,_=>(k(),F("li",{key:_.id},[m("a",{onClick:Xs(C=>d(_.id),["prevent"]),href:"#",class:We(["article-toc-sidebar__link",{"article-toc-sidebar__link--active":i.value===_.id}])},J(_.text),11,yd)]))),128))])]),m("div",{class:"article-detail-content__body",ref_key:"contentRef",ref:o,innerHTML:s.value.content},null,8,Ad)])]),m("section",Sd,[m("div",Ed,[G(h,{to:"/leadership",class:"btn btn--secondary"},{default:ge(()=>[...p[5]||(p[5]=[Ue(" ← 查看所有文章 ",-1)])]),_:1})])])])):(k(),F("div",Cd,[m("div",xd,[p[7]||(p[7]=m("h1",null,"找不到此文章",-1)),G(h,{to:"/leadership",class:"btn btn--primary"},{default:ge(()=>[...p[6]||(p[6]=[Ue("返回 Leadership",-1)])]),_:1})])]))}}},wd={__name:"StoryCanvas",setup(e){const t=Me(null);let s=null;return Ht(()=>{const n=t.value,i=n.getContext("2d"),o=()=>{n.width=n.offsetWidth,n.height=n.offsetHeight};o(),window.addEventListener("resize",o);const r=2e3,l=800,a=()=>({x:(Math.random()-.5)*2,y:(Math.random()-.5)*2,z:Math.random()*l,pz:null}),d=Array.from({length:r},a);d.forEach(h=>{h.pz=h.z});const c=1.5,p=()=>{const h=n.width,_=n.height,C=h/2,E=_/2;i.fillStyle="rgba(10, 14, 26, 0.25)",i.fillRect(0,0,h,_),d.forEach(M=>{if(M.pz=M.z,M.z-=c,M.z<=1){Object.assign(M,a()),M.pz=M.z;return}const w=l/M.z,x=C+M.x*w*(h/2),D=E+M.y*w*(_/2),O=l/M.pz,q=C+M.x*O*(h/2),Y=E+M.y*O*(_/2),Q=1-M.z/l,Ae=Math.pow(Q,1.5),V=Math.max(.3,Q*2.2),X=i.createLinearGradient(q,Y,x,D);if(X.addColorStop(0,"rgba(100,160,255,0)"),X.addColorStop(1,`rgba(200,225,255,${Ae*.95})`),i.beginPath(),i.moveTo(q,Y),i.lineTo(x,D),i.strokeStyle=X,i.lineWidth=V,i.lineCap="round",i.stroke(),Q>.6){const le=(Q-.6)/.4;i.beginPath(),i.arc(x,D,V*1.2,0,Math.PI*2),i.fillStyle=`rgba(220,235,255,${le*.9})`,i.fill()}}),s=requestAnimationFrame(p)};Vt(()=>{cancelAnimationFrame(s),window.removeEventListener("resize",o)}),p()}),(n,i)=>(k(),F("canvas",{ref_key:"canvasRef",ref:t,class:"story-canvas"},null,512))}},Pd=cn(wd,[["__scopeId","data-v-3f74bc40"]]),Rd={class:"about-page"},Td={class:"about-hero section"},Od={class:"container about-hero__inner"},jd={class:"about-hero__image"},Md=["src"],Dd={class:"about-experience section"},$d={class:"container"},Nd={class:"about-experience__list"},kd={class:"about-experience__left"},Ud={class:"about-experience__period"},Ld={class:"about-experience__right"},Bd={class:"about-experience__role"},Fd={class:"about-experience__company"},Hd={class:"about-experience__desc"},Vd={class:"about-story section"},Kd={class:"container"},Wd={class:"about-story__timeline"},qd={class:"about-story__image"},Gd=["src","alt"],Xd={class:"about-story__content"},zd={class:"about-story__period"},Jd={class:"about-story__role"},Qd={class:"about-story__tags"},Yd={class:"about-story__desc"},Zd={__name:"About",setup(e){const t=[{period:"2023 - 現在",role:"UIUX 設計主管",company:"某某科技公司",desc:"帶領設計團隊，負責產品設計策略制定、設計系統建立與跨部門協作。"},{period:"2021 - 2023",role:"UIUX 設計師",company:"MixerBox",desc:"負責 AI 產品的 UIUX 設計，主導多項 A/B 測試，成功提升訂閱轉換率 32%+。"},{period:"2019 - 2021",role:"前端工程師暨視覺設計師",company:"某某設計公司",desc:"負責網站前端切版與視覺設計，累積跨領域的設計與開發實務經驗。"}],s=[{period:"2016 - 2018",title:"視覺設計師",image:mt("/images/general/story/story-1.jpg"),tags:["品牌視覺","平面設計","美感養成"],desc:"從最基礎的視覺語言出發，學會如何用顏色、字型、排版傳達品牌個性。這個階段讓我建立了扎實的美感基礎，也讓我開始對「設計如何影響使用者感受」產生好奇。"},{period:"2018 - 2020",title:"UI 設計師",image:mt("/images/general/story/story-2.jpg"),tags:["介面設計","設計系統","跨部門協作"],desc:"開始接觸數位產品設計，學習如何在螢幕上建立清晰的視覺層次。與工程師合作的過程中，我意識到設計不只是好看，更要能被實作，這驅動我學習前端切版。"},{period:"2020 - 2022",title:"UIUX 設計師",image:mt("/images/general/story/story-3.jpg"),tags:["使用者研究","A/B 測試","數據驅動設計"],desc:"真正走進使用者的世界。透過訪談、測試、數據分析來驗證設計決策，讓我理解「好設計」的定義不是設計師說了算，而是使用者用腳投票的結果。"},{period:"2022 - 現在",title:"設計主管",image:mt("/images/general/story/story-4.jpg"),tags:["團隊管理","設計策略","跨部門影響力"],desc:"角色轉換讓我重新定義「貢獻」的意義。從做好一個設計，到讓整個團隊都能做好設計。管理是一門全新的學問，但也是我目前覺得最有意義的挑戰。"}];return(n,i)=>(k(),F("div",Rd,[m("section",Td,[m("div",Od,[i[0]||(i[0]=es('<div class="about-hero__content"><p class="about-hero__label">About Me</p><h1 class="about-hero__title">嗨，我是 Nomis！</h1><p class="about-hero__desc"> 我是一位橫跨 UIUX 設計、前端切版與設計管理的複合型設計師。 我相信好的設計不只是好看，而是能解決真實問題、創造可量化的商業價值。 </p><p class="about-hero__desc"> 目前專注於 AI 產品設計領域，對於如何在 AI 時代設計出讓使用者信任、願意使用的產品體驗，有深入的研究與實踐。 </p></div>',1)),m("div",jd,[m("img",{src:Ce(mt)("/images/general/avatar.jpg"),alt:"Nomis",class:"about-hero__avatar"},null,8,Md)])])]),m("section",Dd,[m("div",$d,[i[1]||(i[1]=m("h2",{class:"about-experience__title"},"工作經驗",-1)),m("div",Nd,[(k(),F(ee,null,me(t,o=>m("div",{key:o.company,class:"about-experience__item"},[m("div",kd,[m("p",Ud,J(o.period),1)]),m("div",Ld,[m("h3",Bd,J(o.role),1),m("p",Fd,J(o.company),1),m("p",Hd,J(o.desc),1)])])),64))])])]),m("section",Vd,[G(Pd),m("div",Kd,[i[2]||(i[2]=m("p",{class:"about-story__label"},"My Story",-1)),i[3]||(i[3]=m("h2",{class:"about-story__title"},"我如何成為 UIUX 設計師暨設計主管",-1)),i[4]||(i[4]=m("p",{class:"about-story__intro"}," 我的設計之路從視覺出發，一路走向 UIUX、前端，再到帶領設計團隊。 每個階段都讓我對「設計」這件事有更深的理解。 ",-1)),m("div",Wd,[(k(),F(ee,null,me(s,o=>m("div",{class:"about-story__item",key:o.title},[m("div",qd,[m("img",{src:o.image,alt:o.title},null,8,Gd)]),m("div",Xd,[m("p",zd,J(o.period),1),m("h3",Jd,J(o.title),1),m("div",Qd,[(k(!0),F(ee,null,me(o.tags,r=>(k(),F("span",{key:r,class:"about-story__tag"},J(r),1))),128))]),m("p",Yd,J(o.desc),1)])])),64))])])])]))}},ef=Ep({history:sp(),routes:[{path:"/",name:"home",component:au},{path:"/projects",name:"projects",component:gu},{path:"/projects/:id",name:"project-detail",component:Bu},{path:"/leadership",name:"leadership",component:sd},{path:"/leadership/:id",name:"article-detail",component:Id},{path:"/about",name:"about",component:Zd}],scrollBehavior(e,t,s){return s||{top:0}}}),Vr=_c(Dp);Vr.use(ef);Vr.mount("#app");
