(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))n(i);new MutationObserver(i=>{for(const o of i)if(o.type==="childList")for(const r of o.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&n(r)}).observe(document,{childList:!0,subtree:!0});function s(i){const o={};return i.integrity&&(o.integrity=i.integrity),i.referrerPolicy&&(o.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?o.credentials="include":i.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function n(i){if(i.ep)return;i.ep=!0;const o=s(i);fetch(i.href,o)}})();function Hn(e){const t=Object.create(null);for(const s of e.split(","))t[s]=1;return s=>s in t}const de={},Qt=[],at=()=>{},uo=()=>!1,zs=e=>e.charCodeAt(0)===111&&e.charCodeAt(1)===110&&(e.charCodeAt(2)>122||e.charCodeAt(2)<97),Js=e=>e.startsWith("onUpdate:"),ye=Object.assign,Vn=(e,t)=>{const s=e.indexOf(t);s>-1&&e.splice(s,1)},Vr=Object.prototype.hasOwnProperty,oe=(e,t)=>Vr.call(e,t),H=Array.isArray,Yt=e=>Rs(e)==="[object Map]",fo=e=>Rs(e)==="[object Set]",di=e=>Rs(e)==="[object Date]",W=e=>typeof e=="function",_e=e=>typeof e=="string",pt=e=>typeof e=="symbol",re=e=>e!==null&&typeof e=="object",go=e=>(re(e)||W(e))&&W(e.then)&&W(e.catch),ho=Object.prototype.toString,Rs=e=>ho.call(e),Kr=e=>Rs(e).slice(8,-1),_o=e=>Rs(e)==="[object Object]",Kn=e=>_e(e)&&e!=="NaN"&&e[0]!=="-"&&""+parseInt(e,10)===e,ds=Hn(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),Qs=e=>{const t=Object.create(null);return(s=>t[s]||(t[s]=e(s)))},Wr=/-\w/g,$e=Qs(e=>e.replace(Wr,t=>t.slice(1).toUpperCase())),qr=/\B([A-Z])/g,Ft=Qs(e=>e.replace(qr,"-$1").toLowerCase()),Ys=Qs(e=>e.charAt(0).toUpperCase()+e.slice(1)),pn=Qs(e=>e?`on${Ys(e)}`:""),rt=(e,t)=>!Object.is(e,t),un=(e,...t)=>{for(let s=0;s<e.length;s++)e[s](...t)},mo=(e,t,s,n=!1)=>{Object.defineProperty(e,t,{configurable:!0,enumerable:!1,writable:n,value:s})},Gr=e=>{const t=parseFloat(e);return isNaN(t)?e:t},Xr=e=>{const t=_e(e)?Number(e):NaN;return isNaN(t)?e:t};let fi;const Zs=()=>fi||(fi=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});function Wn(e){if(H(e)){const t={};for(let s=0;s<e.length;s++){const n=e[s],i=_e(n)?Yr(n):Wn(n);if(i)for(const o in i)t[o]=i[o]}return t}else if(_e(e)||re(e))return e}const zr=/;(?![^(]*\))/g,Jr=/:([^]+)/,Qr=/\/\*[^]*?\*\//g;function Yr(e){const t={};return e.replace(Qr,"").split(zr).forEach(s=>{if(s){const n=s.split(Jr);n.length>1&&(t[n[0].trim()]=n[1].trim())}}),t}function We(e){let t="";if(_e(e))t=e;else if(H(e))for(let s=0;s<e.length;s++){const n=We(e[s]);n&&(t+=n+" ")}else if(re(e))for(const s in e)e[s]&&(t+=s+" ");return t.trim()}const Zr="itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly",el=Hn(Zr);function vo(e){return!!e||e===""}function tl(e,t){if(e.length!==t.length)return!1;let s=!0;for(let n=0;s&&n<e.length;n++)s=qn(e[n],t[n]);return s}function qn(e,t){if(e===t)return!0;let s=di(e),n=di(t);if(s||n)return s&&n?e.getTime()===t.getTime():!1;if(s=pt(e),n=pt(t),s||n)return e===t;if(s=H(e),n=H(t),s||n)return s&&n?tl(e,t):!1;if(s=re(e),n=re(t),s||n){if(!s||!n)return!1;const i=Object.keys(e).length,o=Object.keys(t).length;if(i!==o)return!1;for(const r in e){const l=e.hasOwnProperty(r),a=t.hasOwnProperty(r);if(l&&!a||!l&&a||!qn(e[r],t[r]))return!1}}return String(e)===String(t)}const bo=e=>!!(e&&e.__v_isRef===!0),G=e=>_e(e)?e:e==null?"":H(e)||re(e)&&(e.toString===ho||!W(e.toString))?bo(e)?G(e.value):JSON.stringify(e,yo,2):String(e),yo=(e,t)=>bo(t)?yo(e,t.value):Yt(t)?{[`Map(${t.size})`]:[...t.entries()].reduce((s,[n,i],o)=>(s[dn(n,o)+" =>"]=i,s),{})}:fo(t)?{[`Set(${t.size})`]:[...t.values()].map(s=>dn(s))}:pt(t)?dn(t):re(t)&&!H(t)&&!_o(t)?String(t):t,dn=(e,t="")=>{var s;return pt(e)?`Symbol(${(s=e.description)!=null?s:t})`:e};let Ue;class sl{constructor(t=!1){this.detached=t,this._active=!0,this._on=0,this.effects=[],this.cleanups=[],this._isPaused=!1,this.__v_skip=!0,this.parent=Ue,!t&&Ue&&(this.index=(Ue.scopes||(Ue.scopes=[])).push(this)-1)}get active(){return this._active}pause(){if(this._active){this._isPaused=!0;let t,s;if(this.scopes)for(t=0,s=this.scopes.length;t<s;t++)this.scopes[t].pause();for(t=0,s=this.effects.length;t<s;t++)this.effects[t].pause()}}resume(){if(this._active&&this._isPaused){this._isPaused=!1;let t,s;if(this.scopes)for(t=0,s=this.scopes.length;t<s;t++)this.scopes[t].resume();for(t=0,s=this.effects.length;t<s;t++)this.effects[t].resume()}}run(t){if(this._active){const s=Ue;try{return Ue=this,t()}finally{Ue=s}}}on(){++this._on===1&&(this.prevScope=Ue,Ue=this)}off(){this._on>0&&--this._on===0&&(Ue=this.prevScope,this.prevScope=void 0)}stop(t){if(this._active){this._active=!1;let s,n;for(s=0,n=this.effects.length;s<n;s++)this.effects[s].stop();for(this.effects.length=0,s=0,n=this.cleanups.length;s<n;s++)this.cleanups[s]();if(this.cleanups.length=0,this.scopes){for(s=0,n=this.scopes.length;s<n;s++)this.scopes[s].stop(!0);this.scopes.length=0}if(!this.detached&&this.parent&&!t){const i=this.parent.scopes.pop();i&&i!==this&&(this.parent.scopes[this.index]=i,i.index=this.index)}this.parent=void 0}}}function nl(){return Ue}let ue;const fn=new WeakSet;class Ao{constructor(t){this.fn=t,this.deps=void 0,this.depsTail=void 0,this.flags=5,this.next=void 0,this.cleanup=void 0,this.scheduler=void 0,Ue&&Ue.active&&Ue.effects.push(this)}pause(){this.flags|=64}resume(){this.flags&64&&(this.flags&=-65,fn.has(this)&&(fn.delete(this),this.trigger()))}notify(){this.flags&2&&!(this.flags&32)||this.flags&8||Eo(this)}run(){if(!(this.flags&1))return this.fn();this.flags|=2,gi(this),Co(this);const t=ue,s=Ge;ue=this,Ge=!0;try{return this.fn()}finally{xo(this),ue=t,Ge=s,this.flags&=-3}}stop(){if(this.flags&1){for(let t=this.deps;t;t=t.nextDep)zn(t);this.deps=this.depsTail=void 0,gi(this),this.onStop&&this.onStop(),this.flags&=-2}}trigger(){this.flags&64?fn.add(this):this.scheduler?this.scheduler():this.runIfDirty()}runIfDirty(){In(this)&&this.run()}get dirty(){return In(this)}}let So=0,fs,gs;function Eo(e,t=!1){if(e.flags|=8,t){e.next=gs,gs=e;return}e.next=fs,fs=e}function Gn(){So++}function Xn(){if(--So>0)return;if(gs){let t=gs;for(gs=void 0;t;){const s=t.next;t.next=void 0,t.flags&=-9,t=s}}let e;for(;fs;){let t=fs;for(fs=void 0;t;){const s=t.next;if(t.next=void 0,t.flags&=-9,t.flags&1)try{t.trigger()}catch(n){e||(e=n)}t=s}}if(e)throw e}function Co(e){for(let t=e.deps;t;t=t.nextDep)t.version=-1,t.prevActiveLink=t.dep.activeLink,t.dep.activeLink=t}function xo(e){let t,s=e.depsTail,n=s;for(;n;){const i=n.prevDep;n.version===-1?(n===s&&(s=i),zn(n),il(n)):t=n,n.dep.activeLink=n.prevActiveLink,n.prevActiveLink=void 0,n=i}e.deps=t,e.depsTail=s}function In(e){for(let t=e.deps;t;t=t.nextDep)if(t.dep.version!==t.version||t.dep.computed&&(Io(t.dep.computed)||t.dep.version!==t.version))return!0;return!!e._dirty}function Io(e){if(e.flags&4&&!(e.flags&16)||(e.flags&=-17,e.globalVersion===As)||(e.globalVersion=As,!e.isSSR&&e.flags&128&&(!e.deps&&!e._dirty||!In(e))))return;e.flags|=2;const t=e.dep,s=ue,n=Ge;ue=e,Ge=!0;try{Co(e);const i=e.fn(e._value);(t.version===0||rt(i,e._value))&&(e.flags|=128,e._value=i,t.version++)}catch(i){throw t.version++,i}finally{ue=s,Ge=n,xo(e),e.flags&=-3}}function zn(e,t=!1){const{dep:s,prevSub:n,nextSub:i}=e;if(n&&(n.nextSub=i,e.prevSub=void 0),i&&(i.prevSub=n,e.nextSub=void 0),s.subs===e&&(s.subs=n,!n&&s.computed)){s.computed.flags&=-5;for(let o=s.computed.deps;o;o=o.nextDep)zn(o,!0)}!t&&!--s.sc&&s.map&&s.map.delete(s.key)}function il(e){const{prevDep:t,nextDep:s}=e;t&&(t.nextDep=s,e.prevDep=void 0),s&&(s.prevDep=t,e.nextDep=void 0)}let Ge=!0;const wo=[];function vt(){wo.push(Ge),Ge=!1}function bt(){const e=wo.pop();Ge=e===void 0?!0:e}function gi(e){const{cleanup:t}=e;if(e.cleanup=void 0,t){const s=ue;ue=void 0;try{t()}finally{ue=s}}}let As=0;class ol{constructor(t,s){this.sub=t,this.dep=s,this.version=s.version,this.nextDep=this.prevDep=this.nextSub=this.prevSub=this.prevActiveLink=void 0}}class Jn{constructor(t){this.computed=t,this.version=0,this.activeLink=void 0,this.subs=void 0,this.map=void 0,this.key=void 0,this.sc=0,this.__v_skip=!0}track(t){if(!ue||!Ge||ue===this.computed)return;let s=this.activeLink;if(s===void 0||s.sub!==ue)s=this.activeLink=new ol(ue,this),ue.deps?(s.prevDep=ue.depsTail,ue.depsTail.nextDep=s,ue.depsTail=s):ue.deps=ue.depsTail=s,Po(s);else if(s.version===-1&&(s.version=this.version,s.nextDep)){const n=s.nextDep;n.prevDep=s.prevDep,s.prevDep&&(s.prevDep.nextDep=n),s.prevDep=ue.depsTail,s.nextDep=void 0,ue.depsTail.nextDep=s,ue.depsTail=s,ue.deps===s&&(ue.deps=n)}return s}trigger(t){this.version++,As++,this.notify(t)}notify(t){Gn();try{for(let s=this.subs;s;s=s.prevSub)s.sub.notify()&&s.sub.dep.notify()}finally{Xn()}}}function Po(e){if(e.dep.sc++,e.sub.flags&4){const t=e.dep.computed;if(t&&!e.dep.subs){t.flags|=20;for(let n=t.deps;n;n=n.nextDep)Po(n)}const s=e.dep.subs;s!==e&&(e.prevSub=s,s&&(s.nextSub=e)),e.dep.subs=e}}const wn=new WeakMap,Ut=Symbol(""),Pn=Symbol(""),Ss=Symbol("");function xe(e,t,s){if(Ge&&ue){let n=wn.get(e);n||wn.set(e,n=new Map);let i=n.get(s);i||(n.set(s,i=new Jn),i.map=n,i.key=s),i.track()}}function mt(e,t,s,n,i,o){const r=wn.get(e);if(!r){As++;return}const l=a=>{a&&a.trigger()};if(Gn(),t==="clear")r.forEach(l);else{const a=H(e),d=a&&Kn(s);if(a&&s==="length"){const c=Number(n);r.forEach((p,g)=>{(g==="length"||g===Ss||!pt(g)&&g>=c)&&l(p)})}else switch((s!==void 0||r.has(void 0))&&l(r.get(s)),d&&l(r.get(Ss)),t){case"add":a?d&&l(r.get("length")):(l(r.get(Ut)),Yt(e)&&l(r.get(Pn)));break;case"delete":a||(l(r.get(Ut)),Yt(e)&&l(r.get(Pn)));break;case"set":Yt(e)&&l(r.get(Ut));break}}Xn()}function Gt(e){const t=te(e);return t===e?t:(xe(t,"iterate",Ss),Ke(e)?t:t.map(Xe))}function en(e){return xe(e=te(e),"iterate",Ss),e}function it(e,t){return yt(e)?ss(Lt(e)?Xe(t):t):Xe(t)}const rl={__proto__:null,[Symbol.iterator](){return gn(this,Symbol.iterator,e=>it(this,e))},concat(...e){return Gt(this).concat(...e.map(t=>H(t)?Gt(t):t))},entries(){return gn(this,"entries",e=>(e[1]=it(this,e[1]),e))},every(e,t){return dt(this,"every",e,t,void 0,arguments)},filter(e,t){return dt(this,"filter",e,t,s=>s.map(n=>it(this,n)),arguments)},find(e,t){return dt(this,"find",e,t,s=>it(this,s),arguments)},findIndex(e,t){return dt(this,"findIndex",e,t,void 0,arguments)},findLast(e,t){return dt(this,"findLast",e,t,s=>it(this,s),arguments)},findLastIndex(e,t){return dt(this,"findLastIndex",e,t,void 0,arguments)},forEach(e,t){return dt(this,"forEach",e,t,void 0,arguments)},includes(...e){return hn(this,"includes",e)},indexOf(...e){return hn(this,"indexOf",e)},join(e){return Gt(this).join(e)},lastIndexOf(...e){return hn(this,"lastIndexOf",e)},map(e,t){return dt(this,"map",e,t,void 0,arguments)},pop(){return ls(this,"pop")},push(...e){return ls(this,"push",e)},reduce(e,...t){return hi(this,"reduce",e,t)},reduceRight(e,...t){return hi(this,"reduceRight",e,t)},shift(){return ls(this,"shift")},some(e,t){return dt(this,"some",e,t,void 0,arguments)},splice(...e){return ls(this,"splice",e)},toReversed(){return Gt(this).toReversed()},toSorted(e){return Gt(this).toSorted(e)},toSpliced(...e){return Gt(this).toSpliced(...e)},unshift(...e){return ls(this,"unshift",e)},values(){return gn(this,"values",e=>it(this,e))}};function gn(e,t,s){const n=en(e),i=n[t]();return n!==e&&!Ke(e)&&(i._next=i.next,i.next=()=>{const o=i._next();return o.done||(o.value=s(o.value)),o}),i}const ll=Array.prototype;function dt(e,t,s,n,i,o){const r=en(e),l=r!==e&&!Ke(e),a=r[t];if(a!==ll[t]){const p=a.apply(e,o);return l?Xe(p):p}let d=s;r!==e&&(l?d=function(p,g){return s.call(this,it(e,p),g,e)}:s.length>2&&(d=function(p,g){return s.call(this,p,g,e)}));const c=a.call(r,d,n);return l&&i?i(c):c}function hi(e,t,s,n){const i=en(e),o=i!==e&&!Ke(e);let r=s,l=!1;i!==e&&(o?(l=n.length===0,r=function(d,c,p){return l&&(l=!1,d=it(e,d)),s.call(this,d,it(e,c),p,e)}):s.length>3&&(r=function(d,c,p){return s.call(this,d,c,p,e)}));const a=i[t](r,...n);return l?it(e,a):a}function hn(e,t,s){const n=te(e);xe(n,"iterate",Ss);const i=n[t](...s);return(i===-1||i===!1)&&Zn(s[0])?(s[0]=te(s[0]),n[t](...s)):i}function ls(e,t,s=[]){vt(),Gn();const n=te(e)[t].apply(e,s);return Xn(),bt(),n}const al=Hn("__proto__,__v_isRef,__isVue"),Ro=new Set(Object.getOwnPropertyNames(Symbol).filter(e=>e!=="arguments"&&e!=="caller").map(e=>Symbol[e]).filter(pt));function cl(e){pt(e)||(e=String(e));const t=te(this);return xe(t,"has",e),t.hasOwnProperty(e)}class To{constructor(t=!1,s=!1){this._isReadonly=t,this._isShallow=s}get(t,s,n){if(s==="__v_skip")return t.__v_skip;const i=this._isReadonly,o=this._isShallow;if(s==="__v_isReactive")return!i;if(s==="__v_isReadonly")return i;if(s==="__v_isShallow")return o;if(s==="__v_raw")return n===(i?o?bl:ko:o?Mo:Oo).get(t)||Object.getPrototypeOf(t)===Object.getPrototypeOf(n)?t:void 0;const r=H(t);if(!i){let a;if(r&&(a=rl[s]))return a;if(s==="hasOwnProperty")return cl}const l=Reflect.get(t,s,we(t)?t:n);if((pt(s)?Ro.has(s):al(s))||(i||xe(t,"get",s),o))return l;if(we(l)){const a=r&&Kn(s)?l:l.value;return i&&re(a)?Tn(a):a}return re(l)?i?Tn(l):tn(l):l}}class jo extends To{constructor(t=!1){super(!1,t)}set(t,s,n,i){let o=t[s];const r=H(t)&&Kn(s);if(!this._isShallow){const d=yt(o);if(!Ke(n)&&!yt(n)&&(o=te(o),n=te(n)),!r&&we(o)&&!we(n))return d||(o.value=n),!0}const l=r?Number(s)<t.length:oe(t,s),a=Reflect.set(t,s,n,we(t)?t:i);return t===te(i)&&(l?rt(n,o)&&mt(t,"set",s,n):mt(t,"add",s,n)),a}deleteProperty(t,s){const n=oe(t,s);t[s];const i=Reflect.deleteProperty(t,s);return i&&n&&mt(t,"delete",s,void 0),i}has(t,s){const n=Reflect.has(t,s);return(!pt(s)||!Ro.has(s))&&xe(t,"has",s),n}ownKeys(t){return xe(t,"iterate",H(t)?"length":Ut),Reflect.ownKeys(t)}}class pl extends To{constructor(t=!1){super(!0,t)}set(t,s){return!0}deleteProperty(t,s){return!0}}const ul=new jo,dl=new pl,fl=new jo(!0);const Rn=e=>e,Os=e=>Reflect.getPrototypeOf(e);function gl(e,t,s){return function(...n){const i=this.__v_raw,o=te(i),r=Yt(o),l=e==="entries"||e===Symbol.iterator&&r,a=e==="keys"&&r,d=i[e](...n),c=s?Rn:t?ss:Xe;return!t&&xe(o,"iterate",a?Pn:Ut),ye(Object.create(d),{next(){const{value:p,done:g}=d.next();return g?{value:p,done:g}:{value:l?[c(p[0]),c(p[1])]:c(p),done:g}}})}}function Ms(e){return function(...t){return e==="delete"?!1:e==="clear"?void 0:this}}function hl(e,t){const s={get(i){const o=this.__v_raw,r=te(o),l=te(i);e||(rt(i,l)&&xe(r,"get",i),xe(r,"get",l));const{has:a}=Os(r),d=t?Rn:e?ss:Xe;if(a.call(r,i))return d(o.get(i));if(a.call(r,l))return d(o.get(l));o!==r&&o.get(i)},get size(){const i=this.__v_raw;return!e&&xe(te(i),"iterate",Ut),i.size},has(i){const o=this.__v_raw,r=te(o),l=te(i);return e||(rt(i,l)&&xe(r,"has",i),xe(r,"has",l)),i===l?o.has(i):o.has(i)||o.has(l)},forEach(i,o){const r=this,l=r.__v_raw,a=te(l),d=t?Rn:e?ss:Xe;return!e&&xe(a,"iterate",Ut),l.forEach((c,p)=>i.call(o,d(c),d(p),r))}};return ye(s,e?{add:Ms("add"),set:Ms("set"),delete:Ms("delete"),clear:Ms("clear")}:{add(i){const o=te(this),r=Os(o),l=te(i),a=!t&&!Ke(i)&&!yt(i)?l:i;return r.has.call(o,a)||rt(i,a)&&r.has.call(o,i)||rt(l,a)&&r.has.call(o,l)||(o.add(a),mt(o,"add",a,a)),this},set(i,o){!t&&!Ke(o)&&!yt(o)&&(o=te(o));const r=te(this),{has:l,get:a}=Os(r);let d=l.call(r,i);d||(i=te(i),d=l.call(r,i));const c=a.call(r,i);return r.set(i,o),d?rt(o,c)&&mt(r,"set",i,o):mt(r,"add",i,o),this},delete(i){const o=te(this),{has:r,get:l}=Os(o);let a=r.call(o,i);a||(i=te(i),a=r.call(o,i)),l&&l.call(o,i);const d=o.delete(i);return a&&mt(o,"delete",i,void 0),d},clear(){const i=te(this),o=i.size!==0,r=i.clear();return o&&mt(i,"clear",void 0,void 0),r}}),["keys","values","entries",Symbol.iterator].forEach(i=>{s[i]=gl(i,e,t)}),s}function Qn(e,t){const s=hl(e,t);return(n,i,o)=>i==="__v_isReactive"?!e:i==="__v_isReadonly"?e:i==="__v_raw"?n:Reflect.get(oe(s,i)&&i in n?s:n,i,o)}const _l={get:Qn(!1,!1)},ml={get:Qn(!1,!0)},vl={get:Qn(!0,!1)};const Oo=new WeakMap,Mo=new WeakMap,ko=new WeakMap,bl=new WeakMap;function yl(e){switch(e){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function Al(e){return e.__v_skip||!Object.isExtensible(e)?0:yl(Kr(e))}function tn(e){return yt(e)?e:Yn(e,!1,ul,_l,Oo)}function $o(e){return Yn(e,!1,fl,ml,Mo)}function Tn(e){return Yn(e,!0,dl,vl,ko)}function Yn(e,t,s,n,i){if(!re(e)||e.__v_raw&&!(t&&e.__v_isReactive))return e;const o=Al(e);if(o===0)return e;const r=i.get(e);if(r)return r;const l=new Proxy(e,o===2?n:s);return i.set(e,l),l}function Lt(e){return yt(e)?Lt(e.__v_raw):!!(e&&e.__v_isReactive)}function yt(e){return!!(e&&e.__v_isReadonly)}function Ke(e){return!!(e&&e.__v_isShallow)}function Zn(e){return e?!!e.__v_raw:!1}function te(e){const t=e&&e.__v_raw;return t?te(t):e}function Sl(e){return!oe(e,"__v_skip")&&Object.isExtensible(e)&&mo(e,"__v_skip",!0),e}const Xe=e=>re(e)?tn(e):e,ss=e=>re(e)?Tn(e):e;function we(e){return e?e.__v_isRef===!0:!1}function ke(e){return Do(e,!1)}function El(e){return Do(e,!0)}function Do(e,t){return we(e)?e:new Cl(e,t)}class Cl{constructor(t,s){this.dep=new Jn,this.__v_isRef=!0,this.__v_isShallow=!1,this._rawValue=s?t:te(t),this._value=s?t:Xe(t),this.__v_isShallow=s}get value(){return this.dep.track(),this._value}set value(t){const s=this._rawValue,n=this.__v_isShallow||Ke(t)||yt(t);t=n?t:te(t),rt(t,s)&&(this._rawValue=t,this._value=n?t:Xe(t),this.dep.trigger())}}function Ee(e){return we(e)?e.value:e}const xl={get:(e,t,s)=>t==="__v_raw"?e:Ee(Reflect.get(e,t,s)),set:(e,t,s,n)=>{const i=e[t];return we(i)&&!we(s)?(i.value=s,!0):Reflect.set(e,t,s,n)}};function No(e){return Lt(e)?e:new Proxy(e,xl)}class Il{constructor(t,s,n){this.fn=t,this.setter=s,this._value=void 0,this.dep=new Jn(this),this.__v_isRef=!0,this.deps=void 0,this.depsTail=void 0,this.flags=16,this.globalVersion=As-1,this.next=void 0,this.effect=this,this.__v_isReadonly=!s,this.isSSR=n}notify(){if(this.flags|=16,!(this.flags&8)&&ue!==this)return Eo(this,!0),!0}get value(){const t=this.dep.track();return Io(this),t&&(t.version=this.dep.version),this._value}set value(t){this.setter&&this.setter(t)}}function wl(e,t,s=!1){let n,i;return W(e)?n=e:(n=e.get,i=e.set),new Il(n,i,s)}const ks={},Bs=new WeakMap;let $t;function Pl(e,t=!1,s=$t){if(s){let n=Bs.get(s);n||Bs.set(s,n=[]),n.push(e)}}function Rl(e,t,s=de){const{immediate:n,deep:i,once:o,scheduler:r,augmentJob:l,call:a}=s,d=j=>i?j:Ke(j)||i===!1||i===0?Pt(j,1):Pt(j);let c,p,g,h,C=!1,E=!1;if(we(e)?(p=()=>e.value,C=Ke(e)):Lt(e)?(p=()=>d(e),C=!0):H(e)?(E=!0,C=e.some(j=>Lt(j)||Ke(j)),p=()=>e.map(j=>{if(we(j))return j.value;if(Lt(j))return d(j);if(W(j))return a?a(j,2):j()})):W(e)?t?p=a?()=>a(e,2):e:p=()=>{if(g){vt();try{g()}finally{bt()}}const j=$t;$t=c;try{return a?a(e,3,[h]):e(h)}finally{$t=j}}:p=at,t&&i){const j=p,q=i===!0?1/0:i;p=()=>Pt(j(),q)}const M=nl(),w=()=>{c.stop(),M&&M.active&&Vn(M.effects,c)};if(o&&t){const j=t;t=(...q)=>{j(...q),w()}}let x=E?new Array(e.length).fill(ks):ks;const k=j=>{if(!(!(c.flags&1)||!c.dirty&&!j))if(t){const q=c.run();if(i||C||(E?q.some((Z,Y)=>rt(Z,x[Y])):rt(q,x))){g&&g();const Z=$t;$t=c;try{const Y=[q,x===ks?void 0:E&&x[0]===ks?[]:x,h];x=q,a?a(t,3,Y):t(...Y)}finally{$t=Z}}}else c.run()};return l&&l(k),c=new Ao(p),c.scheduler=r?()=>r(k,!1):k,h=j=>Pl(j,!1,c),g=c.onStop=()=>{const j=Bs.get(c);if(j){if(a)a(j,4);else for(const q of j)q();Bs.delete(c)}},t?n?k(!0):x=c.run():r?r(k.bind(null,!0),!0):c.run(),w.pause=c.pause.bind(c),w.resume=c.resume.bind(c),w.stop=w,w}function Pt(e,t=1/0,s){if(t<=0||!re(e)||e.__v_skip||(s=s||new Map,(s.get(e)||0)>=t))return e;if(s.set(e,t),t--,we(e))Pt(e.value,t,s);else if(H(e))for(let n=0;n<e.length;n++)Pt(e[n],t,s);else if(fo(e)||Yt(e))e.forEach(n=>{Pt(n,t,s)});else if(_o(e)){for(const n in e)Pt(e[n],t,s);for(const n of Object.getOwnPropertySymbols(e))Object.prototype.propertyIsEnumerable.call(e,n)&&Pt(e[n],t,s)}return e}function Ts(e,t,s,n){try{return n?e(...n):e()}catch(i){sn(i,t,s)}}function ze(e,t,s,n){if(W(e)){const i=Ts(e,t,s,n);return i&&go(i)&&i.catch(o=>{sn(o,t,s)}),i}if(H(e)){const i=[];for(let o=0;o<e.length;o++)i.push(ze(e[o],t,s,n));return i}}function sn(e,t,s,n=!0){const i=t?t.vnode:null,{errorHandler:o,throwUnhandledErrorInProduction:r}=t&&t.appContext.config||de;if(t){let l=t.parent;const a=t.proxy,d=`https://vuejs.org/error-reference/#runtime-${s}`;for(;l;){const c=l.ec;if(c){for(let p=0;p<c.length;p++)if(c[p](e,a,d)===!1)return}l=l.parent}if(o){vt(),Ts(o,null,10,[e,a,d]),bt();return}}Tl(e,s,i,n,r)}function Tl(e,t,s,n=!0,i=!1){if(i)throw e;console.error(e)}const Te=[];let st=-1;const Zt=[];let It=null,Xt=0;const Uo=Promise.resolve();let Fs=null;function ns(e){const t=Fs||Uo;return e?t.then(this?e.bind(this):e):t}function jl(e){let t=st+1,s=Te.length;for(;t<s;){const n=t+s>>>1,i=Te[n],o=Es(i);o<e||o===e&&i.flags&2?t=n+1:s=n}return t}function ei(e){if(!(e.flags&1)){const t=Es(e),s=Te[Te.length-1];!s||!(e.flags&2)&&t>=Es(s)?Te.push(e):Te.splice(jl(t),0,e),e.flags|=1,Lo()}}function Lo(){Fs||(Fs=Uo.then(Fo))}function Ol(e){H(e)?Zt.push(...e):It&&e.id===-1?It.splice(Xt+1,0,e):e.flags&1||(Zt.push(e),e.flags|=1),Lo()}function _i(e,t,s=st+1){for(;s<Te.length;s++){const n=Te[s];if(n&&n.flags&2){if(e&&n.id!==e.uid)continue;Te.splice(s,1),s--,n.flags&4&&(n.flags&=-2),n(),n.flags&4||(n.flags&=-2)}}}function Bo(e){if(Zt.length){const t=[...new Set(Zt)].sort((s,n)=>Es(s)-Es(n));if(Zt.length=0,It){It.push(...t);return}for(It=t,Xt=0;Xt<It.length;Xt++){const s=It[Xt];s.flags&4&&(s.flags&=-2),s.flags&8||s(),s.flags&=-2}It=null,Xt=0}}const Es=e=>e.id==null?e.flags&2?-1:1/0:e.id;function Fo(e){try{for(st=0;st<Te.length;st++){const t=Te[st];t&&!(t.flags&8)&&(t.flags&4&&(t.flags&=-2),Ts(t,t.i,t.i?15:14),t.flags&4||(t.flags&=-2))}}finally{for(;st<Te.length;st++){const t=Te[st];t&&(t.flags&=-2)}st=-1,Te.length=0,Bo(),Fs=null,(Te.length||Zt.length)&&Fo()}}let qe=null,Ho=null;function Hs(e){const t=qe;return qe=e,Ho=e&&e.type.__scopeId||null,t}function fe(e,t=qe,s){if(!t||e._n)return e;const n=(...i)=>{n._d&&Ws(-1);const o=Hs(t);let r;try{r=e(...i)}finally{Hs(o),n._d&&Ws(1)}return r};return n._n=!0,n._c=!0,n._d=!0,n}function jt(e,t,s,n){const i=e.dirs,o=t&&t.dirs;for(let r=0;r<i.length;r++){const l=i[r];o&&(l.oldValue=o[r].value);let a=l.dir[n];a&&(vt(),ze(a,s,8,[e.el,l,e,t]),bt())}}function $s(e,t){if(Ie){let s=Ie.provides;const n=Ie.parent&&Ie.parent.provides;n===s&&(s=Ie.provides=Object.create(n)),s[e]=t}}function ct(e,t,s=!1){const n=Cr();if(n||es){let i=es?es._context.provides:n?n.parent==null||n.ce?n.vnode.appContext&&n.vnode.appContext.provides:n.parent.provides:void 0;if(i&&e in i)return i[e];if(arguments.length>1)return s&&W(t)?t.call(n&&n.proxy):t}}const Ml=Symbol.for("v-scx"),kl=()=>ct(Ml);function Bt(e,t,s){return Vo(e,t,s)}function Vo(e,t,s=de){const{immediate:n,deep:i,flush:o,once:r}=s,l=ye({},s),a=t&&n||!t&&o!=="post";let d;if(Is){if(o==="sync"){const h=kl();d=h.__watcherHandles||(h.__watcherHandles=[])}else if(!a){const h=()=>{};return h.stop=at,h.resume=at,h.pause=at,h}}const c=Ie;l.call=(h,C,E)=>ze(h,c,C,E);let p=!1;o==="post"?l.scheduler=h=>{Ne(h,c&&c.suspense)}:o!=="sync"&&(p=!0,l.scheduler=(h,C)=>{C?h():ei(h)}),l.augmentJob=h=>{t&&(h.flags|=4),p&&(h.flags|=2,c&&(h.id=c.uid,h.i=c))};const g=Rl(e,t,l);return Is&&(d?d.push(g):a&&g()),g}function $l(e,t,s){const n=this.proxy,i=_e(e)?e.includes(".")?Ko(n,e):()=>n[e]:e.bind(n,n);let o;W(t)?o=t:(o=t.handler,s=t);const r=js(this),l=Vo(i,o.bind(n),s);return r(),l}function Ko(e,t){const s=t.split(".");return()=>{let n=e;for(let i=0;i<s.length&&n;i++)n=n[s[i]];return n}}const Dl=Symbol("_vte"),Wo=e=>e.__isTeleport,nt=Symbol("_leaveCb"),as=Symbol("_enterCb");function Nl(){const e={isMounted:!1,isLeaving:!1,isUnmounting:!1,leavingVNodes:new Map};return Ht(()=>{e.isMounted=!0}),er(()=>{e.isUnmounting=!0}),e}const Ve=[Function,Array],qo={mode:String,appear:Boolean,persisted:Boolean,onBeforeEnter:Ve,onEnter:Ve,onAfterEnter:Ve,onEnterCancelled:Ve,onBeforeLeave:Ve,onLeave:Ve,onAfterLeave:Ve,onLeaveCancelled:Ve,onBeforeAppear:Ve,onAppear:Ve,onAfterAppear:Ve,onAppearCancelled:Ve},Go=e=>{const t=e.subTree;return t.component?Go(t.component):t},Ul={name:"BaseTransition",props:qo,setup(e,{slots:t}){const s=Cr(),n=Nl();return()=>{const i=t.default&&Jo(t.default(),!0);if(!i||!i.length)return;const o=Xo(i),r=te(e),{mode:l}=r;if(n.isLeaving)return _n(o);const a=mi(o);if(!a)return _n(o);let d=jn(a,r,n,s,p=>d=p);a.type!==je&&Cs(a,d);let c=s.subTree&&mi(s.subTree);if(c&&c.type!==je&&!Dt(c,a)&&Go(s).type!==je){let p=jn(c,r,n,s);if(Cs(c,p),l==="out-in"&&a.type!==je)return n.isLeaving=!0,p.afterLeave=()=>{n.isLeaving=!1,s.job.flags&8||s.update(),delete p.afterLeave,c=void 0},_n(o);l==="in-out"&&a.type!==je?p.delayLeave=(g,h,C)=>{const E=zo(n,c);E[String(c.key)]=c,g[nt]=()=>{h(),g[nt]=void 0,delete d.delayedLeave,c=void 0},d.delayedLeave=()=>{C(),delete d.delayedLeave,c=void 0}}:c=void 0}else c&&(c=void 0);return o}}};function Xo(e){let t=e[0];if(e.length>1){for(const s of e)if(s.type!==je){t=s;break}}return t}const Ll=Ul;function zo(e,t){const{leavingVNodes:s}=e;let n=s.get(t.type);return n||(n=Object.create(null),s.set(t.type,n)),n}function jn(e,t,s,n,i){const{appear:o,mode:r,persisted:l=!1,onBeforeEnter:a,onEnter:d,onAfterEnter:c,onEnterCancelled:p,onBeforeLeave:g,onLeave:h,onAfterLeave:C,onLeaveCancelled:E,onBeforeAppear:M,onAppear:w,onAfterAppear:x,onAppearCancelled:k}=t,j=String(e.key),q=zo(s,e),Z=(V,z)=>{V&&ze(V,n,9,z)},Y=(V,z)=>{const le=z[1];Z(V,z),H(V)?V.every($=>$.length<=1)&&le():V.length<=1&&le()},Ae={mode:r,persisted:l,beforeEnter(V){let z=a;if(!s.isMounted)if(o)z=M||a;else return;V[nt]&&V[nt](!0);const le=q[j];le&&Dt(e,le)&&le.el[nt]&&le.el[nt](),Z(z,[V])},enter(V){if(q[j]===e)return;let z=d,le=c,$=p;if(!s.isMounted)if(o)z=w||d,le=x||c,$=k||p;else return;let se=!1;V[as]=Le=>{se||(se=!0,Le?Z($,[V]):Z(le,[V]),Ae.delayedLeave&&Ae.delayedLeave(),V[as]=void 0)};const Se=V[as].bind(null,!1);z?Y(z,[V,Se]):Se()},leave(V,z){const le=String(e.key);if(V[as]&&V[as](!0),s.isUnmounting)return z();Z(g,[V]);let $=!1;V[nt]=Se=>{$||($=!0,z(),Se?Z(E,[V]):Z(C,[V]),V[nt]=void 0,q[le]===e&&delete q[le])};const se=V[nt].bind(null,!1);q[le]=e,h?Y(h,[V,se]):se()},clone(V){const z=jn(V,t,s,n,i);return i&&i(z),z}};return Ae}function _n(e){if(nn(e))return e=Rt(e),e.children=null,e}function mi(e){if(!nn(e))return Wo(e.type)&&e.children?Xo(e.children):e;if(e.component)return e.component.subTree;const{shapeFlag:t,children:s}=e;if(s){if(t&16)return s[0];if(t&32&&W(s.default))return s.default()}}function Cs(e,t){e.shapeFlag&6&&e.component?(e.transition=t,Cs(e.component.subTree,t)):e.shapeFlag&128?(e.ssContent.transition=t.clone(e.ssContent),e.ssFallback.transition=t.clone(e.ssFallback)):e.transition=t}function Jo(e,t=!1,s){let n=[],i=0;for(let o=0;o<e.length;o++){let r=e[o];const l=s==null?r.key:String(s)+String(r.key!=null?r.key:o);r.type===Q?(r.patchFlag&128&&i++,n=n.concat(Jo(r.children,t,l))):(t||r.type!==je)&&n.push(l!=null?Rt(r,{key:l}):r)}if(i>1)for(let o=0;o<n.length;o++)n[o].patchFlag=-2;return n}function Qo(e,t){return W(e)?ye({name:e.name},t,{setup:e}):e}function Yo(e){e.ids=[e.ids[0]+e.ids[2]+++"-",0,0]}function vi(e,t){let s;return!!((s=Object.getOwnPropertyDescriptor(e,t))&&!s.configurable)}const Vs=new WeakMap;function hs(e,t,s,n,i=!1){if(H(e)){e.forEach((E,M)=>hs(E,t&&(H(t)?t[M]:t),s,n,i));return}if(_s(n)&&!i){n.shapeFlag&512&&n.type.__asyncResolved&&n.component.subTree.component&&hs(e,t,s,n.component.subTree);return}const o=n.shapeFlag&4?ii(n.component):n.el,r=i?null:o,{i:l,r:a}=e,d=t&&t.r,c=l.refs===de?l.refs={}:l.refs,p=l.setupState,g=te(p),h=p===de?uo:E=>vi(c,E)?!1:oe(g,E),C=(E,M)=>!(M&&vi(c,M));if(d!=null&&d!==a){if(bi(t),_e(d))c[d]=null,h(d)&&(p[d]=null);else if(we(d)){const E=t;C(d,E.k)&&(d.value=null),E.k&&(c[E.k]=null)}}if(W(a))Ts(a,l,12,[r,c]);else{const E=_e(a),M=we(a);if(E||M){const w=()=>{if(e.f){const x=E?h(a)?p[a]:c[a]:C()||!e.k?a.value:c[e.k];if(i)H(x)&&Vn(x,o);else if(H(x))x.includes(o)||x.push(o);else if(E)c[a]=[o],h(a)&&(p[a]=c[a]);else{const k=[o];C(a,e.k)&&(a.value=k),e.k&&(c[e.k]=k)}}else E?(c[a]=r,h(a)&&(p[a]=r)):M&&(C(a,e.k)&&(a.value=r),e.k&&(c[e.k]=r))};if(r){const x=()=>{w(),Vs.delete(e)};x.id=-1,Vs.set(e,x),Ne(x,s)}else bi(e),w()}}}function bi(e){const t=Vs.get(e);t&&(t.flags|=8,Vs.delete(e))}Zs().requestIdleCallback;Zs().cancelIdleCallback;const _s=e=>!!e.type.__asyncLoader,nn=e=>e.type.__isKeepAlive;function Bl(e,t){Zo(e,"a",t)}function Fl(e,t){Zo(e,"da",t)}function Zo(e,t,s=Ie){const n=e.__wdc||(e.__wdc=()=>{let i=s;for(;i;){if(i.isDeactivated)return;i=i.parent}return e()});if(on(t,n,s),s){let i=s.parent;for(;i&&i.parent;)nn(i.parent.vnode)&&Hl(n,t,s,i),i=i.parent}}function Hl(e,t,s,n){const i=on(t,e,n,!0);Vt(()=>{Vn(n[t],i)},s)}function on(e,t,s=Ie,n=!1){if(s){const i=s[e]||(s[e]=[]),o=t.__weh||(t.__weh=(...r)=>{vt();const l=js(s),a=ze(t,s,e,r);return l(),bt(),a});return n?i.unshift(o):i.push(o),o}}const St=e=>(t,s=Ie)=>{(!Is||e==="sp")&&on(e,(...n)=>t(...n),s)},Vl=St("bm"),Ht=St("m"),Kl=St("bu"),Wl=St("u"),er=St("bum"),Vt=St("um"),ql=St("sp"),Gl=St("rtg"),Xl=St("rtc");function zl(e,t=Ie){on("ec",e,t)}const tr="components";function Kt(e,t){return nr(tr,e,!0,t)||e}const sr=Symbol.for("v-ndc");function Jl(e){return _e(e)?nr(tr,e,!1)||e:e||sr}function nr(e,t,s=!0,n=!1){const i=qe||Ie;if(i){const o=i.type;{const l=ka(o,!1);if(l&&(l===t||l===$e(t)||l===Ys($e(t))))return o}const r=yi(i[e]||o[e],t)||yi(i.appContext[e],t);return!r&&n?o:r}}function yi(e,t){return e&&(e[t]||e[$e(t)]||e[Ys($e(t))])}function ge(e,t,s,n){let i;const o=s,r=H(e);if(r||_e(e)){const l=r&&Lt(e);let a=!1,d=!1;l&&(a=!Ke(e),d=yt(e),e=en(e)),i=new Array(e.length);for(let c=0,p=e.length;c<p;c++)i[c]=t(a?d?ss(Xe(e[c])):Xe(e[c]):e[c],c,void 0,o)}else if(typeof e=="number"){i=new Array(e);for(let l=0;l<e;l++)i[l]=t(l+1,l,void 0,o)}else if(re(e))if(e[Symbol.iterator])i=Array.from(e,(l,a)=>t(l,a,void 0,o));else{const l=Object.keys(e);i=new Array(l.length);for(let a=0,d=l.length;a<d;a++){const c=l[a];i[a]=t(e[c],c,a,o)}}else i=[];return i}const On=e=>e?xr(e)?ii(e):On(e.parent):null,ms=ye(Object.create(null),{$:e=>e,$el:e=>e.vnode.el,$data:e=>e.data,$props:e=>e.props,$attrs:e=>e.attrs,$slots:e=>e.slots,$refs:e=>e.refs,$parent:e=>On(e.parent),$root:e=>On(e.root),$host:e=>e.ce,$emit:e=>e.emit,$options:e=>or(e),$forceUpdate:e=>e.f||(e.f=()=>{ei(e.update)}),$nextTick:e=>e.n||(e.n=ns.bind(e.proxy)),$watch:e=>$l.bind(e)}),mn=(e,t)=>e!==de&&!e.__isScriptSetup&&oe(e,t),Ql={get({_:e},t){if(t==="__v_skip")return!0;const{ctx:s,setupState:n,data:i,props:o,accessCache:r,type:l,appContext:a}=e;if(t[0]!=="$"){const g=r[t];if(g!==void 0)switch(g){case 1:return n[t];case 2:return i[t];case 4:return s[t];case 3:return o[t]}else{if(mn(n,t))return r[t]=1,n[t];if(i!==de&&oe(i,t))return r[t]=2,i[t];if(oe(o,t))return r[t]=3,o[t];if(s!==de&&oe(s,t))return r[t]=4,s[t];Mn&&(r[t]=0)}}const d=ms[t];let c,p;if(d)return t==="$attrs"&&xe(e.attrs,"get",""),d(e);if((c=l.__cssModules)&&(c=c[t]))return c;if(s!==de&&oe(s,t))return r[t]=4,s[t];if(p=a.config.globalProperties,oe(p,t))return p[t]},set({_:e},t,s){const{data:n,setupState:i,ctx:o}=e;return mn(i,t)?(i[t]=s,!0):n!==de&&oe(n,t)?(n[t]=s,!0):oe(e.props,t)||t[0]==="$"&&t.slice(1)in e?!1:(o[t]=s,!0)},has({_:{data:e,setupState:t,accessCache:s,ctx:n,appContext:i,props:o,type:r}},l){let a;return!!(s[l]||e!==de&&l[0]!=="$"&&oe(e,l)||mn(t,l)||oe(o,l)||oe(n,l)||oe(ms,l)||oe(i.config.globalProperties,l)||(a=r.__cssModules)&&a[l])},defineProperty(e,t,s){return s.get!=null?e._.accessCache[t]=0:oe(s,"value")&&this.set(e,t,s.value,null),Reflect.defineProperty(e,t,s)}};function Ai(e){return H(e)?e.reduce((t,s)=>(t[s]=null,t),{}):e}let Mn=!0;function Yl(e){const t=or(e),s=e.proxy,n=e.ctx;Mn=!1,t.beforeCreate&&Si(t.beforeCreate,e,"bc");const{data:i,computed:o,methods:r,watch:l,provide:a,inject:d,created:c,beforeMount:p,mounted:g,beforeUpdate:h,updated:C,activated:E,deactivated:M,beforeDestroy:w,beforeUnmount:x,destroyed:k,unmounted:j,render:q,renderTracked:Z,renderTriggered:Y,errorCaptured:Ae,serverPrefetch:V,expose:z,inheritAttrs:le,components:$,directives:se,filters:Se}=t;if(d&&Zl(d,n,null),r)for(const ae in r){const ne=r[ae];W(ne)&&(n[ae]=ne.bind(s))}if(i){const ae=i.call(s,s);re(ae)&&(e.data=tn(ae))}if(Mn=!0,o)for(const ae in o){const ne=o[ae],ut=W(ne)?ne.bind(s,s):W(ne.get)?ne.get.bind(s,s):at,Et=!W(ne)&&W(ne.set)?ne.set.bind(s):at,Qe=Me({get:ut,set:Et});Object.defineProperty(n,ae,{enumerable:!0,configurable:!0,get:()=>Qe.value,set:De=>Qe.value=De})}if(l)for(const ae in l)ir(l[ae],n,s,ae);if(a){const ae=W(a)?a.call(s):a;Reflect.ownKeys(ae).forEach(ne=>{$s(ne,ae[ne])})}c&&Si(c,e,"c");function me(ae,ne){H(ne)?ne.forEach(ut=>ae(ut.bind(s))):ne&&ae(ne.bind(s))}if(me(Vl,p),me(Ht,g),me(Kl,h),me(Wl,C),me(Bl,E),me(Fl,M),me(zl,Ae),me(Xl,Z),me(Gl,Y),me(er,x),me(Vt,j),me(ql,V),H(z))if(z.length){const ae=e.exposed||(e.exposed={});z.forEach(ne=>{Object.defineProperty(ae,ne,{get:()=>s[ne],set:ut=>s[ne]=ut,enumerable:!0})})}else e.exposed||(e.exposed={});q&&e.render===at&&(e.render=q),le!=null&&(e.inheritAttrs=le),$&&(e.components=$),se&&(e.directives=se),V&&Yo(e)}function Zl(e,t,s=at){H(e)&&(e=kn(e));for(const n in e){const i=e[n];let o;re(i)?"default"in i?o=ct(i.from||n,i.default,!0):o=ct(i.from||n):o=ct(i),we(o)?Object.defineProperty(t,n,{enumerable:!0,configurable:!0,get:()=>o.value,set:r=>o.value=r}):t[n]=o}}function Si(e,t,s){ze(H(e)?e.map(n=>n.bind(t.proxy)):e.bind(t.proxy),t,s)}function ir(e,t,s,n){let i=n.includes(".")?Ko(s,n):()=>s[n];if(_e(e)){const o=t[e];W(o)&&Bt(i,o)}else if(W(e))Bt(i,e.bind(s));else if(re(e))if(H(e))e.forEach(o=>ir(o,t,s,n));else{const o=W(e.handler)?e.handler.bind(s):t[e.handler];W(o)&&Bt(i,o,e)}}function or(e){const t=e.type,{mixins:s,extends:n}=t,{mixins:i,optionsCache:o,config:{optionMergeStrategies:r}}=e.appContext,l=o.get(t);let a;return l?a=l:!i.length&&!s&&!n?a=t:(a={},i.length&&i.forEach(d=>Ks(a,d,r,!0)),Ks(a,t,r)),re(t)&&o.set(t,a),a}function Ks(e,t,s,n=!1){const{mixins:i,extends:o}=t;o&&Ks(e,o,s,!0),i&&i.forEach(r=>Ks(e,r,s,!0));for(const r in t)if(!(n&&r==="expose")){const l=ea[r]||s&&s[r];e[r]=l?l(e[r],t[r]):t[r]}return e}const ea={data:Ei,props:Ci,emits:Ci,methods:us,computed:us,beforeCreate:Pe,created:Pe,beforeMount:Pe,mounted:Pe,beforeUpdate:Pe,updated:Pe,beforeDestroy:Pe,beforeUnmount:Pe,destroyed:Pe,unmounted:Pe,activated:Pe,deactivated:Pe,errorCaptured:Pe,serverPrefetch:Pe,components:us,directives:us,watch:sa,provide:Ei,inject:ta};function Ei(e,t){return t?e?function(){return ye(W(e)?e.call(this,this):e,W(t)?t.call(this,this):t)}:t:e}function ta(e,t){return us(kn(e),kn(t))}function kn(e){if(H(e)){const t={};for(let s=0;s<e.length;s++)t[e[s]]=e[s];return t}return e}function Pe(e,t){return e?[...new Set([].concat(e,t))]:t}function us(e,t){return e?ye(Object.create(null),e,t):t}function Ci(e,t){return e?H(e)&&H(t)?[...new Set([...e,...t])]:ye(Object.create(null),Ai(e),Ai(t??{})):t}function sa(e,t){if(!e)return t;if(!t)return e;const s=ye(Object.create(null),e);for(const n in t)s[n]=Pe(e[n],t[n]);return s}function rr(){return{app:null,config:{isNativeTag:uo,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let na=0;function ia(e,t){return function(n,i=null){W(n)||(n=ye({},n)),i!=null&&!re(i)&&(i=null);const o=rr(),r=new WeakSet,l=[];let a=!1;const d=o.app={_uid:na++,_component:n,_props:i,_container:null,_context:o,_instance:null,version:Da,get config(){return o.config},set config(c){},use(c,...p){return r.has(c)||(c&&W(c.install)?(r.add(c),c.install(d,...p)):W(c)&&(r.add(c),c(d,...p))),d},mixin(c){return o.mixins.includes(c)||o.mixins.push(c),d},component(c,p){return p?(o.components[c]=p,d):o.components[c]},directive(c,p){return p?(o.directives[c]=p,d):o.directives[c]},mount(c,p,g){if(!a){const h=d._ceVNode||X(n,i);return h.appContext=o,g===!0?g="svg":g===!1&&(g=void 0),e(h,c,g),a=!0,d._container=c,c.__vue_app__=d,ii(h.component)}},onUnmount(c){l.push(c)},unmount(){a&&(ze(l,d._instance,16),e(null,d._container),delete d._container.__vue_app__)},provide(c,p){return o.provides[c]=p,d},runWithContext(c){const p=es;es=d;try{return c()}finally{es=p}}};return d}}let es=null;const oa=(e,t)=>t==="modelValue"||t==="model-value"?e.modelModifiers:e[`${t}Modifiers`]||e[`${$e(t)}Modifiers`]||e[`${Ft(t)}Modifiers`];function ra(e,t,...s){if(e.isUnmounted)return;const n=e.vnode.props||de;let i=s;const o=t.startsWith("update:"),r=o&&oa(n,t.slice(7));r&&(r.trim&&(i=s.map(c=>_e(c)?c.trim():c)),r.number&&(i=s.map(Gr)));let l,a=n[l=pn(t)]||n[l=pn($e(t))];!a&&o&&(a=n[l=pn(Ft(t))]),a&&ze(a,e,6,i);const d=n[l+"Once"];if(d){if(!e.emitted)e.emitted={};else if(e.emitted[l])return;e.emitted[l]=!0,ze(d,e,6,i)}}const la=new WeakMap;function lr(e,t,s=!1){const n=s?la:t.emitsCache,i=n.get(e);if(i!==void 0)return i;const o=e.emits;let r={},l=!1;if(!W(e)){const a=d=>{const c=lr(d,t,!0);c&&(l=!0,ye(r,c))};!s&&t.mixins.length&&t.mixins.forEach(a),e.extends&&a(e.extends),e.mixins&&e.mixins.forEach(a)}return!o&&!l?(re(e)&&n.set(e,null),null):(H(o)?o.forEach(a=>r[a]=null):ye(r,o),re(e)&&n.set(e,r),r)}function rn(e,t){return!e||!zs(t)?!1:(t=t.slice(2).replace(/Once$/,""),oe(e,t[0].toLowerCase()+t.slice(1))||oe(e,Ft(t))||oe(e,t))}function xi(e){const{type:t,vnode:s,proxy:n,withProxy:i,propsOptions:[o],slots:r,attrs:l,emit:a,render:d,renderCache:c,props:p,data:g,setupState:h,ctx:C,inheritAttrs:E}=e,M=Hs(e);let w,x;try{if(s.shapeFlag&4){const j=i||n,q=j;w=ot(d.call(q,j,c,p,h,g,C)),x=l}else{const j=t;w=ot(j.length>1?j(p,{attrs:l,slots:r,emit:a}):j(p,null)),x=t.props?l:aa(l)}}catch(j){vs.length=0,sn(j,e,1),w=X(je)}let k=w;if(x&&E!==!1){const j=Object.keys(x),{shapeFlag:q}=k;j.length&&q&7&&(o&&j.some(Js)&&(x=ca(x,o)),k=Rt(k,x,!1,!0))}return s.dirs&&(k=Rt(k,null,!1,!0),k.dirs=k.dirs?k.dirs.concat(s.dirs):s.dirs),s.transition&&Cs(k,s.transition),w=k,Hs(M),w}const aa=e=>{let t;for(const s in e)(s==="class"||s==="style"||zs(s))&&((t||(t={}))[s]=e[s]);return t},ca=(e,t)=>{const s={};for(const n in e)(!Js(n)||!(n.slice(9)in t))&&(s[n]=e[n]);return s};function pa(e,t,s){const{props:n,children:i,component:o}=e,{props:r,children:l,patchFlag:a}=t,d=o.emitsOptions;if(t.dirs||t.transition)return!0;if(s&&a>=0){if(a&1024)return!0;if(a&16)return n?Ii(n,r,d):!!r;if(a&8){const c=t.dynamicProps;for(let p=0;p<c.length;p++){const g=c[p];if(ar(r,n,g)&&!rn(d,g))return!0}}}else return(i||l)&&(!l||!l.$stable)?!0:n===r?!1:n?r?Ii(n,r,d):!0:!!r;return!1}function Ii(e,t,s){const n=Object.keys(t);if(n.length!==Object.keys(e).length)return!0;for(let i=0;i<n.length;i++){const o=n[i];if(ar(t,e,o)&&!rn(s,o))return!0}return!1}function ar(e,t,s){const n=e[s],i=t[s];return s==="style"&&re(n)&&re(i)?!qn(n,i):n!==i}function ua({vnode:e,parent:t,suspense:s},n){for(;t;){const i=t.subTree;if(i.suspense&&i.suspense.activeBranch===e&&(i.suspense.vnode.el=i.el=n,e=i),i===e)(e=t.vnode).el=n,t=t.parent;else break}s&&s.activeBranch===e&&(s.vnode.el=n)}const cr={},pr=()=>Object.create(cr),ur=e=>Object.getPrototypeOf(e)===cr;function da(e,t,s,n=!1){const i={},o=pr();e.propsDefaults=Object.create(null),dr(e,t,i,o);for(const r in e.propsOptions[0])r in i||(i[r]=void 0);s?e.props=n?i:$o(i):e.type.props?e.props=i:e.props=o,e.attrs=o}function fa(e,t,s,n){const{props:i,attrs:o,vnode:{patchFlag:r}}=e,l=te(i),[a]=e.propsOptions;let d=!1;if((n||r>0)&&!(r&16)){if(r&8){const c=e.vnode.dynamicProps;for(let p=0;p<c.length;p++){let g=c[p];if(rn(e.emitsOptions,g))continue;const h=t[g];if(a)if(oe(o,g))h!==o[g]&&(o[g]=h,d=!0);else{const C=$e(g);i[C]=$n(a,l,C,h,e,!1)}else h!==o[g]&&(o[g]=h,d=!0)}}}else{dr(e,t,i,o)&&(d=!0);let c;for(const p in l)(!t||!oe(t,p)&&((c=Ft(p))===p||!oe(t,c)))&&(a?s&&(s[p]!==void 0||s[c]!==void 0)&&(i[p]=$n(a,l,p,void 0,e,!0)):delete i[p]);if(o!==l)for(const p in o)(!t||!oe(t,p))&&(delete o[p],d=!0)}d&&mt(e.attrs,"set","")}function dr(e,t,s,n){const[i,o]=e.propsOptions;let r=!1,l;if(t)for(let a in t){if(ds(a))continue;const d=t[a];let c;i&&oe(i,c=$e(a))?!o||!o.includes(c)?s[c]=d:(l||(l={}))[c]=d:rn(e.emitsOptions,a)||(!(a in n)||d!==n[a])&&(n[a]=d,r=!0)}if(o){const a=te(s),d=l||de;for(let c=0;c<o.length;c++){const p=o[c];s[p]=$n(i,a,p,d[p],e,!oe(d,p))}}return r}function $n(e,t,s,n,i,o){const r=e[s];if(r!=null){const l=oe(r,"default");if(l&&n===void 0){const a=r.default;if(r.type!==Function&&!r.skipFactory&&W(a)){const{propsDefaults:d}=i;if(s in d)n=d[s];else{const c=js(i);n=d[s]=a.call(null,t),c()}}else n=a;i.ce&&i.ce._setProp(s,n)}r[0]&&(o&&!l?n=!1:r[1]&&(n===""||n===Ft(s))&&(n=!0))}return n}const ga=new WeakMap;function fr(e,t,s=!1){const n=s?ga:t.propsCache,i=n.get(e);if(i)return i;const o=e.props,r={},l=[];let a=!1;if(!W(e)){const c=p=>{a=!0;const[g,h]=fr(p,t,!0);ye(r,g),h&&l.push(...h)};!s&&t.mixins.length&&t.mixins.forEach(c),e.extends&&c(e.extends),e.mixins&&e.mixins.forEach(c)}if(!o&&!a)return re(e)&&n.set(e,Qt),Qt;if(H(o))for(let c=0;c<o.length;c++){const p=$e(o[c]);wi(p)&&(r[p]=de)}else if(o)for(const c in o){const p=$e(c);if(wi(p)){const g=o[c],h=r[p]=H(g)||W(g)?{type:g}:ye({},g),C=h.type;let E=!1,M=!0;if(H(C))for(let w=0;w<C.length;++w){const x=C[w],k=W(x)&&x.name;if(k==="Boolean"){E=!0;break}else k==="String"&&(M=!1)}else E=W(C)&&C.name==="Boolean";h[0]=E,h[1]=M,(E||oe(h,"default"))&&l.push(p)}}const d=[r,l];return re(e)&&n.set(e,d),d}function wi(e){return e[0]!=="$"&&!ds(e)}const ti=e=>e==="_"||e==="_ctx"||e==="$stable",si=e=>H(e)?e.map(ot):[ot(e)],ha=(e,t,s)=>{if(t._n)return t;const n=fe((...i)=>si(t(...i)),s);return n._c=!1,n},gr=(e,t,s)=>{const n=e._ctx;for(const i in e){if(ti(i))continue;const o=e[i];if(W(o))t[i]=ha(i,o,n);else if(o!=null){const r=si(o);t[i]=()=>r}}},hr=(e,t)=>{const s=si(t);e.slots.default=()=>s},_r=(e,t,s)=>{for(const n in t)(s||!ti(n))&&(e[n]=t[n])},_a=(e,t,s)=>{const n=e.slots=pr();if(e.vnode.shapeFlag&32){const i=t._;i?(_r(n,t,s),s&&mo(n,"_",i,!0)):gr(t,n)}else t&&hr(e,t)},ma=(e,t,s)=>{const{vnode:n,slots:i}=e;let o=!0,r=de;if(n.shapeFlag&32){const l=t._;l?s&&l===1?o=!1:_r(i,t,s):(o=!t.$stable,gr(t,i)),r=t}else t&&(hr(e,t),r={default:1});if(o)for(const l in i)!ti(l)&&r[l]==null&&delete i[l]},Ne=Sa;function va(e){return ba(e)}function ba(e,t){const s=Zs();s.__VUE__=!0;const{insert:n,remove:i,patchProp:o,createElement:r,createText:l,createComment:a,setText:d,setElementText:c,parentNode:p,nextSibling:g,setScopeId:h=at,insertStaticContent:C}=e,E=(u,f,_,v=null,A=null,b=null,R=void 0,P=null,I=!!f.dynamicChildren)=>{if(u===f)return;u&&!Dt(u,f)&&(v=y(u),De(u,A,b,!0),u=null),f.patchFlag===-2&&(I=!1,f.dynamicChildren=null);const{type:S,ref:F,shapeFlag:O}=f;switch(S){case ln:M(u,f,_,v);break;case je:w(u,f,_,v);break;case Ds:u==null&&x(f,_,v,R);break;case Q:$(u,f,_,v,A,b,R,P,I);break;default:O&1?q(u,f,_,v,A,b,R,P,I):O&6?se(u,f,_,v,A,b,R,P,I):(O&64||O&128)&&S.process(u,f,_,v,A,b,R,P,I,U)}F!=null&&A?hs(F,u&&u.ref,b,f||u,!f):F==null&&u&&u.ref!=null&&hs(u.ref,null,b,u,!0)},M=(u,f,_,v)=>{if(u==null)n(f.el=l(f.children),_,v);else{const A=f.el=u.el;f.children!==u.children&&d(A,f.children)}},w=(u,f,_,v)=>{u==null?n(f.el=a(f.children||""),_,v):f.el=u.el},x=(u,f,_,v)=>{[u.el,u.anchor]=C(u.children,f,_,v,u.el,u.anchor)},k=({el:u,anchor:f},_,v)=>{let A;for(;u&&u!==f;)A=g(u),n(u,_,v),u=A;n(f,_,v)},j=({el:u,anchor:f})=>{let _;for(;u&&u!==f;)_=g(u),i(u),u=_;i(f)},q=(u,f,_,v,A,b,R,P,I)=>{if(f.type==="svg"?R="svg":f.type==="math"&&(R="mathml"),u==null)Z(f,_,v,A,b,R,P,I);else{const S=u.el&&u.el._isVueCE?u.el:null;try{S&&S._beginPatch(),V(u,f,A,b,R,P,I)}finally{S&&S._endPatch()}}},Z=(u,f,_,v,A,b,R,P)=>{let I,S;const{props:F,shapeFlag:O,transition:L,dirs:K}=u;if(I=u.el=r(u.type,b,F&&F.is,F),O&8?c(I,u.children):O&16&&Ae(u.children,I,null,v,A,vn(u,b),R,P),K&&jt(u,null,v,"created"),Y(I,u,u.scopeId,R,v),F){for(const ce in F)ce!=="value"&&!ds(ce)&&o(I,ce,null,F[ce],b,v);"value"in F&&o(I,"value",null,F.value,b),(S=F.onVnodeBeforeMount)&&tt(S,v,u)}K&&jt(u,null,v,"beforeMount");const ee=ya(A,L);ee&&L.beforeEnter(I),n(I,f,_),((S=F&&F.onVnodeMounted)||ee||K)&&Ne(()=>{S&&tt(S,v,u),ee&&L.enter(I),K&&jt(u,null,v,"mounted")},A)},Y=(u,f,_,v,A)=>{if(_&&h(u,_),v)for(let b=0;b<v.length;b++)h(u,v[b]);if(A){let b=A.subTree;if(f===b||yr(b.type)&&(b.ssContent===f||b.ssFallback===f)){const R=A.vnode;Y(u,R,R.scopeId,R.slotScopeIds,A.parent)}}},Ae=(u,f,_,v,A,b,R,P,I=0)=>{for(let S=I;S<u.length;S++){const F=u[S]=P?_t(u[S]):ot(u[S]);E(null,F,f,_,v,A,b,R,P)}},V=(u,f,_,v,A,b,R)=>{const P=f.el=u.el;let{patchFlag:I,dynamicChildren:S,dirs:F}=f;I|=u.patchFlag&16;const O=u.props||de,L=f.props||de;let K;if(_&&Ot(_,!1),(K=L.onVnodeBeforeUpdate)&&tt(K,_,f,u),F&&jt(f,u,_,"beforeUpdate"),_&&Ot(_,!0),(O.innerHTML&&L.innerHTML==null||O.textContent&&L.textContent==null)&&c(P,""),S?z(u.dynamicChildren,S,P,_,v,vn(f,A),b):R||ne(u,f,P,null,_,v,vn(f,A),b,!1),I>0){if(I&16)le(P,O,L,_,A);else if(I&2&&O.class!==L.class&&o(P,"class",null,L.class,A),I&4&&o(P,"style",O.style,L.style,A),I&8){const ee=f.dynamicProps;for(let ce=0;ce<ee.length;ce++){const pe=ee[ce],ve=O[pe],Ce=L[pe];(Ce!==ve||pe==="value")&&o(P,pe,ve,Ce,A,_)}}I&1&&u.children!==f.children&&c(P,f.children)}else!R&&S==null&&le(P,O,L,_,A);((K=L.onVnodeUpdated)||F)&&Ne(()=>{K&&tt(K,_,f,u),F&&jt(f,u,_,"updated")},v)},z=(u,f,_,v,A,b,R)=>{for(let P=0;P<f.length;P++){const I=u[P],S=f[P],F=I.el&&(I.type===Q||!Dt(I,S)||I.shapeFlag&198)?p(I.el):_;E(I,S,F,null,v,A,b,R,!0)}},le=(u,f,_,v,A)=>{if(f!==_){if(f!==de)for(const b in f)!ds(b)&&!(b in _)&&o(u,b,f[b],null,A,v);for(const b in _){if(ds(b))continue;const R=_[b],P=f[b];R!==P&&b!=="value"&&o(u,b,P,R,A,v)}"value"in _&&o(u,"value",f.value,_.value,A)}},$=(u,f,_,v,A,b,R,P,I)=>{const S=f.el=u?u.el:l(""),F=f.anchor=u?u.anchor:l("");let{patchFlag:O,dynamicChildren:L,slotScopeIds:K}=f;K&&(P=P?P.concat(K):K),u==null?(n(S,_,v),n(F,_,v),Ae(f.children||[],_,F,A,b,R,P,I)):O>0&&O&64&&L&&u.dynamicChildren&&u.dynamicChildren.length===L.length?(z(u.dynamicChildren,L,_,A,b,R,P),(f.key!=null||A&&f===A.subTree)&&mr(u,f,!0)):ne(u,f,_,F,A,b,R,P,I)},se=(u,f,_,v,A,b,R,P,I)=>{f.slotScopeIds=P,u==null?f.shapeFlag&512?A.ctx.activate(f,_,v,R,I):Se(f,_,v,A,b,R,I):Le(u,f,I)},Se=(u,f,_,v,A,b,R)=>{const P=u.component=Ra(u,v,A);if(nn(u)&&(P.ctx.renderer=U),Ta(P,!1,R),P.asyncDep){if(A&&A.registerDep(P,me,R),!u.el){const I=P.subTree=X(je);w(null,I,f,_),u.placeholder=I.el}}else me(P,u,f,_,A,b,R)},Le=(u,f,_)=>{const v=f.component=u.component;if(pa(u,f,_))if(v.asyncDep&&!v.asyncResolved){ae(v,f,_);return}else v.next=f,v.update();else f.el=u.el,v.vnode=f},me=(u,f,_,v,A,b,R)=>{const P=()=>{if(u.isMounted){let{next:O,bu:L,u:K,parent:ee,vnode:ce}=u;{const Ze=vr(u);if(Ze){O&&(O.el=ce.el,ae(u,O,R)),Ze.asyncDep.then(()=>{Ne(()=>{u.isUnmounted||S()},A)});return}}let pe=O,ve;Ot(u,!1),O?(O.el=ce.el,ae(u,O,R)):O=ce,L&&un(L),(ve=O.props&&O.props.onVnodeBeforeUpdate)&&tt(ve,ee,O,ce),Ot(u,!0);const Ce=xi(u),Ye=u.subTree;u.subTree=Ce,E(Ye,Ce,p(Ye.el),y(Ye),u,A,b),O.el=Ce.el,pe===null&&ua(u,Ce.el),K&&Ne(K,A),(ve=O.props&&O.props.onVnodeUpdated)&&Ne(()=>tt(ve,ee,O,ce),A)}else{let O;const{el:L,props:K}=f,{bm:ee,m:ce,parent:pe,root:ve,type:Ce}=u,Ye=_s(f);Ot(u,!1),ee&&un(ee),!Ye&&(O=K&&K.onVnodeBeforeMount)&&tt(O,pe,f),Ot(u,!0);{ve.ce&&ve.ce._hasShadowRoot()&&ve.ce._injectChildStyle(Ce,u.parent?u.parent.type:void 0);const Ze=u.subTree=xi(u);E(null,Ze,_,v,u,A,b),f.el=Ze.el}if(ce&&Ne(ce,A),!Ye&&(O=K&&K.onVnodeMounted)){const Ze=f;Ne(()=>tt(O,pe,Ze),A)}(f.shapeFlag&256||pe&&_s(pe.vnode)&&pe.vnode.shapeFlag&256)&&u.a&&Ne(u.a,A),u.isMounted=!0,f=_=v=null}};u.scope.on();const I=u.effect=new Ao(P);u.scope.off();const S=u.update=I.run.bind(I),F=u.job=I.runIfDirty.bind(I);F.i=u,F.id=u.uid,I.scheduler=()=>ei(F),Ot(u,!0),S()},ae=(u,f,_)=>{f.component=u;const v=u.vnode.props;u.vnode=f,u.next=null,fa(u,f.props,v,_),ma(u,f.children,_),vt(),_i(u),bt()},ne=(u,f,_,v,A,b,R,P,I=!1)=>{const S=u&&u.children,F=u?u.shapeFlag:0,O=f.children,{patchFlag:L,shapeFlag:K}=f;if(L>0){if(L&128){Et(S,O,_,v,A,b,R,P,I);return}else if(L&256){ut(S,O,_,v,A,b,R,P,I);return}}K&8?(F&16&&He(S,A,b),O!==S&&c(_,O)):F&16?K&16?Et(S,O,_,v,A,b,R,P,I):He(S,A,b,!0):(F&8&&c(_,""),K&16&&Ae(O,_,v,A,b,R,P,I))},ut=(u,f,_,v,A,b,R,P,I)=>{u=u||Qt,f=f||Qt;const S=u.length,F=f.length,O=Math.min(S,F);let L;for(L=0;L<O;L++){const K=f[L]=I?_t(f[L]):ot(f[L]);E(u[L],K,_,null,A,b,R,P,I)}S>F?He(u,A,b,!0,!1,O):Ae(f,_,v,A,b,R,P,I,O)},Et=(u,f,_,v,A,b,R,P,I)=>{let S=0;const F=f.length;let O=u.length-1,L=F-1;for(;S<=O&&S<=L;){const K=u[S],ee=f[S]=I?_t(f[S]):ot(f[S]);if(Dt(K,ee))E(K,ee,_,null,A,b,R,P,I);else break;S++}for(;S<=O&&S<=L;){const K=u[O],ee=f[L]=I?_t(f[L]):ot(f[L]);if(Dt(K,ee))E(K,ee,_,null,A,b,R,P,I);else break;O--,L--}if(S>O){if(S<=L){const K=L+1,ee=K<F?f[K].el:v;for(;S<=L;)E(null,f[S]=I?_t(f[S]):ot(f[S]),_,ee,A,b,R,P,I),S++}}else if(S>L)for(;S<=O;)De(u[S],A,b,!0),S++;else{const K=S,ee=S,ce=new Map;for(S=ee;S<=L;S++){const Be=f[S]=I?_t(f[S]):ot(f[S]);Be.key!=null&&ce.set(Be.key,S)}let pe,ve=0;const Ce=L-ee+1;let Ye=!1,Ze=0;const rs=new Array(Ce);for(S=0;S<Ce;S++)rs[S]=0;for(S=K;S<=O;S++){const Be=u[S];if(ve>=Ce){De(Be,A,b,!0);continue}let et;if(Be.key!=null)et=ce.get(Be.key);else for(pe=ee;pe<=L;pe++)if(rs[pe-ee]===0&&Dt(Be,f[pe])){et=pe;break}et===void 0?De(Be,A,b,!0):(rs[et-ee]=S+1,et>=Ze?Ze=et:Ye=!0,E(Be,f[et],_,null,A,b,R,P,I),ve++)}const ci=Ye?Aa(rs):Qt;for(pe=ci.length-1,S=Ce-1;S>=0;S--){const Be=ee+S,et=f[Be],pi=f[Be+1],ui=Be+1<F?pi.el||br(pi):v;rs[S]===0?E(null,et,_,ui,A,b,R,P,I):Ye&&(pe<0||S!==ci[pe]?Qe(et,_,ui,2):pe--)}}},Qe=(u,f,_,v,A=null)=>{const{el:b,type:R,transition:P,children:I,shapeFlag:S}=u;if(S&6){Qe(u.component.subTree,f,_,v);return}if(S&128){u.suspense.move(f,_,v);return}if(S&64){R.move(u,f,_,U);return}if(R===Q){n(b,f,_);for(let O=0;O<I.length;O++)Qe(I[O],f,_,v);n(u.anchor,f,_);return}if(R===Ds){k(u,f,_);return}if(v!==2&&S&1&&P)if(v===0)P.beforeEnter(b),n(b,f,_),Ne(()=>P.enter(b),A);else{const{leave:O,delayLeave:L,afterLeave:K}=P,ee=()=>{u.ctx.isUnmounted?i(b):n(b,f,_)},ce=()=>{b._isLeaving&&b[nt](!0),O(b,()=>{ee(),K&&K()})};L?L(b,ee,ce):ce()}else n(b,f,_)},De=(u,f,_,v=!1,A=!1)=>{const{type:b,props:R,ref:P,children:I,dynamicChildren:S,shapeFlag:F,patchFlag:O,dirs:L,cacheIndex:K,memo:ee}=u;if(O===-2&&(A=!1),P!=null&&(vt(),hs(P,null,_,u,!0),bt()),K!=null&&(f.renderCache[K]=void 0),F&256){f.ctx.deactivate(u);return}const ce=F&1&&L,pe=!_s(u);let ve;if(pe&&(ve=R&&R.onVnodeBeforeUnmount)&&tt(ve,f,u),F&6)Tt(u.component,_,v);else{if(F&128){u.suspense.unmount(_,v);return}ce&&jt(u,null,f,"beforeUnmount"),F&64?u.type.remove(u,f,_,U,v):S&&!S.hasOnce&&(b!==Q||O>0&&O&64)?He(S,f,_,!1,!0):(b===Q&&O&384||!A&&F&16)&&He(I,f,_),v&&Wt(u)}const Ce=ee!=null&&K==null;(pe&&(ve=R&&R.onVnodeUnmounted)||ce||Ce)&&Ne(()=>{ve&&tt(ve,f,u),ce&&jt(u,null,f,"unmounted"),Ce&&(u.el=null)},_)},Wt=u=>{const{type:f,el:_,anchor:v,transition:A}=u;if(f===Q){qt(_,v);return}if(f===Ds){j(u);return}const b=()=>{i(_),A&&!A.persisted&&A.afterLeave&&A.afterLeave()};if(u.shapeFlag&1&&A&&!A.persisted){const{leave:R,delayLeave:P}=A,I=()=>R(_,b);P?P(u.el,b,I):I()}else b()},qt=(u,f)=>{let _;for(;u!==f;)_=g(u),i(u),u=_;i(f)},Tt=(u,f,_)=>{const{bum:v,scope:A,job:b,subTree:R,um:P,m:I,a:S}=u;Pi(I),Pi(S),v&&un(v),A.stop(),b&&(b.flags|=8,De(R,u,f,_)),P&&Ne(P,f),Ne(()=>{u.isUnmounted=!0},f)},He=(u,f,_,v=!1,A=!1,b=0)=>{for(let R=b;R<u.length;R++)De(u[R],f,_,v,A)},y=u=>{if(u.shapeFlag&6)return y(u.component.subTree);if(u.shapeFlag&128)return u.suspense.next();const f=g(u.anchor||u.el),_=f&&f[Dl];return _?g(_):f};let D=!1;const T=(u,f,_)=>{let v;u==null?f._vnode&&(De(f._vnode,null,null,!0),v=f._vnode.component):E(f._vnode||null,u,f,null,null,null,_),f._vnode=u,D||(D=!0,_i(v),Bo(),D=!1)},U={p:E,um:De,m:Qe,r:Wt,mt:Se,mc:Ae,pc:ne,pbc:z,n:y,o:e};return{render:T,hydrate:void 0,createApp:ia(T)}}function vn({type:e,props:t},s){return s==="svg"&&e==="foreignObject"||s==="mathml"&&e==="annotation-xml"&&t&&t.encoding&&t.encoding.includes("html")?void 0:s}function Ot({effect:e,job:t},s){s?(e.flags|=32,t.flags|=4):(e.flags&=-33,t.flags&=-5)}function ya(e,t){return(!e||e&&!e.pendingBranch)&&t&&!t.persisted}function mr(e,t,s=!1){const n=e.children,i=t.children;if(H(n)&&H(i))for(let o=0;o<n.length;o++){const r=n[o];let l=i[o];l.shapeFlag&1&&!l.dynamicChildren&&((l.patchFlag<=0||l.patchFlag===32)&&(l=i[o]=_t(i[o]),l.el=r.el),!s&&l.patchFlag!==-2&&mr(r,l)),l.type===ln&&(l.patchFlag===-1&&(l=i[o]=_t(l)),l.el=r.el),l.type===je&&!l.el&&(l.el=r.el)}}function Aa(e){const t=e.slice(),s=[0];let n,i,o,r,l;const a=e.length;for(n=0;n<a;n++){const d=e[n];if(d!==0){if(i=s[s.length-1],e[i]<d){t[n]=i,s.push(n);continue}for(o=0,r=s.length-1;o<r;)l=o+r>>1,e[s[l]]<d?o=l+1:r=l;d<e[s[o]]&&(o>0&&(t[n]=s[o-1]),s[o]=n)}}for(o=s.length,r=s[o-1];o-- >0;)s[o]=r,r=t[r];return s}function vr(e){const t=e.subTree.component;if(t)return t.asyncDep&&!t.asyncResolved?t:vr(t)}function Pi(e){if(e)for(let t=0;t<e.length;t++)e[t].flags|=8}function br(e){if(e.placeholder)return e.placeholder;const t=e.component;return t?br(t.subTree):null}const yr=e=>e.__isSuspense;function Sa(e,t){t&&t.pendingBranch?H(e)?t.effects.push(...e):t.effects.push(e):Ol(e)}const Q=Symbol.for("v-fgt"),ln=Symbol.for("v-txt"),je=Symbol.for("v-cmt"),Ds=Symbol.for("v-stc"),vs=[];let Fe=null;function N(e=!1){vs.push(Fe=e?null:[])}function Ea(){vs.pop(),Fe=vs[vs.length-1]||null}let xs=1;function Ws(e,t=!1){xs+=e,e<0&&Fe&&t&&(Fe.hasOnce=!0)}function Ar(e){return e.dynamicChildren=xs>0?Fe||Qt:null,Ea(),xs>0&&Fe&&Fe.push(e),e}function B(e,t,s,n,i,o){return Ar(m(e,t,s,n,i,o,!0))}function At(e,t,s,n,i){return Ar(X(e,t,s,n,i,!0))}function qs(e){return e?e.__v_isVNode===!0:!1}function Dt(e,t){return e.type===t.type&&e.key===t.key}const Sr=({key:e})=>e??null,Ns=({ref:e,ref_key:t,ref_for:s})=>(typeof e=="number"&&(e=""+e),e!=null?_e(e)||we(e)||W(e)?{i:qe,r:e,k:t,f:!!s}:e:null);function m(e,t=null,s=null,n=0,i=null,o=e===Q?0:1,r=!1,l=!1){const a={__v_isVNode:!0,__v_skip:!0,type:e,props:t,key:t&&Sr(t),ref:t&&Ns(t),scopeId:Ho,slotScopeIds:null,children:s,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetStart:null,targetAnchor:null,staticCount:0,shapeFlag:o,patchFlag:n,dynamicProps:i,dynamicChildren:null,appContext:null,ctx:qe};return l?(ni(a,s),o&128&&e.normalize(a)):s&&(a.shapeFlag|=_e(s)?8:16),xs>0&&!r&&Fe&&(a.patchFlag>0||o&6)&&a.patchFlag!==32&&Fe.push(a),a}const X=Ca;function Ca(e,t=null,s=null,n=0,i=null,o=!1){if((!e||e===sr)&&(e=je),qs(e)){const l=Rt(e,t,!0);return s&&ni(l,s),xs>0&&!o&&Fe&&(l.shapeFlag&6?Fe[Fe.indexOf(e)]=l:Fe.push(l)),l.patchFlag=-2,l}if($a(e)&&(e=e.__vccOpts),t){t=xa(t);let{class:l,style:a}=t;l&&!_e(l)&&(t.class=We(l)),re(a)&&(Zn(a)&&!H(a)&&(a=ye({},a)),t.style=Wn(a))}const r=_e(e)?1:yr(e)?128:Wo(e)?64:re(e)?4:W(e)?2:0;return m(e,t,s,n,i,r,o,!0)}function xa(e){return e?Zn(e)||ur(e)?ye({},e):e:null}function Rt(e,t,s=!1,n=!1){const{props:i,ref:o,patchFlag:r,children:l,transition:a}=e,d=t?Ia(i||{},t):i,c={__v_isVNode:!0,__v_skip:!0,type:e.type,props:d,key:d&&Sr(d),ref:t&&t.ref?s&&o?H(o)?o.concat(Ns(t)):[o,Ns(t)]:Ns(t):o,scopeId:e.scopeId,slotScopeIds:e.slotScopeIds,children:l,target:e.target,targetStart:e.targetStart,targetAnchor:e.targetAnchor,staticCount:e.staticCount,shapeFlag:e.shapeFlag,patchFlag:t&&e.type!==Q?r===-1?16:r|16:r,dynamicProps:e.dynamicProps,dynamicChildren:e.dynamicChildren,appContext:e.appContext,dirs:e.dirs,transition:a,component:e.component,suspense:e.suspense,ssContent:e.ssContent&&Rt(e.ssContent),ssFallback:e.ssFallback&&Rt(e.ssFallback),placeholder:e.placeholder,el:e.el,anchor:e.anchor,ctx:e.ctx,ce:e.ce};return a&&n&&Cs(c,a.clone(c)),c}function Oe(e=" ",t=0){return X(ln,null,e,t)}function ts(e,t){const s=X(Ds,null,e);return s.staticCount=t,s}function Er(e="",t=!1){return t?(N(),At(je,null,e)):X(je,null,e)}function ot(e){return e==null||typeof e=="boolean"?X(je):H(e)?X(Q,null,e.slice()):qs(e)?_t(e):X(ln,null,String(e))}function _t(e){return e.el===null&&e.patchFlag!==-1||e.memo?e:Rt(e)}function ni(e,t){let s=0;const{shapeFlag:n}=e;if(t==null)t=null;else if(H(t))s=16;else if(typeof t=="object")if(n&65){const i=t.default;i&&(i._c&&(i._d=!1),ni(e,i()),i._c&&(i._d=!0));return}else{s=32;const i=t._;!i&&!ur(t)?t._ctx=qe:i===3&&qe&&(qe.slots._===1?t._=1:(t._=2,e.patchFlag|=1024))}else W(t)?(t={default:t,_ctx:qe},s=32):(t=String(t),n&64?(s=16,t=[Oe(t)]):s=8);e.children=t,e.shapeFlag|=s}function Ia(...e){const t={};for(let s=0;s<e.length;s++){const n=e[s];for(const i in n)if(i==="class")t.class!==n.class&&(t.class=We([t.class,n.class]));else if(i==="style")t.style=Wn([t.style,n.style]);else if(zs(i)){const o=t[i],r=n[i];r&&o!==r&&!(H(o)&&o.includes(r))?t[i]=o?[].concat(o,r):r:r==null&&o==null&&!Js(i)&&(t[i]=r)}else i!==""&&(t[i]=n[i])}return t}function tt(e,t,s,n=null){ze(e,t,7,[s,n])}const wa=rr();let Pa=0;function Ra(e,t,s){const n=e.type,i=(t?t.appContext:e.appContext)||wa,o={uid:Pa++,vnode:e,type:n,parent:t,appContext:i,root:null,next:null,subTree:null,effect:null,update:null,job:null,scope:new sl(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:t?t.provides:Object.create(i.provides),ids:t?t.ids:["",0,0],accessCache:null,renderCache:[],components:null,directives:null,propsOptions:fr(n,i),emitsOptions:lr(n,i),emit:null,emitted:null,propsDefaults:de,inheritAttrs:n.inheritAttrs,ctx:de,data:de,props:de,attrs:de,slots:de,refs:de,setupState:de,setupContext:null,suspense:s,suspenseId:s?s.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return o.ctx={_:o},o.root=t?t.root:o,o.emit=ra.bind(null,o),e.ce&&e.ce(o),o}let Ie=null;const Cr=()=>Ie||qe;let Gs,Dn;{const e=Zs(),t=(s,n)=>{let i;return(i=e[s])||(i=e[s]=[]),i.push(n),o=>{i.length>1?i.forEach(r=>r(o)):i[0](o)}};Gs=t("__VUE_INSTANCE_SETTERS__",s=>Ie=s),Dn=t("__VUE_SSR_SETTERS__",s=>Is=s)}const js=e=>{const t=Ie;return Gs(e),e.scope.on(),()=>{e.scope.off(),Gs(t)}},Ri=()=>{Ie&&Ie.scope.off(),Gs(null)};function xr(e){return e.vnode.shapeFlag&4}let Is=!1;function Ta(e,t=!1,s=!1){t&&Dn(t);const{props:n,children:i}=e.vnode,o=xr(e);da(e,n,o,t),_a(e,i,s||t);const r=o?ja(e,t):void 0;return t&&Dn(!1),r}function ja(e,t){const s=e.type;e.accessCache=Object.create(null),e.proxy=new Proxy(e.ctx,Ql);const{setup:n}=s;if(n){vt();const i=e.setupContext=n.length>1?Ma(e):null,o=js(e),r=Ts(n,e,0,[e.props,i]),l=go(r);if(bt(),o(),(l||e.sp)&&!_s(e)&&Yo(e),l){if(r.then(Ri,Ri),t)return r.then(a=>{Ti(e,a)}).catch(a=>{sn(a,e,0)});e.asyncDep=r}else Ti(e,r)}else Ir(e)}function Ti(e,t,s){W(t)?e.type.__ssrInlineRender?e.ssrRender=t:e.render=t:re(t)&&(e.setupState=No(t)),Ir(e)}function Ir(e,t,s){const n=e.type;e.render||(e.render=n.render||at);{const i=js(e);vt();try{Yl(e)}finally{bt(),i()}}}const Oa={get(e,t){return xe(e,"get",""),e[t]}};function Ma(e){const t=s=>{e.exposed=s||{}};return{attrs:new Proxy(e.attrs,Oa),slots:e.slots,emit:e.emit,expose:t}}function ii(e){return e.exposed?e.exposeProxy||(e.exposeProxy=new Proxy(No(Sl(e.exposed)),{get(t,s){if(s in t)return t[s];if(s in ms)return ms[s](e)},has(t,s){return s in t||s in ms}})):e.proxy}function ka(e,t=!0){return W(e)?e.displayName||e.name:e.name||t&&e.__name}function $a(e){return W(e)&&"__vccOpts"in e}const Me=(e,t)=>wl(e,t,Is);function oi(e,t,s){try{Ws(-1);const n=arguments.length;return n===2?re(t)&&!H(t)?qs(t)?X(e,null,[t]):X(e,t):X(e,null,t):(n>3?s=Array.prototype.slice.call(arguments,2):n===3&&qs(s)&&(s=[s]),X(e,t,s))}finally{Ws(1)}}const Da="3.5.31";let Nn;const ji=typeof window<"u"&&window.trustedTypes;if(ji)try{Nn=ji.createPolicy("vue",{createHTML:e=>e})}catch{}const wr=Nn?e=>Nn.createHTML(e):e=>e,Na="http://www.w3.org/2000/svg",Ua="http://www.w3.org/1998/Math/MathML",ht=typeof document<"u"?document:null,Oi=ht&&ht.createElement("template"),La={insert:(e,t,s)=>{t.insertBefore(e,s||null)},remove:e=>{const t=e.parentNode;t&&t.removeChild(e)},createElement:(e,t,s,n)=>{const i=t==="svg"?ht.createElementNS(Na,e):t==="mathml"?ht.createElementNS(Ua,e):s?ht.createElement(e,{is:s}):ht.createElement(e);return e==="select"&&n&&n.multiple!=null&&i.setAttribute("multiple",n.multiple),i},createText:e=>ht.createTextNode(e),createComment:e=>ht.createComment(e),setText:(e,t)=>{e.nodeValue=t},setElementText:(e,t)=>{e.textContent=t},parentNode:e=>e.parentNode,nextSibling:e=>e.nextSibling,querySelector:e=>ht.querySelector(e),setScopeId(e,t){e.setAttribute(t,"")},insertStaticContent(e,t,s,n,i,o){const r=s?s.previousSibling:t.lastChild;if(i&&(i===o||i.nextSibling))for(;t.insertBefore(i.cloneNode(!0),s),!(i===o||!(i=i.nextSibling)););else{Oi.innerHTML=wr(n==="svg"?`<svg>${e}</svg>`:n==="mathml"?`<math>${e}</math>`:e);const l=Oi.content;if(n==="svg"||n==="mathml"){const a=l.firstChild;for(;a.firstChild;)l.appendChild(a.firstChild);l.removeChild(a)}t.insertBefore(l,s)}return[r?r.nextSibling:t.firstChild,s?s.previousSibling:t.lastChild]}},Ct="transition",cs="animation",ws=Symbol("_vtc"),Pr={name:String,type:String,css:{type:Boolean,default:!0},duration:[String,Number,Object],enterFromClass:String,enterActiveClass:String,enterToClass:String,appearFromClass:String,appearActiveClass:String,appearToClass:String,leaveFromClass:String,leaveActiveClass:String,leaveToClass:String},Ba=ye({},qo,Pr),Fa=e=>(e.displayName="Transition",e.props=Ba,e),Ha=Fa((e,{slots:t})=>oi(Ll,Va(e),t)),Mt=(e,t=[])=>{H(e)?e.forEach(s=>s(...t)):e&&e(...t)},Mi=e=>e?H(e)?e.some(t=>t.length>1):e.length>1:!1;function Va(e){const t={};for(const $ in e)$ in Pr||(t[$]=e[$]);if(e.css===!1)return t;const{name:s="v",type:n,duration:i,enterFromClass:o=`${s}-enter-from`,enterActiveClass:r=`${s}-enter-active`,enterToClass:l=`${s}-enter-to`,appearFromClass:a=o,appearActiveClass:d=r,appearToClass:c=l,leaveFromClass:p=`${s}-leave-from`,leaveActiveClass:g=`${s}-leave-active`,leaveToClass:h=`${s}-leave-to`}=e,C=Ka(i),E=C&&C[0],M=C&&C[1],{onBeforeEnter:w,onEnter:x,onEnterCancelled:k,onLeave:j,onLeaveCancelled:q,onBeforeAppear:Z=w,onAppear:Y=x,onAppearCancelled:Ae=k}=t,V=($,se,Se,Le)=>{$._enterCancelled=Le,kt($,se?c:l),kt($,se?d:r),Se&&Se()},z=($,se)=>{$._isLeaving=!1,kt($,p),kt($,h),kt($,g),se&&se()},le=$=>(se,Se)=>{const Le=$?Y:x,me=()=>V(se,$,Se);Mt(Le,[se,me]),ki(()=>{kt(se,$?a:o),ft(se,$?c:l),Mi(Le)||$i(se,n,E,me)})};return ye(t,{onBeforeEnter($){Mt(w,[$]),ft($,o),ft($,r)},onBeforeAppear($){Mt(Z,[$]),ft($,a),ft($,d)},onEnter:le(!1),onAppear:le(!0),onLeave($,se){$._isLeaving=!0;const Se=()=>z($,se);ft($,p),$._enterCancelled?(ft($,g),Ui($)):(Ui($),ft($,g)),ki(()=>{$._isLeaving&&(kt($,p),ft($,h),Mi(j)||$i($,n,M,Se))}),Mt(j,[$,Se])},onEnterCancelled($){V($,!1,void 0,!0),Mt(k,[$])},onAppearCancelled($){V($,!0,void 0,!0),Mt(Ae,[$])},onLeaveCancelled($){z($),Mt(q,[$])}})}function Ka(e){if(e==null)return null;if(re(e))return[bn(e.enter),bn(e.leave)];{const t=bn(e);return[t,t]}}function bn(e){return Xr(e)}function ft(e,t){t.split(/\s+/).forEach(s=>s&&e.classList.add(s)),(e[ws]||(e[ws]=new Set)).add(t)}function kt(e,t){t.split(/\s+/).forEach(n=>n&&e.classList.remove(n));const s=e[ws];s&&(s.delete(t),s.size||(e[ws]=void 0))}function ki(e){requestAnimationFrame(()=>{requestAnimationFrame(e)})}let Wa=0;function $i(e,t,s,n){const i=e._endId=++Wa,o=()=>{i===e._endId&&n()};if(s!=null)return setTimeout(o,s);const{type:r,timeout:l,propCount:a}=qa(e,t);if(!r)return n();const d=r+"end";let c=0;const p=()=>{e.removeEventListener(d,g),o()},g=h=>{h.target===e&&++c>=a&&p()};setTimeout(()=>{c<a&&p()},l+1),e.addEventListener(d,g)}function qa(e,t){const s=window.getComputedStyle(e),n=C=>(s[C]||"").split(", "),i=n(`${Ct}Delay`),o=n(`${Ct}Duration`),r=Di(i,o),l=n(`${cs}Delay`),a=n(`${cs}Duration`),d=Di(l,a);let c=null,p=0,g=0;t===Ct?r>0&&(c=Ct,p=r,g=o.length):t===cs?d>0&&(c=cs,p=d,g=a.length):(p=Math.max(r,d),c=p>0?r>d?Ct:cs:null,g=c?c===Ct?o.length:a.length:0);const h=c===Ct&&/\b(?:transform|all)(?:,|$)/.test(n(`${Ct}Property`).toString());return{type:c,timeout:p,propCount:g,hasTransform:h}}function Di(e,t){for(;e.length<t.length;)e=e.concat(e);return Math.max(...t.map((s,n)=>Ni(s)+Ni(e[n])))}function Ni(e){return e==="auto"?0:Number(e.slice(0,-1).replace(",","."))*1e3}function Ui(e){return(e?e.ownerDocument:document).body.offsetHeight}function Ga(e,t,s){const n=e[ws];n&&(t=(t?[t,...n]:[...n]).join(" ")),t==null?e.removeAttribute("class"):s?e.setAttribute("class",t):e.className=t}const Li=Symbol("_vod"),Xa=Symbol("_vsh"),za=Symbol(""),Ja=/(?:^|;)\s*display\s*:/;function Qa(e,t,s){const n=e.style,i=_e(s);let o=!1;if(s&&!i){if(t)if(_e(t))for(const r of t.split(";")){const l=r.slice(0,r.indexOf(":")).trim();s[l]==null&&Us(n,l,"")}else for(const r in t)s[r]==null&&Us(n,r,"");for(const r in s)r==="display"&&(o=!0),Us(n,r,s[r])}else if(i){if(t!==s){const r=n[za];r&&(s+=";"+r),n.cssText=s,o=Ja.test(s)}}else t&&e.removeAttribute("style");Li in e&&(e[Li]=o?n.display:"",e[Xa]&&(n.display="none"))}const Bi=/\s*!important$/;function Us(e,t,s){if(H(s))s.forEach(n=>Us(e,t,n));else if(s==null&&(s=""),t.startsWith("--"))e.setProperty(t,s);else{const n=Ya(e,t);Bi.test(s)?e.setProperty(Ft(n),s.replace(Bi,""),"important"):e[n]=s}}const Fi=["Webkit","Moz","ms"],yn={};function Ya(e,t){const s=yn[t];if(s)return s;let n=$e(t);if(n!=="filter"&&n in e)return yn[t]=n;n=Ys(n);for(let i=0;i<Fi.length;i++){const o=Fi[i]+n;if(o in e)return yn[t]=o}return t}const Hi="http://www.w3.org/1999/xlink";function Vi(e,t,s,n,i,o=el(t)){n&&t.startsWith("xlink:")?s==null?e.removeAttributeNS(Hi,t.slice(6,t.length)):e.setAttributeNS(Hi,t,s):s==null||o&&!vo(s)?e.removeAttribute(t):e.setAttribute(t,o?"":pt(s)?String(s):s)}function Ki(e,t,s,n,i){if(t==="innerHTML"||t==="textContent"){s!=null&&(e[t]=t==="innerHTML"?wr(s):s);return}const o=e.tagName;if(t==="value"&&o!=="PROGRESS"&&!o.includes("-")){const l=o==="OPTION"?e.getAttribute("value")||"":e.value,a=s==null?e.type==="checkbox"?"on":"":String(s);(l!==a||!("_value"in e))&&(e.value=a),s==null&&e.removeAttribute(t),e._value=s;return}let r=!1;if(s===""||s==null){const l=typeof e[t];l==="boolean"?s=vo(s):s==null&&l==="string"?(s="",r=!0):l==="number"&&(s=0,r=!0)}try{e[t]=s}catch{}r&&e.removeAttribute(i||t)}function Za(e,t,s,n){e.addEventListener(t,s,n)}function ec(e,t,s,n){e.removeEventListener(t,s,n)}const Wi=Symbol("_vei");function tc(e,t,s,n,i=null){const o=e[Wi]||(e[Wi]={}),r=o[t];if(n&&r)r.value=n;else{const[l,a]=sc(t);if(n){const d=o[t]=oc(n,i);Za(e,l,d,a)}else r&&(ec(e,l,r,a),o[t]=void 0)}}const qi=/(?:Once|Passive|Capture)$/;function sc(e){let t;if(qi.test(e)){t={};let n;for(;n=e.match(qi);)e=e.slice(0,e.length-n[0].length),t[n[0].toLowerCase()]=!0}return[e[2]===":"?e.slice(3):Ft(e.slice(2)),t]}let An=0;const nc=Promise.resolve(),ic=()=>An||(nc.then(()=>An=0),An=Date.now());function oc(e,t){const s=n=>{if(!n._vts)n._vts=Date.now();else if(n._vts<=s.attached)return;ze(rc(n,s.value),t,5,[n])};return s.value=e,s.attached=ic(),s}function rc(e,t){if(H(t)){const s=e.stopImmediatePropagation;return e.stopImmediatePropagation=()=>{s.call(e),e._stopped=!0},t.map(n=>i=>!i._stopped&&n&&n(i))}else return t}const Gi=e=>e.charCodeAt(0)===111&&e.charCodeAt(1)===110&&e.charCodeAt(2)>96&&e.charCodeAt(2)<123,lc=(e,t,s,n,i,o)=>{const r=i==="svg";t==="class"?Ga(e,n,r):t==="style"?Qa(e,s,n):zs(t)?Js(t)||tc(e,t,s,n,o):(t[0]==="."?(t=t.slice(1),!0):t[0]==="^"?(t=t.slice(1),!1):ac(e,t,n,r))?(Ki(e,t,n),!e.tagName.includes("-")&&(t==="value"||t==="checked"||t==="selected")&&Vi(e,t,n,r,o,t!=="value")):e._isVueCE&&(cc(e,t)||e._def.__asyncLoader&&(/[A-Z]/.test(t)||!_e(n)))?Ki(e,$e(t),n,o,t):(t==="true-value"?e._trueValue=n:t==="false-value"&&(e._falseValue=n),Vi(e,t,n,r))};function ac(e,t,s,n){if(n)return!!(t==="innerHTML"||t==="textContent"||t in e&&Gi(t)&&W(s));if(t==="spellcheck"||t==="draggable"||t==="translate"||t==="autocorrect"||t==="sandbox"&&e.tagName==="IFRAME"||t==="form"||t==="list"&&e.tagName==="INPUT"||t==="type"&&e.tagName==="TEXTAREA")return!1;if(t==="width"||t==="height"){const i=e.tagName;if(i==="IMG"||i==="VIDEO"||i==="CANVAS"||i==="SOURCE")return!1}return Gi(t)&&_e(s)?!1:t in e}function cc(e,t){const s=e._def.props;if(!s)return!1;const n=$e(t);return Array.isArray(s)?s.some(i=>$e(i)===n):Object.keys(s).some(i=>$e(i)===n)}const pc=["ctrl","shift","alt","meta"],uc={stop:e=>e.stopPropagation(),prevent:e=>e.preventDefault(),self:e=>e.target!==e.currentTarget,ctrl:e=>!e.ctrlKey,shift:e=>!e.shiftKey,alt:e=>!e.altKey,meta:e=>!e.metaKey,left:e=>"button"in e&&e.button!==0,middle:e=>"button"in e&&e.button!==1,right:e=>"button"in e&&e.button!==2,exact:(e,t)=>pc.some(s=>e[`${s}Key`]&&!t.includes(s))},Xs=(e,t)=>{if(!e)return e;const s=e._withMods||(e._withMods={}),n=t.join(".");return s[n]||(s[n]=((i,...o)=>{for(let r=0;r<t.length;r++){const l=uc[t[r]];if(l&&l(i,t))return}return e(i,...o)}))},dc=ye({patchProp:lc},La);let Xi;function fc(){return Xi||(Xi=va(dc))}const gc=((...e)=>{const t=fc().createApp(...e),{mount:s}=t;return t.mount=n=>{const i=_c(n);if(!i)return;const o=t._component;!W(o)&&!o.render&&!o.template&&(o.template=i.innerHTML),i.nodeType===1&&(i.textContent="");const r=s(i,!1,hc(i));return i instanceof Element&&(i.removeAttribute("v-cloak"),i.setAttribute("data-v-app","")),r},t});function hc(e){if(e instanceof SVGElement)return"svg";if(typeof MathMLElement=="function"&&e instanceof MathMLElement)return"mathml"}function _c(e){return _e(e)?document.querySelector(e):e}const zt=typeof document<"u";function Rr(e){return typeof e=="object"||"displayName"in e||"props"in e||"__vccOpts"in e}function mc(e){return e.__esModule||e[Symbol.toStringTag]==="Module"||e.default&&Rr(e.default)}const ie=Object.assign;function Sn(e,t){const s={};for(const n in t){const i=t[n];s[n]=Je(i)?i.map(e):e(i)}return s}const bs=()=>{},Je=Array.isArray;function zi(e,t){const s={};for(const n in e)s[n]=n in t?t[n]:e[n];return s}let he=(function(e){return e[e.MATCHER_NOT_FOUND=1]="MATCHER_NOT_FOUND",e[e.NAVIGATION_GUARD_REDIRECT=2]="NAVIGATION_GUARD_REDIRECT",e[e.NAVIGATION_ABORTED=4]="NAVIGATION_ABORTED",e[e.NAVIGATION_CANCELLED=8]="NAVIGATION_CANCELLED",e[e.NAVIGATION_DUPLICATED=16]="NAVIGATION_DUPLICATED",e})({});const Tr=Symbol("");he.MATCHER_NOT_FOUND+"",he.NAVIGATION_GUARD_REDIRECT+"",he.NAVIGATION_ABORTED+"",he.NAVIGATION_CANCELLED+"",he.NAVIGATION_DUPLICATED+"";function is(e,t){return ie(new Error,{type:e,[Tr]:!0},t)}function gt(e,t){return e instanceof Error&&Tr in e&&(t==null||!!(e.type&t))}const vc=["params","query","hash"];function bc(e){if(typeof e=="string")return e;if(e.path!=null)return e.path;const t={};for(const s of vc)s in e&&(t[s]=e[s]);return JSON.stringify(t,null,2)}const yc=Symbol(""),Ji=Symbol(""),ri=Symbol(""),li=Symbol(""),Un=Symbol("");function jr(e){return ct(li)}const Or=/#/g,Ac=/&/g,Sc=/\//g,Ec=/=/g,Cc=/\?/g,Mr=/\+/g,xc=/%5B/g,Ic=/%5D/g,kr=/%5E/g,wc=/%60/g,$r=/%7B/g,Pc=/%7C/g,Dr=/%7D/g,Rc=/%20/g;function ai(e){return e==null?"":encodeURI(""+e).replace(Pc,"|").replace(xc,"[").replace(Ic,"]")}function Tc(e){return ai(e).replace($r,"{").replace(Dr,"}").replace(kr,"^")}function Ln(e){return ai(e).replace(Mr,"%2B").replace(Rc,"+").replace(Or,"%23").replace(Ac,"%26").replace(wc,"`").replace($r,"{").replace(Dr,"}").replace(kr,"^")}function jc(e){return Ln(e).replace(Ec,"%3D")}function Oc(e){return ai(e).replace(Or,"%23").replace(Cc,"%3F")}function Mc(e){return Oc(e).replace(Sc,"%2F")}function Ps(e){if(e==null)return null;try{return decodeURIComponent(""+e)}catch{}return""+e}const kc=/\/$/,$c=e=>e.replace(kc,"");function En(e,t,s="/"){let n,i={},o="",r="";const l=t.indexOf("#");let a=t.indexOf("?");return a=l>=0&&a>l?-1:a,a>=0&&(n=t.slice(0,a),o=t.slice(a,l>0?l:t.length),i=e(o.slice(1))),l>=0&&(n=n||t.slice(0,l),r=t.slice(l,t.length)),n=Lc(n??t,s),{fullPath:n+o+r,path:n,query:i,hash:Ps(r)}}function Dc(e,t){const s=t.query?e(t.query):"";return t.path+(s&&"?")+s+(t.hash||"")}function Qi(e,t){return!t||!e.toLowerCase().startsWith(t.toLowerCase())?e:e.slice(t.length)||"/"}function Nc(e,t,s){const n=t.matched.length-1,i=s.matched.length-1;return n>-1&&n===i&&os(t.matched[n],s.matched[i])&&Nr(t.params,s.params)&&e(t.query)===e(s.query)&&t.hash===s.hash}function os(e,t){return(e.aliasOf||e)===(t.aliasOf||t)}function Nr(e,t){if(Object.keys(e).length!==Object.keys(t).length)return!1;for(var s in e)if(!Uc(e[s],t[s]))return!1;return!0}function Uc(e,t){return Je(e)?Yi(e,t):Je(t)?Yi(t,e):(e&&e.valueOf())===(t&&t.valueOf())}function Yi(e,t){return Je(t)?e.length===t.length&&e.every((s,n)=>s===t[n]):e.length===1&&e[0]===t}function Lc(e,t){if(e.startsWith("/"))return e;if(!e)return t;const s=t.split("/"),n=e.split("/"),i=n[n.length-1];(i===".."||i===".")&&n.push("");let o=s.length-1,r,l;for(r=0;r<n.length;r++)if(l=n[r],l!==".")if(l==="..")o>1&&o--;else break;return s.slice(0,o).join("/")+"/"+n.slice(r).join("/")}const xt={path:"/",name:void 0,params:{},query:{},hash:"",fullPath:"/",matched:[],meta:{},redirectedFrom:void 0};let Bn=(function(e){return e.pop="pop",e.push="push",e})({}),Cn=(function(e){return e.back="back",e.forward="forward",e.unknown="",e})({});function Bc(e){if(!e)if(zt){const t=document.querySelector("base");e=t&&t.getAttribute("href")||"/",e=e.replace(/^\w+:\/\/[^\/]+/,"")}else e="/";return e[0]!=="/"&&e[0]!=="#"&&(e="/"+e),$c(e)}const Fc=/^[^#]+#/;function Hc(e,t){return e.replace(Fc,"#")+t}function Vc(e,t){const s=document.documentElement.getBoundingClientRect(),n=e.getBoundingClientRect();return{behavior:t.behavior,left:n.left-s.left-(t.left||0),top:n.top-s.top-(t.top||0)}}const an=()=>({left:window.scrollX,top:window.scrollY});function Kc(e){let t;if("el"in e){const s=e.el,n=typeof s=="string"&&s.startsWith("#"),i=typeof s=="string"?n?document.getElementById(s.slice(1)):document.querySelector(s):s;if(!i)return;t=Vc(i,e)}else t=e;"scrollBehavior"in document.documentElement.style?window.scrollTo(t):window.scrollTo(t.left!=null?t.left:window.scrollX,t.top!=null?t.top:window.scrollY)}function Zi(e,t){return(history.state?history.state.position-t:-1)+e}const Fn=new Map;function Wc(e,t){Fn.set(e,t)}function qc(e){const t=Fn.get(e);return Fn.delete(e),t}function Gc(e){return typeof e=="string"||e&&typeof e=="object"}function Ur(e){return typeof e=="string"||typeof e=="symbol"}function Xc(e){const t={};if(e===""||e==="?")return t;const s=(e[0]==="?"?e.slice(1):e).split("&");for(let n=0;n<s.length;++n){const i=s[n].replace(Mr," "),o=i.indexOf("="),r=Ps(o<0?i:i.slice(0,o)),l=o<0?null:Ps(i.slice(o+1));if(r in t){let a=t[r];Je(a)||(a=t[r]=[a]),a.push(l)}else t[r]=l}return t}function eo(e){let t="";for(let s in e){const n=e[s];if(s=jc(s),n==null){n!==void 0&&(t+=(t.length?"&":"")+s);continue}(Je(n)?n.map(i=>i&&Ln(i)):[n&&Ln(n)]).forEach(i=>{i!==void 0&&(t+=(t.length?"&":"")+s,i!=null&&(t+="="+i))})}return t}function zc(e){const t={};for(const s in e){const n=e[s];n!==void 0&&(t[s]=Je(n)?n.map(i=>i==null?null:""+i):n==null?n:""+n)}return t}function ps(){let e=[];function t(n){return e.push(n),()=>{const i=e.indexOf(n);i>-1&&e.splice(i,1)}}function s(){e=[]}return{add:t,list:()=>e.slice(),reset:s}}function wt(e,t,s,n,i,o=r=>r()){const r=n&&(n.enterCallbacks[i]=n.enterCallbacks[i]||[]);return()=>new Promise((l,a)=>{const d=g=>{g===!1?a(is(he.NAVIGATION_ABORTED,{from:s,to:t})):g instanceof Error?a(g):Gc(g)?a(is(he.NAVIGATION_GUARD_REDIRECT,{from:t,to:g})):(r&&n.enterCallbacks[i]===r&&typeof g=="function"&&r.push(g),l())},c=o(()=>e.call(n&&n.instances[i],t,s,d));let p=Promise.resolve(c);e.length<3&&(p=p.then(d)),p.catch(g=>a(g))})}function xn(e,t,s,n,i=o=>o()){const o=[];for(const r of e)for(const l in r.components){let a=r.components[l];if(!(t!=="beforeRouteEnter"&&!r.instances[l]))if(Rr(a)){const d=(a.__vccOpts||a)[t];d&&o.push(wt(d,s,n,r,l,i))}else{let d=a();o.push(()=>d.then(c=>{if(!c)throw new Error(`Couldn't resolve component "${l}" at "${r.path}"`);const p=mc(c)?c.default:c;r.mods[l]=c,r.components[l]=p;const g=(p.__vccOpts||p)[t];return g&&wt(g,s,n,r,l,i)()}))}}return o}function Jc(e,t){const s=[],n=[],i=[],o=Math.max(t.matched.length,e.matched.length);for(let r=0;r<o;r++){const l=t.matched[r];l&&(e.matched.find(d=>os(d,l))?n.push(l):s.push(l));const a=e.matched[r];a&&(t.matched.find(d=>os(d,a))||i.push(a))}return[s,n,i]}let Qc=()=>location.protocol+"//"+location.host;function Lr(e,t){const{pathname:s,search:n,hash:i}=t,o=e.indexOf("#");if(o>-1){let r=i.includes(e.slice(o))?e.slice(o).length:1,l=i.slice(r);return l[0]!=="/"&&(l="/"+l),Qi(l,"")}return Qi(s,e)+n+i}function Yc(e,t,s,n){let i=[],o=[],r=null;const l=({state:g})=>{const h=Lr(e,location),C=s.value,E=t.value;let M=0;if(g){if(s.value=h,t.value=g,r&&r===C){r=null;return}M=E?g.position-E.position:0}else n(h);i.forEach(w=>{w(s.value,C,{delta:M,type:Bn.pop,direction:M?M>0?Cn.forward:Cn.back:Cn.unknown})})};function a(){r=s.value}function d(g){i.push(g);const h=()=>{const C=i.indexOf(g);C>-1&&i.splice(C,1)};return o.push(h),h}function c(){if(document.visibilityState==="hidden"){const{history:g}=window;if(!g.state)return;g.replaceState(ie({},g.state,{scroll:an()}),"")}}function p(){for(const g of o)g();o=[],window.removeEventListener("popstate",l),window.removeEventListener("pagehide",c),document.removeEventListener("visibilitychange",c)}return window.addEventListener("popstate",l),window.addEventListener("pagehide",c),document.addEventListener("visibilitychange",c),{pauseListeners:a,listen:d,destroy:p}}function to(e,t,s,n=!1,i=!1){return{back:e,current:t,forward:s,replaced:n,position:window.history.length,scroll:i?an():null}}function Zc(e){const{history:t,location:s}=window,n={value:Lr(e,s)},i={value:t.state};i.value||o(n.value,{back:null,current:n.value,forward:null,position:t.length-1,replaced:!0,scroll:null},!0);function o(a,d,c){const p=e.indexOf("#"),g=p>-1?(s.host&&document.querySelector("base")?e:e.slice(p))+a:Qc()+e+a;try{t[c?"replaceState":"pushState"](d,"",g),i.value=d}catch(h){console.error(h),s[c?"replace":"assign"](g)}}function r(a,d){o(a,ie({},t.state,to(i.value.back,a,i.value.forward,!0),d,{position:i.value.position}),!0),n.value=a}function l(a,d){const c=ie({},i.value,t.state,{forward:a,scroll:an()});o(c.current,c,!0),o(a,ie({},to(n.value,a,null),{position:c.position+1},d),!1),n.value=a}return{location:n,state:i,push:l,replace:r}}function ep(e){e=Bc(e);const t=Zc(e),s=Yc(e,t.state,t.location,t.replace);function n(o,r=!0){r||s.pauseListeners(),history.go(o)}const i=ie({location:"",base:e,go:n,createHref:Hc.bind(null,e)},t,s);return Object.defineProperty(i,"location",{enumerable:!0,get:()=>t.location.value}),Object.defineProperty(i,"state",{enumerable:!0,get:()=>t.state.value}),i}function tp(e){return e=location.host?e||location.pathname+location.search:"",e.includes("#")||(e+="#"),ep(e)}let Nt=(function(e){return e[e.Static=0]="Static",e[e.Param=1]="Param",e[e.Group=2]="Group",e})({});var be=(function(e){return e[e.Static=0]="Static",e[e.Param=1]="Param",e[e.ParamRegExp=2]="ParamRegExp",e[e.ParamRegExpEnd=3]="ParamRegExpEnd",e[e.EscapeNext=4]="EscapeNext",e})(be||{});const sp={type:Nt.Static,value:""},np=/[a-zA-Z0-9_]/;function ip(e){if(!e)return[[]];if(e==="/")return[[sp]];if(!e.startsWith("/"))throw new Error(`Invalid path "${e}"`);function t(h){throw new Error(`ERR (${s})/"${d}": ${h}`)}let s=be.Static,n=s;const i=[];let o;function r(){o&&i.push(o),o=[]}let l=0,a,d="",c="";function p(){d&&(s===be.Static?o.push({type:Nt.Static,value:d}):s===be.Param||s===be.ParamRegExp||s===be.ParamRegExpEnd?(o.length>1&&(a==="*"||a==="+")&&t(`A repeatable param (${d}) must be alone in its segment. eg: '/:ids+.`),o.push({type:Nt.Param,value:d,regexp:c,repeatable:a==="*"||a==="+",optional:a==="*"||a==="?"})):t("Invalid state to consume buffer"),d="")}function g(){d+=a}for(;l<e.length;){if(a=e[l++],a==="\\"&&s!==be.ParamRegExp){n=s,s=be.EscapeNext;continue}switch(s){case be.Static:a==="/"?(d&&p(),r()):a===":"?(p(),s=be.Param):g();break;case be.EscapeNext:g(),s=n;break;case be.Param:a==="("?s=be.ParamRegExp:np.test(a)?g():(p(),s=be.Static,a!=="*"&&a!=="?"&&a!=="+"&&l--);break;case be.ParamRegExp:a===")"?c[c.length-1]=="\\"?c=c.slice(0,-1)+a:s=be.ParamRegExpEnd:c+=a;break;case be.ParamRegExpEnd:p(),s=be.Static,a!=="*"&&a!=="?"&&a!=="+"&&l--,c="";break;default:t("Unknown state");break}}return s===be.ParamRegExp&&t(`Unfinished custom RegExp for param "${d}"`),p(),r(),i}const so="[^/]+?",op={sensitive:!1,strict:!1,start:!0,end:!0};var Re=(function(e){return e[e._multiplier=10]="_multiplier",e[e.Root=90]="Root",e[e.Segment=40]="Segment",e[e.SubSegment=30]="SubSegment",e[e.Static=40]="Static",e[e.Dynamic=20]="Dynamic",e[e.BonusCustomRegExp=10]="BonusCustomRegExp",e[e.BonusWildcard=-50]="BonusWildcard",e[e.BonusRepeatable=-20]="BonusRepeatable",e[e.BonusOptional=-8]="BonusOptional",e[e.BonusStrict=.7000000000000001]="BonusStrict",e[e.BonusCaseSensitive=.25]="BonusCaseSensitive",e})(Re||{});const rp=/[.+*?^${}()[\]/\\]/g;function lp(e,t){const s=ie({},op,t),n=[];let i=s.start?"^":"";const o=[];for(const d of e){const c=d.length?[]:[Re.Root];s.strict&&!d.length&&(i+="/");for(let p=0;p<d.length;p++){const g=d[p];let h=Re.Segment+(s.sensitive?Re.BonusCaseSensitive:0);if(g.type===Nt.Static)p||(i+="/"),i+=g.value.replace(rp,"\\$&"),h+=Re.Static;else if(g.type===Nt.Param){const{value:C,repeatable:E,optional:M,regexp:w}=g;o.push({name:C,repeatable:E,optional:M});const x=w||so;if(x!==so){h+=Re.BonusCustomRegExp;try{new RegExp(`(${x})`)}catch(j){throw new Error(`Invalid custom RegExp for param "${C}" (${x}): `+j.message)}}let k=E?`((?:${x})(?:/(?:${x}))*)`:`(${x})`;p||(k=M&&d.length<2?`(?:/${k})`:"/"+k),M&&(k+="?"),i+=k,h+=Re.Dynamic,M&&(h+=Re.BonusOptional),E&&(h+=Re.BonusRepeatable),x===".*"&&(h+=Re.BonusWildcard)}c.push(h)}n.push(c)}if(s.strict&&s.end){const d=n.length-1;n[d][n[d].length-1]+=Re.BonusStrict}s.strict||(i+="/?"),s.end?i+="$":s.strict&&!i.endsWith("/")&&(i+="(?:/|$)");const r=new RegExp(i,s.sensitive?"":"i");function l(d){const c=d.match(r),p={};if(!c)return null;for(let g=1;g<c.length;g++){const h=c[g]||"",C=o[g-1];p[C.name]=h&&C.repeatable?h.split("/"):h}return p}function a(d){let c="",p=!1;for(const g of e){(!p||!c.endsWith("/"))&&(c+="/"),p=!1;for(const h of g)if(h.type===Nt.Static)c+=h.value;else if(h.type===Nt.Param){const{value:C,repeatable:E,optional:M}=h,w=C in d?d[C]:"";if(Je(w)&&!E)throw new Error(`Provided param "${C}" is an array but it is not repeatable (* or + modifiers)`);const x=Je(w)?w.join("/"):w;if(!x)if(M)g.length<2&&(c.endsWith("/")?c=c.slice(0,-1):p=!0);else throw new Error(`Missing required param "${C}"`);c+=x}}return c||"/"}return{re:r,score:n,keys:o,parse:l,stringify:a}}function ap(e,t){let s=0;for(;s<e.length&&s<t.length;){const n=t[s]-e[s];if(n)return n;s++}return e.length<t.length?e.length===1&&e[0]===Re.Static+Re.Segment?-1:1:e.length>t.length?t.length===1&&t[0]===Re.Static+Re.Segment?1:-1:0}function Br(e,t){let s=0;const n=e.score,i=t.score;for(;s<n.length&&s<i.length;){const o=ap(n[s],i[s]);if(o)return o;s++}if(Math.abs(i.length-n.length)===1){if(no(n))return 1;if(no(i))return-1}return i.length-n.length}function no(e){const t=e[e.length-1];return e.length>0&&t[t.length-1]<0}const cp={strict:!1,end:!0,sensitive:!1};function pp(e,t,s){const n=lp(ip(e.path),s),i=ie(n,{record:e,parent:t,children:[],alias:[]});return t&&!i.record.aliasOf==!t.record.aliasOf&&t.children.push(i),i}function up(e,t){const s=[],n=new Map;t=zi(cp,t);function i(p){return n.get(p)}function o(p,g,h){const C=!h,E=oo(p);E.aliasOf=h&&h.record;const M=zi(t,p),w=[E];if("alias"in p){const j=typeof p.alias=="string"?[p.alias]:p.alias;for(const q of j)w.push(oo(ie({},E,{components:h?h.record.components:E.components,path:q,aliasOf:h?h.record:E})))}let x,k;for(const j of w){const{path:q}=j;if(g&&q[0]!=="/"){const Z=g.record.path,Y=Z[Z.length-1]==="/"?"":"/";j.path=g.record.path+(q&&Y+q)}if(x=pp(j,g,M),h?h.alias.push(x):(k=k||x,k!==x&&k.alias.push(x),C&&p.name&&!ro(x)&&r(p.name)),Fr(x)&&a(x),E.children){const Z=E.children;for(let Y=0;Y<Z.length;Y++)o(Z[Y],x,h&&h.children[Y])}h=h||x}return k?()=>{r(k)}:bs}function r(p){if(Ur(p)){const g=n.get(p);g&&(n.delete(p),s.splice(s.indexOf(g),1),g.children.forEach(r),g.alias.forEach(r))}else{const g=s.indexOf(p);g>-1&&(s.splice(g,1),p.record.name&&n.delete(p.record.name),p.children.forEach(r),p.alias.forEach(r))}}function l(){return s}function a(p){const g=gp(p,s);s.splice(g,0,p),p.record.name&&!ro(p)&&n.set(p.record.name,p)}function d(p,g){let h,C={},E,M;if("name"in p&&p.name){if(h=n.get(p.name),!h)throw is(he.MATCHER_NOT_FOUND,{location:p});M=h.record.name,C=ie(io(g.params,h.keys.filter(k=>!k.optional).concat(h.parent?h.parent.keys.filter(k=>k.optional):[]).map(k=>k.name)),p.params&&io(p.params,h.keys.map(k=>k.name))),E=h.stringify(C)}else if(p.path!=null)E=p.path,h=s.find(k=>k.re.test(E)),h&&(C=h.parse(E),M=h.record.name);else{if(h=g.name?n.get(g.name):s.find(k=>k.re.test(g.path)),!h)throw is(he.MATCHER_NOT_FOUND,{location:p,currentLocation:g});M=h.record.name,C=ie({},g.params,p.params),E=h.stringify(C)}const w=[];let x=h;for(;x;)w.unshift(x.record),x=x.parent;return{name:M,path:E,params:C,matched:w,meta:fp(w)}}e.forEach(p=>o(p));function c(){s.length=0,n.clear()}return{addRoute:o,resolve:d,removeRoute:r,clearRoutes:c,getRoutes:l,getRecordMatcher:i}}function io(e,t){const s={};for(const n of t)n in e&&(s[n]=e[n]);return s}function oo(e){const t={path:e.path,redirect:e.redirect,name:e.name,meta:e.meta||{},aliasOf:e.aliasOf,beforeEnter:e.beforeEnter,props:dp(e),children:e.children||[],instances:{},leaveGuards:new Set,updateGuards:new Set,enterCallbacks:{},components:"components"in e?e.components||null:e.component&&{default:e.component}};return Object.defineProperty(t,"mods",{value:{}}),t}function dp(e){const t={},s=e.props||!1;if("component"in e)t.default=s;else for(const n in e.components)t[n]=typeof s=="object"?s[n]:s;return t}function ro(e){for(;e;){if(e.record.aliasOf)return!0;e=e.parent}return!1}function fp(e){return e.reduce((t,s)=>ie(t,s.meta),{})}function gp(e,t){let s=0,n=t.length;for(;s!==n;){const o=s+n>>1;Br(e,t[o])<0?n=o:s=o+1}const i=hp(e);return i&&(n=t.lastIndexOf(i,n-1)),n}function hp(e){let t=e;for(;t=t.parent;)if(Fr(t)&&Br(e,t)===0)return t}function Fr({record:e}){return!!(e.name||e.components&&Object.keys(e.components).length||e.redirect)}function lo(e){const t=ct(ri),s=ct(li),n=Me(()=>{const a=Ee(e.to);return t.resolve(a)}),i=Me(()=>{const{matched:a}=n.value,{length:d}=a,c=a[d-1],p=s.matched;if(!c||!p.length)return-1;const g=p.findIndex(os.bind(null,c));if(g>-1)return g;const h=ao(a[d-2]);return d>1&&ao(c)===h&&p[p.length-1].path!==h?p.findIndex(os.bind(null,a[d-2])):g}),o=Me(()=>i.value>-1&&bp(s.params,n.value.params)),r=Me(()=>i.value>-1&&i.value===s.matched.length-1&&Nr(s.params,n.value.params));function l(a={}){if(vp(a)){const d=t[Ee(e.replace)?"replace":"push"](Ee(e.to)).catch(bs);return e.viewTransition&&typeof document<"u"&&"startViewTransition"in document&&document.startViewTransition(()=>d),d}return Promise.resolve()}return{route:n,href:Me(()=>n.value.href),isActive:o,isExactActive:r,navigate:l}}function _p(e){return e.length===1?e[0]:e}const mp=Qo({name:"RouterLink",compatConfig:{MODE:3},props:{to:{type:[String,Object],required:!0},replace:Boolean,activeClass:String,exactActiveClass:String,custom:Boolean,ariaCurrentValue:{type:String,default:"page"},viewTransition:Boolean},useLink:lo,setup(e,{slots:t}){const s=tn(lo(e)),{options:n}=ct(ri),i=Me(()=>({[co(e.activeClass,n.linkActiveClass,"router-link-active")]:s.isActive,[co(e.exactActiveClass,n.linkExactActiveClass,"router-link-exact-active")]:s.isExactActive}));return()=>{const o=t.default&&_p(t.default(s));return e.custom?o:oi("a",{"aria-current":s.isExactActive?e.ariaCurrentValue:null,href:s.href,onClick:s.navigate,class:i.value},o)}}}),Jt=mp;function vp(e){if(!(e.metaKey||e.altKey||e.ctrlKey||e.shiftKey)&&!e.defaultPrevented&&!(e.button!==void 0&&e.button!==0)){if(e.currentTarget&&e.currentTarget.getAttribute){const t=e.currentTarget.getAttribute("target");if(/\b_blank\b/i.test(t))return}return e.preventDefault&&e.preventDefault(),!0}}function bp(e,t){for(const s in t){const n=t[s],i=e[s];if(typeof n=="string"){if(n!==i)return!1}else if(!Je(i)||i.length!==n.length||n.some((o,r)=>o.valueOf()!==i[r].valueOf()))return!1}return!0}function ao(e){return e?e.aliasOf?e.aliasOf.path:e.path:""}const co=(e,t,s)=>e??t??s,yp=Qo({name:"RouterView",inheritAttrs:!1,props:{name:{type:String,default:"default"},route:Object},compatConfig:{MODE:3},setup(e,{attrs:t,slots:s}){const n=ct(Un),i=Me(()=>e.route||n.value),o=ct(Ji,0),r=Me(()=>{let d=Ee(o);const{matched:c}=i.value;let p;for(;(p=c[d])&&!p.components;)d++;return d}),l=Me(()=>i.value.matched[r.value]);$s(Ji,Me(()=>r.value+1)),$s(yc,l),$s(Un,i);const a=ke();return Bt(()=>[a.value,l.value,e.name],([d,c,p],[g,h,C])=>{c&&(c.instances[p]=d,h&&h!==c&&d&&d===g&&(c.leaveGuards.size||(c.leaveGuards=h.leaveGuards),c.updateGuards.size||(c.updateGuards=h.updateGuards))),d&&c&&(!h||!os(c,h)||!g)&&(c.enterCallbacks[p]||[]).forEach(E=>E(d))},{flush:"post"}),()=>{const d=i.value,c=e.name,p=l.value,g=p&&p.components[c];if(!g)return po(s.default,{Component:g,route:d});const h=p.props[c],C=h?h===!0?d.params:typeof h=="function"?h(d):h:null,M=oi(g,ie({},C,t,{onVnodeUnmounted:w=>{w.component.isUnmounted&&(p.instances[c]=null)},ref:a}));return po(s.default,{Component:M,route:d})||M}}});function po(e,t){if(!e)return null;const s=e(t);return s.length===1?s[0]:s}const Ap=yp;function Sp(e){const t=up(e.routes,e),s=e.parseQuery||Xc,n=e.stringifyQuery||eo,i=e.history,o=ps(),r=ps(),l=ps(),a=El(xt);let d=xt;zt&&e.scrollBehavior&&"scrollRestoration"in history&&(history.scrollRestoration="manual");const c=Sn.bind(null,y=>""+y),p=Sn.bind(null,Mc),g=Sn.bind(null,Ps);function h(y,D){let T,U;return Ur(y)?(T=t.getRecordMatcher(y),U=D):U=y,t.addRoute(U,T)}function C(y){const D=t.getRecordMatcher(y);D&&t.removeRoute(D)}function E(){return t.getRoutes().map(y=>y.record)}function M(y){return!!t.getRecordMatcher(y)}function w(y,D){if(D=ie({},D||a.value),typeof y=="string"){const _=En(s,y,D.path),v=t.resolve({path:_.path},D),A=i.createHref(_.fullPath);return ie(_,v,{params:g(v.params),hash:Ps(_.hash),redirectedFrom:void 0,href:A})}let T;if(y.path!=null)T=ie({},y,{path:En(s,y.path,D.path).path});else{const _=ie({},y.params);for(const v in _)_[v]==null&&delete _[v];T=ie({},y,{params:p(_)}),D.params=p(D.params)}const U=t.resolve(T,D),J=y.hash||"";U.params=c(g(U.params));const u=Dc(n,ie({},y,{hash:Tc(J),path:U.path})),f=i.createHref(u);return ie({fullPath:u,hash:J,query:n===eo?zc(y.query):y.query||{}},U,{redirectedFrom:void 0,href:f})}function x(y){return typeof y=="string"?En(s,y,a.value.path):ie({},y)}function k(y,D){if(d!==y)return is(he.NAVIGATION_CANCELLED,{from:D,to:y})}function j(y){return Y(y)}function q(y){return j(ie(x(y),{replace:!0}))}function Z(y,D){const T=y.matched[y.matched.length-1];if(T&&T.redirect){const{redirect:U}=T;let J=typeof U=="function"?U(y,D):U;return typeof J=="string"&&(J=J.includes("?")||J.includes("#")?J=x(J):{path:J},J.params={}),ie({query:y.query,hash:y.hash,params:J.path!=null?{}:y.params},J)}}function Y(y,D){const T=d=w(y),U=a.value,J=y.state,u=y.force,f=y.replace===!0,_=Z(T,U);if(_)return Y(ie(x(_),{state:typeof _=="object"?ie({},J,_.state):J,force:u,replace:f}),D||T);const v=T;v.redirectedFrom=D;let A;return!u&&Nc(n,U,T)&&(A=is(he.NAVIGATION_DUPLICATED,{to:v,from:U}),Qe(U,U,!0,!1)),(A?Promise.resolve(A):z(v,U)).catch(b=>gt(b)?gt(b,he.NAVIGATION_GUARD_REDIRECT)?b:Et(b):ne(b,v,U)).then(b=>{if(b){if(gt(b,he.NAVIGATION_GUARD_REDIRECT))return Y(ie({replace:f},x(b.to),{state:typeof b.to=="object"?ie({},J,b.to.state):J,force:u}),D||v)}else b=$(v,U,!0,f,J);return le(v,U,b),b})}function Ae(y,D){const T=k(y,D);return T?Promise.reject(T):Promise.resolve()}function V(y){const D=qt.values().next().value;return D&&typeof D.runWithContext=="function"?D.runWithContext(y):y()}function z(y,D){let T;const[U,J,u]=Jc(y,D);T=xn(U.reverse(),"beforeRouteLeave",y,D);for(const _ of U)_.leaveGuards.forEach(v=>{T.push(wt(v,y,D))});const f=Ae.bind(null,y,D);return T.push(f),He(T).then(()=>{T=[];for(const _ of o.list())T.push(wt(_,y,D));return T.push(f),He(T)}).then(()=>{T=xn(J,"beforeRouteUpdate",y,D);for(const _ of J)_.updateGuards.forEach(v=>{T.push(wt(v,y,D))});return T.push(f),He(T)}).then(()=>{T=[];for(const _ of u)if(_.beforeEnter)if(Je(_.beforeEnter))for(const v of _.beforeEnter)T.push(wt(v,y,D));else T.push(wt(_.beforeEnter,y,D));return T.push(f),He(T)}).then(()=>(y.matched.forEach(_=>_.enterCallbacks={}),T=xn(u,"beforeRouteEnter",y,D,V),T.push(f),He(T))).then(()=>{T=[];for(const _ of r.list())T.push(wt(_,y,D));return T.push(f),He(T)}).catch(_=>gt(_,he.NAVIGATION_CANCELLED)?_:Promise.reject(_))}function le(y,D,T){l.list().forEach(U=>V(()=>U(y,D,T)))}function $(y,D,T,U,J){const u=k(y,D);if(u)return u;const f=D===xt,_=zt?history.state:{};T&&(U||f?i.replace(y.fullPath,ie({scroll:f&&_&&_.scroll},J)):i.push(y.fullPath,J)),a.value=y,Qe(y,D,T,f),Et()}let se;function Se(){se||(se=i.listen((y,D,T)=>{if(!Tt.listening)return;const U=w(y),J=Z(U,Tt.currentRoute.value);if(J){Y(ie(J,{replace:!0,force:!0}),U).catch(bs);return}d=U;const u=a.value;zt&&Wc(Zi(u.fullPath,T.delta),an()),z(U,u).catch(f=>gt(f,he.NAVIGATION_ABORTED|he.NAVIGATION_CANCELLED)?f:gt(f,he.NAVIGATION_GUARD_REDIRECT)?(Y(ie(x(f.to),{force:!0}),U).then(_=>{gt(_,he.NAVIGATION_ABORTED|he.NAVIGATION_DUPLICATED)&&!T.delta&&T.type===Bn.pop&&i.go(-1,!1)}).catch(bs),Promise.reject()):(T.delta&&i.go(-T.delta,!1),ne(f,U,u))).then(f=>{f=f||$(U,u,!1),f&&(T.delta&&!gt(f,he.NAVIGATION_CANCELLED)?i.go(-T.delta,!1):T.type===Bn.pop&&gt(f,he.NAVIGATION_ABORTED|he.NAVIGATION_DUPLICATED)&&i.go(-1,!1)),le(U,u,f)}).catch(bs)}))}let Le=ps(),me=ps(),ae;function ne(y,D,T){Et(y);const U=me.list();return U.length?U.forEach(J=>J(y,D,T)):console.error(y),Promise.reject(y)}function ut(){return ae&&a.value!==xt?Promise.resolve():new Promise((y,D)=>{Le.add([y,D])})}function Et(y){return ae||(ae=!y,Se(),Le.list().forEach(([D,T])=>y?T(y):D()),Le.reset()),y}function Qe(y,D,T,U){const{scrollBehavior:J}=e;if(!zt||!J)return Promise.resolve();const u=!T&&qc(Zi(y.fullPath,0))||(U||!T)&&history.state&&history.state.scroll||null;return ns().then(()=>J(y,D,u)).then(f=>f&&Kc(f)).catch(f=>ne(f,y,D))}const De=y=>i.go(y);let Wt;const qt=new Set,Tt={currentRoute:a,listening:!0,addRoute:h,removeRoute:C,clearRoutes:t.clearRoutes,hasRoute:M,getRoutes:E,resolve:w,options:e,push:j,replace:q,go:De,back:()=>De(-1),forward:()=>De(1),beforeEach:o.add,beforeResolve:r.add,afterEach:l.add,onError:me.add,isReady:ut,install(y){y.component("RouterLink",Jt),y.component("RouterView",Ap),y.config.globalProperties.$router=Tt,Object.defineProperty(y.config.globalProperties,"$route",{enumerable:!0,get:()=>Ee(a)}),zt&&!Wt&&a.value===xt&&(Wt=!0,j(i.location).catch(U=>{}));const D={};for(const U in xt)Object.defineProperty(D,U,{get:()=>a.value[U],enumerable:!0});y.provide(ri,Tt),y.provide(li,$o(D)),y.provide(Un,a);const T=y.unmount;qt.add(y),y.unmount=function(){qt.delete(y),qt.size<1&&(d=xt,se&&se(),se=null,a.value=xt,Wt=!1,ae=!1),T()}}};function He(y){return y.reduce((D,T)=>D.then(()=>V(T)),Promise.resolve())}return Tt}const Ep={class:"header"},Cp={class:"container header__inner"},xp=["aria-expanded"],Ip={__name:"Header",setup(e){const t=ke(!1),s=()=>{t.value=!t.value},n=()=>{t.value=!1};return Bt(t,i=>{document.body.style.overflow=i?"hidden":""}),(i,o)=>(N(),B("header",Ep,[m("div",Cp,[X(Ee(Jt),{to:"/",class:"header__logo",onClick:n},{default:fe(()=>[...o[0]||(o[0]=[Oe(" Nomis ",-1)])]),_:1}),m("nav",{class:We(["header__nav",{"header__nav--open":t.value}])},[X(Ee(Jt),{to:"/",class:"header__nav-link",onClick:n},{default:fe(()=>[...o[1]||(o[1]=[Oe("Home",-1)])]),_:1}),X(Ee(Jt),{to:"/projects",class:"header__nav-link",onClick:n},{default:fe(()=>[...o[2]||(o[2]=[Oe("Projects",-1)])]),_:1}),X(Ee(Jt),{to:"/leadership",class:"header__nav-link",onClick:n},{default:fe(()=>[...o[3]||(o[3]=[Oe("Leadership",-1)])]),_:1}),X(Ee(Jt),{to:"/about",class:"header__nav-link",onClick:n},{default:fe(()=>[...o[4]||(o[4]=[Oe("About",-1)])]),_:1}),m("a",{href:"/resume.pdf",target:"_blank",class:"header__nav-link header__nav-link--resume",onClick:n},"Resume")],2),m("button",{class:We(["header__hamburger",{"header__hamburger--open":t.value}]),onClick:s,"aria-expanded":t.value},[...o[5]||(o[5]=[m("span",null,null,-1),m("span",null,null,-1),m("span",null,null,-1)])],10,xp)])]))}},cn=(e,t)=>{const s=e.__vccOpts||e;for(const[n,i]of t)s[n]=i;return s},wp={},Pp={class:"footer"};function Rp(e,t){return N(),B("footer",Pp,[...t[0]||(t[0]=[m("div",{class:"container footer__inner"},[m("p",{class:"footer__copy"},"© 2026 Nomis. All rights reserved."),m("a",{href:"mailto:nomis820710@gmail.com",class:"footer__email"},"nomis820710@gmail.com")],-1)])])}const Tp=cn(wp,[["render",Rp]]),jp={__name:"BackToTop",setup(e){const t=ke(!1),s=()=>{t.value=window.scrollY>400},n=()=>{window.scrollTo({top:0,behavior:"smooth"})};return Ht(()=>window.addEventListener("scroll",s)),Vt(()=>window.removeEventListener("scroll",s)),(i,o)=>(N(),B("button",{class:We(["back-to-top",{"back-to-top--visible":t.value}]),onClick:n,"aria-label":"回到頂部"},[...o[0]||(o[0]=[m("i",{class:"fa-solid fa-arrow-up"},null,-1)])],2))}},Op={__name:"App",setup(e){return(t,s)=>{const n=Kt("RouterView");return N(),B(Q,null,[X(Ip),m("main",null,[X(n,null,{default:fe(({Component:i})=>[X(Ha,{name:"fade",mode:"out-in"},{default:fe(()=>[(N(),At(Jl(i)))]),_:2},1024)]),_:1})]),X(Tp),X(jp)],64)}}},Mp=cn(Op,[["__scopeId","data-v-91c92250"]]),kp="/portfolio/images/general/hero-photo.jpg",$p="/portfolio/images/general/avatar-chen.jpg",Dp="/portfolio/images/general/avatar-liao.jpg";function lt(e){return"/portfolio/"+e.replace(/^\//,"")}const Np={class:"project-card__cover"},Up=["src","alt"],Lp={class:"project-card__body"},Bp={class:"project-card__hashtags"},Fp={class:"project-card__title"},Hp={class:"project-card__desc"},Vp={class:"project-card__tags"},Kp={__name:"ProjectCard",props:{project:{type:Object,required:!0}},setup(e){return(t,s)=>{const n=Kt("RouterLink");return N(),At(n,{to:`/projects/${e.project.id}`,class:"project-card"},{default:fe(()=>[m("div",Np,[m("img",{src:Ee(lt)(e.project.cover),alt:e.project.title},null,8,Up)]),m("div",Lp,[m("div",Bp,[(N(!0),B(Q,null,ge(e.project.hashtags,i=>(N(),B("span",{key:i,class:"project-card__hashtag"}," #"+G(i),1))),128))]),m("h3",Fp,G(e.project.title),1),m("p",Hp,G(e.project.description),1),m("div",Vp,[(N(!0),B(Q,null,ge(e.project.tags,i=>(N(),B("span",{key:i,class:"project-card__tag"},G(i),1))),128))])]),s[0]||(s[0]=m("div",{class:"project-card__cta"}," 查看專案 → ",-1))]),_:1},8,["to"])}}},ys=[{id:"bd-portal-demo-report",title:"顛覆 Form 表單的邊界：獨立主導業務銷售工具 Demo Report 的從 0 到 1 設計",description:"業務團隊用 Xmind 整理客戶學習資訊，但心智圖輸出只是一張圖檔，資料無法被內部系統收回再利用。我在 PM 資源幾乎缺席的情況下，獨立完成 UX 研究、UI 設計、Prototype 與切版，並透過業務銷售流程的深度研究，將原始需求從「心智圖系統」重新定位為陪伴業務完整銷售旅程的數位報告工具，更首創將 Form 表單與心智圖操作邏輯融合的後台設計，讓大主管直呼「從來沒想過 Form 表單可以做成這樣」。",cover:"/images/projects/bd-portal-demo-report/cover.png",hashtags:["研究驅動設計","產品重新定位","創新互動設計"],tags:["UIUX","Research","Frontend","Cross-functional"],category:["uiux","frontend"],content:`
    <!-- 角色資訊 -->
    <div class="pd-info">
  ...
  `}],Wp={__name:"HeroCanvas",setup(e){const t=ke(null);let s=null;return Ht(()=>{const n=t.value,i=n.getContext("2d"),o=()=>{n.width=n.offsetWidth,n.height=n.offsetHeight};o(),window.addEventListener("resize",o);const l=Array.from({length:80},()=>({x:Math.random()*n.width,y:Math.random()*n.height,vx:(Math.random()-.5)*.3,vy:(Math.random()-.5)*.3,r:Math.random()*2+1}));let a=0;const d=()=>{n.width=n.offsetWidth,n.height=n.offsetHeight;const c=n.width,p=n.height;i.clearRect(0,0,c,p),a+=.005;const g=(Math.sin(a)+1)/2,h=i.createRadialGradient(c*.15,p*.5,0,c*.15,p*.5,c*.55);h.addColorStop(0,`rgba(79,142,247,${.25+g*.12})`),h.addColorStop(1,"transparent"),i.fillStyle=h,i.fillRect(0,0,c,p);const C=i.createRadialGradient(c*.85,p*.2,0,c*.85,p*.2,c*.45);C.addColorStop(0,`rgba(124,95,247,${.15+g*.1})`),C.addColorStop(1,"transparent"),i.fillStyle=C,i.fillRect(0,0,c,p);const E=i.createRadialGradient(c*.6,p*.8,0,c*.6,p*.8,c*.3);E.addColorStop(0,`rgba(79,142,247,${.08+g*.06})`),E.addColorStop(1,"transparent"),i.fillStyle=E,i.fillRect(0,0,c,p),l.forEach(w=>{w.x+=w.vx,w.y+=w.vy,(w.x<0||w.x>c)&&(w.vx*=-1),(w.y<0||w.y>p)&&(w.vy*=-1)});const M=130;for(let w=0;w<l.length;w++)for(let x=w+1;x<l.length;x++){const k=l[w].x-l[x].x,j=l[w].y-l[x].y,q=Math.sqrt(k*k+j*j);if(q<M){const Z=(1-q/M)*.35;i.beginPath(),i.moveTo(l[w].x,l[w].y),i.lineTo(l[x].x,l[x].y),i.strokeStyle=`rgba(79,142,247,${Z})`,i.lineWidth=.8,i.stroke()}}l.forEach(w=>{i.beginPath(),i.arc(w.x,w.y,w.r,0,Math.PI*2),i.fillStyle="rgba(79,142,247,0.65)",i.fill()}),s=requestAnimationFrame(d)};Vt(()=>{cancelAnimationFrame(s),window.removeEventListener("resize",o)}),d()}),(n,i)=>(N(),B("canvas",{ref_key:"canvasRef",ref:t,class:"hero-canvas"},null,512))}},qp=cn(Wp,[["__scopeId","data-v-92edd766"]]),Gp={class:"home"},Xp={class:"hero section"},zp={class:"projects-preview section"},Jp={class:"container"},Qp={class:"projects-preview__grid"},Yp={class:"projects-preview__cta"},Zp={class:"leadership-preview section"},eu={class:"container leadership-preview__inner"},tu={class:"leadership-preview__content"},su={class:"leadership-preview__articles"},nu={class:"skills section"},iu={class:"container"},ou={class:"skills__grid"},ru={class:"skills__card-title"},lu={class:"skills__card-list"},au={class:"skills__card-tags"},cu={__name:"Home",setup(e){const t=[{title:"UIUX 設計",items:["使用者研究","資訊架構","互動設計","視覺設計"],tags:[{label:"查看 UIUX 專案",link:"/projects?tag=UIUX"}]},{title:"前端切版",items:["Vue.js","HTML / CSS","RWD","SCSS"],tags:[{label:"查看切版專案",link:"/projects?tag=Frontend"}]},{title:"設計策略",items:["競品分析","A/B 測試","數據分析","設計系統"],tags:[{label:"查看相關專案",link:"/projects?tag=Growth Design"}]},{title:"設計領導",items:["團隊管理","跨部門協作","設計評審","人才培育"],tags:[{label:"閱讀 Leadership 文章",link:"/leadership"}]},{title:"AI 產品設計",items:["AI 框架制定","AI 互動設計","信任設計","Prompt 設計"],tags:[{label:"查看 AI 專案",link:"/projects?tag=AI"}]},{title:"溝通與協作",items:["利害關係人溝通","設計提案","跨文化協作","衝突處理"],tags:[{label:"閱讀 Leadership 文章",link:"/leadership"}]},{title:"使用者研究",items:["使用者訪談","易用性測試","問卷設計","研究報告"],tags:[{label:"查看研究相關專案",link:"/projects?tag=Research"}]},{title:"數據驅動設計",items:["數據判讀","A/B 測試規劃","轉換率優化","成效追蹤"],tags:[{label:"查看相關專案",link:"/projects?tag=A/B Testing"}]},{title:"成長心態",items:["快速學習","主動解決問題","接受回饋","持續優化"],tags:[{label:"閱讀我的反思文章",link:"/leadership"}]}];return(s,n)=>{const i=Kt("RouterLink");return N(),B("div",Gp,[m("section",Xp,[X(qp),n[0]||(n[0]=ts('<div class="container hero__inner"><div class="hero__content"><h1 class="hero__title">嗨，我是 Nomis！</h1><p class="hero__subtitle">UIUX 設計師・前端切版・設計主管</p><p class="hero__desc"> 我相信設計師最大的競爭力，是跨越專業邊界的能力。<br> 橫跨 UIUX、前端與設計管理，擁有人資與社會心理學背景的我，<br> 習慣用數據驗證設計決策，也具備在資源不足的情況下，仍能獨立推進專案、讓成果落地的能力。 </p><div class="hero__cta"><a href="/portfolio/resume.pdf" target="_blank" class="btn btn--primary">下載履歷</a><a href="https://www.linkedin.com/in/nomis-yang/" target="_blank" class="btn btn--secondary">LinkedIn</a><a href="mailto:nomis820710@gmail.com" class="btn btn--secondary">聯絡我</a></div></div><div class="hero__photo"><img src="'+kp+'" alt="Nomis Yang"></div></div>',1))]),n[11]||(n[11]=ts('<section class="features section"><div class="container features__grid"><div class="features__item"><h3 class="features__title">跨領域設計能力</h3><p class="features__desc"> 橫跨 UIUX 設計、前端切版與設計管理，能從使用者研究、視覺設計到程式實作一手包辦。曾在 PM 幾乎缺席的情況下獨立完成 UX 研究、UI 設計、Prototype 與切版，確保設計落地不失真。 </p></div><div class="features__item"><h3 class="features__title">數據驅動的設計決策</h3><p class="features__desc"> 習慣在設計提案前先問「這解決了什麼問題」、上線後追問「它真的有效嗎」。曾透過使用者訪談發現需求被錯誤定義，主動將產品從「心智圖系統」重新定位為陪伴完整銷售旅程的數位報告工具。 </p></div><div class="features__item"><h3 class="features__title">跨部門協作與領導</h3><p class="features__desc"> 具備帶領設計團隊的實戰經驗，善於在產品、工程與商業目標之間建立共識。曾在兩週內拆解跨部門任務、同步推進四條工作線，帶領團隊準時交付一個 PM 規劃了一個月的專案。 </p></div></div></section>',1)),m("section",zp,[m("div",Jp,[m("div",Qp,[(N(!0),B(Q,null,ge(Ee(ys).slice(0,3),o=>(N(),At(Kp,{key:o.id,project:o},null,8,["project"]))),128))]),m("div",Yp,[X(i,{to:"/projects",class:"btn btn--ghost"},{default:fe(()=>[...n[1]||(n[1]=[Oe("查看全部專案 →",-1)])]),_:1})])])]),m("section",Zp,[m("div",eu,[m("div",tu,[n[3]||(n[3]=m("p",{class:"leadership-preview__label"},"Leadership",-1)),n[4]||(n[4]=m("h2",{class:"leadership-preview__title"},"設計領導力的實踐與反思",-1)),n[5]||(n[5]=m("p",{class:"leadership-preview__desc"}," 從個人貢獻者到帶領團隊，我持續記錄在設計管理路上的觀察與學習。 包含團隊管理心得、專案決策過程、帶人的方法論，以及個人成長反思。 ",-1)),X(i,{to:"/leadership",class:"btn btn--primary"},{default:fe(()=>[...n[2]||(n[2]=[Oe(" 閱讀更多文章 → ",-1)])]),_:1})]),m("div",su,[X(i,{to:"/leadership/psychological-safety",class:"leadership-preview__article"},{default:fe(()=>[...n[6]||(n[6]=[m("p",{class:"leadership-preview__article-tag"},"帶團隊的方法論",-1),m("h4",{class:"leadership-preview__article-title"},"如何在設計評審中建立心理安全感",-1),m("p",{class:"leadership-preview__article-cta"},"閱讀文章 →",-1)])]),_:1}),X(i,{to:"/leadership/design-vs-business",class:"leadership-preview__article"},{default:fe(()=>[...n[7]||(n[7]=[m("p",{class:"leadership-preview__article-tag"},"專案決策過程",-1),m("h4",{class:"leadership-preview__article-title"},"當設計目標與商業目標衝突時，我怎麼做決定",-1),m("p",{class:"leadership-preview__article-cta"},"閱讀文章 →",-1)])]),_:1}),X(i,{to:"/leadership/designer-to-lead",class:"leadership-preview__article"},{default:fe(()=>[...n[8]||(n[8]=[m("p",{class:"leadership-preview__article-tag"},"個人成長反思",-1),m("h4",{class:"leadership-preview__article-title"},"從設計師到設計主管：角色轉換的第一年",-1),m("p",{class:"leadership-preview__article-cta"},"閱讀文章 →",-1)])]),_:1})])])]),m("section",nu,[m("div",iu,[n[9]||(n[9]=m("p",{class:"skills__label"},"How I Contribute",-1)),n[10]||(n[10]=m("h2",{class:"skills__title"},"我如何用專業技能貢獻",-1)),m("div",ou,[(N(),B(Q,null,ge(t,o=>m("div",{key:o.title,class:"skills__card"},[m("h4",ru,G(o.title),1),m("ul",lu,[(N(!0),B(Q,null,ge(o.items,r=>(N(),B("li",{key:r},G(r),1))),128))]),m("div",au,[(N(!0),B(Q,null,ge(o.tags,r=>(N(),At(i,{key:r.label,to:r.link,class:"skills__card-tag"},{default:fe(()=>[Oe(G(r.label),1)]),_:2},1032,["to"]))),128))])])),64))])])]),n[12]||(n[12]=ts('<section class="testimonials section"><div class="container"><p class="testimonials__label">Recommendations</p><h2 class="testimonials__title">他們這樣說</h2><div class="testimonials__grid"><div class="testimonials__card"><p class="testimonials__card-title">執行力與溝通能力超乎預期，對回饋保持開放</p><p class="testimonials__card-content"> Nomis 是一位充滿熱情的 UIUX 設計師，以創新思維和快速適應新挑戰的能力著稱。 她的執行速度與溝通品質持續超乎預期，是團隊中不可或缺的夥伴。 對回饋始終保持開放，持續尋求改進，對團隊的成功貢獻良多。 </p><div class="testimonials__card-author"><img src="'+$p+'" alt="陳大明" class="testimonials__card-avatar"><div><p class="testimonials__card-name">陳大明</p><p class="testimonials__card-role">2024年6月・iOS 工程師・直接主管</p></div></div></div><div class="testimonials__card"><p class="testimonials__card-title">能理解並轉化使用者需求為直覺且美觀的設計</p><p class="testimonials__card-content"> 與 Nomis 共事是非常愉快的經驗。她始終展現出理解並將使用者需求轉化為直覺且視覺吸引力設計的能力。 她的創意和解決問題的技巧在應對專案挑戰時發揮了關鍵作用。 支持性的個性與強大的溝通技巧營造了積極的協作環境，是可靠又具創新力的夥伴。 </p><div class="testimonials__card-author"><img src="'+Dp+'" alt="廖小華" class="testimonials__card-avatar"><div><p class="testimonials__card-name">廖小華</p><p class="testimonials__card-role">2024年6月・產品經理・同團隊成員</p></div></div></div></div></div></section>',1))])}}},pu={class:"project-card-h__cover"},uu=["src","alt"],du={class:"project-card-h__body"},fu={class:"project-card-h__hashtags"},gu={class:"project-card-h__title"},hu={class:"project-card-h__desc"},_u={class:"project-card-h__tags"},mu={__name:"ProjectCardHorizontal",props:{project:{type:Object,required:!0}},setup(e){return(t,s)=>{const n=Kt("RouterLink");return N(),At(n,{to:`/projects/${e.project.id}`,class:"project-card-h"},{default:fe(()=>[m("div",pu,[m("img",{src:Ee(lt)(e.project.cover),alt:e.project.title},null,8,uu)]),m("div",du,[m("div",fu,[(N(!0),B(Q,null,ge(e.project.hashtags,i=>(N(),B("span",{key:i,class:"project-card-h__hashtag"}," #"+G(i),1))),128))]),m("h3",gu,G(e.project.title),1),m("p",hu,G(e.project.description),1),m("div",_u,[(N(!0),B(Q,null,ge(e.project.tags,i=>(N(),B("span",{key:i,class:"project-card-h__tag"},G(i),1))),128))]),s[0]||(s[0]=m("div",{class:"project-card-h__cta"},"查看專案 →",-1))])]),_:1},8,["to"])}}},vu={class:"projects-page"},bu={class:"projects-list section"},yu={class:"container"},Au={class:"projects-list__filters"},Su=["onClick"],Eu={class:"projects-list__grid projects-list__grid--horizontal"},Cu={key:0,class:"projects-list__empty"},xu={__name:"Projects",setup(e){const t=["All",...new Set(ys.flatMap(i=>i.tags))],s=ke("All"),n=Me(()=>s.value==="All"?ys:ys.filter(i=>i.tags.includes(s.value)));return(i,o)=>(N(),B("div",vu,[o[0]||(o[0]=ts('<section class="projects-hero section"><div class="container"><p class="projects-hero__label">My Work</p><h1 class="projects-hero__title">Projects</h1><p class="projects-hero__desc"> 橫跨 UIUX 設計、前端切版與 AI 產品設計的實戰專案，每個專案都有可量化的成效與完整的設計思考過程。 </p></div></section>',1)),m("section",bu,[m("div",yu,[m("div",Au,[(N(),B(Q,null,ge(t,r=>m("button",{key:r,class:We(["projects-list__filter",{"projects-list__filter--active":s.value===r}]),onClick:l=>s.value=r},G(r),11,Su)),64))]),m("div",Eu,[(N(!0),B(Q,null,ge(n.value,r=>(N(),At(mu,{key:r.id,project:r},null,8,["project"]))),128))]),n.value.length===0?(N(),B("p",Cu," 目前沒有符合此分類的專案。 ")):Er("",!0)])])]))}},Iu={key:0,class:"project-detail"},wu={class:"project-detail-hero section"},Pu={class:"container"},Ru={class:"project-detail-hero__hashtags"},Tu={class:"project-detail-hero__title"},ju={class:"project-detail-hero__desc"},Ou={class:"project-detail-hero__tags"},Mu={class:"project-detail-cover"},ku={class:"container"},$u=["src","alt"],Du={class:"project-detail-content section"},Nu={class:"container project-detail-content__layout"},Uu={class:"toc-float__panel"},Lu={class:"toc-float__list"},Bu=["onClick"],Fu={class:"toc-sidebar"},Hu={class:"toc-sidebar__list"},Vu=["onClick"],Ku=["innerHTML"],Wu={class:"project-detail-nav section"},qu={class:"container"},Gu={key:1,class:"project-detail-notfound section"},Xu={class:"container"},zu={__name:"ProjectDetail",setup(e){const t=jr(),s=Me(()=>ys.find(c=>c.id===t.params.id)),n=ke([]),i=ke(""),o=ke(null),r=ke(!1),l=()=>{if(!o.value)return;const c=o.value.querySelectorAll("h2, h3");n.value=Array.from(c).map((p,g)=>{const h=`heading-${g}`;return p.id=h,{id:h,text:p.textContent,level:p.tagName}})},a=()=>{if(!o.value)return;const c=o.value.querySelectorAll("h2, h3");let p="";c.forEach(g=>{g.getBoundingClientRect().top<=350&&(p=g.id)}),i.value=p},d=c=>{const p=document.getElementById(c);p&&p.scrollIntoView({behavior:"smooth",block:"start"})};return Ht(()=>{ns(()=>{l(),window.addEventListener("scroll",a)})}),Vt(()=>{window.removeEventListener("scroll",a)}),Bt(s,()=>{ns(()=>l())}),(c,p)=>{const g=Kt("RouterLink");return s.value?(N(),B("div",Iu,[m("section",wu,[m("div",Pu,[X(g,{to:"/projects",class:"project-detail-hero__back"},{default:fe(()=>[...p[1]||(p[1]=[Oe("← 返回 Projects",-1)])]),_:1}),m("div",Ru,[(N(!0),B(Q,null,ge(s.value.hashtags,h=>(N(),B("span",{key:h,class:"project-detail-hero__hashtag"},"#"+G(h),1))),128))]),m("h1",Tu,G(s.value.title),1),m("p",ju,G(s.value.description),1),m("div",Ou,[(N(!0),B(Q,null,ge(s.value.tags,h=>(N(),B("span",{key:h,class:"project-detail-hero__tag"},G(h),1))),128))])])]),m("div",Mu,[m("div",ku,[m("img",{src:Ee(lt)(s.value.cover),alt:s.value.title,class:"project-detail-cover__img"},null,8,$u)])]),m("section",Du,[m("div",Nu,[m("div",{class:We(["toc-float",{"toc-float--open":r.value}])},[m("button",{class:"toc-float__toggle",onClick:p[0]||(p[0]=h=>r.value=!r.value),"aria-label":"目錄"},[...p[2]||(p[2]=[m("i",{class:"fa-solid fa-list"},null,-1)])]),m("div",Uu,[p[3]||(p[3]=m("p",{class:"toc-float__title"},"目錄",-1)),m("ul",Lu,[(N(!0),B(Q,null,ge(n.value,h=>(N(),B("li",{key:h.id},[m("a",{onClick:Xs(C=>{d(h.id),r.value=!1},["prevent"]),href:"#"},G(h.text),9,Bu)]))),128))])])],2),m("aside",Fu,[p[4]||(p[4]=m("p",{class:"toc-sidebar__title"},"目錄",-1)),m("ul",Hu,[(N(!0),B(Q,null,ge(n.value,h=>(N(),B("li",{key:h.id,class:"toc-sidebar__item"},[m("a",{onClick:Xs(C=>d(h.id),["prevent"]),href:"#",class:We(["toc-sidebar__link",{"toc-sidebar__link--active":i.value===h.id}])},G(h.text),11,Vu)]))),128))])]),m("div",{class:"project-detail-content__body",ref_key:"contentRef",ref:o,innerHTML:s.value.content},null,8,Ku)])]),m("section",Wu,[m("div",qu,[X(g,{to:"/projects",class:"btn btn--secondary"},{default:fe(()=>[...p[5]||(p[5]=[Oe("← 查看所有專案",-1)])]),_:1})])])])):(N(),B("div",Gu,[m("div",Xu,[p[7]||(p[7]=m("h1",null,"找不到此專案",-1)),X(g,{to:"/projects",class:"btn btn--primary"},{default:fe(()=>[...p[6]||(p[6]=[Oe("返回 Projects",-1)])]),_:1})])]))}}},Ju={class:"article-card__cover"},Qu=["src","alt"],Yu={class:"article-card__body"},Zu={class:"article-card__hashtags"},ed={class:"article-card__title"},td={class:"article-card__desc"},sd={class:"article-card__date"},nd={__name:"ArticleCard",props:{article:{type:Object,required:!0}},setup(e){return(t,s)=>{const n=Kt("RouterLink");return N(),At(n,{to:`/leadership/${e.article.id}`,class:"article-card"},{default:fe(()=>[m("div",Ju,[m("img",{src:Ee(lt)(e.article.cover),alt:e.article.title},null,8,Qu)]),m("div",Yu,[m("div",Zu,[(N(!0),B(Q,null,ge(e.article.hashtags,i=>(N(),B("span",{key:i,class:"article-card__hashtag"}," #"+G(i),1))),128))]),m("h3",ed,G(e.article.title),1),m("p",td,G(e.article.description),1),m("p",sd,G(e.article.date),1)]),s[0]||(s[0]=m("div",{class:"article-card__cta"}," 閱讀文章 → ",-1))]),_:1},8,["to"])}}},Ls=[{id:"equal-treatment-trap",title:"我以為一視同仁是公平，這機會卻差點壓垮了她",description:"把同一份標準套在每個人身上，不一定是公平，有時候是一種忽視。這篇文章分享我如何在一個新手設計師的第一個獨立 UIUX 專案中，從「太晚發現問題」到「找到適合她的工作方式」。",cover:"/images/articles/equal-treatment-trap/cover.png",hashtags:["工作拆解","因材施教","設計師成長"],tags:["個人成長反思","設計團隊管理心得","專案決策過程"],date:"2026-02-06",content:`
  ...
  `},{id:"impossible-deadline-two-weeks",title:"我們如何在兩週內，完成一個不可能的任務",description:"老闆踩死的 deadline、PM 規劃一個月才丟來的需求，但最後設計部不只準時交付，還讓我看見一件更重要的事：真正讓任務得以完成的力量，早在這個專案之前就已經存在了。",cover:"/images/articles/impossible-deadline-two-weeks/cover.png",hashtags:["任務拆解與同步推進","自主分工設計","長期信任感積累"],tags:["帶團隊的方法論","專案決策過程"],date:"2025-02-24",content:`
    ...
    <p>我何德何能，有這樣一群夥伴。</p>
  `}],id={class:"leadership-page"},od={class:"leadership-list section"},rd={class:"container"},ld={class:"leadership-list__filters"},ad=["onClick"],cd={class:"leadership-list__grid"},pd={key:0,class:"leadership-list__empty"},ud={__name:"Leadership",setup(e){const t=["All",...new Set(Ls.flatMap(i=>i.tags))],s=ke("All"),n=Me(()=>s.value==="All"?Ls:Ls.filter(i=>i.tags.includes(s.value)));return(i,o)=>(N(),B("div",id,[o[0]||(o[0]=ts('<section class="leadership-hero section"><div class="container"><p class="leadership-hero__label">My Thoughts</p><h1 class="leadership-hero__title">Leadership</h1><p class="leadership-hero__desc"> 記錄我在設計管理路上真實發生的事：那些摸索過的方法論、踩過的決策、帶人時的觀察，以及在過程中慢慢長出來的反思。 </p></div></section>',1)),m("section",od,[m("div",rd,[m("div",ld,[(N(),B(Q,null,ge(t,r=>m("button",{key:r,class:We(["leadership-list__filter",{"leadership-list__filter--active":s.value===r}]),onClick:l=>s.value=r},G(r),11,ad)),64))]),m("div",cd,[(N(!0),B(Q,null,ge(n.value,r=>(N(),At(nd,{key:r.id,article:r},null,8,["article"]))),128))]),n.value.length===0?(N(),B("p",pd," 目前沒有符合此分類的文章。 ")):Er("",!0)])])]))}},dd={key:0,class:"article-detail"},fd={class:"article-detail-hero section"},gd={class:"container"},hd={class:"article-detail-hero__hashtags"},_d={class:"article-detail-hero__title"},md={class:"article-detail-hero__desc"},vd={class:"article-detail-hero__date"},bd={class:"article-detail-cover"},yd={class:"container"},Ad=["src","alt"],Sd={class:"article-detail-content section"},Ed={class:"container article-detail-content__layout"},Cd={class:"article-toc-float__panel"},xd={class:"article-toc-float__list"},Id=["onClick"],wd={class:"article-toc-sidebar"},Pd={class:"article-toc-sidebar__list"},Rd=["onClick"],Td=["innerHTML"],jd={class:"article-detail-nav section"},Od={class:"container"},Md={key:1,class:"article-detail-notfound section"},kd={class:"container"},$d={__name:"ArticleDetail",setup(e){const t=jr(),s=Me(()=>Ls.find(c=>c.id===t.params.id)),n=ke([]),i=ke(""),o=ke(null),r=ke(!1),l=()=>{if(!o.value)return;const c=o.value.querySelectorAll("h2, h3");n.value=Array.from(c).map((p,g)=>{const h=`article-heading-${g}`;return p.id=h,{id:h,text:p.textContent,level:p.tagName}})},a=()=>{if(!o.value)return;const c=o.value.querySelectorAll("h2, h3");let p="";c.forEach(g=>{g.getBoundingClientRect().top<=350&&(p=g.id)}),i.value=p},d=c=>{const p=document.getElementById(c);p&&p.scrollIntoView({behavior:"smooth",block:"start"})};return Ht(()=>{ns(()=>{l(),window.addEventListener("scroll",a)})}),Vt(()=>{window.removeEventListener("scroll",a)}),Bt(s,()=>{ns(()=>l())}),(c,p)=>{const g=Kt("RouterLink");return s.value?(N(),B("div",dd,[m("section",fd,[m("div",gd,[X(g,{to:"/leadership",class:"article-detail-hero__back"},{default:fe(()=>[...p[1]||(p[1]=[Oe(" ← 返回 Leadership ",-1)])]),_:1}),m("div",hd,[(N(!0),B(Q,null,ge(s.value.hashtags,h=>(N(),B("span",{key:h,class:"article-detail-hero__hashtag"}," #"+G(h),1))),128))]),m("h1",_d,G(s.value.title),1),m("p",md,G(s.value.description),1),m("p",vd,G(s.value.date),1)])]),m("div",bd,[m("div",yd,[m("img",{src:Ee(lt)(s.value.cover),alt:s.value.title,class:"article-detail-cover__img"},null,8,Ad)])]),m("section",Sd,[m("div",Ed,[m("div",{class:We(["article-toc-float",{"article-toc-float--open":r.value}])},[m("button",{class:"article-toc-float__toggle",onClick:p[0]||(p[0]=h=>r.value=!r.value),"aria-label":"目錄"},[...p[2]||(p[2]=[m("i",{class:"fa-solid fa-list"},null,-1)])]),m("div",Cd,[p[3]||(p[3]=m("p",{class:"article-toc-float__title"},"目錄",-1)),m("ul",xd,[(N(!0),B(Q,null,ge(n.value,h=>(N(),B("li",{key:h.id},[m("a",{onClick:Xs(C=>{d(h.id),r.value=!1},["prevent"]),href:"#"},G(h.text),9,Id)]))),128))])])],2),m("aside",wd,[p[4]||(p[4]=m("p",{class:"article-toc-sidebar__title"},"目錄",-1)),m("ul",Pd,[(N(!0),B(Q,null,ge(n.value,h=>(N(),B("li",{key:h.id},[m("a",{onClick:Xs(C=>d(h.id),["prevent"]),href:"#",class:We(["article-toc-sidebar__link",{"article-toc-sidebar__link--active":i.value===h.id}])},G(h.text),11,Rd)]))),128))])]),m("div",{class:"article-detail-content__body",ref_key:"contentRef",ref:o,innerHTML:s.value.content},null,8,Td)])]),m("section",jd,[m("div",Od,[X(g,{to:"/leadership",class:"btn btn--secondary"},{default:fe(()=>[...p[5]||(p[5]=[Oe(" ← 查看所有文章 ",-1)])]),_:1})])])])):(N(),B("div",Md,[m("div",kd,[p[7]||(p[7]=m("h1",null,"找不到此文章",-1)),X(g,{to:"/leadership",class:"btn btn--primary"},{default:fe(()=>[...p[6]||(p[6]=[Oe("返回 Leadership",-1)])]),_:1})])]))}}},Dd={__name:"StoryCanvas",setup(e){const t=ke(null);let s=null;return Ht(()=>{const n=t.value,i=n.getContext("2d"),o=()=>{n.width=n.offsetWidth,n.height=n.offsetHeight};o(),window.addEventListener("resize",o);const r=2e3,l=800,a=()=>({x:(Math.random()-.5)*2,y:(Math.random()-.5)*2,z:Math.random()*l,pz:null}),d=Array.from({length:r},a);d.forEach(g=>{g.pz=g.z});const c=1.5,p=()=>{const g=n.width,h=n.height,C=g/2,E=h/2;i.fillStyle="rgba(10, 14, 26, 0.25)",i.fillRect(0,0,g,h),d.forEach(M=>{if(M.pz=M.z,M.z-=c,M.z<=1){Object.assign(M,a()),M.pz=M.z;return}const w=l/M.z,x=C+M.x*w*(g/2),k=E+M.y*w*(h/2),j=l/M.pz,q=C+M.x*j*(g/2),Z=E+M.y*j*(h/2),Y=1-M.z/l,Ae=Math.pow(Y,1.5),V=Math.max(.3,Y*2.2),z=i.createLinearGradient(q,Z,x,k);if(z.addColorStop(0,"rgba(100,160,255,0)"),z.addColorStop(1,`rgba(200,225,255,${Ae*.95})`),i.beginPath(),i.moveTo(q,Z),i.lineTo(x,k),i.strokeStyle=z,i.lineWidth=V,i.lineCap="round",i.stroke(),Y>.6){const le=(Y-.6)/.4;i.beginPath(),i.arc(x,k,V*1.2,0,Math.PI*2),i.fillStyle=`rgba(220,235,255,${le*.9})`,i.fill()}}),s=requestAnimationFrame(p)};Vt(()=>{cancelAnimationFrame(s),window.removeEventListener("resize",o)}),p()}),(n,i)=>(N(),B("canvas",{ref_key:"canvasRef",ref:t,class:"story-canvas"},null,512))}},Nd=cn(Dd,[["__scopeId","data-v-3f74bc40"]]),Ud={class:"about-page"},Ld={class:"about-hero section"},Bd={class:"container about-hero__inner"},Fd={class:"about-hero__image"},Hd=["src"],Vd={class:"about-experience section"},Kd={class:"container"},Wd={class:"about-experience__list"},qd={class:"about-experience__left"},Gd={class:"about-experience__period"},Xd={class:"about-experience__right"},zd={class:"about-experience__role"},Jd={class:"about-experience__company"},Qd={class:"about-experience__desc"},Yd={class:"about-story section"},Zd={class:"container"},ef={class:"about-story__timeline"},tf={class:"about-story__image"},sf=["src","alt"],nf={class:"about-story__content"},of={class:"about-story__period"},rf={class:"about-story__role"},lf={class:"about-story__tags"},af={class:"about-story__desc"},cf={__name:"About",setup(e){const t=[{period:"2023 - 現在",role:"UIUX 設計主管",company:"某某科技公司",desc:"帶領設計團隊，負責產品設計策略制定、設計系統建立與跨部門協作。"},{period:"2021 - 2023",role:"UIUX 設計師",company:"MixerBox",desc:"負責 AI 產品的 UIUX 設計，主導多項 A/B 測試，成功提升訂閱轉換率 32%+。"},{period:"2019 - 2021",role:"前端工程師暨視覺設計師",company:"某某設計公司",desc:"負責網站前端切版與視覺設計，累積跨領域的設計與開發實務經驗。"}],s=[{period:"2016 - 2018",title:"視覺設計師",image:lt("/images/general/story/story-1.jpg"),tags:["品牌視覺","平面設計","美感養成"],desc:"從最基礎的視覺語言出發，學會如何用顏色、字型、排版傳達品牌個性。這個階段讓我建立了扎實的美感基礎，也讓我開始對「設計如何影響使用者感受」產生好奇。"},{period:"2018 - 2020",title:"UI 設計師",image:lt("/images/general/story/story-2.jpg"),tags:["介面設計","設計系統","跨部門協作"],desc:"開始接觸數位產品設計，學習如何在螢幕上建立清晰的視覺層次。與工程師合作的過程中，我意識到設計不只是好看，更要能被實作，這驅動我學習前端切版。"},{period:"2020 - 2022",title:"UIUX 設計師",image:lt("/images/general/story/story-3.jpg"),tags:["使用者研究","A/B 測試","數據驅動設計"],desc:"真正走進使用者的世界。透過訪談、測試、數據分析來驗證設計決策，讓我理解「好設計」的定義不是設計師說了算，而是使用者用腳投票的結果。"},{period:"2022 - 現在",title:"設計主管",image:lt("/images/general/story/story-4.jpg"),tags:["團隊管理","設計策略","跨部門影響力"],desc:"角色轉換讓我重新定義「貢獻」的意義。從做好一個設計，到讓整個團隊都能做好設計。管理是一門全新的學問，但也是我目前覺得最有意義的挑戰。"}];return(n,i)=>(N(),B("div",Ud,[m("section",Ld,[m("div",Bd,[i[0]||(i[0]=ts('<div class="about-hero__content"><p class="about-hero__label">About Me</p><h1 class="about-hero__title">嗨，我是 Nomis！</h1><p class="about-hero__desc"> 我是一位橫跨 UIUX 設計、前端切版與設計管理的<strong>複合型設計師</strong>，同時有人資與社會心理學的跨領域背景。 </p><p class="about-hero__desc"> 在從業的過程中，我慢慢發現：<strong>好的設計不只是好看，而是能解決真實問題、在可量化的成效中被驗證。</strong>這讓我養成了一個習慣，在提案之前先問「這個設計解決了什麼問題」、在上線之後繼續追問「它真的有效嗎」。 </p><p class="about-hero__desc"> 我也走過一段跨領域的路：做過人資、讀過教育心理、寫過前端，最後在設計這個位置找到了把這些全部串起來的方法。<strong>這些看似「繞遠路」的經歷，反而成了我在設計決策與跨部門溝通上最獨特的底氣。</strong></p></div>',1)),m("div",Fd,[m("img",{src:Ee(lt)("/images/general/avatar.jpg"),alt:"Nomis",class:"about-hero__avatar"},null,8,Hd)])])]),m("section",Vd,[m("div",Kd,[i[1]||(i[1]=m("h2",{class:"about-experience__title"},"工作經驗",-1)),m("div",Wd,[(N(),B(Q,null,ge(t,o=>m("div",{key:o.company,class:"about-experience__item"},[m("div",qd,[m("p",Gd,G(o.period),1)]),m("div",Xd,[m("h3",zd,G(o.role),1),m("p",Jd,G(o.company),1),m("p",Qd,G(o.desc),1)])])),64))])])]),m("section",Yd,[X(Nd),m("div",Zd,[i[2]||(i[2]=m("p",{class:"about-story__label"},"My Story",-1)),i[3]||(i[3]=m("h2",{class:"about-story__title"},"我如何成為 UIUX 設計師暨設計主管",-1)),i[4]||(i[4]=m("p",{class:"about-story__intro"}," 我的設計之路從視覺出發，一路走向 UIUX、前端，再到帶領設計團隊。 每個階段都讓我對「設計」這件事有更深的理解。 ",-1)),m("div",ef,[(N(),B(Q,null,ge(s,o=>m("div",{class:"about-story__item",key:o.title},[m("div",tf,[m("img",{src:o.image,alt:o.title},null,8,sf)]),m("div",nf,[m("p",of,G(o.period),1),m("h3",rf,G(o.title),1),m("div",lf,[(N(!0),B(Q,null,ge(o.tags,r=>(N(),B("span",{key:r,class:"about-story__tag"},G(r),1))),128))]),m("p",af,G(o.desc),1)])])),64))])])])]))}},pf=Sp({history:tp(),routes:[{path:"/",name:"home",component:cu},{path:"/projects",name:"projects",component:xu},{path:"/projects/:id",name:"project-detail",component:zu},{path:"/leadership",name:"leadership",component:ud},{path:"/leadership/:id",name:"article-detail",component:$d},{path:"/about",name:"about",component:cf}],scrollBehavior(e,t,s){return s||{top:0}}}),Hr=gc(Mp);Hr.use(pf);Hr.mount("#app");
